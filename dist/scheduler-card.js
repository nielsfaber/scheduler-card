...
/**
  ...
  `,t([le({attribute:!1})],da.prototype,"hass",void 0),t([le()],da.prototype,"domain",void 0),t([le()],da.prototype,"config",void 0),t([le({type:Array})],da.prototype,"value",void 0),t([le({type:Boolean})],da.prototype,"multiple",void 0),t([le({type:Boolean})],da.prototype,"disabled",void 0),t([ce()],da.prototype,"multipleMode",void 0),t([ce()],da.prototype,"scheduleEntities",void 0),da=t([re("scheduler-entity-picker")],da);let la=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
    ...
    `}};t([le()],ca.prototype,"disabled",void 0),t([ce()],ca.prototype,"_openedItem",void 0),t([ce()],ca.prototype,"_numItems",void 0),ca=t([re("scheduler-collapsible-group")],ca);const ha="__NONE_OPTION__";let ua=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){var e;if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),Ts(this,"value-changed",{value:this.value})},s=()=>{let e=t.map(e=>Object({name:e,value:e}));return q`
        ...
        `)},l=e=>{let t=e.target,i=t.querySelector("ha-picker-field");this.style.setProperty("--select-menu-width",i.offsetWidth+"px"),t.classList.add("opened")},c=e=>{e.target.classList.remove("opened")},h=e=>{const t=e.detail.item.value;(t!=ha&&!Array.isArray(this.value)||(e.target.value=void 0,t!=ha))&&this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))},u=()=>{this._valueChanged(new CustomEvent("value-changed",{detail:{value:void 0}}))},m=Be(this.value)&&!Array.isArray(this.value)?n.find(e=>e.id===this.value):void 0,p=m?m.primary||m.id:Be(this.value)&&!Array.isArray(this.value)?this.value:void 0;return q`
    ...
    `}catch(e){return q`
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return q`
        ...
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){let t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return q`
          ...
          </div>`}return to(e)};return Ss(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>q`${t(e)}<br/>`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_toggleEnableDisable(e){e.stopPropagation();const t=!e.target.checked;this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:this.schedule.entity_id})}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
