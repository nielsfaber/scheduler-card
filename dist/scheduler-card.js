...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
const Da=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}{constructor(e){var t;if(super(e),e.type!==Ta||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`},"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ht){this.ht=new Set;for(const e in t)this.ht.add(e);return this.render(t)}this.ht.forEach(e=>{null==t[e]&&(this.ht.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")});for(const e in t){const a=t[e];if(null!=a){this.ht.add(e);const t="string"==typeof a&&a.endsWith(" !important");e.includes("-")||t?i.setProperty(e,t?a.slice(0,-11):a,t?"important":""):i[e]=a}}return R}}),Ma=["alarm_control_panel","binary_sensor","climate","calendar","cover","device_tracker","fan","humidifier","input_boolean","input_number","input_select","light","lock","number","person","proximity","select","sensor","sun","switch","timer","water_heater"],La=(e,t)=>{const i=Object.keys(t.states).includes(e)?t.states[e]:void 0,a=Ki(e),s=(null==i?void 0:i.attributes)||{};switch(a){case"alarm_control_panel":let e=["disarmed","triggered"];return 2&(s.supported_features||0)&&(e=[...e,"armed_away"]),1&(s.supported_features||0)&&(e=[...e,"armed_home"]),4&(s.supported_features||0)&&(e=[...e,"armed_night"]),16&(s.supported_features||0)&&(e=[...e,"armed_custom_bypass"]),32&(s.supported_features||0)&&(e=[...e,"armed_vacation"]),la({options:e,translation_key:"component.${domain}.entity_component._.state.${value}"});case"binary_sensor":return la({options:["on","off"],translation_key:"component.${domain}.entity_component.${deviceClass}.state.${value}"});case"climate":return la({options:s.hvac_modes,translation_key:"component.${domain}.entity_component._.state.${value}"});case"calendar":case"fan":case"humidifier":case"input_boolean":case"light":case"switch":return la({options:["on","off"],translation_key:"component.${domain}.entity_component._.state.${value}"});case"cover":return la({options:["open","closed"],translation_key:"component.${domain}.entity_component._.state.${value}"});case"device_tracker":return la({options:["home","not_home"],translation_key:"component.${domain}.entity_component._.state.${value}"});case"input_number":case"number":return da({min:s.min,max:s.max,step:s.step,mode:s.mode,unit_of_measurement:s.unit_of_measurement});case"input_select":case"select":return la({options:s.options});case"lock":return la({options:["locked","unlocked"],translation_key:"component.${domain}.entity_component._.state.${value}"});case"person":const a=Object.keys(t.states).filter(e=>"zone"==Ki(e)).map(Zi);return la({options:[...new Set(["home","not_home",...a])]});case"proximity":return da({mode:"box",unit_of_measurement:s.unit_of_measurement});case"sensor":return isNaN(Number(null==i?void 0:i.state))?{text:{}}:da({mode:"box",unit_of_measurement:s.unit_of_measurement});case"sun":return la({options:["above_horizon","below_horizon"],translation_key:"component.${domain}.entity_component._.state.${value}"});case"timer":return la({options:["active","paused","idle"],translation_key:"component.${domain}.entity_component._.state.${value}"});case"water_heater":case"climate":return la({options:s.operation_list,translation_key:"component.${domain}.entity_component._.state.${value}"});default:return{text:{}}}},Pa=e=>Ma.includes(e),Ia=(e,t)=>{let i=Object.keys(e.states).map(e=>Ki(e)).reduce((e,t)=>e.includes(t)?e:[...e,t],[]).filter(Pa);return i=i.filter(e=>((t.include||[]).some(t=>Ji(Ki(t),e))||Object.keys(t.customize||{}).some(t=>Ji(Ki(t),e)))&&!(t.exclude||[]).some(t=>Ji(t,e))),i.map(t=>Object({key:t,name:ea(`component.${t}.title`,e,!1)||t.replace(/_/g," "),description:"",icon:za(t)}))},Na=(e,t)=>{if(!Object.keys(t.states).includes(e))return"mdi:help";const i=t.states[e];if(i.attributes.icon)return i.attributes.icon;const a=Ki(e);return za(a)},qa=(e,t)=>{if(["script","notify"].includes(e)){let i=Object.keys(t.services[e]).map(i=>{var a;return Object({key:`${e}.${i}`,name:t.states[`${e}.${i}`]?Gi(`${e}.${i}`,null===(a=t.states[`${e}.${i}`])||void 0===a?void 0:a.attributes):t.services[e][i].name,description:"",icon:t.states[`${e}.${i}`]?Na(`${e}.${i}`,t):za(e)})});return i.sort((e,t)=>Qi(e.name,t.name)),i}{let i=Object.keys(t.states).filter(t=>Ki(t)==e).map(e=>{var i;return Object({key:e,name:Gi(e,null===(i=t.states[e])||void 0===i?void 0:i.attributes),description:"",icon:Na(e,t)})});return i.sort((e,t)=>Qi(e.name,t.name)),i}},Ra=(e,t)=>t.every(t=>e.name.toLowerCase().includes(t))||t.every(t=>e.key.toLowerCase().includes(t));let Ha=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.expandedGroups=[]}async showDialog(e){this._params=e,this.loadOptions(),await this.updateComplete}async closeDialog(){this._params&&this._params.confirm({domains:this._params.domains,entities:this._params.entities}),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}loadOptions(){let e=(e=>{let t=Ea(e,{include:["*"]}),i=Ia(e,{include:["*"]});return i=i.filter(e=>!t.map(e=>e.key).includes(e.key)),t=[...t,...i],t.sort((e,t)=>Qi(e.name,t.name)),t})(this.hass);this.options=e.map(e=>Object(Object.assign(Object.assign({},e),{entities:qa(e.key,this.hass)})))}shouldUpdate(e){return!!(e.has("_params")||e.has("expandedGroups")||e.has("_filter"))}render(){return this._params?q`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
    ...
    `}};t([de({attribute:!1})],Ha.prototype,"hass",void 0),t([ce()],Ha.prototype,"_params",void 0),t([ce()],Ha.prototype,"_search",void 0),t([ce()],Ha.prototype,"_filter",void 0),t([ce()],Ha.prototype,"_width",void 0),t([ce()],Ha.prototype,"_height",void 0),t([ce()],Ha.prototype,"expandedGroups",void 0),t([ce()],Ha.prototype,"options",void 0),Ha=t([re("dialog-select-entities")],Ha);var Va=Object.freeze({__proto__:null,get DialogSelectEntities(){return Ha}});let Fa=class extends oe{constructor(){super(...arguments),this.active=!1}render(){return q`
    ...
    `}};t([de({attribute:!1})],Fa.prototype,"hass",void 0),t([de({type:String})],Fa.prototype,"icon",void 0),t([de({type:Boolean})],Fa.prototype,"useStateIcon",void 0),t([de({type:Boolean})],Fa.prototype,"selectable",void 0),t([de({type:Boolean})],Fa.prototype,"removable",void 0),t([de({type:Boolean})],Fa.prototype,"toggleable",void 0),t([de({type:Boolean})],Fa.prototype,"active",void 0),t([de({type:String})],Fa.prototype,"badge",void 0),t([de({type:String})],Fa.prototype,"value",void 0),t([de({type:Boolean})],Fa.prototype,"disabled",void 0),Fa=t([re("scheduler-chip")],Fa);let Ba=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?q`
    ...
    `}};t([de({attribute:!1})],Ba.prototype,"hass",void 0),t([de({attribute:!1})],Ba.prototype,"items",void 0),t([de({attribute:!1})],Ba.prototype,"value",void 0),t([de({type:Boolean})],Ba.prototype,"selectable",void 0),t([de({type:Boolean})],Ba.prototype,"toggleable",void 0),t([de({type:Boolean})],Ba.prototype,"removable",void 0),t([de({type:Boolean})],Ba.prototype,"disabled",void 0),Ba=t([re("scheduler-chip-set")],Ba);let Ua=class extends oe{constructor(){super(...arguments),this.autofocus=!1,this.disabled=!1,this.hideClearIcon=!1,this._opened=!1,this._isOpening=!1,this._items=[],this._getItems=()=>{const e=(this.getItems?this.getItems():[]).sort((e,t)=>Qi(e.primary,t.primary));return e.length||e.push({id:"___no_matching_items_found___",primary:Wi("ui.dialog.entity_picker.no_results",this.hass),icon:"mdi:cancel"}),e}}shouldUpdate(e){return!!(e.has("value")||e.has("label")||e.has("disabled"))||!(!e.has("_opened")&&this._opened)}willUpdate(e){e.has("_opened")&&this._opened&&(this._items=this._getItems())}render(){const e=!!this.value&&!this.disabled&&!this.hideClearIcon;return q`
    ...
    `}get _value(){return this.value||""}_renderHelper(){return this.helper?q`<ha-input-helper-text .disabled=${this.disabled}
      ...
      `]}};t([de({attribute:!1})],Ua.prototype,"hass",void 0),t([de({type:Boolean})],Ua.prototype,"autofocus",void 0),t([de({type:Boolean})],Ua.prototype,"disabled",void 0),t([de({type:Boolean,attribute:"allow-custom-value"})],Ua.prototype,"allowCustomValue",void 0),t([de()],Ua.prototype,"label",void 0),t([de()],Ua.prototype,"value",void 0),t([de()],Ua.prototype,"helper",void 0),t([de()],Ua.prototype,"placeholder",void 0),t([de({type:String,attribute:"search-label"})],Ua.prototype,"searchLabel",void 0),t([de({attribute:"hide-clear-icon",type:Boolean})],Ua.prototype,"hideClearIcon",void 0),t([de({attribute:!1,type:Array})],Ua.prototype,"getItems",void 0),t([de({attribute:!1,type:Array})],Ua.prototype,"getAdditionalItems",void 0),t([de({attribute:!1})],Ua.prototype,"rowRenderer",void 0),t([de({attribute:!1})],Ua.prototype,"valueRenderer",void 0),t([de({attribute:"not-found-label",type:String})],Ua.prototype,"notFoundLabel",void 0),t([he(".textInput")],Ua.prototype,"_field",void 0),t([he("ha-combo-box")],Ua.prototype,"_comboBox",void 0),t([ce()],Ua.prototype,"_opened",void 0),Ua=t([re("scheduler-picker")],Ua);let Wa=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this._valueRenderer=e=>{const t=e||"",i=this.hass.states[t];if(!i)return q`
        <ha-svg-icon
          slot="start"
          .path=${Ca}
          style="margin: 0 4px"
  ...
  `,t([de({attribute:!1})],Wa.prototype,"hass",void 0),t([de()],Wa.prototype,"domain",void 0),t([de()],Wa.prototype,"config",void 0),t([de({type:Array})],Wa.prototype,"value",void 0),t([de({type:Boolean})],Wa.prototype,"multiple",void 0),t([de({type:Boolean})],Wa.prototype,"disabled",void 0),Wa=t([re("scheduler-entity-picker")],Wa);let Za=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
      <div
    ...
    `}};t([de()],Ka.prototype,"disabled",void 0),t([ce()],Ka.prototype,"_openedItem",void 0),t([ce()],Ka.prototype,"_numItems",void 0),Ka=t([re("scheduler-collapsible-group")],Ka);let Ga=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),wa(this,"value-changed",{value:this.value})},a=()=>{let e=t.map(e=>Object({name:e,value:e}));return q`
      ...
      `}if(this.config.text){this.config.text;return q`
          <ha-textfield
            ...
            ?disabled=${this.disabled}
          ></ha-textfield>      
      `}return q``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t],e.target.value=""}else if(e.detail){let t=e.detail.value;if(void 0===t)return;this.value=t}else this.value=e.target.value;wa(this,"value-changed",{value:this.value})}};Ga.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
  ...
  `,t([de({attribute:!1})],Ga.prototype,"hass",void 0),t([de({attribute:!1})],Ga.prototype,"config",void 0),t([de()],Ga.prototype,"value",void 0),t([de()],Ga.prototype,"disabled",void 0),Ga=t([re("scheduler-combo-selector")],Ga);let Ja=class extends oe{constructor(){super(...arguments),this._config=qe,this.title="",this.tagOptions=[]}setConfig(e){this._config=Object.assign(Object.assign({},qe),e)}async firstUpdated(){this.title="string"==typeof this._config.title?this._config.title:"";const e=(await xa(this.hass)).map(e=>e.name);e.sort(Qi),this.tagOptions=e}render(){const e={select:{options:this.tagOptions,multiple:!0,custom_value:!0}};return q`
  ...
  `,t([de({attribute:!1})],Ja.prototype,"hass",void 0),t([de()],Ja.prototype,"_config",void 0),t([de()],Ja.prototype,"title",void 0),t([de()],Ja.prototype,"tagOptions",void 0),Ja=t([re("scheduler-card-editor")],Ja);const Ya=r`
  ha-dialog {
...
`,(e,t,i,a)=>{var s;const o=e.service,n=null===(s=e.target)||void 0===s?void 0:s.entity_id,r=oa(e,a);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const l=r.fields[t];if(null===ca(o,n,t,i,a))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(l.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return 1==((i.states[e].attributes.supported_features||0)&l.supported_features)}))return!1}return!0});var Xa;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(Xa||(Xa={}));const es=(e,t,i)=>{let a=[];a=[...a,...e.entries.map(e=>((e,t)=>e.every((i,a)=>{const s=ze(i.start,t),o=void 0===i.stop?s:ze(i.stop,t)||86400;return!(s>o)&&e.every((e,i)=>{if(i<=a)return!0;return ze(e.start,t)>=o})})?null:Xa.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let s=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return s.length||(a=[...a,Xa.MissingAction]),a=[...a,...s.map(e=>((e,t,i)=>{var a;const s=oa(e,i);return(null==s?void 0:s.target)&&!(null===(a=e.target)||void 0===a?void 0:a.entity_id)?Xa.MissingTargetEntity:(null==s?void 0:s.fields)&&!Object.entries(s.fields).filter(([a])=>Qa(e,a,t,i)).every(([t,i])=>!(!Object.keys(e.service_data).includes(t)&&!i.optional))?Xa.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],a.length?a.shift():null},ts=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(is),timeslots:e.entries[0].slots.map(as),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},is=e=>{switch(e){case _e.Monday:return"mon";case _e.Tuesday:return"tue";case _e.Wednesday:return"wed";case _e.Thursday:return"thu";case _e.Friday:return"fri";case _e.Saturday:return"sat";case _e.Sunday:return"sun";case _e.Workday:return"workday";case _e.Weekend:return"weekend";default:return"daily"}},as=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>ss(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ge.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),ss=e=>{var t,i;if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>Object({service:e.service,service_data:e.service_data,entity_id:t}))}return{service:e.service,service_data:e.service_data,entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:e.service_data}},os=(e,t,i)=>{const a={title:ea("state_badge.default.error",i),description:q`
  ...
  `,primaryButtonLabel:ea("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};wa(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ss})),dialogParams:a})},ns=e=>{let t=e.locale.first_weekday;if(t&&"language"!=t)return rs.map(e=>e.toLowerCase()).findIndex(e=>e==t);if("weekInfo"in Intl.Locale.prototype)return new Intl.Locale(e.locale.language).weekInfo.firstDay%7;{const t="AEAFBHDJDZEGIQIRJOKWLYOMQASDSY".match(/../g),i="AGARASAUBDBRBSBTBWBZCACNCODMDOETGTGUHKHNIDILINJMJPKEKHKRLAMHMMMOMTMXMZNINPPAPEPHPKPRPTPYSASGSVTHTTTWUMUSVEVIWSYEZAZW".match(/../g),a=["ar","arq","arz","fa"],s="amasbndzengnguhehiidjajvkmknkolomhmlmrmtmyneomorpapssdsmsnsutatethtnurzhzu".match(/../g),o=e.locale.language.match(/^([a-z]{2,3})(?:-([a-z]{3})(?=$|-))?(?:-([a-z]{4})(?=$|-))?(?:-([a-z]{2}|\d{3})(?=$|-))?/i);return o[1]?i.includes(o[4])?0:t.includes(o[4])?6:1:s.includes(o[1])?0:a.includes(o[1])?6:1}},rs=[_e.Sunday,_e.Monday,_e.Tuesday,_e.Wednesday,_e.Thursday,_e.Friday,_e.Saturday],ls={alarm_control_panel:{services:{alarm_arm_away:"mdi:shield-lock",alarm_arm_home:"mdi:shield-home",alarm_arm_night:"mdi:shield-moon",alarm_custom_bypass:"mdi:security",alarm_disarm:"mdi:shield-off",alarm_trigger:"mdi:bell-ring",alarm_arm_vacation:"mdi:shield-airplane"}},automation:{services:{turn_on:"mdi:robot",turn_off:"mdi:robot-off",trigger:"mdi:play"}},button:{services:{press:"mdi:gesture-tap-button"}},climate:{services:{set_temperature:"mdi:thermometer",set_hvac_mode:"mdi:cog-transfer-outline",set_preset_mode:"mdi:cloud-download-outline",set_fan_mode:"mdi:fan",set_humidity:"mdi:water-percent",set_swing_mode:"mdi:arrow-oscillating"},attributes:{hvac_mode:{cool:"mdi:snowflake",dry:"mdi:water-percent",fan_only:"mdi:fan",heat:"mdi:fire",heat_cool:"mdi:thermometer",off:"mdi:power"},preset_mode:{activity:"mdi:motion-sensor",away:"mdi:account-arrow-right",boost:"mdi:rocket-launch",comfort:"mdi:sofa",eco:"mdi:leaf",home:"mdi:home",sleep:"mdi:bed"},fan_mode:{diffuse:"mdi:weather-windy",focus:"mdi:target",high:"mdi:speedometer",low:"mdi:speedometer-slow",medium:"mdi:speedometer-medium",middle:"mdi:speedometer-medium",off:"mdi:fan-off",on:"mdi:fan"},swing_mode:{both:"mdi:arrow-all",horizontal:"mdi:arrow-left-right",off:"mdi:arrow-oscillating-off",on:"mdi:arrow-oscillating",vertical:"mdi:arrow-up-down"}}},cover:{services:{close_cover:"mdi:arrow-down-box",close_cover_tilt:"mdi:arrow-bottom-left",open_cover:"mdi:arrow-up-box",open_cover_tilt:"mdi:arrow-top-right",set_cover_position:"mdi:arrow-down-box",set_cover_tilt_position:"mdi:arrow-top-right"}},fan:{services:{oscillate:"mdi:arrow-oscillating",set_percentage:"mdi:fan",set_preset_mode:"mdi:fan-auto",turn_off:"mdi:fan-off",turn_on:"mdi:fan"}},humidifier:{services:{set_humidity:"mdi:water-percent",set_mode:"mdi:air-humidifier",turn_off:"mdi:air-humidifier-off",turn_on:"mdi:air-humidifier"},attributes:{mode:{auto:"mdi:refresh-auto",away:"mdi:account-arrow-right",baby:"mdi:baby-carriage",boost:"mdi:rocket-launch",comfort:"mdi:sofa",eco:"mdi:leaf",home:"mdi:home",normal:"mdi:water-percent",sleep:"mdi:power-sleep"}}},input_boolean:{services:{turn_off:"mdi:toggle-switch-off",turn_on:"mdi:toggle-switch"}},input_button:{services:{press:"mdi:gesture-tap-button"}},input_number:{services:{set_value:"mdi:counter"}},input_select:{services:{select_option:"mdi:counter"}},lawn_mower:{services:{dock:"mdi:home-import-outline",start_mowing:"mdi:play"}},light:{services:{turn_off:"mdi:lightbulb-off",turn_on:"mdi:lightbulb-on"}},lock:{services:{lock:"mdi:lock",unlock:"mdi:lock-open"}},media_player:{services:{media_play:"mdi:play",media_stop:"mdi:stop",play_media:"mdi:play",select_source:"mdi:import",turn_off:"mdi:power",turn_on:"mdi:power"}},notify:{services:{"{entity_id}":"mdi:message-alert"}},scene:{services:{turn_on:"mdi:play"}},script:{services:{turn_on:"mdi:flash",turn_off:"mdi:flash-off","{entity_id}":"mdi:play"}},select:{services:{select_option:"mdi:counter"}},switch:{services:{turn_off:"mdi:toggle-switch-variant-off",turn_on:"mdi:toggle-switch-variant"}},vacuum:{services:{send_command:"mdi:send",start:"mdi:play",turn_off:"mdi:stop",turn_on:"mdi:play"}},water_heater:{services:{set_away_mode:"mdi:account-arrow-right",set_operation_mode:"mdi:water-boiler",set_temperature:"mdi:thermometer",turn_off:"mdi:water-boiler-off",turn_on:"mdi:water-boiler"},attributes:{operation_mode:{eco:"mdi:leaf",electric:"mdi:lightning-bolt",gas:"mdi:fire-circle",heat_pump:"mdi:heat-wave",high_demand:"mdi:finance",off:"mdi:power",performance:"mdi:rocket-launch"}}}},ds=(e,t)=>{const i=oa(e,t),a=Ki(e.service),s=Zi(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:"mdi:"+o;var o;if(!Object.keys(ls).includes(a)||!Object.keys(ls[a].services).includes(s))return"mdi:flash";if(void 0!==ls[a].attributes){let t=ls[a].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return ls[a].services[s]},cs=(e,t)=>{const i=new Date(t),a=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let s=3600*e.hours+60*e.minutes-a;const o=s<0?-1:1;s=Math.abs(s);let n=Math.floor(s/3600),r=Math.round((s-3600*n)/60);return o<0&&(n>0?n=-n:r=-r),Se({hours:n,minutes:r})};let us=class extends oe{constructor(){super(),this.selectedSlot=null,this.timeout=0,this.large=!1,this.handleResize=this.handleResize.bind(this)}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){}render(){return q`
    ...
    `}renderTimebar(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=[1,2,3,4,6,8,12],i=De(this.hass.locale),a=i?130:100;let s=Math.ceil(24/(e/a));for(;!t.includes(s);)s++;const o=[0,...Array.from(Array(24/s-1).keys()).map(e=>(e+1)*s),24];return o.map((e,t)=>{let a=s/24*100;a=Math.floor(100*a)/100;let n={mode:ke.Fixed,hours:e,minutes:0};return 0==t?q`
      ...
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,a)=>{let s=ze(i.start,this.hass),o=ze(i.stop||i.start,this.hass);!o&&s&&(o=86400);const n=(o-s)/86400*100,r=i.actions.length?_a(i.actions[0],this.hass,this.config.customize,!0):"",l=parseFloat(getComputedStyle(this).getPropertyValue("width")),d=5*r.length+10,c=a>0?15:0,u=a<e.length-1?15:0,h=n*l/100-c-u,m=e[a+1];return q`
        ...
        >
          ${i.stop,""}
          ${i.actions.length?r&&(h>d/3||h>50)&&h>30?q`<span style="margin-left: ${c}px; margin-right: ${u}px">${r}</span>`:h>16?q`<ha-icon icon="${ds(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
    ...
    `}};t([de({attribute:!1})],us.prototype,"hass",void 0),t([de({attribute:!1})],us.prototype,"config",void 0),t([ce()],us.prototype,"schedule",void 0),t([ce()],us.prototype,"selectedSlot",void 0),t([de({type:Boolean})],us.prototype,"large",void 0),t([function(e){return ue({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}({passive:!0})],us.prototype,"_handleDragStart",null),us=t([re("scheduler-timeslot-editor")],us);let hs=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=ke.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1}set time(e){this.hours=Number(e.split(":")[0]),this.minutes=Number(e.split(":")[1]);const t=Ae(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return q`
  ...
  `,t([de({attribute:!1})],hs.prototype,"hass",void 0),t([ce()],hs.prototype,"hours",void 0),t([ce()],hs.prototype,"minutes",void 0),t([ce()],hs.prototype,"mode",void 0),t([de({type:Boolean})],hs.prototype,"autoValidate",void 0),t([de({type:Boolean})],hs.prototype,"required",void 0),t([de({type:Boolean})],hs.prototype,"disabled",void 0),t([de({type:String})],hs.prototype,"label",void 0),t([de({type:Boolean})],hs.prototype,"useAmPm",void 0),hs=t([re("scheduler-time-picker")],hs);let ms=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![_e.Daily,_e.Weekend,_e.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
    ...
    `:q``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[_e.Sunday,_e.Monday,_e.Tuesday,_e.Wednesday,_e.Thursday,_e.Friday,_e.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,ns(this.hass))}else e=[_e.Daily,_e.Workday,_e.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.every(e=>![_e.Daily,_e.Weekend,_e.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>q`
        <mwc-list-item
          graphic="icon"
    ...
    `}};t([de({attribute:!1})],_s.prototype,"hass",void 0),t([ce()],_s.prototype,"_params",void 0),t([ce()],_s.prototype,"_search",void 0),t([ce()],_s.prototype,"_filter",void 0),t([ce()],_s.prototype,"_width",void 0),t([ce()],_s.prototype,"_height",void 0),t([ce()],_s.prototype,"lockDomain",void 0),_s=t([re("dialog-select-action")],_s);var gs=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return _s}});let vs=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return q`
      ${this.showPrefix?q`
    ...
    `}};t([de({type:Boolean})],vs.prototype,"showPrefix",void 0),vs=t([re("scheduler-settings-row")],vs);let ys=class extends oe{constructor(){super(...arguments),this.selectedEntry=0,this.selectedSlot=null,this.large=!1}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return q`
  ...
  scheduler-collapsible-section .header span {
    ...
    `}};t([de({attribute:!1})],ys.prototype,"hass",void 0),t([de({attribute:!1})],ys.prototype,"config",void 0),t([ce()],ys.prototype,"schedule",void 0),t([ce()],ys.prototype,"selectedEntry",void 0),t([ce()],ys.prototype,"selectedSlot",void 0),t([de({type:Boolean})],ys.prototype,"large",void 0),ys=t([re("scheduler-main-panel")],ys);const bs=["January","February","March","April","May","June","July","August","September","October","November","December"];function fs(e){return e.toISOString().split("T")[0]}function ks(e){let t=new Date;const i=(e||"").match(/^([0-9]{4})-([0-9]{2})-([0-9]{2})/);null!==i&&t.setFullYear(Number(i[1]),Number(i[2])-1,Number(i[3]));const a=(e||"").match(/([0-9]{2}):([0-9]{2})(:([0-9]{2}))?$/);return null!==a&&t.setHours(Number(a[1]),Number(a[2]),a.length>4?Number(a[4]):t.getSeconds()),t}const ws=(e,t)=>"select"in t&&null!==t.select?((e,t)=>{var i;return((null===(i=t.select)||void 0===i?void 0:i.options)||[]).some(t=>"object"==typeof t?t.value==e:t==e)})(String(e),t):"number"in t&&null!==t.number?((e,t)=>{var i,a;return isNaN(e)||void 0!==(null===(i=t.number)||void 0===i?void 0:i.min)&&e<t.number.min||void 0!==(null===(a=t.number)||void 0===a?void 0:a.max)&&t.number.max,!1})(Number(e),t):!("text"in t)||null===t.text||String(e).length>0,xs=e=>null==e||Array.isArray(e)?e:[e];let $s=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0}async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title")}render(){return this._params?q`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
    ...
    `}};t([de({attribute:!1})],$s.prototype,"hass",void 0),t([ce()],$s.prototype,"_params",void 0),t([ce()],$s.prototype,"_search",void 0),t([ce()],$s.prototype,"_filter",void 0),t([ce()],$s.prototype,"_width",void 0),t([ce()],$s.prototype,"_height",void 0),$s=t([re("dialog-select-condition")],$s);var js=Object.freeze({__proto__:null,get DialogSelectCondition(){return $s}});let Os=class extends oe{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[]}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||fs(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||fs(new Date);const i=(await xa(this.hass)).map(e=>e.name),a=[...this.config.tags].flat();this.tags=[...i,...a.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return q`
      ...
      <scheduler-collapsible-section idx="${t}">
        ...
        <scheduler-settings-row>
          ...
          <scheduler-entity-picker
            ...
            .domain=${i}
            @value-changed=${this._selectEntity}
            .value=${this.conditionIdx==t?xs(this.selectedEntity):xs(e.entity_id)}
            ?multiple=${!1}
          >
          </scheduler-entity-picker>
        </scheduler-settings-row>
    ...
    `}};t([de({attribute:!1})],Os.prototype,"hass",void 0),t([de({attribute:!1})],Os.prototype,"config",void 0),t([ce()],Os.prototype,"schedule",void 0),t([ce()],Os.prototype,"conditionIdx",void 0),t([ce()],Os.prototype,"selectedDomain",void 0),t([ce()],Os.prototype,"selectedEntity",void 0),t([ce()],Os.prototype,"selectedMatchType",void 0),t([ce()],Os.prototype,"conditionValue",void 0),t([ce()],Os.prototype,"conditionValid",void 0),t([ce()],Os.prototype,"startDate",void 0),t([ce()],Os.prototype,"endDate",void 0),t([de()],Os.prototype,"tags",void 0),Os=t([re("scheduler-options-panel")],Os);let Cs=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          <ha-icon-button
            slot="navigationIcon"
    ...
    `}};t([de({attribute:!1})],Cs.prototype,"hass",void 0),t([ce()],Cs.prototype,"_params",void 0),Cs=t([re("scheduler-generic-dialog")],Cs);var Ss=Object.freeze({__proto__:null,get GenericDialog(){return Cs}});let As=class extends oe{constructor(){super(...arguments),this.large=!1,this.selectedEntry=0,this.selectedSlot=0,this._panel="main"}async showDialog(e){this._params=e,this.schedule=e.schedule,this._panel="main",this.large=!1,await this.updateComplete}async closeDialog(){this._params=void 0}willUpdate(){this.hass.loadBackendTranslation("config")}render(){var e;return this._params?q`
    ...
    `:q``}_updateSchedule(e){let t=e.detail.schedule;t&&(this.schedule=t)}async _handleSaveClick(e){const t=es(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const a={cancel:()=>i(!1),confirm:()=>i(!0),title:ea("state_badge.default.error",this.hass),description:Wi("ui.panel.editor.validation_errors."+t,this.hass),primaryButtonLabel:ea("ui.common.ok",this.hass)};wa(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ss})),dialogParams:a})});else if(this.schedule.schedule_id){const t=Ne(await ka(this.hass,this.schedule.schedule_id),this.hass);if(pe(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Wi("ui.dialog.enable_schedule.title",this.hass),description:Wi("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:ea("ui.common.yes",this.hass),secondaryButtonLabel:ea("ui.common.no",this.hass),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};wa(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ss})),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=ts(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>os(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=ts(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>os(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Wi("ui.dialog.confirm_delete.title",this.hass),description:Wi("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:ea("ui.common.ok",this.hass),secondaryButtonLabel:ea("ui.common.cancel",this.hass)};wa(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ss})),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>os(e,this,this.hass)).then(()=>{this.closeDialog()})})}};As.styles=Ya,t([de({attribute:!1})],As.prototype,"hass",void 0),t([ce()],As.prototype,"_params",void 0),t([de({type:Boolean,reflect:!0})],As.prototype,"large",void 0),t([ce()],As.prototype,"schedule",void 0),t([ce()],As.prototype,"selectedEntry",void 0),t([ce()],As.prototype,"selectedSlot",void 0),t([ce()],As.prototype,"_panel",void 0),As=t([re("dialog-scheduler-editor")],As);var zs=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return As}}),Es=window&&window.__assign||function(){return(Es=Object.assign||function(e){for(var t,i=1,a=arguments.length;i<a;i++)for(var s in t=arguments[i])Object.prototype.hasOwnProperty.call(t,s)&&(e[s]=t[s]);return e}).apply(this,arguments)};var Ts={second:45,minute:45,hour:22,day:5};const Ds=(e,t,i)=>{if(i===Te.am_pm||!i&&t.time_format===Te.am_pm){const t=Le(e.getHours()).am_pm;return`${Le(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===Te.twenty_four||!i&&t.time_format===Te.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:De(t)}):De(t)?Ds(e,t,Te.am_pm):Ds(e,t,Te.twenty_four)};let Ms=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const a=i>=0?"past":"future";i=Math.abs(i);const s=Math.round(i);if("future"==a&&s>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),a=Math.floor((e.valueOf()-i.valueOf())/864e5);let s="";a>14?s=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},a=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return bs[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${a(e,"month")} ${a(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${a(e,"month")} ${a(e,"day")}, ${a(e,"year")}`}(e,this._hass.locale):a>7?s=Wi("ui.components.date.next_week_day",this._hass,"{weekday}",ya(e,"long",this._hass)):1==a?s=Wi("ui.components.date.tomorrow",this._hass):a>0&&(s=ya(e,"long",this._hass));let o=Wi("ui.components.time.absolute",this._hass,"{time}",Ds(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Wi("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Wi("ui.components.time.at_midnight",this._hass)),String(s+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=ea("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=ea("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var a=Es(Es({},Ts),i||{}),s=(+e-+t)/1e3;if(Math.abs(s)<a.second)return{value:Math.round(s),unit:"second"};var o=s/60;if(Math.abs(o)<a.minute)return{value:Math.round(o),unit:"minute"};var n=s/3600;if(Math.abs(n)<a.hour)return{value:Math.round(n),unit:"hour"};var r=s/86400;if(Math.abs(r)<a.day)return{value:Math.round(r),unit:"day"};var l=new Date(e),d=new Date(t),c=l.getFullYear()-d.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+l.getMonth()-d.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var h=s/604800;return{value:Math.round(h),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return q``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),q`
      ${Xi(this.relativeTime(this.datetime))}
    `}};t([de()],Ms.prototype,"_hass",void 0),t([de()],Ms.prototype,"datetime",void 0),Ms=t([re("scheduler-relative-time")],Ms);let Ls=class extends oe{render(){const e=this.hass.states[this.schedule.entity_id];if(!e)return q``;const t="off"==e.state,i=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];return q`
      <ha-icon
        icon="${ds(i,this.config.customize)}"
      >
      </ha-icon>
