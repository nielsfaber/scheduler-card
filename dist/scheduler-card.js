...
/**
        ...
        <div slot="header">
          <ha-dialog-header>
            <ha-icon-button
              slot="navigationIcon"
              data-dialog="close"
              .label=${es("ui.dialogs.more_info_control.dismiss",this.hass)}
              .path=${Ns}
            ></ha-icon-button>
            <div slot="title">${Bi("ui.dialog.entity_picker.title",this.hass)}</div>
          </ha-dialog-header>

          <ha-input
            dialogInitialFocus
            .placeholder=${es("ui.common.search",this.hass)}
            aria-label=${es("ui.common.search",this.hass)}
            ...
            <div class="trailing" slot="trailingIcon">
              ${this._search&&q`
                <ha-icon-button
                  ...
                  .label=${es("ui.common.clear",this.hass)}
                  .path=${Ns}
                  class="clear-button"
                ></ha-icon-button>
              `}
    ...
    `:q``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("ha-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_toggleSelectEntity(e){let t=e.target;for(;"HA-LIST-ITEM"!=t.tagName;)t=t.parentElement;t.querySelector("ha-checkbox");const i=t.getAttribute("key");this._params.entities.includes(i)?this._params=Object.assign(Object.assign({},this._params),{entities:this._params.entities.filter(e=>e!=i)}):this._params=Object.assign(Object.assign({},this._params),{entities:[...this._params.entities,i]})}_toggleSelectDomain(e,t){var i;let s=e.target;for(;"HA-LIST-ITEM"!=s.tagName;)s=s.parentElement;const a=s.getAttribute("key"),o=null===(i=this.options)||void 0===i?void 0:i.find(e=>e.key==a).entities.map(e=>e.key);this._params=t?Object.assign(Object.assign({},this._params),{domains:this._params.domains.filter(e=>e!=a),entities:this._params.entities.filter(e=>!(null==o?void 0:o.includes(e)))}):Object.assign(Object.assign({},this._params),{domains:[...this._params.domains,a]}),e.stopPropagation()}closeGroupByKey(e){this.shadowRoot.querySelector("ha-list").childNodes.forEach(t=>{if(t.nodeType==Node.ELEMENT_NODE&&"HA-LIST-ITEM"==t.tagName&&t.getAttribute("key")==e){const e=t,i=e.nextElementSibling,s=e.querySelector("ha-icon-button");i.style.height="0px",e.removeAttribute("expanded"),s.classList.remove("expanded")}})}async _toggleExpandGroup(e){let t=e.target;for(;"HA-LIST-ITEM"!=t.tagName;)t=t.parentElement;const i=t.querySelector("ha-icon-button"),s=t.getAttribute("key");this.expandedGroups.includes(s)||(this.expandedGroups.forEach(e=>this.closeGroupByKey(e)),this.expandedGroups=[s],await this.requestUpdate());const a=t.nextElementSibling,o=a.scrollHeight;t.hasAttribute("expanded")?(t.removeAttribute("expanded"),i.classList.remove("expanded"),a.style.height="0px",setTimeout(()=>{this.expandedGroups=this.expandedGroups.filter(e=>e!=s)},300)):(t.setAttribute("expanded","true"),i.classList.add("expanded"),a.style.height=`${o}px`)}_renderOptions(){if(!this.options)return;let e=[...this.options];const t=this._filter&&this._filter.trim().length;if(t){const t=this._filter.toLowerCase().trim().split(" ");e=e.map(e=>oa(e,t)||(e=Object.assign(Object.assign({},e),{entities:(e.entities||[]).filter(e=>oa(e,t))})).entities.length?e:void 0).filter(e=>void 0!==e)}return e.length?Object.keys(e).map(i=>{var s,a;const o=e[i].key,n=null===(s=this._params)||void 0===s?void 0:s.domains.includes(o);let r=[...e[i].entities];"switch"==o&&(r=r.filter(e=>!this.scheduleEntities.includes(e.key)));const d=n?r.length:r.filter(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)}).length,l=(null===(a=this._params)||void 0===a?void 0:a.domains.includes(o))||e[i].entities.every(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)});return q`
        <ha-list-item graphic="icon" twoline hasMeta @click=${this._toggleExpandGroup} key="${o}">
          ...
          <div slot="meta" class="meta">
            <ha-button
              ...
              size="small"
            >
              ${es(l?"ui.components.media-browser.file_management.deselect_all":"ui.components.subpage-data-table.select_all",this.hass)}
            </ha-button>
            <ha-icon-button
              .path="${Ls}"
          ...
          <span>${e[i].name}</span>
          <span slot="secondary"
            >${Bi("ui.panel.card_editor.fields.entities.included_number",this.hass,["{number}","{total}"],[d,r.length])}</span
          >
        </ha-list-item>
      ...
      `}):q`
        <ha-list-item disabled>
          ${es("ui.components.entity.entity-picker.no_match",this.hass)}
        </ha-list-item>
    ...
    `}};t([le({attribute:!1})],na.prototype,"hass",void 0),t([ce()],na.prototype,"_params",void 0),t([ce()],na.prototype,"_search",void 0),t([ce()],na.prototype,"_filter",void 0),t([ce()],na.prototype,"_width",void 0),t([ce()],na.prototype,"_height",void 0),t([ce()],na.prototype,"expandedGroups",void 0),t([ce()],na.prototype,"options",void 0),t([ce()],na.prototype,"scheduleEntities",void 0),na=t([re("dialog-select-entities")],na);var ra=Object.freeze({__proto__:null,get DialogSelectEntities(){return na}});let da=class extends oe{constructor(){super(...arguments),this.active=!1}render(){return q`
    ...
    `}renderTrailingIcon(){const e=`icn_${Math.random().toString(36).substring(2,9)}`;return this.removable||this.badge?this.badge?q` <div class="badge">${this.badge}</div> `:q`
      <div class="trailing-icon" @click=${this._iconClick}>
        ...
        ${this.disabled?V:q`<ha-tooltip for="${e}">${es("ui.common.remove",this.hass)}</ha-tooltip>`}
      </div>
    ...
    `}};t([le({attribute:!1})],da.prototype,"hass",void 0),t([le({type:String})],da.prototype,"icon",void 0),t([le({type:Boolean})],da.prototype,"useStateIcon",void 0),t([le({type:Boolean})],da.prototype,"selectable",void 0),t([le({type:Boolean})],da.prototype,"removable",void 0),t([le({type:Boolean})],da.prototype,"toggleable",void 0),t([le({type:Boolean})],da.prototype,"active",void 0),t([le({type:String})],da.prototype,"badge",void 0),t([le({type:String})],da.prototype,"value",void 0),t([le({type:Boolean})],da.prototype,"disabled",void 0),da=t([re("scheduler-chip")],da);let la=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?q` ${Object.values(this.items).map(e=>this.renderChipitem(e))} `:q``}renderChipitem(e){const t=e.useStateIcon&&!Object.keys(this.hass.states).includes(e.value||"");return q`
      <scheduler-chip
        .hass=${this.hass}
    ...
    `}};t([le({attribute:!1})],la.prototype,"hass",void 0),t([le({attribute:!1})],la.prototype,"items",void 0),t([le({attribute:!1})],la.prototype,"value",void 0),t([le({type:Boolean})],la.prototype,"selectable",void 0),t([le({type:Boolean})],la.prototype,"toggleable",void 0),t([le({type:Boolean})],la.prototype,"removable",void 0),t([le({type:Boolean})],la.prototype,"disabled",void 0),la=t([re("scheduler-chip-set")],la);const ca=[{name:"primary",weight:10},{name:"secondary",weight:8}];let ua=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this.multipleMode=!1,this.scheduleEntities=[],this._valueRenderer=e=>{Array.isArray(e)&&(e=e.length?[...e].pop():"");const t=e||"",i=this.hass.states[t];if(!i)return q`
        <ha-svg-icon slot="start" .path=${Rs} style="margin: 0 4px"></ha-svg-icon>
        <span slot="headline">${t}</span>
      `;const s=this._parseEntityItem(t);return q`
      ${s.icon?q` <ha-icon slot="start" icon="${s.icon}"></ha-icon> `:q`
            <state-badge
              .hass=${this.hass}
              .stateObj=${i}
              slot="start"
    ...
    `},this._filteredItems=()=>{let e=Object.keys(this.hass.states);this.domain&&(e=e.filter(e=>Zi(e)==this.domain)),this.multiple&&(e=e.filter(e=>{var t;return!(null===(t=this.value)||void 0===t?void 0:t.includes(e))})),this.config&&(e=e.filter(e=>((this.config.include||He).some(t=>Gi(t,e))||Object.keys(this.config.customize||{}).some(t=>Gi(t,e)))&&!(this.config.exclude||[]).some(t=>Gi(t,e)))),e=e.filter(e=>!this.scheduleEntities.includes(e)),this.filterFunc&&(e=e.filter(e=>this.filterFunc(this.hass.states[e])));const t=e.map(e=>this._parseEntityItem(e));return t}}async firstUpdated(){this.scheduleEntities=Object.entries(await Oe(this.hass)).map(([,e])=>e.entity_id),this.domain&&this.config&&!Ji(this.domain,this.config)&&(this.config=Object.assign(Object.assign({},this.config),{include:[...this.config.include||[],this.domain],exclude:[...(this.config.exclude||[]).filter(e=>!e.startsWith(this.domain))]})),this._autoSelectIfSingleEntity()}updated(e){super.updated(e),e.has("domain")&&this._autoSelectIfSingleEntity()}_autoSelectIfSingleEntity(){if(this.value&&this.value.length>0)return;const e=this._filteredItems();1===e.length&&(this.value=[e[0].id],Es(this,"value-changed",{value:this.value}))}render(){var e,t;return q`
      ...
      ${(null===(e=this.value)||void 0===e?void 0:e.length)&&!this.multipleMode&&this.multiple?V:q`
            <ha-generic-picker
              ...
              .searchKeys=${ca}
              .searchLabel=${es("ui.dialogs.quick-bar.filter_placeholder",this.hass)}
        ...
        <div class="column-right">
          ${e.length?q`
                <ha-icon-button
                  ...
                  .path=${this.multipleMode?"M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z":Ls}
                  slot="end"
                ></ha-icon-button>
              `:V}
        </div>
      </div>
    `}_valueChanged(e){const t=e.detail.value,i=e.currentTarget;t&&(this.value=[...this.value||[],t],this.multiple&&(i.value=""),Es(this,"value-changed",{value:this.value}),e.stopPropagation())}_removeClick(e){const t=e.detail;this.value=(this.value||[]).filter(e=>e!==t),Es(this,"value-changed",{value:this.value})}_parseEntityItem(e){var t,i,s,a;const o=Object.entries((null===(t=this.config)||void 0===t?void 0:t.customize)||{}).filter(([t,i])=>Gi(t,e)).map(([e,t])=>t),n=null===(i=o.find(e=>"name"in e))||void 0===i?void 0:i.name,r=null===(s=o.find(e=>"icon"in e))||void 0===s?void 0:s.icon;return{id:e,primary:n||Ki(e,null===(a=this.hass.states[e])||void 0===a?void 0:a.attributes),secondary:e,icon:r}}};ua.styles=r`
    :host {
      display: flex;
  ...
  `,t([le({attribute:!1})],ua.prototype,"hass",void 0),t([le()],ua.prototype,"domain",void 0),t([le()],ua.prototype,"config",void 0),t([le({type:Array})],ua.prototype,"value",void 0),t([le({type:Boolean})],ua.prototype,"multiple",void 0),t([le({type:Boolean})],ua.prototype,"disabled",void 0),t([ce()],ua.prototype,"multipleMode",void 0),t([ce()],ua.prototype,"scheduleEntities",void 0),ua=t([re("scheduler-entity-picker")],ua);let ha=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
      <div
    ...
    `}};t([le({type:Boolean,reflect:!0})],ha.prototype,"expanded",void 0),t([le({type:Boolean,reflect:!0})],ha.prototype,"disabled",void 0),t([le({attribute:!0})],ha.prototype,"idx",void 0),t([le({type:CustomEvent})],ha.prototype,"openClose",void 0),ha=t([re("scheduler-collapsible-section")],ha);let ma=class extends oe{set openedItem(e){e!==this._openedItem&&void 0!==e&&setTimeout(()=>{this.updateOpenedItem(e)},50)}constructor(){super(),this.disabled=!1,this._openedItem=-1,this._numItems=0,this.addEventListener("open-close",this.toggleActiveSection)}firstUpdated(){const e=this.querySelectorAll("scheduler-collapsible-section");this._numItems=e.length}toggleActiveSection(e){if(this.disabled)return;const t=e.target,i=Number(t.getAttribute("idx"));"true"===t.getAttribute("expanded")?this.updateOpenedItem(-1):this.updateOpenedItem(i)}updateOpenedItem(e){this.querySelectorAll("scheduler-collapsible-section").forEach(function(t){const i=Number(t.getAttribute("idx"));i!==e&&t.getAttribute("expanded")?t.removeAttribute("expanded"):i!==e||t.getAttribute("expanded")||t.setAttribute("expanded","true")}),this._openedItem=e;const t=new CustomEvent("openclose-changed",{detail:{item:e}});this.dispatchEvent(t)}render(){return q` <slot></slot> `}};t([le()],ma.prototype,"disabled",void 0),t([ce()],ma.prototype,"_openedItem",void 0),t([ce()],ma.prototype,"_numItems",void 0),ma=t([re("scheduler-collapsible-group")],ma);const pa="__NONE_OPTION__";let _a=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){var e;if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),Es(this,"value-changed",{value:this.value})},s=()=>{const e=t.map(e=>Object({name:e,value:e}));return q` <scheduler-chip-set .hass=${this.hass} .items=${e} removable @value-changed=${i}>
        </scheduler-chip-set>`},a=e=>{var t;const i=null===(t=this.config.select)||void 0===t?void 0:t.translation_key;let s="";return i&&(s=es(i.replace("${value}",e),this.hass,!1)),s||(s=e),s},o=e=>"object"==typeof e?{id:e.value,primary:a(e.label),icon:e.icon}:{id:e,primary:a(e)};let n=[...null==e?void 0:e.options].map(o);const r=[this.value||[]].flat().map(String);n=[...n,...r.filter(e=>!n.find(t=>t.id==e)).map(o)],Array.isArray(this.value)&&(n=n.filter(e=>"object"==typeof e?!t.includes(e.id):!t.includes(e)));const d=()=>n.length?(n.some(e=>e.icon),n.map(e=>q`
            <ha-dropdown-item .value=${e.id}>
              ${e.icon?q`<ha-icon slot="icon" .icon=${e.icon}></ha-icon>`:V}
              <span>${e.primary}</span>
            </ha-dropdown-item>
          `)):q`
            <ha-dropdown-item .value=${pa}>
              ${this.hass.localize("ui.components.combo-box.no_match")}
            </ha-dropdown-item>
          `,l=e=>{const t=e.target,i=t.querySelector("ha-picker-field");this.style.setProperty("--select-menu-width",`${i.offsetWidth}px`),t.classList.add("opened")},c=e=>{e.target.classList.remove("opened")},u=e=>{const t=e.detail.item.value;(t!=pa&&!Array.isArray(this.value)||(e.target.value=void 0,t!=pa))&&this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))},h=()=>{this._valueChanged(new CustomEvent("value-changed",{detail:{value:void 0}}))},m=We(this.value)&&!Array.isArray(this.value)?n.find(e=>e.id===this.value):void 0,p=m?m.primary||m.id:We(this.value)&&!Array.isArray(this.value)?this.value:void 0;return q`
        <div class="select-wrapper">
          ${e.multiple?q` <div class="chips">${s()}</div> `:""}
          <ha-dropdown placement="bottom" @wa-select=${u} @wa-show=${l} @wa-hide=${c}>
            <ha-picker-field
              slot="trigger"
              type="button"
              compact
              @clear=${h}
              .disabled=${this.disabled}
              .hideClearIcon=${this.disabled||!We(this.value)||Array.isArray(this.value)&&!this.value.length}
              .value=${p}
      ...
      `}if(this.config.number){const t=this.config.number,i="box"==t.mode||!We(t.min)||!We(t.max);let s=this.value;i||"number"==typeof s||(s=t.min),"number"==typeof t.scale_factor&&(s=Number(s)/t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(s=Math.round(Number(s)/t.step)*t.step),We(s)&&(s=ds(Number(s)));const a=e=>{let i=Number(e.target.value);"number"==typeof t.scale_factor&&(i*=t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(i=Math.round(i/t.step)*t.step),i=ds(i),this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}})),e.stopPropagation()},o=e=>{e.stopPropagation();const t=e.target.value,i=""===t||isNaN(Number(t))?void 0:Number(t);this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}}))},n=(e,i)=>{let s=t.step&&Number(t.step)%1==0?null!==e.match(/^-?\d+$/):null!==e.match(/^[+-]?\d+([.,]\d+)?$/);return s&&We(t.min)&&(s=Number(e)>=t.min),s&&We(t.max)&&(s=Number(e)<=t.max),{valid:s,customError:!s}};return q`
      ...
      `;if(this.config.boolean){const e={select:{options:[{value:"true",label:"True",icon:"mdi:check"},{value:"false",label:"False",icon:"mdi:close"}]}},t=e=>{const t=We(e.detail.value)?"true"===e.detail.value:void 0;e.stopPropagation(),this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))};return q`
      ...
      `}return q``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){const t=e.detail.value;if(!t)return;this.value=[...this.value,t]}else if(e.detail){let t=e.detail.value;void 0===t&&(t=null),this.value=t}else this.value=e.target.value;Es(this,"value-changed",{value:this.value})}};_a.styles=r`
    :host {
      display: flex;
      width: 100%;
    }
  ...
  `,t([le({attribute:!1})],_a.prototype,"hass",void 0),t([le({attribute:!1})],_a.prototype,"config",void 0),t([le()],_a.prototype,"value",void 0),t([le({type:Boolean})],_a.prototype,"disabled",void 0),_a=t([re("scheduler-combo-selector")],_a);let ga=class extends oe{constructor(){super(...arguments),this._config={},this.title="",this.tagOptions=[],this.customTagValue=""}setConfig(e){this._config=Object.assign({},e)}async firstUpdated(){this.title="string"==typeof this._config.title?this._config.title:"";const e=(await Ms(this.hass)).map(e=>e.name);e.sort(Qi),this.tagOptions=e}render(){var e,t,i,s,a,o;const n={number:{min:0,max:30,step:1,unit_of_measurement:Bi("ui.panel.card_editor.fields.time_step.unit_minutes",this.hass)}},r={select:{options:this.tagOptions,multiple:!0,custom_value:!0}};return q`
      <div class="card-config">
        <ha-button @click=${this._showIncludedEntitiesDialog} outlined>
          ${Bi("ui.panel.card_editor.fields.entities.button_label",this.hass)}
        ...
        <div class="two-columns" style="margin: 10px 0px 15px 0px">
          ...
          <div class="column">
            <ha-formfield label="${Bi("ui.panel.card_editor.fields.show_toggle_switches.heading",this.hass)}">
              <ha-switch
        ...
        <scheduler-settings-row>
          <span slot="heading">${Bi("ui.panel.card_editor.fields.time_step.heading",this.hass)}</span>
        ...
        <span>${Bi("ui.panel.card_editor.fields.default_editor.heading",this.hass)}</span>
        <div class="two-columns">
          <div class="column">
            <ha-formfield label="${Bi("ui.panel.card_editor.fields.default_editor.options.single",this.hass)}">
              <ha-radio
                name="default_editor"
                value="${me.Single}"
          ...
          <div class="column">
            <ha-formfield label="${Bi("ui.panel.card_editor.fields.default_editor.options.scheme",this.hass)}">
              <ha-radio
                name="default_editor"
                value="${me.Scheme}"
        ...
        <span>${Bi("ui.panel.card_editor.fields.default_repeat_type.heading",this.hass)}</span>
        <div class="two-columns">
          <div class="column">
            <ha-formfield label="${es("ui.components.calendar.event.repeat.label",this.hass)}">
              <ha-radio
                name="default_repeat_type"
                value="${fe.Repeat}"
                @change=${()=>{this._updateConfig({default_repeat_type:fe.Repeat})}}
                ?checked=${(this._config.default_repeat_type||fe.Repeat)==fe.Repeat}
              >
              </ha-radio>
            </ha-formfield>
          </div>
          <div class="column">
            <ha-formfield label="${es("ui.dialogs.more_info_control.vacuum.stop",this.hass)}">
              <ha-radio
                name="default_repeat_type"
                value="${fe.Pause}"
                @change=${()=>{this._updateConfig({default_repeat_type:fe.Pause})}}
                ?checked=${this._config.default_repeat_type==fe.Pause}
              >
              </ha-radio>
            </ha-formfield>
          </div>
          <div class="column">
            <ha-formfield label="${es("ui.common.delete",this.hass)}">
              <ha-radio
                name="default_repeat_type"
                value="${fe.Single}"
                @change=${()=>{this._updateConfig({default_repeat_type:fe.Single})}}
                ?checked=${this._config.default_repeat_type==fe.Single}
              >
              </ha-radio>
            </ha-formfield>
          </div>
        ...
        <div class="two-columns">
          <div class="column">
            <ha-formfield
              label="${Bi("ui.panel.card_editor.fields.display_format_primary.options.default",this.hass)}"
            >
              <ha-radio
                name="display_format_primary"
                value="default"
                @change=${this._setDisplayOptionsPrimary}
                ?checked=${[(null===(e=this._config.display_options)||void 0===e?void 0:e.primary_info)||Re].flat().includes("default")}
              >
              </ha-radio>
            </ha-formfield>
          </div>
          <div class="column">
            <ha-formfield
              label="${Bi("ui.panel.card_editor.fields.display_format_primary.options.entity_action",this.hass)}"
            >
              <ha-radio
                name="display_format_primary"
                value="{entity}: {action}"
                @change=${this._setDisplayOptionsPrimary}
                ?checked=${[(null===(t=this._config.display_options)||void 0===t?void 0:t.primary_info)||Re].flat().includes("{entity}: {action}")}
              >
              </ha-radio>
            </ha-formfield>
          </div>
        ...
        <div class="two-columns">
          <div class="column">
            <ha-formfield
              label="${Bi("ui.panel.card_editor.fields.display_format_secondary.options.relative_time",this.hass)}"
            >
              <ha-checkbox
                value="relative-time"
            ...
            <ha-formfield
              label="${Bi("ui.panel.card_editor.fields.display_format_secondary.options.time",this.hass)}"
            >
              <ha-checkbox
                value="time"
                @change=${this._setDisplayOptionsSecondary}
          ...
          <div class="column">
            <ha-formfield
              label="${Bi("ui.panel.card_editor.fields.display_format_secondary.options.days",this.hass)}"
            >
              <ha-checkbox
                value="days"
                @change=${this._setDisplayOptionsSecondary}
            ...
            <ha-formfield
              label="${Bi("ui.panel.card_editor.fields.display_format_secondary.options.additional_tasks",this.hass)}"
            >
              <ha-checkbox
  ...
  `,t([le({attribute:!1})],ga.prototype,"hass",void 0),t([le()],ga.prototype,"_config",void 0),t([le()],ga.prototype,"title",void 0),t([le()],ga.prototype,"tagOptions",void 0),t([ce()],ga.prototype,"customTagValue",void 0),ga=t([re("scheduler-card-editor")],ga);const va=r`
  ha-dialog {
...
`;const ya=(e,t,i,s)=>{var a;const o=e.service,n=null===(a=e.target)||void 0===a?void 0:a.entity_id,r=rs(e,s);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const d=r.fields[t];if(null===hs(o,n,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(d.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&d.supported_features)>0}))return!1}return!("light"==Zi(o)&&![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;const s=i.states[e].attributes.supported_color_modes||[];return"brightness"!=t||s.filter(e=>"onoff"!=e).length}))};var fa;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(fa||(fa={}));const ba=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>{const i=e.every((i,s)=>{const a=Ae(i.start,t),o=void 0===i.stop?a:Ae(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>i<=s||Ae(e.start,t)>=o)});return i?null:fa.OverlappingTime})(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,fa.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{var s;const a=rs(e,i);return(null==a?void 0:a.target)&&!(null===(s=e.target)||void 0===s?void 0:s.entity_id)?fa.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).filter(([s])=>ya(e,s,t,i)).every(([s,a])=>{var o,n;let r=hs(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,s,t,i);const d=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||a.optional;return!(!Object.keys(e.service_data).includes(s)&&!d||!We(e.service_data[s])&&!d)})?fa.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},wa=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))});let i={weekdays:e.entries[0].weekdays.map(ka),timeslots:e.entries[0].slots.map(xa),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},ka=e=>{switch(e){case pe.Monday:return"mon";case pe.Tuesday:return"tue";case pe.Wednesday:return"wed";case pe.Thursday:return"thu";case pe.Friday:return"fri";case pe.Saturday:return"sat";case pe.Sunday:return"sun";case pe.Workday:return"workday";case pe.Weekend:return"weekend";default:return"daily"}},xa=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>$a(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==_e.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),$a=e=>{var t,i;const s=e=>Object.keys(e).filter(t=>We(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){let t=null==e?void 0:e.target.entity_id.map(t=>({service:e.service,service_data:s(e.service_data),entity_id:t}));return t}return{service:e.service,service_data:s(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:s(e.service_data)}},ja=(e,t,i)=>{const s={title:es("state_badge.default.error",i),description:q`
      <b>Something went wrong!</b><br />
      ${e.body.message}<br /><br />
      ${e.error}<br /><br />
      Please <a href="https://github.com/nielsfaber/scheduler-card/issues">report</a> the bug.
    `,primaryButtonLabel:es("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};Es(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return io}),dialogParams:s})},Oa=e=>{if(!Object.keys(e).includes("select")||!e.select){if(Object.keys(e).includes("number")&&e.number){const t=e.number.min;return void 0!==t?t:0}return Object.keys(e).includes("boolean")&&e.boolean?void 0:(Object.keys(e).includes("text")&&e.text,"")}e.select.options},Sa=(e,t)=>{const i=rs(e,t),s=Zi(e.service),a=Wi(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:`mdi:${o}`;if(Object.keys(us).includes(s)&&Object.keys(us[s].services).includes(a)){if(void 0!==us[s].attributes){let t=us[s].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return us[s].services[a]}return Object.keys(us).includes(s)&&Object.keys(us[s].services).includes("{entity_id}")?us[s].services["{entity_id}"]:"mdi:flash";var o},za=(e,t,i)=>{let s=Ae("string"==typeof e?Ce(e):e,i),a=Ae("string"==typeof t?Ce(t):t,i);return a>s?1:a<s?-1:0},Ca=e=>Ce(e.start),Aa=e=>{if(We(e.stop)){const t=Ce(e.stop);return 0==t.hours&&0==t.minutes&&t.mode==be.Fixed?Object.assign(Object.assign({},t),{hours:24}):t}return Se(Ca(e),{minutes:1})},Ta=(e,t,i,s)=>{let a=t;if(We(i.stop))return[e,a]=Ta(e,t+1,{start:i.stop},s),[e,a-1];if(!We(i.start))return[e,a];let o=Ca(e[t]),n=i.start,r=Ca(e[t]);for(let i=t-1;i>=0;i--){if(e[i].actions.length){r=i==t-1?Se(Ca(e[i]),{minutes:1}):Aa(e[i]);break}r=Ca(e[i])}let d=Se(Aa(e[t]),{minutes:-1});if(!We(e[t].stop))for(let i=t+1;i<e.length;i++){if(e[i].actions.length){d=i==t+1?Se(Aa(e[i]),{minutes:-1}):Ca(e[i]);break}d=Aa(e[i])}if(za(r,n,s)<0&&(n=r),za(d,n,s)>0&&Ae(d,s)>0&&(n=d),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Ne(n)})}),za(o,n,s)<=0)for(let i=t-1;i>=0;i--){let t=za(Ca(e[i]),n,s),o=za(Aa(e[i]),n,s);if(t>0&&o<=0){e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:Ne(n)})});break}if(o>=0)break;t<=0&&(e=Object.assign(e,{[i]:null}),a-=1)}if(za(o,n,s)<0&&!We(e[t].stop)&&(e=We(e[t+1].stop)&&!e[t+1].actions.length?Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:Ne(Aa(e[t]))})}):[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:Ne(Aa(e[t])),stop:Ne(Ca(e[t+1])),actions:[]}),...e.slice(t+1)]),za(o,n,s)>=0)for(let t=a+1;t<e.length;t++){let i=Aa(e[a]),o=za(Ca(e[t]),i,s),n=za(Aa(e[t]),i,s);if(o>=0&&n<0)e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Ne(i)})});else{if(o<0)break;n>=0&&(e=Object.assign(e,{[t]:null}))}}return za(o,n,s)>0&&(t>0&&We(e[t-1].stop)?e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:Ne(n)})}):(e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:t>0?Ne(Aa(e[t-1])):"00:00:00",stop:Ne(n),actions:[]}),...e.slice(t)],a=t+1)),[e=e.filter(We),a]},Ea=(e,t)=>{const i=new Date(t),s=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let a=3600*e.hours+60*e.minutes-s;const o=a<0?-1:1;a=Math.abs(a);let n=Math.floor(a/3600),r=Math.round((a-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),ze({hours:n,minutes:r})},Da=86400;let Ma=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this._width=0,this.large=!1}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=t.contentRect.width;e!==this._width&&(this._width=e)}}),this._resizeObserver.observe(this)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._resizeObserver)||void 0===e||e.disconnect()}render(){return q`
      <div class="bar">${this.renderTimeslots()}</div>
      <div class="time-bar">${this.renderTimebar()}</div>
    `}renderTimebar(){const e=this._width,t=[1,2,3,4,6,8,12],i=De(this.hass.locale),s=i?130:100;if(!e)return q``;let a=Math.ceil(24/(e/s));for(;!t.includes(a);)a++;const o=[0,...Array.from(Array(24/a-1).keys()).map(e=>(e+1)*a),24];return o.map((e,t)=>{let s=a/24*100;s=Math.floor(100*s)/100;const n={mode:be.Fixed,hours:e,minutes:0};return 0==t?q`
          <span class="left" style=${Js({width:s/2+"%"})}
            >${Ne(n,{seconds:!1,am_pm:i})}</span
          >
        `:t==o.length-1?q`
          <span class="right" style=${Js({width:s/2+"%"})}
            >${Ne(n,{seconds:!1,am_pm:i})}</span
          >
        `:q`
          <span style=${Js({width:`${s}%`})}>${Ne(n,{seconds:!1,am_pm:i})}</span>
        `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,s)=>{const a=i.actions.length?bs(i.actions[0],this.hass,this.config.customize,!0,!0):"",o=5*a.length+10,n=s>0?15:0,r=s<e.length-1?15:0,d=t[s]-n-r,l=e[s+1];return q`
        <div
          class="slot ${this.selectedSlot==s?"selected":""} ${i.actions.length?"":"empty"} ${void 0===i.stop?"short":""}"
          style="${Js({width:`${t[s]}px`})}"
          @click=${this._toggleSelectTimeslot}
          idx="${s}"
        >
          ${i.stop,""}
          ${i.actions.length?a&&(d>o/3||d>50)&&d>30?q`<span style="margin-left: ${n}px; margin-right: ${r}px">${a}</span>`:d>16?q`<ha-icon icon="${Sa(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
        ${s<e.length-1&&i.stop?q`
              <div
                idx="${s}"
                class="handle ${this.selectedSlot==s+1||this.selectedSlot==s?"":"hidden"} ${l&&!l.stop?"center":""}"
              >
                <span>
                  <ha-icon-button
            ...
            `:""}
      `})}computeSlotWidths(){const e=this._width,t=this.schedule.slots,i=e-3*(t.length-1),s=t.map((e,i)=>{const s=Ae(e.start,this.hass);let a;if(void 0!==e.stop)a=Ae(e.stop,this.hass),!a&&s&&(a=Da);else{const e=t[i+1];a=e&&Ae(e.start,this.hass)||Da}return(a-s)/Da}),a=5/i,o=s.filter(e=>e<a).length,n=i-5*o,r=s.map(e=>e<a?5:e*n);return r}_toggleSelectTimeslot(e){let t=e.target;"div"!=t.tagName.toLowerCase()&&(t=t.parentElement);const i=Number(t.getAttribute("idx"));this.selectedSlot=this.selectedSlot!==i?i:null;const s=new CustomEvent("update",{detail:{selectedSlot:this.selectedSlot}});this.dispatchEvent(s),e.stopPropagation()}_handleDragStart(e){e.preventDefault(),e.stopPropagation();let t=e.target;for(;"DIV"!==t.tagName;)t=t.parentElement;const i=t.parentElement.getBoundingClientRect(),s=Number(t.getAttribute("idx")),a=this.config.time_step||15,o=60*a;let n=s>0?Ae(this.schedule.slots[s-1].stop||this.schedule.slots[s-1].start,this.hass)+o:o,r=(Ae(this.schedule.slots[s+1].stop||this.schedule.slots[s+1].start,this.hass)||Da)-o;void 0===this.schedule.slots[s+1].stop&&(r=(Ae(this.schedule.slots[s+2].stop||this.schedule.slots[s+2].start,this.hass)||Da)-o);const d=Ce(this.schedule.slots[s+1].start).mode;if([be.Sunrise,be.Sunset].includes(d)){const e=Ce(this.schedule.slots[s+1].start),t=Ae(Object.assign(Object.assign({},e),{hours:4,minutes:0}),this.hass),i=Ae(Object.assign(Object.assign({},e),{hours:-4,minutes:0}),this.hass);i>n&&(n=i),t<r&&(r=t)}let l=e=>{let t;e.preventDefault(),t="undefined"!=typeof TouchEvent&&e instanceof TouchEvent?e.changedTouches[0].pageX:e.pageX,t-=i.left,t>i.width&&(t=i.width),t<0&&(t=0);let o=Math.round(t/i.width*Da);o<n?o=n:o>r&&(o=r);const l=Math.floor(o/3600),c=Math.round((o-3600*l)/60);let u={mode:be.Fixed,hours:l,minutes:c};if([be.Sunrise,be.Sunset].includes(d)){const e=d==be.Sunrise?this.hass.states["sun.sun"].attributes.next_rising:this.hass.states["sun.sun"].attributes.next_setting,t=Ea(u,e);u={mode:d,hours:t.hours,minutes:t.minutes}}u=ze(u,a);const h=Ne(u);let m=[...this.schedule.slots];if(m=Object.assign(m,{[s]:Object.assign(Object.assign({},m[s]),{stop:h}),[s+1]:Object.assign(Object.assign({},m[s+1]),{start:Ne(u)})}),void 0===m[s+1].stop){const e=Ne(Se(u,{minutes:1}));m=Object.assign(m,{[s+2]:Object.assign(Object.assign({},m[s+2]),{start:e})})}this.schedule=Object.assign(Object.assign({},this.schedule),{slots:m});const p=new CustomEvent("update",{detail:{slots:m}});this.dispatchEvent(p)};const c=e=>{e.preventDefault()},u=()=>{window.removeEventListener("mousemove",l),window.removeEventListener("touchmove",l),window.removeEventListener("mouseup",u),window.removeEventListener("touchend",u),window.removeEventListener("blur",u),window.removeEventListener("dragstart",c),l=()=>{}};window.addEventListener("mouseup",u),window.addEventListener("touchend",u),window.addEventListener("blur",u),window.addEventListener("dragstart",c),window.addEventListener("mousemove",l),window.addEventListener("touchmove",l)}static get styles(){return r`
      :host {
        display: block;
        max-width: 100%;
        overflow: hidden;
    ...
    `}};t([le({attribute:!1})],Ma.prototype,"config",void 0),t([ce()],Ma.prototype,"schedule",void 0),t([ce()],Ma.prototype,"selectedSlot",void 0),t([ce()],Ma.prototype,"_width",void 0),t([le({type:Boolean})],Ma.prototype,"large",void 0),Ma=t([re("scheduler-timeslot-editor")],Ma);const La=e=>{const t=60*e.hours+e.minutes;return t>240?e=Object.assign(Object.assign({},e),{hours:4,minutes:0}):t<-240&&(e=Object.assign(Object.assign({},e),{hours:-4,minutes:0})),e};let Pa=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=be.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1,this.large=!1,this.stepSize=10}set time(e){const t=Ce(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return q`
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return V;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=be.Fixed&&(e=La(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return q`
        <div class="mode">
      ...
      `}{const e=[be.Fixed,be.Sunrise,be.Sunset],t={[be.Fixed]:es("ui.components.selectors.selector.types.time",this.hass),[be.Sunrise]:es("ui.panel.config.automation.editor.triggers.type.sun.sunrise",this.hass),[be.Sunset]:es("ui.panel.config.automation.editor.triggers.type.sun.sunset",this.hass)},i={[be.Fixed]:"mdi:clock-outline",[be.Sunrise]:"mdi:weather-sunset-up",[be.Sunset]:"mdi:weather-sunset-down"},s={[be.Fixed]:"M12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22C6.47,22 2,17.5 2,12A10,10 0 0,1 12,2M12.5,7V12.25L17,14.92L16.25,16.15L11,13V7H12.5Z",[be.Sunrise]:"M3,12H7A5,5 0 0,1 12,7A5,5 0 0,1 17,12H21A1,1 0 0,1 22,13A1,1 0 0,1 21,14H3A1,1 0 0,1 2,13A1,1 0 0,1 3,12M15,12A3,3 0 0,0 12,9A3,3 0 0,0 9,12H15M12,2L14.39,5.42C13.65,5.15 12.84,5 12,5C11.16,5 10.35,5.15 9.61,5.42L12,2M3.34,7L7.5,6.65C6.9,7.16 6.36,7.78 5.94,8.5C5.5,9.24 5.25,10 5.11,10.79L3.34,7M20.65,7L18.88,10.79C18.74,10 18.47,9.23 18.05,8.5C17.63,7.78 17.1,7.15 16.5,6.64L20.65,7M12.71,16.3L15.82,19.41C16.21,19.8 16.21,20.43 15.82,20.82C15.43,21.21 14.8,21.21 14.41,20.82L12,18.41L9.59,20.82C9.2,21.21 8.57,21.21 8.18,20.82C7.79,20.43 7.79,19.8 8.18,19.41L11.29,16.3C11.5,16.1 11.74,16 12,16C12.26,16 12.5,16.1 12.71,16.3Z",[be.Sunset]:"M3,12H7A5,5 0 0,1 12,7A5,5 0 0,1 17,12H21A1,1 0 0,1 22,13A1,1 0 0,1 21,14H3A1,1 0 0,1 2,13A1,1 0 0,1 3,12M15,12A3,3 0 0,0 12,9A3,3 0 0,0 9,12H15M12,2L14.39,5.42C13.65,5.15 12.84,5 12,5C11.16,5 10.35,5.15 9.61,5.42L12,2M3.34,7L7.5,6.65C6.9,7.16 6.36,7.78 5.94,8.5C5.5,9.24 5.25,10 5.11,10.79L3.34,7M20.65,7L18.88,10.79C18.74,10 18.47,9.23 18.05,8.5C17.63,7.78 17.1,7.15 16.5,6.64L20.65,7M12.71,20.71L15.82,17.6C16.21,17.21 16.21,16.57 15.82,16.18C15.43,15.79 14.8,15.79 14.41,16.18L12,18.59L9.59,16.18C9.2,15.79 8.57,15.79 8.18,16.18C7.79,16.57 7.79,17.21 8.18,17.6L11.29,20.71C11.5,20.9 11.74,21 12,21C12.26,21 12.5,20.9 12.71,20.71Z"},a=e=>{if(e==be.Fixed)return!1;const t=this._convertTimeMode(e);return Math.abs(60*t.hours+t.minutes)>240};return q`
        <ha-dropdown
          ...
          ?disabled=${this.disabled}
        >
          <ha-icon-button slot="trigger" .path=${s[this.mode]} ?disabled=${this.disabled}> </ha-icon-button>
          ${e.map(e=>q`
              <ha-dropdown-item
        ...
        <div class="suffix">
          ...
          ${this.mode!=be.Fixed?q`
                ...
                <ha-button appearance="plain" @click=${i}>
                  <ha-icon
                    icon="${this.mode==be.Sunrise?"mdi:weather-sunny":"mdi:weather-night"}"
                  ></ha-icon>
                </ha-button>
              `:V}
        </div>
      ...
      `:V}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=be.Fixed||this.mode==be.Fixed){const s=Ea({hours:this.hours,minutes:this.minutes},t),a=Ea({hours:this.hours,minutes:this.minutes},i),o=60*s.hours+s.minutes,n=60*a.hours+a.minutes,r=e||(Math.abs(o)<=Math.abs(n)?be.Sunrise:be.Sunset),d=r==be.Sunrise?s:a;return{mode:r,hours:d.hours,minutes:d.minutes}}{let e=this.mode==be.Sunrise?Ce(t):Ce(i);return e=Se(e,{hours:this.hours,minutes:this.minutes}),{mode:be.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Le(this.hours).am_pm;t=Pe(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.detail.value;if(Le(this.hours).am_pm==t)return;const i=Le(this.hours).hours;this.hours=Pe(i,"AM"==t?Me.AM:Me.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=Se(t,e),e.minutes&&(t=ze(t,this.stepSize)),this.mode!=be.Fixed&&(t=La(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};Es(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0,t=this.useAmPm&&this.mode==be.Fixed?Le(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==be.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};Pa.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([le({attribute:!1})],Pa.prototype,"hass",void 0),t([ce()],Pa.prototype,"hours",void 0),t([ce()],Pa.prototype,"minutes",void 0),t([ce()],Pa.prototype,"mode",void 0),t([le({type:Boolean})],Pa.prototype,"autoValidate",void 0),t([le({type:Boolean})],Pa.prototype,"required",void 0),t([le({type:Boolean})],Pa.prototype,"disabled",void 0),t([le({type:String})],Pa.prototype,"label",void 0),t([le({type:Boolean})],Pa.prototype,"useAmPm",void 0),t([le({type:Boolean})],Pa.prototype,"large",void 0),t([le({attribute:!1})],Pa.prototype,"stepSize",void 0),Pa=t([re("scheduler-time-picker")],Pa);const Na="Custom";let Ia=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![pe.Daily,pe.Weekend,pe.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0&&this._params.weekdays.length==this.selectedWeekdays.length}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
        ...
        <ha-dialog-header slot="header">
          ${this.weekdayTypeCustomSelected?q`
              ...
              `:q`
                ...
                ></ha-icon-button>
              `};
          <div slot="title">${Bi("ui.dialog.weekday_picker.title",this.hass)}</div>
        </ha-dialog-header>
        <div class="wrapper">
          <ha-list> ${this._renderWeekdayOptions()} </ha-list>
        </div>

        <ha-dialog-footer slot="footer">
          <ha-button appearance="plain" slot="secondaryAction" @click=${this.cancelClick} data-dialog="close">
            ${es("ui.common.cancel",this.hass)}
          </ha-button>
          <ha-button
            appearance="accent"
            slot="primaryAction"
    ...
    `:q``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[pe.Sunday,pe.Monday,pe.Tuesday,pe.Wednesday,pe.Thursday,pe.Friday,pe.Saturday];const t=(e,t)=>e.concat(e).slice(t,t+e.length);e=t(e,$s(this.hass))}else e=[pe.Daily,pe.Workday,pe.Weekend,Na];const t=e=>{var t,i;return e==Na?null===(t=this._params)||void 0===t?void 0:t.weekdays.some(e=>![pe.Daily,pe.Weekend,pe.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>q`
        <ha-list-item
          graphic="icon"
    ...
    `}};t([le({attribute:!1})],Ia.prototype,"hass",void 0),t([ce()],Ia.prototype,"_params",void 0),t([ce()],Ia.prototype,"weekdayTypeCustomSelected",void 0),t([ce()],Ia.prototype,"selectedWeekdays",void 0),Ia=t([re("dialog-select-weekdays")],Ia);var qa=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return Ia}});const Ra=(e,t)=>((e,t)=>e<t?-1:e>t?1:0)(e.toLowerCase(),t.toLowerCase()),Va=(e,t,i)=>{const s=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(e=>{if(!Object.keys(is).includes(t))return!1;let s=Object.keys(is[t]).includes(e);if(!s&&Object.keys(is[t]).includes("{entity_id}")){if("script"==t&&["turn_on","turn_off","reload","toggle","test"].includes(e))return!1;s=Ji(`${t}.${e}`,i)}return s}):[],a=t=>es(`component.${t}.title`,e,!1)||t.replace(/_/g," "),o=s=>{let o=Xi(bs({service:`${t}.${s}`,service_data:{}},e,i.customize));return"script"==t?Object.keys(i.customize||{}).includes(`${t}.${s}`)&&We(i.customize[`${t}.${s}`].name)?i.customize[`${t}.${s}`].name:`${Xi(Ss(`${t}.${s}`,e,i.customize))}: ${o}`:`${a(t)}: ${o}`},n=i=>{let s=es(`component.${t}.services.${i}.description`,e,!1);return s||(s=e.services[t][i].description),s||"script"!=t||(s=es(`component.${t}.services.turn_on.description`,e,!1)),s};let r=s.map(s=>{return{key:s,name:o(s),description:n(s),icon:(a=s,"script"==t&&Object.keys(i.customize||{}).includes(`${t}.${a}`)&&We(i.customize[`${t}.${a}`].icon)?i.customize[`${t}.${a}`].icon:Object.keys(us).includes(t)&&Object.keys(us[t].services).includes(a)?us[t].services[a]:Hs(t)),action:{service:s.includes(".")?s:`${t}.${s}`,service_data:{},target:e.services[t][s].target?{}:void 0}};var a}),d=(l=i.customize||{},c=t,Object.keys(l).filter(e=>{var t;return null===(t=l[e].exclude_actions)||void 0===t?void 0:t.length}).filter(e=>!c||!c.includes(".")&&Gi(Zi(e),c)||Gi(e,c)).map(e=>l[e].exclude_actions).flat().filter(We));var l,c;return d.length&&(r=r.filter(t=>!d.some(s=>Ra(Wi(t.action.service),s)>0||Ra(bs(t.action,e,i.customize),s)>0))),ns(i.customize||{},t).forEach(e=>{let i=e.service;for(;r.find(e=>e.key==i);)i+="_2";e.variables&&Object.entries(e.variables).forEach(([t,i])=>{let s=_s(i),a=Oa(s);!We(e.service_data[t])&&We(a)?e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:a})}):We(e.service_data[t])||(e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:null})}))}),r.push({key:i,name:`${a(t)}: ${Ha(e.name||o(Wi(e.service)))}`,description:Ha(e.name||""),icon:e.icon||Hs(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},target:e.target?e.target:void 0,name:e.name,icon:e.icon}})}),r},Ha=e=>{if(null!==/<.+?>/g.exec(e)){e=(new DOMParser).parseFromString(e,"text/html").body.textContent||""}let t;for(;t=/\[([^\]]+)\]/.exec(e);)e=e.replace(t[0],"");for(;t=/\{([^\}]+)\}/.exec(e);)e=e.replace(t[0],"");return e};let Ua=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.lockDomain=!1,this.showAll=!1}async showDialog(e){this._params=e,this.lockDomain=void 0!==e.domainFilter,this.showAll=!1,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title"),this.hass.loadBackendTranslation("services")}render(){return this._params?q`
      <ha-dialog open @closed=${this.closeDialog} @wa-after-show=${this._opened}>
        <div slot="header">
          <ha-dialog-header>
            ${void 0===this._params.domainFilter||this.lockDomain?q`
                ...
                `:q`
                  <ha-icon-button
                    slot="navigationIcon"
                    .label=${es("ui.common.back",this.hass)}
                    .path=${Ps}
                    @click=${this._clearDomain}
                  ></ha-icon-button>
                `}
            <div slot="title">${Bi("ui.dialog.action_picker.title",this.hass)}</div>
            ${!this.lockDomain&&We(this._params.cardConfig.include)?q` <ha-dropdown
                ...
                >
                  ...
                  <ha-dropdown-item @click=${this._toggleShowAll}>
                    ...
                    ${Bi("ui.dialog.action_picker.show_all",this.hass)}
                  </ha-dropdown-item>
                </ha-dropdown>`:""}
          </ha-dialog-header>
    ...
    `}};t([le({attribute:!1})],Ua.prototype,"hass",void 0),t([ce()],Ua.prototype,"_params",void 0),t([ce()],Ua.prototype,"_search",void 0),t([ce()],Ua.prototype,"_filter",void 0),t([ce()],Ua.prototype,"_width",void 0),t([ce()],Ua.prototype,"_height",void 0),t([ce()],Ua.prototype,"lockDomain",void 0),t([ce()],Ua.prototype,"showAll",void 0),Ua=t([re("dialog-select-action")],Ua);var Fa=Object.freeze({__proto__:null,get DialogSelectAction(){return Ua}});let Ba=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return q`
      ${this.showPrefix?q`
    ...
    `}};t([le({type:Boolean})],Ba.prototype,"showPrefix",void 0),Ba=t([re("scheduler-settings-row")],Ba);let Wa=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this.large=!1,this.selectedEntry=0}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return q`
          ...
          <div class="editor-header">
            ...
            <div class="weekdays-actions">
              <ha-button appearance="plain" size="small" @click=${this.toggleViewMode}>
                ${this.viewMode==me.Scheme?Bi("ui.panel.editor.toggle_single_mode",this.hass):Bi("ui.panel.editor.toggle_scheme_mode",this.hass)}
    ...
    `}renderSlot(){if(null===this.selectedEntry||null===this.selectedSlot)return q` <div class="slot-placeholder">${Bi("ui.panel.editor.select_timeslot",this.hass)}</div> `;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot],t=this.selectedSlot===this.schedule.entries[this.selectedEntry].slots.length-1;let i=e.stop;return!i&&this.selectedSlot<this.schedule.entries[this.selectedEntry].slots.length-1&&(i=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot+1].start),i||(i=e.start),q`
      ...
      ${Bi("ui.panel.editor.action",this.hass)}: ${this._renderActionConfig()}
    `}_renderActionConfig(){var e,t,i,s;const a=Object.assign({},this.schedule.entries[this.selectedEntry].slots[this.selectedSlot]),o=a.actions.length?a.actions[0]:void 0;if(!o)return q`
      ...
      `;const n=rs(o,this.config.customize),r=(null===(e=n.target)||void 0===e?void 0:e.domain)||Zi(o.service),d=We(null===(t=null==n?void 0:n.target)||void 0===t?void 0:t.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&We(null===(i=null===(t=rs(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return q``;const l=Object.keys(n.fields||{}).filter(e=>ya(o,e,this.hass,this.config.customize));let c="",u=[(null===(i=o.target)||void 0===i?void 0:i.entity_id)||[]].flat();return!u.length&&["notify","script"].includes(r)&&(u=[o.service]),u.length&&(c+=u.map(e=>Ss(e,this.hass,this.config.customize)).join(", "),c+=": "),c+=bs(o,this.hass,this.config.customize,!1,!0),q`
      <scheduler-collapsible-section ?expanded=${!0} ?disabled=${!0}>
        <div slot="header" class="header">
          <ha-icon slot="icon" icon="${Sa(o,this.config.customize)}"></ha-icon>
          <span>${Xi(c)}</span>
        </div>
        ...
        <ha-dropdown
          ...
          placement="bottom-end"
        >
          <ha-icon-button slot="trigger" .path=${Is}> </ha-icon-button>
          <ha-dropdown-item value="change_type">
            <ha-icon icon="mdi:pencil"></ha-icon>
            ${es("ui.panel.lovelace.editor.card.conditional.change_type",this.hass)}
          </ha-dropdown-item>
          <ha-dropdown-item variant="danger" value="delete">
            <ha-icon icon="mdi:delete"></ha-icon>
            ${es("ui.common.delete",this.hass)}
          </ha-dropdown-item>
        </ha-dropdown>
        ...
        <div slot="content">
          ${n.target?q`
                <scheduler-settings-row>
                  <span slot="heading">${es("ui.components.entity.entity-picker.entity",this.hass)}</span>
              ...
              `:""}
          ${l.map(e=>{var t;const i=hs(o.service,null===(t=o.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";const s=n.fields[e].optional||(i.number||{}).optional,a=!s||Object.keys(o.service_data).includes(e);return q`
              <scheduler-settings-row ?showPrefix=${s}>
                ${s?q`
                    ...
                    `:""}
                <span slot="heading"> ${((e,t,i,s)=>{var a;const o=Zi(e.service),n=Wi(e.service);let r=es(`component.${o}.services.${n}.fields.${t}.name`,i,!1);!r&&i.services[o]&&i.services[o][e.service]&&i.services[o][e.service].fields&&i.services[o][e.service].fields[t]&&(r=String(i.services[o][e.service].fields[t].name));const d=["script","notify"].includes(o)?[e.service]:[(null===(a=e.target)||void 0===a?void 0:a.entity_id)||[]].flat();let l=ns(s||{},d.length?d[0]:o);if(l.length){let i=l.map(i=>i.service==e.service&&Object.keys(i.variables||{}).includes(t)?(i.variables||{})[t].name:null).filter(We);if(i.length)return i[0]}return r||(r=t.replace(/_/g," ")),r})(o,e,this.hass,this.config.customize)} </span>
                <scheduler-combo-selector
                  .hass=${this.hass}
                  .config=${i}
                  ?disabled=${!a}
    ...
    `}};t([le({attribute:!1})],Wa.prototype,"hass",void 0),t([le({attribute:!1})],Wa.prototype,"config",void 0),t([le({attribute:!1})],Wa.prototype,"viewMode",void 0),t([le({attribute:!1})],Wa.prototype,"selectedSlot",void 0),t([le({type:Boolean})],Wa.prototype,"large",void 0),t([ce()],Wa.prototype,"schedule",void 0),t([ce()],Wa.prototype,"selectedEntry",void 0),Wa=t([re("scheduler-main-panel")],Wa);const Za=["January","February","March","April","May","June","July","August","September","October","November","December"];function Ka(e){return e.toISOString().split("T")[0]}function Ga(e){let t=new Date;const i=(e||"").match(/^([0-9]{4})-([0-9]{2})-([0-9]{2})/);null!==i&&t.setFullYear(Number(i[1]),Number(i[2])-1,Number(i[3]));const s=(e||"").match(/([0-9]{2}):([0-9]{2})(:([0-9]{2}))?$/);return null!==s&&t.setHours(Number(s[1]),Number(s[2]),s.length>4?Number(s[4]):t.getSeconds()),t}const Ja=(e,t)=>"select"in t&&null!==t.select?((e,t)=>{var i;return((null===(i=t.select)||void 0===i?void 0:i.options)||[]).some(t=>"object"==typeof t?t.value==e:t==e)})(String(e),t):"number"in t&&null!==t.number?((e,t)=>{var i,s;return!(isNaN(e)||void 0!==(null===(i=t.number)||void 0===i?void 0:i.min)&&e<t.number.min||void 0!==(null===(s=t.number)||void 0===s?void 0:s.max)&&e>t.number.max)})(Number(e),t):!("text"in t)||null===t.text||String(e).length>0,Ya=e=>null==e||Array.isArray(e)?e:[e];let Qa=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.showAll=!1}async showDialog(e){this._params=e,this.showAll=!1,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title")}render(){return this._params?q`
      <ha-dialog open @closed=${this.closeDialog} @wa-after-show=${this._opened}>
        <div slot="header">
          <ha-dialog-header>
            <ha-icon-button
              ...
              .path=${Ns}
            ></ha-icon-button>
            <div slot="title">${Bi("ui.panel.options.conditions.add_condition",this.hass)}</div>
            ${We(this._params.domain)?"":q` <ha-dropdown
                  placement="bottom-end"
                  slot="actionItems"
                  @wa-after-hide=${e=>{e.target.firstElementChild.blur()}}
                >
    ...
    `}};t([le({attribute:!1})],Qa.prototype,"hass",void 0),t([ce()],Qa.prototype,"_params",void 0),t([ce()],Qa.prototype,"_search",void 0),t([ce()],Qa.prototype,"_filter",void 0),t([ce()],Qa.prototype,"_width",void 0),t([ce()],Qa.prototype,"_height",void 0),t([ce()],Qa.prototype,"showAll",void 0),Qa=t([re("dialog-select-condition")],Qa);var Xa=Object.freeze({__proto__:null,get DialogSelectCondition(){return Qa}});let eo=class extends oe{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[],this.customTagValue=""}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||Ka(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||Ka(new Date);const i=(await Ms(this.hass)).map(e=>e.name),s=[this.config.tags||[]].flat();this.tags=[...new Set([...i,...s.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))])]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return q`
      ...
      <div class="period">
        ...
        <div class="input">
          <ha-date-input
            ...
            .label=${es("ui.components.date-range-picker.start_date",this.hass)}
        ...
        <div class="input">
          <ha-date-input
            .locale=${this.hass.locale}
            value=${this.endDate}
            .label=${es("ui.components.date-range-picker.end_date",this.hass)}
      ...
      <span class="header">${es("ui.common.name",this.hass)}:</span>
      <div class="period">
        <ha-input
          value=${this.schedule.name||""}
          placeholder=${this.schedule.name?"":es("ui.common.name",this.hass)}
      ...
      >
        ...
        ${es("ui.components.calendar.event.repeat.label",this.hass)}
      </ha-button>
      <ha-button
      ...
      >
        ...
        ${es("ui.dialogs.more_info_control.vacuum.stop",this.hass)}
      </ha-button>
      <ha-button
    ...
    `}renderConditions(){let e=this.schedule.entries[0].slots[0].conditions.items;return this.conditionIdx==e.length&&(e=[...e,{}]),e.map((e,t)=>{var i;const s=this.conditionIdx==t?this.selectedEntity||e.entity_id||"":e.entity_id||"",a=this.conditionIdx==t&&this.selectedDomain||Zi(s),o=ta(s||a,this.hass,this.config.customize),n=o&&o.hasOwnProperty("number")?[ge.Above,ge.Below]:[ge.Equal,ge.Unequal],r={[ge.Equal]:"mdi:equal",[ge.Unequal]:"mdi:not-equal-variant",[ge.Above]:"mdi:greater-than",[ge.Below]:"mdi:less-than"},d={[ge.Equal]:"ui.panel.options.conditions.types.equal_to",[ge.Unequal]:"ui.panel.options.conditions.types.unequal_to",[ge.Above]:"ui.panel.options.conditions.types.above",[ge.Below]:"ui.panel.options.conditions.types.below"};return this.conditionIdx!==t||this.selectedMatchType||(this.selectedMatchType=n[0]),q`
        <scheduler-collapsible-section idx="${t}">
          ...
          <div slot="content">
            <scheduler-settings-row>
              <span slot="heading"> ${es("ui.components.selectors.selector.types.entity",this.hass)} </span>
              <scheduler-entity-picker
                .hass=${this.hass}
                .config=${this.config}
                .domain=${a}
                @value-changed=${this._selectEntity}
                .value=${this.conditionIdx==t?Ya(this.selectedEntity):Ya(e.entity_id)}
                ?multiple=${!1}
              >
              </scheduler-entity-picker>
            </scheduler-settings-row>
            ...
            <scheduler-settings-row>
              <span slot="heading">
                ${Xi(Bi(d[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
                <ha-dropdown
                  @wa-select=${this._selectMatchType}
                  @wa-after-hide=${e=>{e.target.firstElementChild.blur()}}
                >
                  <ha-icon-button slot="trigger" .path=${qs}> </ha-icon-button>
                  ${n.map(i=>q`
                      <ha-dropdown-item
                      ...
                      >
                        ...
                        ${Xi(Bi(d[i],this.hass,["{entity}","{value}"],["",""]))}
                      </ha-dropdown-item>
                    `)}
                </ha-dropdown>
              </span>
    ...
    `}};t([le({attribute:!1})],eo.prototype,"hass",void 0),t([le({attribute:!1})],eo.prototype,"config",void 0),t([ce()],eo.prototype,"schedule",void 0),t([ce()],eo.prototype,"conditionIdx",void 0),t([ce()],eo.prototype,"selectedDomain",void 0),t([ce()],eo.prototype,"selectedEntity",void 0),t([ce()],eo.prototype,"selectedMatchType",void 0),t([ce()],eo.prototype,"conditionValue",void 0),t([ce()],eo.prototype,"conditionValid",void 0),t([ce()],eo.prototype,"startDate",void 0),t([ce()],eo.prototype,"endDate",void 0),t([le()],eo.prototype,"tags",void 0),t([ce()],eo.prototype,"customTagValue",void 0),eo=t([re("scheduler-options-panel")],eo);let to=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open @closed=${this.closeDialog} width="small">
        <ha-dialog-header slot="header">
          <ha-icon-button
            slot="navigationIcon"
    ...
    `:q``}confirmClick(){this._params.confirm()}cancelClick(){this._params.cancel()}};t([le({attribute:!1})],to.prototype,"hass",void 0),t([ce()],to.prototype,"_params",void 0),to=t([re("scheduler-generic-dialog")],to);var io=Object.freeze({__proto__:null,get GenericDialog(){return to}});let so=class extends oe{constructor(){super(...arguments),this.large=!1,this.selectedEntry=0,this.selectedSlot=null,this._panel="main",this._viewMode=me.Single}set viewMode(e){if(this._viewMode=e,e==me.Single){const e=this.schedule.entries[this.selectedEntry].slots.findIndex(e=>e.actions.length);this.selectedSlot=e>=0?e:1}}shouldUpdate(e){return 1!=e.size||!e.has("hass")||!We(this.hass)}async showDialog(e){var t;this._params=e,this.schedule=e.schedule,this._panel="main",this.large=!1;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length&&We(e.stop)).length>0||this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1||this.schedule.entries[this.selectedEntry].slots.length>3,s=this.schedule.entries[this.selectedEntry].slots.findIndex(e=>e.actions.length);this.selectedSlot=s>=0?s:null,this.viewMode=i?me.Scheme:(null===(t=this._params)||void 0===t?void 0:t.cardConfig.default_editor)||me.Single,await this.updateComplete}async closeDialog(){this._params=void 0}willUpdate(){this.hass.loadBackendTranslation("config")}render(){var e;return this._params?q`
      <ha-dialog open @closed=${this.closeDialog} width="${this.large?"full":"medium"}" prevent-scrim-close>
        <ha-dialog-header slot="header">
          ${"main"==this._panel?q`
                <ha-icon-button
                  slot="navigationIcon"
        ...
        <div class="buttons" slot="footer">
          ...
          <ha-button appearance="plain" @click=${this._handleSaveClick}>
            ${es("ui.common.save",this.hass)}
          </ha-button>
        </div>
      </ha-dialog>
    `:q``}_updateSchedule(e){const t=Object.keys(e.detail);if(t.includes("schedule")){const t=e.detail.schedule;this.schedule=t}t.includes("selectedSlot")&&(this.selectedSlot=e.detail.selectedSlot)}async _handleSaveClick(e){const t=ba(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const s={cancel:()=>i(!1),confirm:()=>i(!0),title:es("state_badge.default.error",this.hass),description:Bi(`ui.panel.editor.validation_errors.${t}`,this.hass),primaryButtonLabel:es("ui.common.ok",this.hass)};Es(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return io}),dialogParams:s})});else if(this.schedule.schedule_id){const t=Ie(await Ts(this.hass,this.schedule.schedule_id),this.hass);if(he(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Bi("ui.dialog.enable_schedule.title",this.hass),description:Bi("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:es("ui.common.yes",this.hass),secondaryButtonLabel:es("ui.common.no",this.hass),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};Es(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return io}),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=wa(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>ja(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=wa(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>ja(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Bi("ui.dialog.confirm_delete.title",this.hass),description:Bi("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:es("ui.common.ok",this.hass),secondaryButtonLabel:es("ui.common.cancel",this.hass)};Es(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return io}),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>ja(e,this,this.hass)).then(()=>{this.closeDialog()})})}_setViewMode(e){const t=e.detail,i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1;if(t==me.Scheme){this.viewMode=t;if(he([...this.schedule.entries],[...Be.entries]))this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...Fe.entries]});else{const e=this.schedule.entries.some(e=>e.slots.some(e=>void 0===e.stop));e&&(this.schedule=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map((e,t,i)=>{if(void 0!==e.stop)return e;const s=i[t+1];return Object.assign(Object.assign({},e),{stop:s?s.start:"00:00:00"})})}))}))}return}if(t==me.Single&&!i){if(he([...this.schedule.entries],[...Fe.entries]))this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...Be.entries]});else{const e=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>{let t=e.slots.findIndex(e=>e.actions.length);return t<0&&(t=Math.floor(e.slots.length/2)),Object.assign(Object.assign({},e),{slots:e.slots.map((e,i)=>i==t?Object.assign(Object.assign({},e),{stop:void 0}):null).filter(We)})})});this.schedule=Ie(e,this.hass)}return void(this.viewMode=t)}new Promise(t=>{const i={title:Bi("ui.dialog.confirm_migrate.title",this.hass),description:Bi("ui.dialog.confirm_migrate.description",this.hass),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};Es(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return io}),dialogParams:i})}).then(e=>{e&&(this.schedule=(e=>{const t=e=>{let t=e.findIndex(e=>e.actions.length);t<0&&(t=Math.floor(e.length/2));let i=Object.assign(Object.assign({},e[t]),{stop:void 0});const s=i.conditions,a=i.start;return[{start:"00:00:00",stop:a,actions:[],conditions:s},i,{start:Ne(Se(Ce(a),{minutes:1})),stop:"00:00:00",actions:[],conditions:s}]};return e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object(Object.assign(Object.assign({},e),{slots:t(e.slots)})))}),e})(this.schedule),this.viewMode=t)})}};so.styles=va,t([le({attribute:!1})],so.prototype,"hass",void 0),t([ce()],so.prototype,"_params",void 0),t([le({type:Boolean,reflect:!0})],so.prototype,"large",void 0),t([ce()],so.prototype,"schedule",void 0),t([ce()],so.prototype,"selectedEntry",void 0),t([ce()],so.prototype,"selectedSlot",void 0),t([ce()],so.prototype,"_panel",void 0),t([ce()],so.prototype,"_viewMode",void 0),so=t([re("dialog-scheduler-editor")],so);var ao=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return so}});
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */class oo extends Zs{constructor(e){if(super(e),this.et=V,e.type!==Bs)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===V||null==e)return this.ft=void 0,this.et=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}oo.directiveName="unsafeHTML",oo.resultType=1;const no=Ws(oo);var ro=window&&window.__assign||function(){return ro=Object.assign||function(e){for(var t,i=1,s=arguments.length;i<s;i++)for(var a in t=arguments[i])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e},ro.apply(this,arguments)};var lo={second:45,minute:45,hour:22,day:5};const co=(e,t,i)=>{if(i===Ee.am_pm||!i&&t.time_format===Ee.am_pm){const t=Le(e.getHours()).am_pm;return`${Le(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===Ee.twenty_four||!i&&t.time_format===Ee.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:De(t)}):De(t)?co(e,t,Ee.am_pm):co(e,t,Ee.twenty_four)};let uo=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},s=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return Za[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}, ${s(e,"year")}`}(e,this._hass.locale):s>7?a=Bi("ui.components.date.next_week_day",this._hass,"{weekday}",xs(e,"long",this._hass)):1==s?a=Bi("ui.components.date.tomorrow",this._hass):s>0&&(a=xs(e,"long",this._hass));let o=Bi("ui.components.time.absolute",this._hass,"{time}",co(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Bi("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Bi("ui.components.time.at_midnight",this._hass)),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=es("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=es("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=ro(ro({},lo),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var d=new Date(e),l=new Date(t),c=d.getFullYear()-l.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+d.getMonth()-l.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var h=a/604800;return{value:Math.round(h),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return q``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),q` ${Xi(this.relativeTime(this.datetime))} `}};t([le()],uo.prototype,"_hass",void 0),t([le()],uo.prototype,"datetime",void 0),uo=t([re("scheduler-relative-time")],uo);let ho=class extends oe{render(){var e,t,i,s,a;try{const o=this.hass.states[this.schedule.entity_id];if(!o)return q``;const n=["off","completed"].includes(o.state),r=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let d=Sa(r,this.config.customize);if("entity"==(null===(e=this.config.display_options)||void 0===e?void 0:e.icon)){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Zi(r.service))&&(e=r.service),e&&(d=sa(e,this.config.customize,this.hass))}const l=![(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat().every(e=>Object.keys(this.hass.states).includes(e));return l&&(d="mdi:help"),q`
        ...
        >
          ${this.renderDisplayItem((null===(s=this.config.display_options)||void 0===s?void 0:s.primary_info)||Re)}
          <div class="secondary">
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return q`
          ...
          ${t[1]?no(t[1]):""}
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){const t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return q` <div class="tags">${null==t?void 0:t.map(e=>q`<span class="tag">${e}</span>`)}</div>`}return no(e)};return zs(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>q`${t(e)}<br />`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_toggleEnableDisable(e){e.stopPropagation();const t=!e.target.checked;this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:this.schedule.entity_id})}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
    ...
    `}};t([le()],ho.prototype,"hass",void 0),t([le()],ho.prototype,"schedule_id",void 0),t([le()],ho.prototype,"schedule",void 0),t([le()],ho.prototype,"config",void 0),ho=t([re("scheduler-item-row")],ho),e.SchedulerCard=class extends oe{constructor(){super(...arguments),this._config={},this.showDiscovered=!1,this.translationsLoaded=!1,this.connectionError=!1}async setConfig(e){e=(e=>{const t=[];if(Ze(e,"include")&&!Qe(e.include)&&t.push("'include' must be a list of strings"),Ze(e,"exclude")&&!Qe(e.exclude)&&t.push("'exclude' must be a list of strings"),Ze(e,"discover_existing")&&!Ke(e.discover_existing)&&t.push("'discover_existing' must be a boolean"),!Ze(e,"title")||Ke(e.title)||Je(e.title)||t.push("'title' must be a boolean or string"),Ze(e,"time_step")&&(!Ge(e.time_step)||Number(e.time_step)<1||Number(e.time_step)>30)&&t.push("'time_step' must be a number between 1 and 30"),Ze(e,"show_header_toggle")&&!Ke(e.show_header_toggle)&&t.push("'show_header_toggle' must be a boolean"),Ze(e,"show_add_button")&&!Ke(e.show_add_button)&&t.push("'show_add_button' must be a boolean"),Ze(e,"show_toggle_switches")&&!Ke(e.show_toggle_switches)&&t.push("'show_toggle_switches' must be a boolean"),!Ze(e,"default_repeat_type")||Je(e.default_repeat_type)&&Object.values(fe).includes(e.default_repeat_type)||t.push("'default_repeat_type' must be one of: repeat, pause, single"),Ze(e,"display_options")&&(Ye(e.display_options)?(!Ze(e.display_options,"primary_info")||Je(e.display_options.primary_info)||Qe(e.display_options.primary_info)||t.push("in 'display_options': 'primary_info' must be a string or list of strings"),!Ze(e.display_options,"secondary_info")||Je(e.display_options.secondary_info)||Qe(e.display_options.secondary_info)||t.push("in 'display_options': 'secondary_info' must be a string or list of strings"),!Ze(e.display_options,"icon")||Je(e.display_options.icon)&&["action","entity"].includes(e.display_options.icon)||t.push("in 'display_options': 'icon' must be a set to either 'action' or 'entity' ")):t.push("'display_options' must be a struct")),!Ze(e,"sort_by")||Je(e.sort_by)||Qe(e.sort_by)||t.push("'sort_by' must be a string or list of strings"),Ze(e,"customize")&&!Ye(e.customize))t.push("'customize' must be a struct");else if(Ze(e,"customize")){const i=Object.entries(e.customize).map(([e,t])=>Xe(e,t)).filter(We);i.length&&t.push(...i)}if(!Ze(e,"tags")||Je(e.tags)||Qe(e.tags)||t.push("'tags' must be a string or list of strings"),!Ze(e,"exclude_tags")||Je(e.tags)||Qe(e.tags)||t.push("'exclude_tags' must be a string or list of strings"),t.length)throw new Error(`Invalid configuration provided (${t.length} error${t.length>1?"s":""}): ${t.join(", ")}.`);return e})(e),this._config=Object.assign({},e)}async firstUpdated(){await(async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider")&&customElements.get("ha-generic-picker"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.automation.load()})();document.querySelector("home-assistant")._loadFragmentTranslations(this.hass.language,"config"),await Ds(this.hass).then(e=>{e=Object.fromEntries(Object.entries(e).filter(([e])=>Ji(e,this._config))),this._config=Object.assign(Object.assign({},this._config),{customize:Object.assign(Object.assign({},e),this._config.customize||{})})})}willUpdate(){this.hass.loadBackendTranslation("services")}__checkSubscribed(){void 0===this.__unsubs&&this.isConnected&&void 0!==this.hass&&(this.__unsubs=this.hassSubscribe())}connectedCallback(){super.connectedCallback(),this.__checkSubscribed()}disconnectedCallback(){if(super.disconnectedCallback(),this.__unsubs){for(;this.__unsubs.length;){const e=this.__unsubs.pop();e instanceof Promise?e.then(e=>e()):e()}this.__unsubs=void 0}}updated(e){super.updated(e),e.has("hass")&&this.__checkSubscribed()}hassSubscribe(){return this.loadSchedules(),[this.hass.connection.subscribeMessage(e=>this.handleScheduleItemUpdated(e),{type:"scheduler_updated"})]}shouldUpdate(e){const t=e.get("hass"),i=e.get("_config");if(i&&this._config){const e=Object.keys(i).filter(e=>i[e]!==this._config[e]);e.some(e=>["tags","discover_existing","sort_by","display_options"].includes(e))&&(async()=>{await this.loadSchedules()})()}return!this.translationsLoaded&&es("component.input_boolean.services.turn_on.name",this.hass,!1).length&&es("ui.panel.config.automation.editor.conditions.type.sun.sunrise",this.hass,!1).length?(this.translationsLoaded=!0,!0):!t||1!=e.size||!this.schedules||Object.values(this.schedules).some(e=>JSON.stringify(t.states[e.entity_id])!==JSON.stringify(this.hass.states[e.entity_id]))}render(){let e=[...this.schedules||[]],t=e.filter(e=>Yi(e,this._config)),i=e.filter(e=>!Yi(e,this._config));const s=this.showDiscovered?e.some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")}):t.some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")});return q`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${!We(this._config.title)||"boolean"==typeof this._config.title&&this._config.title?Bi("ui.panel.common.title",this.hass):"boolean"==typeof this._config.title?"":this._config.title}
          </div>

          ${Object.keys(this.schedules||{}).length&&this._config.show_header_toggle?q` <ha-switch ?checked=${s} @change=${this.toggleDisableAll}> </ha-switch> `:""}
        </div>
          ...
          ${this.connectionError?q`
                <div>
                  <hui-warning .hass=${this.hass}>
                    <span style="white-space: normal"> ${Bi("ui.panel.overview.backend_error",this.hass)} </span>
                  </hui-warning>
                </div>
              `:Object.keys(e).length?t.map(e=>q`
                  ...
                  `):q` <div>${Bi("ui.panel.overview.no_entries",this.hass)}</div> `}
        ...
        ${!1!==this._config.show_add_button?q` <div class="card-actions">
              ${this.connectionError?q`
                    <ha-button appearance="plain" variant="warning" @click=${this._retryConnection}
                      >${es("ui.common.refresh",this.hass)}
                    </ha-button>
                  `:q`
                    <ha-button appearance="plain" @click=${this._addClick}
                      >${es("ui.common.add",this.hass)}
                    </ha-button>
                  `}
            </div>`:""}
      </ha-card>
    `}async loadSchedules(){Oe(this.hass).then(e=>{this.schedules=As(e,this._config,this.hass)}).catch(e=>{this.schedules=[],this.connectionError=!0})}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{var s;if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let a=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(a+=1);const o=(([(null===(s=this._config.display_options)||void 0===s?void 0:s.secondary_info)||[]].flat().length||2)+1)/2;this.schedules&&(a+=this.showDiscovered?Object.keys(this.schedules).length*o:Object.values(this.schedules).filter(e=>Yi(e,this._config)).length*o),clearInterval(i),e(Math.round(a))},50)})}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?Ts(this.hass,e.schedule_id).then(t=>{const i=this.schedules.findIndex(t=>t.schedule_id==e.schedule_id),s=i>=0?this.schedules[i]:null;let a=[...this.schedules||[]];!t||!1===this._config.discover_existing&&!Yi(t,this._config)?s&&(a=a.filter(t=>t.schedule_id!==e.schedule_id)):s?s.timestamps[s.next_entries[0]||0]==t.timestamps[t.next_entries[0]||0]?a=Object.assign(a,{[i]:t}):(a=Object.assign(a,{[i]:t}),a=As(a,this._config,this.hass)):a=As([...a,t],this._config,this.hass),this.schedules=[...a]}):this.schedules=(this.schedules||[]).filter(t=>t.schedule_id!==e.schedule_id)}_handleEditClick(e,t){if(!this.schedules)return;const i={schedule:Ie(t,this.hass),cardConfig:this._config,editItem:t.schedule_id};Es(e.target,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then(function(){return ao}),dialogParams:i})}_addClick(e){const t=[this._config.tags||[]].flat().filter(e=>!["none","disabled","enabled"].includes(e));let i=this._config.default_editor==me.Scheme?JSON.parse(JSON.stringify(Fe)):JSON.parse(JSON.stringify(Be));const s=this._config.default_repeat_type;s&&Object.values(fe).includes(s)&&(i=Object.assign(Object.assign({},i),{repeat_type:s}));const a={schedule:Object.assign(Object.assign({},i),{tags:1==t.length?t:[]}),cardConfig:this._config};Es(this,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then(function(){return ao}),dialogParams:a})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked,i=Object.values(this.schedules).filter(e=>this.showDiscovered||Yi(e,this._config));i.forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}static getConfigElement(){return document.createElement("scheduler-card-editor")}},e.SchedulerCard.styles=r`
    .card-header {
      display: flex;
      justify-content: space-between;
    }
