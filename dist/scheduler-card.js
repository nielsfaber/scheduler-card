...
/**
        ...
        <div slot="heading">
          <ha-dialog-header>
            <ha-icon-button
              slot="navigationIcon"
              dialogAction="cancel"
              .label=${Wi("ui.dialogs.more_info_control.dismiss",this.hass)}
              .path=${Ss}
            ></ha-icon-button>
            <span slot="title">
          ...
          <ha-textfield
            dialogInitialFocus
            .placeholder=${Wi("ui.common.search",this.hass)}
            aria-label=${Wi("ui.common.search",this.hass)}
            ...
            <div class="trailing" slot="trailingIcon">
              ${this._search&&q`
                <ha-icon-button
                  ...
                  .label=${Wi("ui.common.clear",this.hass)}
                  .path=${Ss}
                  class="clear-button"
                ></ha-icon-button>
              `}
    ...
    `:q``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("mwc-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_toggleSelectEntity(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;t.querySelector("ha-checkbox");const i=t.getAttribute("key");this._params.entities.includes(i)?this._params=Object.assign(Object.assign({},this._params),{entities:this._params.entities.filter(e=>e!=i)}):this._params=Object.assign(Object.assign({},this._params),{entities:[...this._params.entities,i]})}_toggleSelectDomain(e){var t;let i=e.target;for(;"MWC-LIST-ITEM"!=i.tagName;)i=i.parentElement;const s=i.getAttribute("key"),a=null===(t=this.options)||void 0===t?void 0:t.find(e=>e.key==s).entities.map(e=>e.key);this._params.domains.includes(s)?this._params=Object.assign(Object.assign({},this._params),{domains:this._params.domains.filter(e=>e!=s),entities:this._params.entities.filter(e=>!(null==a?void 0:a.includes(e)))}):this._params=Object.assign(Object.assign({},this._params),{domains:[...this._params.domains,s]}),e.stopPropagation()}closeGroupByKey(e){this.shadowRoot.querySelector("mwc-list").childNodes.forEach(t=>{if(t.nodeType==Node.ELEMENT_NODE&&"MWC-LIST-ITEM"==t.tagName&&t.getAttribute("key")==e){const e=t,i=e.nextElementSibling,s=e.querySelector("ha-icon-button");i.style.height="0px",e.removeAttribute("expanded"),s.classList.remove("expanded")}})}async _toggleExpandGroup(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;const i=t.querySelector("ha-icon-button"),s=t.getAttribute("key");this.expandedGroups.includes(s)||(this.expandedGroups.forEach(e=>this.closeGroupByKey(e)),this.expandedGroups=[s],await this.requestUpdate());const a=t.nextElementSibling,o=a.scrollHeight;t.hasAttribute("expanded")?(t.removeAttribute("expanded"),i.classList.remove("expanded"),a.style.height="0px",setTimeout(()=>{this.expandedGroups=this.expandedGroups.filter(e=>e!=s)},300)):(t.setAttribute("expanded","true"),i.classList.add("expanded"),a.style.height=o+"px")}_renderOptions(){if(!this.options)return;let e=[...this.options];const t=this._filter&&this._filter.trim().length;if(t){const t=this._filter.toLowerCase().trim().split(" ");e=e.map(e=>Zs(e,t)||(e=Object.assign(Object.assign({},e),{entities:(e.entities||[]).filter(e=>Zs(e,t))})).entities.length?e:void 0).filter(e=>void 0!==e)}return e.length?Object.keys(e).map(i=>{var s,a;const o=e[i].key,n=null===(s=this._params)||void 0===s?void 0:s.domains.includes(o);let r=[...e[i].entities];"switch"==o&&(r=r.filter(e=>!this.scheduleEntities.includes(e.key)));const l=n?r.length:r.filter(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)}).length;return q`
        ...
        >
          ...
          <div slot="meta" class="meta">
            <ha-button
              ...
              size="small"
            >
              ${(null===(a=this._params)||void 0===a?void 0:a.domains.includes(o))||e[i].entities.every(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)})?Wi("ui.components.media-browser.file_management.deselect_all",this.hass):Wi("ui.components.subpage-data-table.select_all",this.hass)}
            </ha-button>
            <ha-icon-button .path="${Os}" @click=${e=>{e.target.blur()}} class="chevron"></ha-icon-button>
          </div>
          <span>${e[i].name}</span>
      ...
      `}):q`
        <mwc-list-item disabled>
          ${Wi("ui.components.entity.entity-picker.no_match",this.hass)}
        </mwc-list-item>
    ...
    `}};t([de({attribute:!1})],Ks.prototype,"hass",void 0),t([ce()],Ks.prototype,"_params",void 0),t([ce()],Ks.prototype,"_search",void 0),t([ce()],Ks.prototype,"_filter",void 0),t([ce()],Ks.prototype,"_width",void 0),t([ce()],Ks.prototype,"_height",void 0),t([ce()],Ks.prototype,"expandedGroups",void 0),t([ce()],Ks.prototype,"options",void 0),t([ce()],Ks.prototype,"scheduleEntities",void 0),Ks=t([re("dialog-select-entities")],Ks);var Gs=Object.freeze({__proto__:null,get DialogSelectEntities(){return Ks}});let Js=class extends oe{constructor(){super(...arguments),this.active=!1}render(){return q`
    ...
    `}renderIcon(){if(!this.icon&&!this.toggleable&&!this.useStateIcon)return V;if(this.toggleable)return q`
      ...
      `:q`
        <div class="trailing-icon" @click=${this._iconClick}>
          ...
          ${this.disabled?V:q`<ha-tooltip for="${e}">${Wi("ui.common.remove",this.hass)}</ha-tooltip>`}
        </div>
    ...
    `}};t([de({attribute:!1})],Js.prototype,"hass",void 0),t([de({type:String})],Js.prototype,"icon",void 0),t([de({type:Boolean})],Js.prototype,"useStateIcon",void 0),t([de({type:Boolean})],Js.prototype,"selectable",void 0),t([de({type:Boolean})],Js.prototype,"removable",void 0),t([de({type:Boolean})],Js.prototype,"toggleable",void 0),t([de({type:Boolean})],Js.prototype,"active",void 0),t([de({type:String})],Js.prototype,"badge",void 0),t([de({type:String})],Js.prototype,"value",void 0),t([de({type:Boolean})],Js.prototype,"disabled",void 0),Js=t([re("scheduler-chip")],Js);let Ys=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?q`
    ...
    `}};t([de({attribute:!1})],Ys.prototype,"hass",void 0),t([de({attribute:!1})],Ys.prototype,"items",void 0),t([de({attribute:!1})],Ys.prototype,"value",void 0),t([de({type:Boolean})],Ys.prototype,"selectable",void 0),t([de({type:Boolean})],Ys.prototype,"toggleable",void 0),t([de({type:Boolean})],Ys.prototype,"removable",void 0),t([de({type:Boolean})],Ys.prototype,"disabled",void 0),Ys=t([re("scheduler-chip-set")],Ys);let Qs=class extends oe{constructor(){super(...arguments),this.autofocus=!1,this.disabled=!1,this.hideClearIcon=!1,this._opened=!1,this._isOpening=!1,this._items=[],this._getItems=()=>{const e=(this.getItems?this.getItems():[]).sort((e,t)=>Ui(e.primary,t.primary));return e.length||e.push({id:"___no_matching_items_found___",primary:Ni("ui.dialog.entity_picker.no_results",this.hass),icon:"mdi:cancel"}),e}}shouldUpdate(e){return!!(e.has("value")||e.has("label")||e.has("disabled"))||!(!e.has("_opened")&&this._opened)}willUpdate(e){e.has("_opened")&&this._opened&&(this._items=this._getItems())}render(){const e=!!this.value&&!this.disabled&&!this.hideClearIcon;return q`
    ...
    `}get _value(){return this.value||""}_renderHelper(){return this.helper?q`<ha-input-helper-text .disabled=${this.disabled}
        ...
        >`:V}_valueChanged(e){var t;e.stopPropagation(),this._comboBox.setTextFieldValue("");const i=null===(t=e.detail.value)||void 0===t?void 0:t.trim();"___no_matching_items_found___"!==i&&(this._items.find(e=>e.id==i)||this.allowCustomValue)&&i!==this._value&&this._setValue(i)}_filterChanged(e){if(!this._opened)return;let t=this._items;const i=e.target,s=e.detail.value.trim().split(" ").map(String).filter(e=>e.length).map(e=>e.trim());s.length&&(t=t.filter(e=>s.every(t=>{var i;return e.primary.includes(t)||(null===(i=e.secondary)||void 0===i?void 0:i.includes(t))}))),i.filteredItems=t}_clear(e){e.stopPropagation(),this._setValue(void 0)}_setValue(e){this.value=e,xs(this,"value-changed",{value:e})}async focus(){var e;await this.updateComplete,await(null===(e=this._comboBox)||void 0===e?void 0:e.focus())}async open(){var e;this._opened=!0,this._isOpening=!0,await this.updateComplete,null===(e=this._comboBox)||void 0===e||e.focus(),this._comboBox.open(),this._comboBox.value=""}async _openedChanged(e){var t;const i=e.detail.value;e.stopPropagation(),this._isOpening?this._isOpening=!1:this._opened&&!i&&(this._opened=!1,await this.updateComplete,null===(t=this._field)||void 0===t||t.focus())}static get styles(){return[r`
        .container {
          position: relative;
          display: block;
        }
      ...
      `]}};t([de({attribute:!1})],Qs.prototype,"hass",void 0),t([de({type:Boolean})],Qs.prototype,"autofocus",void 0),t([de({type:Boolean})],Qs.prototype,"disabled",void 0),t([de({type:Boolean,attribute:"allow-custom-value"})],Qs.prototype,"allowCustomValue",void 0),t([de()],Qs.prototype,"label",void 0),t([de()],Qs.prototype,"value",void 0),t([de()],Qs.prototype,"helper",void 0),t([de()],Qs.prototype,"placeholder",void 0),t([de({type:String,attribute:"search-label"})],Qs.prototype,"searchLabel",void 0),t([de({attribute:"hide-clear-icon",type:Boolean})],Qs.prototype,"hideClearIcon",void 0),t([de({attribute:!1,type:Array})],Qs.prototype,"getItems",void 0),t([de({attribute:!1,type:Array})],Qs.prototype,"getAdditionalItems",void 0),t([de({attribute:!1})],Qs.prototype,"rowRenderer",void 0),t([de({attribute:!1})],Qs.prototype,"valueRenderer",void 0),t([de({attribute:"not-found-label",type:String})],Qs.prototype,"notFoundLabel",void 0),t([he(".textInput")],Qs.prototype,"_field",void 0),t([he("ha-combo-box")],Qs.prototype,"_comboBox",void 0),t([ce()],Qs.prototype,"_opened",void 0),Qs=t([re("scheduler-picker")],Qs);let Xs=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this.multipleMode=!1,this.scheduleEntities=[],this._valueRenderer=e=>{Array.isArray(e)&&(e=e.length?[...e].pop():"");const t=e||"",i=this.hass.states[t];if(!i)return q`
        <ha-svg-icon
          slot="start"
          .path=${Es}
          style="margin: 0 4px"
    ...
    `}renderChips(){if(!this.multiple)return V;let e=(this.value||[]).map(e=>{const t=this._parseEntityItem(e);return{name:t.primary,value:e,useStateIcon:!t.icon,icon:t.icon}});return q`
      ...
      <ha-icon-button
        ...
        .path=${this.multipleMode?"M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z":Os}
        slot="end"
      ></ha-icon-button>
      `:V}
      </div>
      </div>
      `}_valueChanged(e){let t=e.detail.value;const i=e.currentTarget;t&&(this.value=[...this.value||[],t],this.multiple&&(i.value=""),xs(this,"value-changed",{value:this.value}),e.stopPropagation())}_removeClick(e){const t=e.detail;this.value=(this.value||[]).filter(e=>e!==t),xs(this,"value-changed",{value:this.value})}_parseEntityItem(e){var t,i,s,a;const o=Object.entries((null===(t=this.config)||void 0===t?void 0:t.customize)||{}).filter(([t,i])=>Hi(t,e)).map(([e,t])=>t),n=null===(i=o.find(e=>"name"in e))||void 0===i?void 0:i.name,r=null===(s=o.find(e=>"icon"in e))||void 0===s?void 0:s.icon;return{id:e,primary:n||Vi(e,null===(a=this.hass.states[e])||void 0===a?void 0:a.attributes),secondary:e,icon:r}}};Xs.styles=r`
    :host {
      display: flex;
  ...
  `,t([de({attribute:!1})],Xs.prototype,"hass",void 0),t([de()],Xs.prototype,"domain",void 0),t([de()],Xs.prototype,"config",void 0),t([de({type:Array})],Xs.prototype,"value",void 0),t([de({type:Boolean})],Xs.prototype,"multiple",void 0),t([de({type:Boolean})],Xs.prototype,"disabled",void 0),t([ce()],Xs.prototype,"multipleMode",void 0),t([ce()],Xs.prototype,"scheduleEntities",void 0),Xs=t([re("scheduler-entity-picker")],Xs);let ea=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
      <div
    ...
    `}};t([de()],ta.prototype,"disabled",void 0),t([ce()],ta.prototype,"_openedItem",void 0),t([ce()],ta.prototype,"_numItems",void 0),ta=t([re("scheduler-collapsible-group")],ta);let ia=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){var e;if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),xs(this,"value-changed",{value:this.value})},s=()=>{let e=t.map(e=>Object({name:e,value:e}));return q`
      ...
      `}if(this.config.number){const t=this.config.number,i="box"==t.mode||!Ze(t.min)||!Ze(t.max);let s=this.value;i||"number"==typeof s||(s=t.min),"number"==typeof t.scale_factor&&(s=Number(s)/t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(s=Math.round(Number(s)/t.step)*t.step),Ze(s)&&(s=Xi(Number(s)));const a=e=>{let i=Number(e.target.value);"number"==typeof t.scale_factor&&(i*=t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(i=Math.round(i/t.step)*t.step),i=Xi(i),this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}})),e.stopPropagation()},o=e=>{e.stopPropagation();let t=e.target.value;const i=""===t||isNaN(Number(t))?void 0:Number(t);this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}}))},n=(e,i)=>{let s=t.step&&Number(t.step)%1==0?null!==e.match(/^-?\d+$/):null!==e.match(/^[+-]?\d+([.,]\d+)?$/);return s&&Ze(t.min)&&(s=Number(e)>=t.min),s&&Ze(t.max)&&(s=Number(e)<=t.max),{valid:s,customError:!s}};return q`
      ...
      `}return q``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t],e.target.value=""}else if(e.detail){let t=e.detail.value;void 0===t&&(t=null),this.value=t}else this.value=e.target.value;xs(this,"value-changed",{value:this.value})}};ia.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
  ...
  `,t([de({attribute:!1})],sa.prototype,"hass",void 0),t([de()],sa.prototype,"_config",void 0),t([de()],sa.prototype,"title",void 0),t([de()],sa.prototype,"tagOptions",void 0),sa=t([re("scheduler-card-editor")],sa);const aa=r`
  ha-dialog {
...
`,(e,t,i,s)=>{var a;const o=e.service,n=null===(a=e.target)||void 0===a?void 0:a.entity_id,r=Qi(e,s);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const l=r.fields[t];if(null===ss(o,n,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(l.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&l.supported_features)>0}))return!1}return!("light"==Ri(o)&&![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;const s=i.states[e].attributes.supported_color_modes||[];return"brightness"!=t||s.filter(e=>"onoff"!=e).length}))});var na;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(na||(na={}));const ra=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>e.every((i,s)=>{const a=Te(i.start,t),o=void 0===i.stop?a:Te(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>{if(i<=s)return!0;return Te(e.start,t)>=o})})?null:na.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,na.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{var s;const a=Qi(e,i);return(null==a?void 0:a.target)&&!(null===(s=e.target)||void 0===s?void 0:s.entity_id)?na.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).filter(([s])=>oa(e,s,t,i)).every(([s,a])=>{var o,n;let r=ss(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,s,t,i);const l=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||a.optional;return!(!Object.keys(e.service_data).includes(s)&&!l)&&!(!Ze(e.service_data[s])&&!l)})?na.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},la=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(da),timeslots:e.entries[0].slots.map(ca),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},da=e=>{switch(e){case ge.Monday:return"mon";case ge.Tuesday:return"tue";case ge.Wednesday:return"wed";case ge.Thursday:return"thu";case ge.Friday:return"fri";case ge.Saturday:return"sat";case ge.Sunday:return"sun";case ge.Workday:return"workday";case ge.Weekend:return"weekend";default:return"daily"}},ca=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>ua(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ve.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),ua=e=>{var t,i;const s=e=>Object.keys(e).filter(t=>Ze(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>({service:e.service,service_data:s(e.service_data),entity_id:t}))}return{service:e.service,service_data:s(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:s(e.service_data)}},ha=(e,t,i)=>{const s={title:Wi("state_badge.default.error",i),description:q`
    <b>Something went wrong!</b><br />
    ${e.body.message}<br /><br />
    ${e.error}<br /><br />
    Please <a href="https://github.com/nielsfaber/scheduler-card/issues">report</a> the bug.
  `,primaryButtonLabel:Wi("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};xs(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Va})),dialogParams:s})},ma=e=>{if(!Object.keys(e).includes("select")||!e.select){if(Object.keys(e).includes("number")&&e.number){const t=e.number.min;return void 0!==t?t:0}return Object.keys(e).includes("boolean")&&e.boolean?void 0:(Object.keys(e).includes("text")&&e.text,"")}e.select.options},pa=(e,t)=>{const i=Qi(e,t),s=Ri(e.service),a=qi(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:"mdi:"+o;if(Object.keys(is).includes(s)&&Object.keys(is[s].services).includes(a)){if(void 0!==is[s].attributes){let t=is[s].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return is[s].services[a]}return Object.keys(is).includes(s)&&Object.keys(is[s].services).includes("{entity_id}")?is[s].services["{entity_id}"]:"mdi:flash";var o},_a=(e,t,i)=>{let s=Te("string"==typeof e?Ee(e):e,i),a=Te("string"==typeof t?Ee(t):t,i);return a>s?1:a<s?-1:0},ga=e=>Ee(e.start),va=e=>{if(Ze(e.stop)){const t=Ee(e.stop);return 0==t.hours&&0==t.minutes&&t.mode==we.Fixed?Object.assign(Object.assign({},t),{hours:24}):t}return Ce(ga(e),{minutes:1})},ya=(e,t,i,s)=>{let a=t;if(i.stop)return[e,a]=ya(e,t+1,{start:i.stop},s),[e,a-1];if(i.start){let o=ga(e[t]),n=i.start;if(_a(o,n,s)<0){let i=ga(e[t]);for(let s=t-1;s>=0;s--){if(e[s].actions.length){i=s==t-1?Ce(ga(e[s]),{minutes:1}):va(e[s]);break}i=ga(e[s])}_a(i,n,s)<0&&(n=i),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:qe(n)})});for(let i=t-1;i>=0;i--){let t=_a(ga(e[i]),n,s),o=_a(va(e[i]),n,s);if(t>0&&o<0){e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:qe(n)})});break}if(o>=0)break;t<=0&&(e=Object.assign(e,{[i]:null}),a-=1)}Ze(e[t].stop)||(e=Ze(e[t+1].stop)&&!e[t+1].actions.length?Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:qe(va(e[t]))})}):[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:qe(va(e[t])),stop:qe(ga(e[t+1])),actions:[]}),...e.slice(t+1)])}else if(_a(o,n,s)>0){let i=Ce(va(e[t]),{minutes:-1});if(!Ze(e[t].stop))for(let s=t+1;s<e.length;s++){if(e[s].actions.length){i=s==t+1?Ce(va(e[s]),{minutes:-1}):ga(e[s]);break}i=va(e[s])}_a(i,n,s)>0&&Te(i,s)>0&&(n=i),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:qe(n)})}),t>0&&Ze(e[t-1].stop)?e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:qe(n)})}):(e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:t>0?qe(va(e[t-1])):"00:00:00",stop:qe(n),actions:[]}),...e.slice(t)],a=t+1);for(let t=a+1;t<e.length;t++){let i=va(e[a]),o=_a(ga(e[t]),i,s),n=_a(va(e[t]),i,s);if(o>0&&n<0)e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:qe(i)})});else{if(o<0)break;n>=0&&(e=Object.assign(e,{[t]:null}))}}}}return[e=e.filter(Ze),a]},fa=(e,t)=>{const i=new Date(t),s=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let a=3600*e.hours+60*e.minutes-s;const o=a<0?-1:1;a=Math.abs(a);let n=Math.floor(a/3600),r=Math.round((a-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),Ae({hours:n,minutes:r})};let ba=class extends oe{constructor(){super(),this.selectedSlot=null,this.timeout=0,this.large=!1,this.handleResize=this.handleResize.bind(this)}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){}render(){return q`
      <div class="bar">
    ...
    `}renderTimebar(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=[1,2,3,4,6,8,12],i=Le(this.hass.locale),s=i?130:100;let a=Math.ceil(24/(e/s));for(;!t.includes(a);)a++;const o=[0,...Array.from(Array(24/a-1).keys()).map(e=>(e+1)*a),24];return o.map((e,t)=>{let s=a/24*100;s=Math.floor(100*s)/100;let n={mode:we.Fixed,hours:e,minutes:0};return 0==t?q`
        <span class="left" style=${qs({width:s/2+"%"})}>${qe(n,{seconds:!1,am_pm:i})}</span>
      `:t==o.length-1?q`
        <span class="right" style=${qs({width:s/2+"%"})}>${qe(n,{seconds:!1,am_pm:i})}</span>
      `:q`
        <span style=${qs({width:s+"%"})}>${qe(n,{seconds:!1,am_pm:i})}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,s)=>{let a=Te(i.start,this.hass),o=Te(i.stop||i.start,this.hass);!o&&a&&(o=86400);const n=(o-a)/86400*100,r=i.actions.length?us(i.actions[0],this.hass,this.config.customize,!0,!0):"",l=parseFloat(getComputedStyle(this).getPropertyValue("width")),d=5*r.length+10,c=s>0?15:0,u=s<e.length-1?15:0,h=n*l/100-c-u,m=e[s+1];return q`
        <div
          class="slot ${this.selectedSlot==s?"selected":""} ${i.actions.length?"":"empty"} ${void 0===i.stop?"short":""}"
          style="${qs({width:t[s]+"px"})}"
          @click=${this._toggleSelectTimeslot}
          idx="${s}"
        >
          ${i.stop,""}
          ${i.actions.length?r&&(h>d/3||h>50)&&h>30?q`<span style="margin-left: ${c}px; margin-right: ${u}px">${r}</span>`:h>16?q`<ha-icon icon="${pa(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
    ...
    `}};t([de({attribute:!1})],ba.prototype,"config",void 0),t([ce()],ba.prototype,"schedule",void 0),t([ce()],ba.prototype,"selectedSlot",void 0),t([de({type:Boolean})],ba.prototype,"large",void 0),t([function(e){return ue({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}({passive:!0})],ba.prototype,"_handleDragStart",null),ba=t([re("scheduler-timeslot-editor")],ba);const ka=e=>{let t=60*e.hours+e.minutes;return t>240?e=Object.assign(Object.assign({},e),{hours:4,minutes:0}):t<-240&&(e=Object.assign(Object.assign({},e),{hours:-4,minutes:0})),e};let wa=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=we.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1,this.large=!1,this.stepSize=10}set time(e){const t=Ee(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return q`
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return V;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=we.Fixed&&(e=ka(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return q`
        <div class="mode">
    ...
    `}}_renderSuffix(){if(this.large){const e=()=>{let e=Ie(this.hours).am_pm;const t=Ie(this.hours).hours;this.hours=Ne(t,"AM"==e?Pe.PM:Pe.AM),this._valueChanged()},t=()=>{0!=this.hours?this.hours=-this.hours:this.minutes=-this.minutes,this._valueChanged()},i=()=>{this.mode=this.mode==we.Sunrise?we.Sunset:we.Sunrise,this._valueChanged()};return q`
      ...
      `:V}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=we.Fixed||this.mode==we.Fixed){const s=fa({hours:this.hours,minutes:this.minutes},t),a=fa({hours:this.hours,minutes:this.minutes},i),o=60*s.hours+s.minutes,n=60*a.hours+a.minutes;let r=e||(Math.abs(o)<=Math.abs(n)?we.Sunrise:we.Sunset),l=r==we.Sunrise?s:a;return{mode:r,hours:l.hours,minutes:l.minutes}}{let e=this.mode==we.Sunrise?Ee(t):Ee(i);return e=Ce(e,{hours:this.hours,minutes:this.minutes}),{mode:we.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Ie(this.hours).am_pm;t=Ne(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.target.value;if(Ie(this.hours).am_pm==t)return;const i=Ie(this.hours).hours;this.hours=Ne(i,"AM"==t?Pe.AM:Pe.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=Ce(t,e),this.mode!=we.Fixed&&(t=ka(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};xs(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==we.Fixed?Ie(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==we.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};wa.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([de({attribute:!1})],wa.prototype,"hass",void 0),t([ce()],wa.prototype,"hours",void 0),t([ce()],wa.prototype,"minutes",void 0),t([ce()],wa.prototype,"mode",void 0),t([de({type:Boolean})],wa.prototype,"autoValidate",void 0),t([de({type:Boolean})],wa.prototype,"required",void 0),t([de({type:Boolean})],wa.prototype,"disabled",void 0),t([de({type:String})],wa.prototype,"label",void 0),t([de({type:Boolean})],wa.prototype,"useAmPm",void 0),t([de({type:Boolean})],wa.prototype,"large",void 0),t([de({attribute:!1})],wa.prototype,"stepSize",void 0),wa=t([re("scheduler-time-picker")],wa);let xa=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![ge.Daily,ge.Weekend,ge.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        ...
        >
          ${Wi("ui.common.ok",this.hass)}
        </ha-button>
      </ha-dialog>
    `:q``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[ge.Sunday,ge.Monday,ge.Tuesday,ge.Wednesday,ge.Thursday,ge.Friday,ge.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,_s(this.hass))}else e=[ge.Daily,ge.Workday,ge.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.every(e=>![ge.Daily,ge.Weekend,ge.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>q`
        <mwc-list-item
          graphic="icon"
        ...
        >
          ...
          ${"Custom"==e?q`
            ...
            ${Bi(Ni("ui.dialog.weekday_picker.choose",this.hass))}
            ${t(e)?q`<span class="badge">${this.selectedWeekdays.length}</span>`:""}
            `:Bi(ps(e,"long",this.hass))}
    ...
    `}};t([de({attribute:!1})],xa.prototype,"hass",void 0),t([ce()],xa.prototype,"_params",void 0),t([ce()],xa.prototype,"weekdayTypeCustomSelected",void 0),xa=t([re("dialog-select-weekdays")],xa);var $a=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return xa}});const ja=(e,t)=>((e,t)=>e<t?-1:e>t?1:0)(e.toLowerCase(),t.toLowerCase()),Oa=(e,t,i)=>{const s=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(e=>{if(!Object.keys(Ki).includes(t))return!1;let s=Object.keys(Ki[t]).includes(e);if(!s&&Object.keys(Ki[t]).includes("{entity_id}")){if("script"==t&&["turn_on","turn_off","reload","toggle","test"].includes(e))return!1;s=((i.include||[]).some(i=>Hi(i,`${t}.${e}`))||Object.keys(i.customize||{}).some(i=>Hi(i,`${t}.${e}`)))&&!(i.exclude||[]).some(i=>Hi(i,`${t}.${e}`))}return s}):[],a=t=>Wi(`component.${t}.title`,e,!1)||t.replace(/_/g," "),o=s=>{const o=Wi(`component.${t}.services.${s}.name`,e,!1)||!!e.services[t]&&!!e.services[t][s]&&e.services[t][s].name||s.replace(/_/g," ");return"script"==t?Object.keys(i.customize||{}).includes(`${t}.${s}`)&&Ze(i.customize[`${t}.${s}`].name)?i.customize[`${t}.${s}`].name:o:`${a(t)}: ${o}`},n=i=>{let s=Wi(`component.${t}.services.${i}.description`,e,!1);return s||(s=e.services[t][i].description),s||"script"!=t||(s=Wi(`component.${t}.services.turn_on.description`,e,!1)),s};let r=s.map(s=>{return{key:s,name:o(s),description:n(s),icon:(a=s,"script"==t&&Object.keys(i.customize||{}).includes(`${t}.${a}`)&&Ze(i.customize[`${t}.${a}`].icon)?i.customize[`${t}.${a}`].icon:Object.keys(is).includes(t)&&Object.keys(is[t].services).includes(a)?is[t].services[a]:Ds(t)),action:{service:s.includes(".")?s:`${t}.${s}`,service_data:{},target:e.services[t][s].target?{}:void 0}};var a}),l=(d=i.customize||{},c=t,Object.keys(d).filter(e=>{var t;return null===(t=d[e].exclude_actions)||void 0===t?void 0:t.length}).filter(e=>!c||!c.includes(".")&&Hi(Ri(e),c)||Hi(e,c)).map(e=>d[e].exclude_actions).flat().filter(Ze));var d,c;return l.length&&(r=r.filter(t=>!l.some(s=>ja(qi(t.action.service),s)>0||ja(us(t.action,e,i.customize),s)>0))),Yi(i.customize||{},t).forEach(e=>{let i=e.service;for(;r.find(e=>e.key==i);)i+="_2";e.variables&&Object.entries(e.variables).forEach(([t,i])=>{let s=ns(i),a=ma(s);!Ze(e.service_data[t])&&Ze(a)&&(e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:a})}))}),r.push({key:i,name:`${a(t)}: ${za(e.name||o(qi(e.service)))}`,description:za(e.name||""),icon:e.icon||Ds(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},target:e.target?e.target:void 0,name:e.name,icon:e.icon}})}),r},za=e=>{if(null!==/<.+?>/g.exec(e)){e=(new DOMParser).parseFromString(e,"text/html").body.textContent||""}let t;for(;t=/\[([^\]]+)\]/.exec(e);)e=e.replace(t[0],"");for(;t=/\{([^\}]+)\}/.exec(e);)e=e.replace(t[0],"");return e};let Sa=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.lockDomain=!1}async showDialog(e){this._params=e,e.domainFilter&&(this.lockDomain=!0),await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title"),this.hass.loadBackendTranslation("services")}render(){return this._params?q`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
      ...
      >
        <div slot="heading">
          <ha-dialog-header>
            ...
            <ha-icon-button
              slot="navigationIcon"
              .label=${Wi("ui.common.back",this.hass)}
              .path=${zs}
    ...
    `}};t([de({attribute:!1})],Sa.prototype,"hass",void 0),t([ce()],Sa.prototype,"_params",void 0),t([ce()],Sa.prototype,"_search",void 0),t([ce()],Sa.prototype,"_filter",void 0),t([ce()],Sa.prototype,"_width",void 0),t([ce()],Sa.prototype,"_height",void 0),t([ce()],Sa.prototype,"lockDomain",void 0),Sa=t([re("dialog-select-action")],Sa);var Ca=Object.freeze({__proto__:null,get DialogSelectAction(){return Sa}});let Aa=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return q`
      ${this.showPrefix?q`
    ...
    `}};t([de({type:Boolean})],Aa.prototype,"showPrefix",void 0),Aa=t([re("scheduler-settings-row")],Aa);let Ea=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this.large=!1,this.selectedEntry=0}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return q`
      ...
      <div class="editor-header">
        <div class="weekdays">
          <span>
            ...
            ${vs(e.weekdays,"short",this.hass)}
          </span>
          <ha-icon-button .path=${As} @click=${e=>this._showWeekdayDialog(e,t)}></ha-icon-button>
        </div>
    ...
    `}toggleViewMode(){const e=this.viewMode==_e.Scheme?_e.Single:_e.Scheme;this.dispatchEvent(new CustomEvent("setViewMode",{detail:e}))}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return q``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=Te(e,this.hass),s=(Te(t,this.hass)||86400)-i;return q`
      <div class="actions">
        <ha-icon-button .path=${zs} @click=${e=>{this._updateSelectedSlot(this.selectedSlot-1),e.target.blur()}} ?disabled=${null===this.selectedSlot||this.selectedSlot<1}>
        </ha-icon-button> 
    ...
    `;const n=Qi(o,this.config.customize),r=(null===(e=n.target)||void 0===e?void 0:e.domain)||Ri(o.service),l=Ze(null===(t=null==n?void 0:n.target)||void 0===t?void 0:t.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&Ze(null===(i=null===(t=Qi(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return q``;const d=Object.keys(n.fields||{}).filter(e=>oa(o,e,this.hass,this.config.customize));let c="",u=[(null===(i=o.target)||void 0===i?void 0:i.entity_id)||[]].flat();return!u.length&&["notify","script"].includes(r)&&(u=[o.service]),u.length&&(c+=u.map(e=>ys(e,this.hass,this.config.customize)).join(", "),c+=": "),c+=us(o,this.hass,this.config.customize,!1,!0),q`
      <scheduler-collapsible-section
        ?expanded=${!0}
        ?disabled=${!0}
      >
        <div slot="header" class="header">
          <ha-icon slot="icon" icon="${pa(o,this.config.customize)}"></ha-icon>
          <span>${Bi(c)}</span>
        </div>
        ...
        >
          ...
          <mwc-list-item graphic="icon">
            ${Wi("ui.panel.lovelace.editor.card.conditional.change_type",this.hass)}
            <ha-icon slot="graphic" icon="mdi:pencil"></ha-icon>
          </mwc-list-item>
          <mwc-list-item graphic="icon" class="warning">
            ${Wi("ui.common.delete",this.hass)}
        ...
        <div slot="content">
          ...
          ${n.target?q`
          <scheduler-settings-row>
            <span slot="heading">${Wi("ui.components.entity.entity-picker.entity",this.hass)}</span>
          ...
          ${d.map(e=>{var t;const i=ss(o.service,null===(t=o.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let s=n.fields[e].optional||(i.number||{}).optional;const a=!s||Object.keys(o.service_data).includes(e);return q`
            <scheduler-settings-row ?showPrefix=${s}>
              ...
              `:""}
              <span slot="heading">
                ${((e,t,i,s)=>{var a;const o=Ri(e.service),n=qi(e.service);let r=Wi(`component.${o}.services.${n}.fields.${t}.name`,i,!1);!r&&i.services[o]&&i.services[o][e.service]&&i.services[o][e.service].fields&&i.services[o][e.service].fields[t]&&(r=String(i.services[o][e.service].fields[t].name));const l=["script","notify"].includes(o)?[e.service]:[(null===(a=e.target)||void 0===a?void 0:a.entity_id)||[]].flat();let d=Yi(s||{},l.length?l[0]:o);if(d.length){let i=d.map(i=>{if(i.service!=e.service||!Object.keys(i.variables||{}).includes(t))return null;return(i.variables||{})[t].name}).filter(e=>void 0!==e);if(i.length)return i[0]}return r||(r=t.replace(/_/g," ")),r})(o,e,this.hass,this.config.customize)}
              </span>
              <scheduler-combo-selector
                .hass=${this.hass}
                .config=${i}
  ...
  mwc-list-item.warning, mwc-list-item.warning ha-icon {
    ...
    `}};t([de({attribute:!1})],Ia.prototype,"hass",void 0),t([ce()],Ia.prototype,"_params",void 0),t([ce()],Ia.prototype,"_search",void 0),t([ce()],Ia.prototype,"_filter",void 0),t([ce()],Ia.prototype,"_width",void 0),t([ce()],Ia.prototype,"_height",void 0),Ia=t([re("dialog-select-condition")],Ia);var Na=Object.freeze({__proto__:null,get DialogSelectCondition(){return Ia}});let qa=class extends oe{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[]}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||Da(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||Da(new Date);const i=(await js(this.hass)).map(e=>e.name),s=[...this.config.tags||[]].flat();this.tags=[...i,...s.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return q`
      ...
      <div class="period">
        ...
        <ha-date-input
          ...
          .label=${Wi("ui.components.date-range-picker.start_date",this.hass)}
        ...
        <ha-date-input
          .locale=${this.hass.locale}
          value=${this.endDate}
          .label=${Wi("ui.components.date-range-picker.end_date",this.hass)}
      ...
      <span class="header">${Wi("ui.common.name",this.hass)}:</span>
      <div class="period">
        <ha-textfield
          value=${this.schedule.name||""}
          placeholder=${this.schedule.name?"":Wi("ui.common.name",this.hass)}
      ...
      >
        ...
        ${Wi("ui.components.calendar.event.repeat.label",this.hass)}
      </ha-button>
      <ha-button
      ...
      >
        ...
        ${Wi("ui.dialogs.more_info_control.vacuum.stop",this.hass)}
      </ha-button>
      <ha-button
    ...
    `}renderConditions(){let e=this.schedule.entries[0].slots[0].conditions.items;return this.conditionIdx==e.length&&(e=[...e,{}]),e.map((e,t)=>{const i=this.conditionIdx==t?this.selectedEntity||e.entity_id||"":e.entity_id||"",s=this.conditionIdx==t&&this.selectedDomain||Ri(i),a=Fs(i||s,this.hass,this.config.customize),o=a&&a.hasOwnProperty("number")?[ye.Above,ye.Below]:[ye.Equal,ye.Unequal],n={[ye.Equal]:"mdi:equal",[ye.Unequal]:"mdi:not-equal-variant",[ye.Above]:"mdi:greater-than",[ye.Below]:"mdi:less-than"},r={[ye.Equal]:"ui.panel.options.conditions.types.equal_to",[ye.Unequal]:"ui.panel.options.conditions.types.unequal_to",[ye.Above]:"ui.panel.options.conditions.types.above",[ye.Below]:"ui.panel.options.conditions.types.below"};return this.conditionIdx!==t||this.selectedMatchType||(this.selectedMatchType=o[0]),q`
      <scheduler-collapsible-section idx="${t}">
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${Wi("ui.components.selectors.selector.types.entity",this.hass)}
          </span>
          <scheduler-entity-picker
            .hass=${this.hass}
            .config=${this.config}
            .domain=${s}
            @value-changed=${this._selectEntity}
            .value=${this.conditionIdx==t?Pa(this.selectedEntity):Pa(e.entity_id)}
            ?multiple=${!1}
          >
          </scheduler-entity-picker>
        </scheduler-settings-row>
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${Bi(Ni(r[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
            <ha-button-menu
            ...
            >
              ...
              ${o.map(i=>q`
                <mwc-list-item graphic="icon" ?noninteractive=${this.conditionIdx==t?this.selectedMatchType==i:e.match_type==i}>
                  ${Bi(Ni(r[i],this.hass,["{entity}","{value}"],["",""]))}
    ...
    `}};t([de({attribute:!1})],qa.prototype,"hass",void 0),t([de({attribute:!1})],qa.prototype,"config",void 0),t([ce()],qa.prototype,"schedule",void 0),t([ce()],qa.prototype,"conditionIdx",void 0),t([ce()],qa.prototype,"selectedDomain",void 0),t([ce()],qa.prototype,"selectedEntity",void 0),t([ce()],qa.prototype,"selectedMatchType",void 0),t([ce()],qa.prototype,"conditionValue",void 0),t([ce()],qa.prototype,"conditionValid",void 0),t([ce()],qa.prototype,"startDate",void 0),t([ce()],qa.prototype,"endDate",void 0),t([de()],qa.prototype,"tags",void 0),qa=t([re("scheduler-options-panel")],qa);let Ra=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          <ha-icon-button
            slot="navigationIcon"
      ...
      <ha-dialog open @closed=${this.closeDialog} .heading=${!0} hideActions scrimClickAction="">
        ...
        <div class="buttons">
          ...
          <ha-button appearance="plain" @click=${this._handleSaveClick}>
            ${Wi("ui.common.save",this.hass)}
          </ha-button>
        </div>
      </ha-dialog>
    `:q``}_updateSchedule(e){let t=Object.keys(e.detail);if(t.includes("schedule")){let t=e.detail.schedule;this.schedule=t}t.includes("selectedSlot")&&(this.selectedSlot=e.detail.selectedSlot)}async _handleSaveClick(e){const t=ra(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const s={cancel:()=>i(!1),confirm:()=>i(!0),title:Wi("state_badge.default.error",this.hass),description:Ni("ui.panel.editor.validation_errors."+t,this.hass),primaryButtonLabel:Wi("ui.common.ok",this.hass)};xs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Va})),dialogParams:s})});else if(this.schedule.schedule_id){const t=Re(await ws(this.hass,this.schedule.schedule_id),this.hass);if(pe(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Ni("ui.dialog.enable_schedule.title",this.hass),description:Ni("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:Wi("ui.common.yes",this.hass),secondaryButtonLabel:Wi("ui.common.no",this.hass),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};xs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Va})),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=la(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>ha(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=la(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>ha(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Ni("ui.dialog.confirm_delete.title",this.hass),description:Ni("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:Wi("ui.common.ok",this.hass),secondaryButtonLabel:Wi("ui.common.cancel",this.hass)};xs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Va})),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>ha(e,this,this.hass)).then(()=>{this.closeDialog()})})}_setViewMode(e){let t=e.detail;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1;if(t!=_e.Scheme){if(t==_e.Single&&!i){let e=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>{let t=e.slots.findIndex(e=>e.actions.length);return t<0&&(t=Math.floor(e.slots.length/2)),Object.assign(Object.assign({},e),{slots:e.slots.map((e,i)=>i==t?Object.assign(Object.assign({},e),{stop:void 0}):null).filter(Ze)})})});return this.schedule=Re(e,this.hass),void(this.viewMode=t)}new Promise(t=>{const i={title:Ni("ui.dialog.confirm_migrate.title",this.hass),description:Ni("ui.dialog.confirm_migrate.description",this.hass),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};xs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Va})),dialogParams:i})}).then(e=>{e&&(this.schedule=(e=>{const t=e=>{let t=e.findIndex(e=>e.actions.length);t<0&&(t=Math.floor(e.length/2));let i=Object.assign(Object.assign({},e[t]),{stop:void 0});const s=i.conditions,a=i.start;return e=[{start:"00:00:00",stop:a,actions:[],conditions:s},i,{start:qe(Ce(Ee(a),{minutes:1})),stop:"00:00:00",actions:[],conditions:s}]};return e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object(Object.assign(Object.assign({},e),{slots:t(e.slots)})))})})(this.schedule),this.viewMode=t)})}else this.viewMode=t}};Ha.styles=aa,t([de({attribute:!1})],Ha.prototype,"hass",void 0),t([ce()],Ha.prototype,"_params",void 0),t([de({type:Boolean,reflect:!0})],Ha.prototype,"large",void 0),t([ce()],Ha.prototype,"schedule",void 0),t([ce()],Ha.prototype,"selectedEntry",void 0),t([ce()],Ha.prototype,"selectedSlot",void 0),t([ce()],Ha.prototype,"_panel",void 0),t([ce()],Ha.prototype,"_viewMode",void 0),Ha=t([re("dialog-scheduler-editor")],Ha);var Fa=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return Ha}});
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */class Ua extends Ns{constructor(e){if(super(e),this.et=V,e.type!==Ps)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===V||null==e)return this.ft=void 0,this.et=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Ua.directiveName="unsafeHTML",Ua.resultType=1;const Ba=Is(Ua);var Wa=window&&window.__assign||function(){return(Wa=Object.assign||function(e){for(var t,i=1,s=arguments.length;i<s;i++)for(var a in t=arguments[i])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e}).apply(this,arguments)};var Za={second:45,minute:45,hour:22,day:5};const Ka=(e,t,i)=>{if(i===Me.am_pm||!i&&t.time_format===Me.am_pm){const t=Ie(e.getHours()).am_pm;return`${Ie(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===Me.twenty_four||!i&&t.time_format===Me.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:Le(t)}):Le(t)?Ka(e,t,Me.am_pm):Ka(e,t,Me.twenty_four)};let Ga=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},s=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return Ta[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}, ${s(e,"year")}`}(e,this._hass.locale):s>7?a=Ni("ui.components.date.next_week_day",this._hass,"{weekday}",ps(e,"long",this._hass)):1==s?a=Ni("ui.components.date.tomorrow",this._hass):s>0&&(a=ps(e,"long",this._hass));let o=Ni("ui.components.time.absolute",this._hass,"{time}",Ka(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Ni("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Ni("ui.components.time.at_midnight",this._hass)),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=Wi("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=Wi("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=Wa(Wa({},Za),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var l=new Date(e),d=new Date(t),c=l.getFullYear()-d.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+l.getMonth()-d.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var h=a/604800;return{value:Math.round(h),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return q``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),q`
      ${Bi(this.relativeTime(this.datetime))}
    `}};t([de()],Ga.prototype,"_hass",void 0),t([de()],Ga.prototype,"datetime",void 0),Ga=t([re("scheduler-relative-time")],Ga);let Ja=class extends oe{render(){var e,t,i,s,a;try{const o=this.hass.states[this.schedule.entity_id];if(!o)return q``;const n="off"==o.state,r=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let l=pa(r,this.config.customize);if("entity"==(null===(e=this.config.display_options)||void 0===e?void 0:e.icon)){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Ri(r.service))&&(e=r.service),e&&(l=Bs(e,this.config.customize,this.hass))}const d=![(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat().every(e=>Object.keys(this.hass.states).includes(e));return d&&(l="mdi:help"),q`
      <ha-icon
        icon="${l}"
    ...
    `}catch(e){return q`
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return q`
        ...
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){let t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return q`
          ...
          </div>`}return Ba(e)};return fs(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>q`${t(e)}<br/>`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
      ...
      ${Object.keys(e).length>t.length&&!1!==this._config.discover_existing?this.showDiscovered?q`
        ...
        <div class="card-actions">
          ...
          <ha-button appearance="plain" variant="warning" @click=${this._retryConnection}
            >${Wi("ui.common.refresh",this.hass)}
          </ha-button>
            `:q`
          <ha-button appearance="plain" @click=${this._addClick}
            >${Wi("ui.common.add",this.hass)}
          </ha-button>
          `}
        </div>`:""}
      </ha-card>
    `}async loadSchedules(){Se(this.hass).then(e=>{this.schedules=ks(e,this._config,this.hass)}).catch(e=>{this.schedules=[],this.connectionError=!0})}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{var s;if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let a=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(a+=1);const o=(([(null===(s=this._config.display_options)||void 0===s?void 0:s.secondary_info)||[]].flat().length||2)+1)/2;this.schedules&&(a+=this.showDiscovered?Object.keys(this.schedules).length*o:Object.values(this.schedules).filter(e=>Fi(e,this._config)).length*o),clearInterval(i),e(Math.round(a))},50)})}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?ws(this.hass,e.schedule_id).then(t=>{const i=this.schedules.findIndex(t=>t.schedule_id==e.schedule_id),s=i>=0?this.schedules[i]:null;let a=[...this.schedules||[]];!t||!1===this._config.discover_existing&&!Fi(t,this._config)?s&&(a=a.filter(t=>t.schedule_id!==e.schedule_id)):s?s.timestamps[s.next_entries[0]||0]==t.timestamps[t.next_entries[0]||0]?a=Object.assign(a,{[i]:t}):(a=Object.assign(a,{[i]:t}),a=ks(a,this._config,this.hass)):a=ks([...a,t],this._config,this.hass),this.schedules=[...a]}):this.schedules=(this.schedules||[]).filter(t=>t.schedule_id!==e.schedule_id)}_handleEditClick(e,t){if(!this.schedules)return;const i={schedule:Re(t,this.hass),cardConfig:this._config,editItem:t.schedule_id};xs(e.target,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return Fa})),dialogParams:i})}_addClick(e){const t=[this._config.tags||[]].flat().filter(e=>!["none","disabled","enabled"].includes(e));let i=this._config.default_editor==_e.Scheme?JSON.parse(JSON.stringify(Be)):JSON.parse(JSON.stringify(We));const s={schedule:Object.assign(Object.assign({},i),{tags:1==t.length?t:[]}),cardConfig:this._config};xs(this,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return Fa})),dialogParams:s})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked;Object.values(this.schedules).filter(e=>this.showDiscovered||Fi(e,this._config)).forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}static getConfigElement(){return document.createElement("scheduler-card-editor")}},e.SchedulerCard.styles=r`
    .card-header {
      display: flex;
      justify-content: space-between;
    }
