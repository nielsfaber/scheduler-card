...
/**
        ...
        <div slot="heading">
          <ha-dialog-header>
            <ha-icon-button
              slot="navigationIcon"
              dialogAction="cancel"
              .label=${Gi("ui.dialogs.more_info_control.dismiss",this.hass)}
              .path=${Es}
            ></ha-icon-button>
            <span slot="title">
              ${Ri("ui.dialog.entity_picker.title",this.hass)}
            </span>
          </ha-dialog-header>

          <ha-textfield
            dialogInitialFocus
            .placeholder=${Gi("ui.common.search",this.hass)}
            aria-label=${Gi("ui.common.search",this.hass)}
            ...
            <div class="trailing" slot="trailingIcon">
              ${this._search&&q`
                <ha-icon-button
                  ...
                  .label=${Gi("ui.common.clear",this.hass)}
                  .path=${Es}
                  class="clear-button"
                ></ha-icon-button>
              `}
    ...
    `:q``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("mwc-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_toggleSelectEntity(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;t.querySelector("ha-checkbox");const i=t.getAttribute("key");this._params.entities.includes(i)?this._params=Object.assign(Object.assign({},this._params),{entities:this._params.entities.filter(e=>e!=i)}):this._params=Object.assign(Object.assign({},this._params),{entities:[...this._params.entities,i]})}_toggleSelectDomain(e,t){var i;let s=e.target;for(;"MWC-LIST-ITEM"!=s.tagName;)s=s.parentElement;const a=s.getAttribute("key"),o=null===(i=this.options)||void 0===i?void 0:i.find(e=>e.key==a).entities.map(e=>e.key);this._params=t?Object.assign(Object.assign({},this._params),{domains:this._params.domains.filter(e=>e!=a),entities:this._params.entities.filter(e=>!(null==o?void 0:o.includes(e)))}):Object.assign(Object.assign({},this._params),{domains:[...this._params.domains,a]}),e.stopPropagation()}closeGroupByKey(e){this.shadowRoot.querySelector("mwc-list").childNodes.forEach(t=>{if(t.nodeType==Node.ELEMENT_NODE&&"MWC-LIST-ITEM"==t.tagName&&t.getAttribute("key")==e){const e=t,i=e.nextElementSibling,s=e.querySelector("ha-icon-button");i.style.height="0px",e.removeAttribute("expanded"),s.classList.remove("expanded")}})}async _toggleExpandGroup(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;const i=t.querySelector("ha-icon-button"),s=t.getAttribute("key");this.expandedGroups.includes(s)||(this.expandedGroups.forEach(e=>this.closeGroupByKey(e)),this.expandedGroups=[s],await this.requestUpdate());const a=t.nextElementSibling,o=a.scrollHeight;t.hasAttribute("expanded")?(t.removeAttribute("expanded"),i.classList.remove("expanded"),a.style.height="0px",setTimeout(()=>{this.expandedGroups=this.expandedGroups.filter(e=>e!=s)},300)):(t.setAttribute("expanded","true"),i.classList.add("expanded"),a.style.height=o+"px")}_renderOptions(){if(!this.options)return;let e=[...this.options];const t=this._filter&&this._filter.trim().length;if(t){const t=this._filter.toLowerCase().trim().split(" ");e=e.map(e=>Gs(e,t)||(e=Object.assign(Object.assign({},e),{entities:(e.entities||[]).filter(e=>Gs(e,t))})).entities.length?e:void 0).filter(e=>void 0!==e)}return e.length?Object.keys(e).map(i=>{var s,a;const o=e[i].key,n=null===(s=this._params)||void 0===s?void 0:s.domains.includes(o);let r=[...e[i].entities];"switch"==o&&(r=r.filter(e=>!this.scheduleEntities.includes(e.key)));const d=n?r.length:r.filter(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)}).length,l=(null===(a=this._params)||void 0===a?void 0:a.domains.includes(o))||e[i].entities.every(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)});return q`
        ...
        >
          ...
          <div slot="meta" class="meta">
            <ha-button
              ...
              size="small"
            >
              ${Gi(l?"ui.components.media-browser.file_management.deselect_all":"ui.components.subpage-data-table.select_all",this.hass)}
            </ha-button>
          ...
          <span>${e[i].name}</span>
          <span slot="secondary">${Ri("ui.panel.card_editor.fields.entities.included_number",this.hass,["{number}","{total}"],[d,r.length])}</span>
        </mwc-list-item>
      ...
      `}):q`
        <mwc-list-item disabled>
          ${Gi("ui.components.entity.entity-picker.no_match",this.hass)}
        </mwc-list-item>
    ...
    `}};t([le({attribute:!1})],Js.prototype,"hass",void 0),t([ce()],Js.prototype,"_params",void 0),t([ce()],Js.prototype,"_search",void 0),t([ce()],Js.prototype,"_filter",void 0),t([ce()],Js.prototype,"_width",void 0),t([ce()],Js.prototype,"_height",void 0),t([ce()],Js.prototype,"expandedGroups",void 0),t([ce()],Js.prototype,"options",void 0),t([ce()],Js.prototype,"scheduleEntities",void 0),Js=t([re("dialog-select-entities")],Js);var Ys=Object.freeze({__proto__:null,get DialogSelectEntities(){return Js}});let Qs=class extends oe{constructor(){super(...arguments),this.active=!1}render(){return q`
    ...
    `}renderIcon(){if(!this.icon&&!this.toggleable&&!this.useStateIcon)return V;if(this.toggleable)return q`
      ...
      `:q`
        <div class="trailing-icon" @click=${this._iconClick}>
          ...
          ${this.disabled?V:q`<ha-tooltip for="${e}">${Gi("ui.common.remove",this.hass)}</ha-tooltip>`}
        </div>
    ...
    `}};t([le({attribute:!1})],Qs.prototype,"hass",void 0),t([le({type:String})],Qs.prototype,"icon",void 0),t([le({type:Boolean})],Qs.prototype,"useStateIcon",void 0),t([le({type:Boolean})],Qs.prototype,"selectable",void 0),t([le({type:Boolean})],Qs.prototype,"removable",void 0),t([le({type:Boolean})],Qs.prototype,"toggleable",void 0),t([le({type:Boolean})],Qs.prototype,"active",void 0),t([le({type:String})],Qs.prototype,"badge",void 0),t([le({type:String})],Qs.prototype,"value",void 0),t([le({type:Boolean})],Qs.prototype,"disabled",void 0),Qs=t([re("scheduler-chip")],Qs);let Xs=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?q`
    ...
    `}};t([le({attribute:!1})],Xs.prototype,"hass",void 0),t([le({attribute:!1})],Xs.prototype,"items",void 0),t([le({attribute:!1})],Xs.prototype,"value",void 0),t([le({type:Boolean})],Xs.prototype,"selectable",void 0),t([le({type:Boolean})],Xs.prototype,"toggleable",void 0),t([le({type:Boolean})],Xs.prototype,"removable",void 0),t([le({type:Boolean})],Xs.prototype,"disabled",void 0),Xs=t([re("scheduler-chip-set")],Xs);let ea=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this.scheduleEntities=[],this._filteredItems=()=>{let e=Object.keys(this.hass.states);return this.domain&&(e=e.filter(e=>Hi(e)==this.domain)),this.config&&(e=e.filter(e=>((this.config.include||Ve).some(t=>Ui(t,e))||Object.keys(this.config.customize||{}).some(t=>Ui(t,e)))&&!(this.config.exclude||[]).some(t=>Ui(t,e)))),e=e.filter(e=>!this.scheduleEntities.includes(e)),this.filterFunc&&(e=e.filter(e=>this.filterFunc(this.hass.states[e]))),e.map(e=>this._parseEntityItem(e))}}async firstUpdated(){this.scheduleEntities=Object.entries(await Oe(this.hass)).map(([,e])=>e.entity_id),this._autoSelectIfSingleEntity()}updated(e){super.updated(e),e.has("domain")&&this._autoSelectIfSingleEntity()}_autoSelectIfSingleEntity(){if(this.value&&this.value.length>0)return;const e=this._filteredItems();1===e.length&&(this.value=[e[0].id],zs(this,"value-changed",{value:this.value}))}render(){return q`
      <ha-selector
        .hass=${this.hass}
    ...
    `}_valueChanged(e){this.value=e.detail.value,zs(this,"value-changed",{value:this.value}),e.stopPropagation()}_removeClick(e){const t=e.detail;this.value=(this.value||[]).filter(e=>e!==t),zs(this,"value-changed",{value:this.value})}_parseEntityItem(e){var t,i,s,a;const o=Object.entries((null===(t=this.config)||void 0===t?void 0:t.customize)||{}).filter(([t,i])=>Ui(t,e)).map(([e,t])=>t),n=null===(i=o.find(e=>"name"in e))||void 0===i?void 0:i.name,r=null===(s=o.find(e=>"icon"in e))||void 0===s?void 0:s.icon;return{id:e,primary:n||Fi(e,null===(a=this.hass.states[e])||void 0===a?void 0:a.attributes),secondary:e,icon:r}}};ea.styles=r`
    :host {
      display: flex;
  ...
  `,t([le({attribute:!1})],ea.prototype,"hass",void 0),t([le()],ea.prototype,"domain",void 0),t([le()],ea.prototype,"config",void 0),t([le({type:Array})],ea.prototype,"value",void 0),t([le({type:Boolean})],ea.prototype,"multiple",void 0),t([le({type:Boolean})],ea.prototype,"disabled",void 0),t([ce()],ea.prototype,"scheduleEntities",void 0),ea=t([re("scheduler-entity-picker")],ea);let ta=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
      <div
    ...
    `}};t([le()],ia.prototype,"disabled",void 0),t([ce()],ia.prototype,"_openedItem",void 0),t([ce()],ia.prototype,"_numItems",void 0),ia=t([re("scheduler-collapsible-group")],ia);let sa=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){var e;if(this.config.select){const e=this.config.select,t=([this.value||[]].flat().map(String),e=>{var t;let i=null===(t=this.config.select)||void 0===t?void 0:t.translation_key,s="";return i&&(s=Gi(i.replace("${value}",e),this.hass,!1)),s||(s=e),s}),i=()=>e.options.map(e=>"object"==typeof e?{value:e.value,label:t(e.label)}:{value:e,label:t(e)}),s={select:Object.assign(Object.assign({mode:"dropdown"},e),{options:i()})},a=e=>{e.stopPropagation(),this.value=e.detail.value,zs(this,"value-changed",{value:this.value})};return q`
      ...
      `}if(this.config.number){const t=this.config.number,i="box"==t.mode||!Be(t.min)||!Be(t.max);let s=this.value;i||"number"==typeof s||(s=t.min),"number"==typeof t.scale_factor&&(s=Number(s)/t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(s=Math.round(Number(s)/t.step)*t.step),Be(s)&&(s=ss(Number(s)));const a=e=>{let i=Number(e.target.value);"number"==typeof t.scale_factor&&(i*=t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(i=Math.round(i/t.step)*t.step),i=ss(i),this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}})),e.stopPropagation()},o=e=>{e.stopPropagation();let t=e.target.value;const i=""===t||isNaN(Number(t))?void 0:Number(t);this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}}))},n=(e,i)=>{let s=t.step&&Number(t.step)%1==0?null!==e.match(/^-?\d+$/):null!==e.match(/^[+-]?\d+([.,]\d+)?$/);return s&&Be(t.min)&&(s=Number(e)>=t.min),s&&Be(t.max)&&(s=Number(e)<=t.max),{valid:s,customError:!s}};return q`
      ...
      `}return q``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t],e.target.value=""}else if(e.detail){let t=e.detail.value;void 0===t&&(t=null),this.value=t}else this.value=e.target.value;zs(this,"value-changed",{value:this.value})}};sa.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
  ...
  `,t([le({attribute:!1})],sa.prototype,"hass",void 0),t([le({attribute:!1})],sa.prototype,"config",void 0),t([le()],sa.prototype,"value",void 0),t([le()],sa.prototype,"disabled",void 0),sa=t([re("scheduler-combo-selector")],sa);let aa=class extends oe{constructor(){super(...arguments),this._config={},this.title="",this.tagOptions=[]}setConfig(e){this._config=Object.assign({},e)}async firstUpdated(){this.title="string"==typeof this._config.title?this._config.title:"";const e=(await Cs(this.hass)).map(e=>e.name);e.sort(Zi),this.tagOptions=e}render(){var e,t,i,s,a,o;const n={number:{min:0,max:30,step:1,unit_of_measurement:Ri("ui.panel.card_editor.fields.time_step.unit_minutes",this.hass)}},r={select:{options:this.tagOptions,multiple:!0,custom_value:!0}};return q`
      <div class="card-config">

        <ha-button @click=${this._showIncludedEntitiesDialog} outlined>
          ${Ri("ui.panel.card_editor.fields.entities.button_label",this.hass)}
          <ha-svg-icon
            slot="trailingIcon"
        ...
        <scheduler-settings-row ?showPrefix=${!0}>
          ...
          <span slot="heading">${Ri("ui.panel.card_editor.fields.title.heading",this.hass)}</span>

          <ha-textfield
            .value=${this.title}
            @input=${this._setTitle}
            .placeholder=${Ri("ui.panel.common.title",this.hass)}
        ...
        <div class="column">
          <ha-formfield label="${Ri("ui.panel.card_editor.fields.discover_existing.heading",this.hass)}">
            <ha-switch
        ...
        <div class="column">
          <ha-formfield label="${Ri("ui.panel.card_editor.fields.show_header_toggle.heading",this.hass)}">
            <ha-switch
        ...
        <scheduler-settings-row>
          <span slot="heading">${Ri("ui.panel.card_editor.fields.time_step.heading",this.hass)}</span>
        ...
        <span>${Ri("ui.panel.card_editor.fields.default_editor.heading",this.hass)}</span>
        <div class="two-columns">
          <div class="column">
            <ha-formfield label="${Ri("ui.panel.card_editor.fields.default_editor.options.single",this.hass)}">
              <ha-radio
                name="default_editor"
                value="${me.Single}"
          ...
          <div class="column">
            <ha-formfield label="${Ri("ui.panel.card_editor.fields.default_editor.options.scheme",this.hass)}">
              <ha-radio
                name="default_editor"
                value="${me.Scheme}"
          ...
          <span slot="heading">${Ri("ui.panel.card_editor.fields.sort_by.heading",this.hass)}</span>

        <div class="two-columns">
        <div class="column">

          <ha-formfield label="${Ri("ui.panel.card_editor.fields.sort_by.options.relative_time",this.hass)}">
            <ha-radio
              name="sort_by"
              value="relative-time"
        ...
        <div class="column">
          ...
          <ha-formfield label="${Ri("ui.panel.card_editor.fields.sort_by.options.title",this.hass)}">
            <ha-radio
              name="sort_by"
              value="title"
              @change=${this._setSortBy}
          ...
          <span>${Ri("ui.panel.card_editor.fields.display_format_primary.heading",this.hass)}</span>


        <div class="two-columns">
        <div class="column">

          <ha-formfield label="${Ri("ui.panel.card_editor.fields.display_format_primary.options.default",this.hass)}">
            <ha-radio
        ...
        <div class="column">
          ...
          <ha-formfield label="${Ri("ui.panel.card_editor.fields.display_format_primary.options.entity_action",this.hass)}">
            <ha-radio
              name="display_format_primary"
              value="{entity}: {action}"
              @change=${this._setDisplayOptionsPrimary}
          ...
          <span>${Ri("ui.panel.card_editor.fields.display_format_secondary.heading",this.hass)}</span>

        <div class="two-columns">
        <div class="column">
          <ha-formfield label="${Ri("ui.panel.card_editor.fields.display_format_secondary.options.relative_time",this.hass)}">
            <ha-checkbox
              value="relative-time"
          ...
          <ha-formfield label="${Ri("ui.panel.card_editor.fields.display_format_secondary.options.time",this.hass)}">
            <ha-checkbox
              value="time"
              @change=${this._setDisplayOptionsSecondary}
        ...
        <div class="column">
          <ha-formfield label="${Ri("ui.panel.card_editor.fields.display_format_secondary.options.days",this.hass)}">
            <ha-checkbox
              value="days"
              @change=${this._setDisplayOptionsSecondary}
          ...
          <ha-formfield label="${Ri("ui.panel.card_editor.fields.display_format_secondary.options.additional_tasks",this.hass)}">
            <ha-checkbox
        ...
        <scheduler-settings-row>
          <span slot="heading">${Ri("ui.panel.card_editor.fields.tags.heading",this.hass)}</span>
  ...
  `,t([le({attribute:!1})],aa.prototype,"hass",void 0),t([le()],aa.prototype,"_config",void 0),t([le()],aa.prototype,"title",void 0),t([le()],aa.prototype,"tagOptions",void 0),aa=t([re("scheduler-card-editor")],aa);const oa=r`
  ha-dialog {
...
`,(e,t,i,s)=>{var a;const o=e.service,n=null===(a=e.target)||void 0===a?void 0:a.entity_id,r=is(e,s);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const d=r.fields[t];if(null===rs(o,n,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(d.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&d.supported_features)>0}))return!1}return!("light"==Hi(o)&&![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;const s=i.states[e].attributes.supported_color_modes||[];return"brightness"!=t||s.filter(e=>"onoff"!=e).length}))});var ra;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(ra||(ra={}));const da=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>e.every((i,s)=>{const a=Ae(i.start,t),o=void 0===i.stop?a:Ae(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>{if(i<=s)return!0;return Ae(e.start,t)>=o})})?null:ra.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,ra.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{var s;const a=is(e,i);return(null==a?void 0:a.target)&&!(null===(s=e.target)||void 0===s?void 0:s.entity_id)?ra.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).filter(([s])=>na(e,s,t,i)).every(([s,a])=>{var o,n;let r=rs(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,s,t,i);const d=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||a.optional;return!(!Object.keys(e.service_data).includes(s)&&!d)&&!(!Be(e.service_data[s])&&!d)})?ra.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},la=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(ca),timeslots:e.entries[0].slots.map(ua),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},ca=e=>{switch(e){case pe.Monday:return"mon";case pe.Tuesday:return"tue";case pe.Wednesday:return"wed";case pe.Thursday:return"thu";case pe.Friday:return"fri";case pe.Saturday:return"sat";case pe.Sunday:return"sun";case pe.Workday:return"workday";case pe.Weekend:return"weekend";default:return"daily"}},ua=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>ha(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==_e.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),ha=e=>{var t,i;const s=e=>Object.keys(e).filter(t=>Be(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>({service:e.service,service_data:s(e.service_data),entity_id:t}))}return{service:e.service,service_data:s(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:s(e.service_data)}},ma=(e,t,i)=>{const s={title:Gi("state_badge.default.error",i),description:q`
    <b>Something went wrong!</b><br />
    ${e.body.message}<br /><br />
    ${e.error}<br /><br />
    Please <a href="https://github.com/nielsfaber/scheduler-card/issues">report</a> the bug.
  `,primaryButtonLabel:Gi("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};zs(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ha})),dialogParams:s})},pa=e=>{if(!Object.keys(e).includes("select")||!e.select){if(Object.keys(e).includes("number")&&e.number){const t=e.number.min;return void 0!==t?t:0}return Object.keys(e).includes("boolean")&&e.boolean?void 0:(Object.keys(e).includes("text")&&e.text,"")}e.select.options},_a=(e,t)=>{const i=is(e,t),s=Hi(e.service),a=Vi(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:"mdi:"+o;if(Object.keys(ns).includes(s)&&Object.keys(ns[s].services).includes(a)){if(void 0!==ns[s].attributes){let t=ns[s].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return ns[s].services[a]}return Object.keys(ns).includes(s)&&Object.keys(ns[s].services).includes("{entity_id}")?ns[s].services["{entity_id}"]:"mdi:flash";var o},ga=(e,t,i)=>{let s=Ae("string"==typeof e?Ce(e):e,i),a=Ae("string"==typeof t?Ce(t):t,i);return a>s?1:a<s?-1:0},va=e=>Ce(e.start),ya=e=>{if(Be(e.stop)){const t=Ce(e.stop);return 0==t.hours&&0==t.minutes&&t.mode==be.Fixed?Object.assign(Object.assign({},t),{hours:24}):t}return ze(va(e),{minutes:1})},fa=(e,t,i,s)=>{let a=t;if(Be(i.stop))return[e,a]=fa(e,t+1,{start:i.stop},s),[e,a-1];if(!Be(i.start))return[e,a];let o=va(e[t]),n=i.start,r=va(e[t]);for(let i=t-1;i>=0;i--){if(e[i].actions.length){r=i==t-1?ze(va(e[i]),{minutes:1}):ya(e[i]);break}r=va(e[i])}let d=ze(ya(e[t]),{minutes:-1});if(!Be(e[t].stop))for(let i=t+1;i<e.length;i++){if(e[i].actions.length){d=i==t+1?ze(ya(e[i]),{minutes:-1}):va(e[i]);break}d=ya(e[i])}if(ga(r,n,s)<0&&(n=r),ga(d,n,s)>0&&Ae(d,s)>0&&(n=d),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Ne(n)})}),ga(o,n,s)<=0)for(let i=t-1;i>=0;i--){let t=ga(va(e[i]),n,s),o=ga(ya(e[i]),n,s);if(t>0&&o<=0){e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:Ne(n)})});break}if(o>=0)break;t<=0&&(e=Object.assign(e,{[i]:null}),a-=1)}if(ga(o,n,s)<0&&!Be(e[t].stop)&&(e=Be(e[t+1].stop)&&!e[t+1].actions.length?Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:Ne(ya(e[t]))})}):[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:Ne(ya(e[t])),stop:Ne(va(e[t+1])),actions:[]}),...e.slice(t+1)]),ga(o,n,s)>=0)for(let t=a+1;t<e.length;t++){let i=ya(e[a]),o=ga(va(e[t]),i,s),n=ga(ya(e[t]),i,s);if(o>=0&&n<0)e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Ne(i)})});else{if(o<0)break;n>=0&&(e=Object.assign(e,{[t]:null}))}}return ga(o,n,s)>0&&(t>0&&Be(e[t-1].stop)?e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:Ne(n)})}):(e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:t>0?Ne(ya(e[t-1])):"00:00:00",stop:Ne(n),actions:[]}),...e.slice(t)],a=t+1)),[e=e.filter(Be),a]},ba=(e,t)=>{const i=new Date(t),s=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let a=3600*e.hours+60*e.minutes-s;const o=a<0?-1:1;a=Math.abs(a);let n=Math.floor(a/3600),r=Math.round((a-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),Se({hours:n,minutes:r})};let ka=class extends oe{constructor(){super(),this.selectedSlot=null,this.timeout=0,this.large=!1,this.handleResize=this.handleResize.bind(this)}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){}render(){return q`
      <div class="bar">
    ...
    `}renderTimebar(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=[1,2,3,4,6,8,12],i=De(this.hass.locale),s=i?130:100;let a=Math.ceil(24/(e/s));for(;!t.includes(a);)a++;const o=[0,...Array.from(Array(24/a-1).keys()).map(e=>(e+1)*a),24];return o.map((e,t)=>{let s=a/24*100;s=Math.floor(100*s)/100;let n={mode:be.Fixed,hours:e,minutes:0};return 0==t?q`
        <span class="left" style=${Vs({width:s/2+"%"})}>${Ne(n,{seconds:!1,am_pm:i})}</span>
      `:t==o.length-1?q`
        <span class="right" style=${Vs({width:s/2+"%"})}>${Ne(n,{seconds:!1,am_pm:i})}</span>
      `:q`
        <span style=${Vs({width:s+"%"})}>${Ne(n,{seconds:!1,am_pm:i})}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,s)=>{let a=Ae(i.start,this.hass),o=Ae(i.stop||i.start,this.hass);!o&&a&&(o=86400);const n=(o-a)/86400*100,r=i.actions.length?_s(i.actions[0],this.hass,this.config.customize,!0,!0):"",d=parseFloat(getComputedStyle(this).getPropertyValue("width")),l=5*r.length+10,c=s>0?15:0,u=s<e.length-1?15:0,h=n*d/100-c-u,m=e[s+1];return q`
        <div
          class="slot ${this.selectedSlot==s?"selected":""} ${i.actions.length?"":"empty"} ${void 0===i.stop?"short":""}"
          style="${Vs({width:t[s]+"px"})}"
          @click=${this._toggleSelectTimeslot}
          idx="${s}"
        >
          ${i.stop,""}
          ${i.actions.length?r&&(h>l/3||h>50)&&h>30?q`<span style="margin-left: ${c}px; margin-right: ${u}px">${r}</span>`:h>16?q`<ha-icon icon="${_a(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
...
function(e){return(({finisher:e,descriptor:t})=>(i,s)=>{var a;if(void 0===s){const s=null!==(a=i.originalKey)&&void 0!==a?a:i.key,o=null!=t?{kind:"method",placement:"prototype",key:s,descriptor:t(i.key)}:{...i,key:s};return null!=e&&(o.finisher=function(t){e(t,s)}),o}{const a=i.constructor;void 0!==t&&Object.defineProperty(i,s,t(s)),null==e||e(a,s)}})({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}({passive:!0})],ka.prototype,"_handleDragStart",null),ka=t([re("scheduler-timeslot-editor")],ka);const wa=e=>{let t=60*e.hours+e.minutes;return t>240?e=Object.assign(Object.assign({},e),{hours:4,minutes:0}):t<-240&&(e=Object.assign(Object.assign({},e),{hours:-4,minutes:0})),e};let xa=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=be.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1,this.large=!1,this.stepSize=10}set time(e){const t=Ce(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return q`
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return V;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=be.Fixed&&(e=wa(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return q`
        <div class="mode">
    ...
    `}}_renderSuffix(){if(this.large){const e=()=>{let e=Pe(this.hours).am_pm;const t=Pe(this.hours).hours;this.hours=Le(t,"AM"==e?Me.PM:Me.AM),this._valueChanged()},t=()=>{0!=this.hours?this.hours=-this.hours:this.minutes=-this.minutes,this._valueChanged()},i=()=>{this.mode=this.mode==be.Sunrise?be.Sunset:be.Sunrise,this._valueChanged()};return q`
        <div class="suffix">
        ${this.useAmPm&&this.mode==be.Fixed?q`
            <ha-button appearance="plain" @click=${e}>
              <span class="large">
                ${Pe(this.hours).am_pm==Me.AM?"AM":"PM"}
              </span>
            </ha-button>
          `:V}
      ...
      `}return this.useAmPm&&this.mode==be.Fixed?q`
        <ha-select
          .required=${this.required}
          .value=${Pe(this.hours).am_pm==Me.AM?"AM":"PM"}
          .disabled=${this.disabled}
          name="amPm"
          naturalMenuWidth
          fixedMenuPosition
      ...
      `:V}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=be.Fixed||this.mode==be.Fixed){const s=ba({hours:this.hours,minutes:this.minutes},t),a=ba({hours:this.hours,minutes:this.minutes},i),o=60*s.hours+s.minutes,n=60*a.hours+a.minutes;let r=e||(Math.abs(o)<=Math.abs(n)?be.Sunrise:be.Sunset),d=r==be.Sunrise?s:a;return{mode:r,hours:d.hours,minutes:d.minutes}}{let e=this.mode==be.Sunrise?Ce(t):Ce(i);return e=ze(e,{hours:this.hours,minutes:this.minutes}),{mode:be.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Pe(this.hours).am_pm;t=Le(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.target.value;if(Pe(this.hours).am_pm==t)return;const i=Pe(this.hours).hours;this.hours=Le(i,"AM"==t?Me.AM:Me.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=ze(t,e),e.minutes&&(t=Se(t,this.stepSize)),this.mode!=be.Fixed&&(t=wa(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};zs(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==be.Fixed?Pe(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==be.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};xa.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([le({attribute:!1})],xa.prototype,"hass",void 0),t([ce()],xa.prototype,"hours",void 0),t([ce()],xa.prototype,"minutes",void 0),t([ce()],xa.prototype,"mode",void 0),t([le({type:Boolean})],xa.prototype,"autoValidate",void 0),t([le({type:Boolean})],xa.prototype,"required",void 0),t([le({type:Boolean})],xa.prototype,"disabled",void 0),t([le({type:String})],xa.prototype,"label",void 0),t([le({type:Boolean})],xa.prototype,"useAmPm",void 0),t([le({type:Boolean})],xa.prototype,"large",void 0),t([le({attribute:!1})],xa.prototype,"stepSize",void 0),xa=t([re("scheduler-time-picker")],xa);let $a=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![pe.Daily,pe.Weekend,pe.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          ...
          `};
          <span slot="title">
              ${Ri("ui.dialog.weekday_picker.title",this.hass)}
          </span>
        </ha-dialog-header>
        <div class="wrapper">
          <mwc-list>
        ...
        >
          ${Gi("ui.common.ok",this.hass)}
        </ha-button>
      </ha-dialog>
    `:q``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[pe.Sunday,pe.Monday,pe.Tuesday,pe.Wednesday,pe.Thursday,pe.Friday,pe.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,fs(this.hass))}else e=[pe.Daily,pe.Workday,pe.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.every(e=>![pe.Daily,pe.Weekend,pe.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>q`
        <mwc-list-item
          graphic="icon"
        ...
        >
          ...
          ${"Custom"==e?q`
            ...
            ${Ki(Ri("ui.dialog.weekday_picker.choose",this.hass))}
            ${t(e)?q`<span class="badge">${this.selectedWeekdays.length}</span>`:""}
            `:Ki(ys(e,"long",this.hass))}
    ...
    `}};t([le({attribute:!1})],$a.prototype,"hass",void 0),t([ce()],$a.prototype,"_params",void 0),t([ce()],$a.prototype,"weekdayTypeCustomSelected",void 0),$a=t([re("dialog-select-weekdays")],$a);var ja=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return $a}});const Oa=(e,t)=>((e,t)=>e<t?-1:e>t?1:0)(e.toLowerCase(),t.toLowerCase()),za=(e,t,i)=>{const s=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(e=>{if(!Object.keys(Yi).includes(t))return!1;let s=Object.keys(Yi[t]).includes(e);if(!s&&Object.keys(Yi[t]).includes("{entity_id}")){if("script"==t&&["turn_on","turn_off","reload","toggle","test"].includes(e))return!1;s=Bi(`${t}.${e}`,i)}return s}):[],a=t=>Gi(`component.${t}.title`,e,!1)||t.replace(/_/g," "),o=s=>{const o=Gi(`component.${t}.services.${s}.name`,e,!1)||!!e.services[t]&&!!e.services[t][s]&&e.services[t][s].name||s.replace(/_/g," ");return"script"==t?Object.keys(i.customize||{}).includes(`${t}.${s}`)&&Be(i.customize[`${t}.${s}`].name)?i.customize[`${t}.${s}`].name:o:`${a(t)}: ${o}`},n=i=>{let s=Gi(`component.${t}.services.${i}.description`,e,!1);return s||(s=e.services[t][i].description),s||"script"!=t||(s=Gi(`component.${t}.services.turn_on.description`,e,!1)),s};let r=s.map(s=>{return{key:s,name:o(s),description:n(s),icon:(a=s,"script"==t&&Object.keys(i.customize||{}).includes(`${t}.${a}`)&&Be(i.customize[`${t}.${a}`].icon)?i.customize[`${t}.${a}`].icon:Object.keys(ns).includes(t)&&Object.keys(ns[t].services).includes(a)?ns[t].services[a]:Ps(t)),action:{service:s.includes(".")?s:`${t}.${s}`,service_data:{},target:e.services[t][s].target?{}:void 0}};var a}),d=(l=i.customize||{},c=t,Object.keys(l).filter(e=>{var t;return null===(t=l[e].exclude_actions)||void 0===t?void 0:t.length}).filter(e=>!c||!c.includes(".")&&Ui(Hi(e),c)||Ui(e,c)).map(e=>l[e].exclude_actions).flat().filter(Be));var l,c;return d.length&&(r=r.filter(t=>!d.some(s=>Oa(Vi(t.action.service),s)>0||Oa(_s(t.action,e,i.customize),s)>0))),ts(i.customize||{},t).forEach(e=>{let i=e.service;for(;r.find(e=>e.key==i);)i+="_2";e.variables&&Object.entries(e.variables).forEach(([t,i])=>{let s=cs(i),a=pa(s);!Be(e.service_data[t])&&Be(a)?e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:a})}):Be(e.service_data[t])||(e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:null})}))}),r.push({key:i,name:`${a(t)}: ${Sa(e.name||o(Vi(e.service)))}`,description:Sa(e.name||""),icon:e.icon||Ps(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},target:e.target?e.target:void 0,name:e.name,icon:e.icon}})}),r},Sa=e=>{if(null!==/<.+?>/g.exec(e)){e=(new DOMParser).parseFromString(e,"text/html").body.textContent||""}let t;for(;t=/\[([^\]]+)\]/.exec(e);)e=e.replace(t[0],"");for(;t=/\{([^\}]+)\}/.exec(e);)e=e.replace(t[0],"");return e};let Ca=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.lockDomain=!1}async showDialog(e){this._params=e,e.domainFilter&&(this.lockDomain=!0),await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title"),this.hass.loadBackendTranslation("services")}render(){return this._params?q`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
      ...
      >
        <div slot="heading">
          <ha-dialog-header>
            ...
            <ha-icon-button
              slot="navigationIcon"
              .label=${Gi("ui.common.back",this.hass)}
              .path=${As}
              @click=${this._clearDomain}
            ></ha-icon-button>
            `}
            <span slot="title">
              ${Ri("ui.dialog.action_picker.title",this.hass)}
            </span>
          </ha-dialog-header>
    ...
    `}};t([le({attribute:!1})],Ca.prototype,"hass",void 0),t([ce()],Ca.prototype,"_params",void 0),t([ce()],Ca.prototype,"_search",void 0),t([ce()],Ca.prototype,"_filter",void 0),t([ce()],Ca.prototype,"_width",void 0),t([ce()],Ca.prototype,"_height",void 0),t([ce()],Ca.prototype,"lockDomain",void 0),Ca=t([re("dialog-select-action")],Ca);var Aa=Object.freeze({__proto__:null,get DialogSelectAction(){return Ca}});let Ea=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return q`
      ${this.showPrefix?q`
    ...
    `}toggleViewMode(){const e=this.viewMode==me.Scheme?me.Single:me.Scheme;this.dispatchEvent(new CustomEvent("setViewMode",{detail:e}))}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return q``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=Ae(e,this.hass),s=(Ae(t,this.hass)||86400)-i;return q`
      <div class="actions">
        <ha-icon-button .path=${As} @click=${e=>{this._updateSelectedSlot(this.selectedSlot-1),e.target.blur()}} ?disabled=${null===this.selectedSlot||this.selectedSlot<1}>
        </ha-icon-button> 
    ...
    `}renderSlot(){if(null===this.selectedEntry||null===this.selectedSlot)return q`
        <div class="slot-placeholder"> 
          ${Ri("ui.panel.editor.select_timeslot",this.hass)}
        </div>
      ...
      <div class="two-column">
        <div class="column">
          <scheduler-time-picker
            .hass=${this.hass}
            label="${Ri("ui.panel.editor.start_time",this.hass)}:"
        ...
        <div class="column">
          ...
          <scheduler-time-picker
            .hass=${this.hass}
            label="${Ri("ui.panel.editor.stop_time",this.hass)}:"
      ...
      ${Ri("ui.panel.editor.action",this.hass)}:
    ...
    `}_renderActionConfig(){var e,t,i,s;const a=Object.assign({},this.schedule.entries[this.selectedEntry].slots[this.selectedSlot]),o=a.actions.length?a.actions[0]:void 0;if(!o)return q`
      <div>
        ...
        >
          ...
          ${Ri("ui.panel.editor.add_action",this.hass)}
        </ha-button>
      </div>
    `;const n=is(o,this.config.customize),r=(null===(e=n.target)||void 0===e?void 0:e.domain)||Hi(o.service),d=Be(null===(t=null==n?void 0:n.target)||void 0===t?void 0:t.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&Be(null===(i=null===(t=is(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return q``;const l=Object.keys(n.fields||{}).filter(e=>na(o,e,this.hass,this.config.customize));let c="",u=[(null===(i=o.target)||void 0===i?void 0:i.entity_id)||[]].flat();return!u.length&&["notify","script"].includes(r)&&(u=[o.service]),u.length&&(c+=u.map(e=>ws(e,this.hass,this.config.customize)).join(", "),c+=": "),c+=_s(o,this.hass,this.config.customize,!1,!0),q`
      ...
      >
        ...
        <ha-button-menu
          ...
          fixed
        >
          <ha-icon-button slot="trigger" .path=${Ts}>
          </ha-icon-button>
          <mwc-list-item graphic="icon">
            ${Gi("ui.panel.lovelace.editor.card.conditional.change_type",this.hass)}
            <ha-icon slot="graphic" icon="mdi:pencil"></ha-icon>
          </mwc-list-item>
          <mwc-list-item graphic="icon" class="warning">
            ${Gi("ui.common.delete",this.hass)}
        ...
        <div slot="content">
          ...
          ${n.target?q`
          <scheduler-settings-row>
            <span slot="heading">${Gi("ui.components.entity.entity-picker.entity",this.hass)}</span>
          ...
          ${l.map(e=>{var t;const i=rs(o.service,null===(t=o.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let s=n.fields[e].optional||(i.number||{}).optional;const a=!s||Object.keys(o.service_data).includes(e);return q`
            <scheduler-settings-row ?showPrefix=${s}>
              ...
              `:""}
              <span slot="heading">
                ${((e,t,i,s)=>{var a;const o=Hi(e.service),n=Vi(e.service);let r=Gi(`component.${o}.services.${n}.fields.${t}.name`,i,!1);!r&&i.services[o]&&i.services[o][e.service]&&i.services[o][e.service].fields&&i.services[o][e.service].fields[t]&&(r=String(i.services[o][e.service].fields[t].name));const d=["script","notify"].includes(o)?[e.service]:[(null===(a=e.target)||void 0===a?void 0:a.entity_id)||[]].flat();let l=ts(s||{},d.length?d[0]:o);if(l.length){let i=l.map(i=>{if(i.service!=e.service||!Object.keys(i.variables||{}).includes(t))return null;return(i.variables||{})[t].name}).filter(Be);if(i.length)return i[0]}return r||(r=t.replace(/_/g," ")),r})(o,e,this.hass,this.config.customize)}
              </span>
              <scheduler-combo-selector
                .hass=${this.hass}
                .config=${i}
  ...
  mwc-list-item.warning, mwc-list-item.warning ha-icon {
    ...
    `}};t([le({attribute:!1})],Ta.prototype,"hass",void 0),t([le({attribute:!1})],Ta.prototype,"config",void 0),t([le({attribute:!1})],Ta.prototype,"viewMode",void 0),t([le({attribute:!1})],Ta.prototype,"selectedSlot",void 0),t([le({type:Boolean})],Ta.prototype,"large",void 0),t([ce()],Ta.prototype,"schedule",void 0),t([ce()],Ta.prototype,"selectedEntry",void 0),Ta=t([re("scheduler-main-panel")],Ta);const Da=["January","February","March","April","May","June","July","August","September","October","November","December"];function Ma(e){return e.toISOString().split("T")[0]}function Pa(e){let t=new Date;const i=(e||"").match(/^([0-9]{4})-([0-9]{2})-([0-9]{2})/);null!==i&&t.setFullYear(Number(i[1]),Number(i[2])-1,Number(i[3]));const s=(e||"").match(/([0-9]{2}):([0-9]{2})(:([0-9]{2}))?$/);return null!==s&&t.setHours(Number(s[1]),Number(s[2]),s.length>4?Number(s[4]):t.getSeconds()),t}const La=(e,t)=>"select"in t&&null!==t.select?((e,t)=>{var i;return((null===(i=t.select)||void 0===i?void 0:i.options)||[]).some(t=>"object"==typeof t?t.value==e:t==e)})(String(e),t):"number"in t&&null!==t.number?((e,t)=>{var i,s;return!isNaN(e)&&(!(void 0!==(null===(i=t.number)||void 0===i?void 0:i.min)&&e<t.number.min)&&!(void 0!==(null===(s=t.number)||void 0===s?void 0:s.max)&&e>t.number.max))})(Number(e),t):!("text"in t)||null===t.text||String(e).length>0,Na=e=>null==e||Array.isArray(e)?e:[e];let Ia=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0}async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title")}render(){return this._params?q`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
      ...
      >
        <div slot="heading">
          <ha-dialog-header>
            ...
            ></ha-icon-button>
            <span slot="title">
              ${Ri("ui.panel.options.conditions.add_condition",this.hass)}
            </span>
          </ha-dialog-header>
    ...
    `}};t([le({attribute:!1})],Ia.prototype,"hass",void 0),t([ce()],Ia.prototype,"_params",void 0),t([ce()],Ia.prototype,"_search",void 0),t([ce()],Ia.prototype,"_filter",void 0),t([ce()],Ia.prototype,"_width",void 0),t([ce()],Ia.prototype,"_height",void 0),Ia=t([re("dialog-select-condition")],Ia);var qa=Object.freeze({__proto__:null,get DialogSelectCondition(){return Ia}});let Ra=class extends oe{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[]}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||Ma(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||Ma(new Date);const i=(await Cs(this.hass)).map(e=>e.name),s=[...this.config.tags||[]].flat();this.tags=[...i,...s.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return q`
      <div class="header first">
        <span>${Ri("ui.panel.options.conditions.header",this.hass)}:</span>
      ...
      <span class="header">${Ri("ui.panel.options.period.header",this.hass)}:</span>
      <div class="period">
        <ha-checkbox
        ...
        <span>${Ri("ui.panel.options.period.start_date",this.hass)}</span>
        <ha-date-input
          .locale=${this.hass.locale}
          value=${this.startDate}
          .label=${Gi("ui.components.date-range-picker.start_date",this.hass)}
          @value-changed=${this._setStartDate}
          ?disabled=${!this.schedule.start_date}
        >
        </ha-date-input>
        <span>${Ri("ui.panel.options.period.end_date",this.hass)}</span>
        <ha-date-input
          .locale=${this.hass.locale}
          value=${this.endDate}
          .label=${Gi("ui.components.date-range-picker.end_date",this.hass)}
      ...
      <span class="header">${Gi("ui.common.name",this.hass)}:</span>
      <div class="period">
        <ha-textfield
          value=${this.schedule.name||""}
          placeholder=${this.schedule.name?"":Gi("ui.common.name",this.hass)}
          @input=${this.updateName}
        ></ha-textfield>
      </div>

      <span class="header">${Ri("ui.panel.options.tags",this.hass)}:</span>
      <div>
        <scheduler-combo-selector
          .hass=${this.hass}
          .config=${e}
      ...
      <span class="header">${Ri("ui.panel.options.repeat_type",this.hass)}:</span>
      <ha-button
      ...
      >
        ...
        ${Gi("ui.components.calendar.event.repeat.label",this.hass)}
      </ha-button>
      <ha-button
      ...
      >
        ...
        ${Gi("ui.dialogs.more_info_control.vacuum.stop",this.hass)}
      </ha-button>
      <ha-button
    ...
    `}renderConditions(){let e=this.schedule.entries[0].slots[0].conditions.items;return this.conditionIdx==e.length&&(e=[...e,{}]),e.map((e,t)=>{var i;const s=this.conditionIdx==t?this.selectedEntity||e.entity_id||"":e.entity_id||"",a=this.conditionIdx==t&&this.selectedDomain||Hi(s),o=Bs(s||a,this.hass,this.config.customize),n=o&&o.hasOwnProperty("number")?[ge.Above,ge.Below]:[ge.Equal,ge.Unequal],r={[ge.Equal]:"mdi:equal",[ge.Unequal]:"mdi:not-equal-variant",[ge.Above]:"mdi:greater-than",[ge.Below]:"mdi:less-than"},d={[ge.Equal]:"ui.panel.options.conditions.types.equal_to",[ge.Unequal]:"ui.panel.options.conditions.types.unequal_to",[ge.Above]:"ui.panel.options.conditions.types.above",[ge.Below]:"ui.panel.options.conditions.types.below"};return this.conditionIdx!==t||this.selectedMatchType||(this.selectedMatchType=n[0]),q`
      <scheduler-collapsible-section idx="${t}">
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${Gi("ui.components.selectors.selector.types.entity",this.hass)}
          </span>
          <scheduler-entity-picker
            .hass=${this.hass}
            .config=${this.config}
            .domain=${a}
            @value-changed=${this._selectEntity}
            .value=${this.conditionIdx==t?Na(this.selectedEntity):Na(e.entity_id)}
            ?multiple=${!1}
          >
          </scheduler-entity-picker>
        </scheduler-settings-row>
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${Ki(Ri(d[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
            <ha-button-menu
              @action=${e=>this._selectMatchType(e,n)}
              @closed=${e=>{e.stopPropagation()}}
              fixed
            >
              <ha-icon-button slot="trigger" .path=${Ds}>
              </ha-icon-button>
              ${n.map(i=>q`
                <mwc-list-item graphic="icon" ?noninteractive=${this.conditionIdx==t?this.selectedMatchType==i:e.match_type==i}>
                  ${Ki(Ri(d[i],this.hass,["{entity}","{value}"],["",""]))}
    ...
    `}};t([le({attribute:!1})],Ra.prototype,"hass",void 0),t([le({attribute:!1})],Ra.prototype,"config",void 0),t([ce()],Ra.prototype,"schedule",void 0),t([ce()],Ra.prototype,"conditionIdx",void 0),t([ce()],Ra.prototype,"selectedDomain",void 0),t([ce()],Ra.prototype,"selectedEntity",void 0),t([ce()],Ra.prototype,"selectedMatchType",void 0),t([ce()],Ra.prototype,"conditionValue",void 0),t([ce()],Ra.prototype,"conditionValid",void 0),t([ce()],Ra.prototype,"startDate",void 0),t([ce()],Ra.prototype,"endDate",void 0),t([le()],Ra.prototype,"tags",void 0),Ra=t([re("scheduler-options-panel")],Ra);let Va=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          <ha-icon-button
            slot="navigationIcon"
      ...
      <ha-dialog open @closed=${this.closeDialog} .heading=${!0} hideActions scrimClickAction="">
        <ha-dialog-header slot="heading">
          ...
          <span slot="title" @click=${()=>this.large=!this.large}>
            ${this._params.editItem?this.schedule.name?null===(e=this.schedule)||void 0===e?void 0:e.name:Ri("ui.panel.common.default_name",this.hass,"{id}",this._params.editItem):Ri("ui.panel.common.new_schedule",this.hass)}
          </span>
        ...
        <div class="buttons">
          ...
          <ha-button appearance="plain" @click=${this._handleSaveClick}>
            ${Gi("ui.common.save",this.hass)}
          </ha-button>
        </div>
      </ha-dialog>
    `:q``}_updateSchedule(e){let t=Object.keys(e.detail);if(t.includes("schedule")){let t=e.detail.schedule;this.schedule=t}t.includes("selectedSlot")&&(this.selectedSlot=e.detail.selectedSlot)}async _handleSaveClick(e){const t=da(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const s={cancel:()=>i(!1),confirm:()=>i(!0),title:Gi("state_badge.default.error",this.hass),description:Ri("ui.panel.editor.validation_errors."+t,this.hass),primaryButtonLabel:Gi("ui.common.ok",this.hass)};zs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ha})),dialogParams:s})});else if(this.schedule.schedule_id){const t=Ie(await Os(this.hass,this.schedule.schedule_id),this.hass);if(he(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Ri("ui.dialog.enable_schedule.title",this.hass),description:Ri("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:Gi("ui.common.yes",this.hass),secondaryButtonLabel:Gi("ui.common.no",this.hass),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};zs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ha})),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=la(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>ma(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=la(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>ma(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Ri("ui.dialog.confirm_delete.title",this.hass),description:Ri("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:Gi("ui.common.ok",this.hass),secondaryButtonLabel:Gi("ui.common.cancel",this.hass)};zs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ha})),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>ma(e,this,this.hass)).then(()=>{this.closeDialog()})})}_setViewMode(e){let t=e.detail;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1;if(t!=me.Scheme)if(t!=me.Single||i)new Promise(t=>{const i={title:Ri("ui.dialog.confirm_migrate.title",this.hass),description:Ri("ui.dialog.confirm_migrate.description",this.hass),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};zs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ha})),dialogParams:i})}).then(e=>{e&&(this.schedule=(e=>{const t=e=>{let t=e.findIndex(e=>e.actions.length);t<0&&(t=Math.floor(e.length/2));let i=Object.assign(Object.assign({},e[t]),{stop:void 0});const s=i.conditions,a=i.start;return e=[{start:"00:00:00",stop:a,actions:[],conditions:s},i,{start:Ne(ze(Ce(a),{minutes:1})),stop:"00:00:00",actions:[],conditions:s}]};return e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object(Object.assign(Object.assign({},e),{slots:t(e.slots)})))})})(this.schedule),this.viewMode=t)});else{if(he([...this.schedule.entries],[...Fe.entries]))this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...Ue.entries]});else{let e=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>{let t=e.slots.findIndex(e=>e.actions.length);return t<0&&(t=Math.floor(e.slots.length/2)),Object.assign(Object.assign({},e),{slots:e.slots.map((e,i)=>i==t?Object.assign(Object.assign({},e),{stop:void 0}):null).filter(Be)})})});this.schedule=Ie(e,this.hass)}this.viewMode=t}else{this.viewMode=t;he([...this.schedule.entries],[...Ue.entries])&&(this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...Fe.entries]}))}}};Fa.styles=oa,t([le({attribute:!1})],Fa.prototype,"hass",void 0),t([ce()],Fa.prototype,"_params",void 0),t([le({type:Boolean,reflect:!0})],Fa.prototype,"large",void 0),t([ce()],Fa.prototype,"schedule",void 0),t([ce()],Fa.prototype,"selectedEntry",void 0),t([ce()],Fa.prototype,"selectedSlot",void 0),t([ce()],Fa.prototype,"_panel",void 0),t([ce()],Fa.prototype,"_viewMode",void 0),Fa=t([re("dialog-scheduler-editor")],Fa);var Ua=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return Fa}});
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */class Ba extends Rs{constructor(e){if(super(e),this.et=V,e.type!==Is)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===V||null==e)return this.ft=void 0,this.et=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Ba.directiveName="unsafeHTML",Ba.resultType=1;const Wa=qs(Ba);var Za=window&&window.__assign||function(){return(Za=Object.assign||function(e){for(var t,i=1,s=arguments.length;i<s;i++)for(var a in t=arguments[i])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e}).apply(this,arguments)};var Ka={second:45,minute:45,hour:22,day:5};const Ga=(e,t,i)=>{if(i===Te.am_pm||!i&&t.time_format===Te.am_pm){const t=Pe(e.getHours()).am_pm;return`${Pe(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===Te.twenty_four||!i&&t.time_format===Te.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:De(t)}):De(t)?Ga(e,t,Te.am_pm):Ga(e,t,Te.twenty_four)};let Ja=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},s=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return Da[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}, ${s(e,"year")}`}(e,this._hass.locale):s>7?a=Ri("ui.components.date.next_week_day",this._hass,"{weekday}",ys(e,"long",this._hass)):1==s?a=Ri("ui.components.date.tomorrow",this._hass):s>0&&(a=ys(e,"long",this._hass));let o=Ri("ui.components.time.absolute",this._hass,"{time}",Ga(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Ri("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Ri("ui.components.time.at_midnight",this._hass)),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=Gi("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=Gi("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=Za(Za({},Ka),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var d=new Date(e),l=new Date(t),c=d.getFullYear()-l.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+d.getMonth()-l.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var h=a/604800;return{value:Math.round(h),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return q``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),q`
      ${Ki(this.relativeTime(this.datetime))}
    `}};t([le()],Ja.prototype,"_hass",void 0),t([le()],Ja.prototype,"datetime",void 0),Ja=t([re("scheduler-relative-time")],Ja);let Ya=class extends oe{render(){var e,t,i,s,a;try{const o=this.hass.states[this.schedule.entity_id];if(!o)return q``;const n="off"==o.state,r=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let d=_a(r,this.config.customize);if("entity"==(null===(e=this.config.display_options)||void 0===e?void 0:e.icon)){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Hi(r.service))&&(e=r.service),e&&(d=Zs(e,this.config.customize,this.hass))}const l=![(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat().every(e=>Object.keys(this.hass.states).includes(e));return l&&(d="mdi:help"),q`
      <ha-icon
        icon="${d}"
    ...
    `}catch(e){return q`
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return q`
        ...
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){let t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return q`
          ...
          </div>`}return Wa(e)};return xs(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>q`${t(e)}<br/>`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
    ...
    ${this.connectionError?q`
        <div>
          <hui-warning .hass=${this.hass}>
            <span style="white-space: normal">
              ${Ri("ui.panel.overview.backend_error",this.hass)}
            </span>
          </hui-warning>
        </div>
      `:Object.keys(e).length?t.map(e=>q`
          ...
          `):q`
        <div>
          ${Ri("ui.panel.overview.no_entries",this.hass)}
        </div>
        `}
      ...
      ${Object.keys(e).length>t.length&&!1!==this._config.discover_existing?this.showDiscovered?q`
          ...
          ${i.map(e=>q`
              ...
              <div>
                ...
                >
                  ${Ri("ui.panel.overview.hide_excluded",this.hass)}
                </ha-button>
              </div>
            `:q`
              <div>
                ...
                >
                  +
                  ${Ri("ui.panel.overview.excluded_items",this.hass,"{number}",Object.keys(e).length-t.length)}
                </ha-button>
              </div>
            `:""}
        </div>
        ...
        <div class="card-actions">
          ...
          <ha-button appearance="plain" variant="warning" @click=${this._retryConnection}
            >${Gi("ui.common.refresh",this.hass)}
          </ha-button>
            `:q`
          <ha-button appearance="plain" @click=${this._addClick}
            >${Gi("ui.common.add",this.hass)}
          </ha-button>
          `}
        </div>`:""}
      </ha-card>
    `}async loadSchedules(){Oe(this.hass).then(e=>{this.schedules=js(e,this._config,this.hass)}).catch(e=>{this.schedules=[],this.connectionError=!0})}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{var s;if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let a=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(a+=1);const o=(([(null===(s=this._config.display_options)||void 0===s?void 0:s.secondary_info)||[]].flat().length||2)+1)/2;this.schedules&&(a+=this.showDiscovered?Object.keys(this.schedules).length*o:Object.values(this.schedules).filter(e=>Wi(e,this._config)).length*o),clearInterval(i),e(Math.round(a))},50)})}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?Os(this.hass,e.schedule_id).then(t=>{const i=this.schedules.findIndex(t=>t.schedule_id==e.schedule_id),s=i>=0?this.schedules[i]:null;let a=[...this.schedules||[]];!t||!1===this._config.discover_existing&&!Wi(t,this._config)?s&&(a=a.filter(t=>t.schedule_id!==e.schedule_id)):s?s.timestamps[s.next_entries[0]||0]==t.timestamps[t.next_entries[0]||0]?a=Object.assign(a,{[i]:t}):(a=Object.assign(a,{[i]:t}),a=js(a,this._config,this.hass)):a=js([...a,t],this._config,this.hass),this.schedules=[...a]}):this.schedules=(this.schedules||[]).filter(t=>t.schedule_id!==e.schedule_id)}_handleEditClick(e,t){if(!this.schedules)return;const i={schedule:Ie(t,this.hass),cardConfig:this._config,editItem:t.schedule_id};zs(e.target,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return Ua})),dialogParams:i})}_addClick(e){const t=[this._config.tags||[]].flat().filter(e=>!["none","disabled","enabled"].includes(e));let i=this._config.default_editor==me.Scheme?JSON.parse(JSON.stringify(Fe)):JSON.parse(JSON.stringify(Ue));const s={schedule:Object.assign(Object.assign({},i),{tags:1==t.length?t:[]}),cardConfig:this._config};zs(this,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return Ua})),dialogParams:s})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked;Object.values(this.schedules).filter(e=>this.showDiscovered||Wi(e,this._config)).forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}static getConfigElement(){return document.createElement("scheduler-card-editor")}},e.SchedulerCard.styles=r`
    .card-header {
      display: flex;
      justify-content: space-between;
    }
