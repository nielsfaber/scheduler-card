...
/**
        ...
        <div slot="heading">
          <ha-dialog-header>
            <ha-icon-button
              slot="navigationIcon"
              dialogAction="cancel"
              .label=${ss("ui.dialogs.more_info_control.dismiss",this.hass)}
              .path=${Is}
            ></ha-icon-button>
            <span slot="title">
          ...
          <ha-textfield
            dialogInitialFocus
            .placeholder=${ss("ui.common.search",this.hass)}
            aria-label=${ss("ui.common.search",this.hass)}
            ...
            <div class="trailing" slot="trailingIcon">
              ${this._search&&q`
                <ha-icon-button
                  ...
                  .label=${ss("ui.common.clear",this.hass)}
                  .path=${Is}
                  class="clear-button"
                ></ha-icon-button>
              `}
    ...
    `:q``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("mwc-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_toggleSelectEntity(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;t.querySelector("ha-checkbox");const i=t.getAttribute("key");this._params.entities.includes(i)?this._params=Object.assign(Object.assign({},this._params),{entities:this._params.entities.filter(e=>e!=i)}):this._params=Object.assign(Object.assign({},this._params),{entities:[...this._params.entities,i]})}_toggleSelectDomain(e){var t;let i=e.target;for(;"MWC-LIST-ITEM"!=i.tagName;)i=i.parentElement;const s=i.getAttribute("key"),a=null===(t=this.options)||void 0===t?void 0:t.find(e=>e.key==s).entities.map(e=>e.key);this._params.domains.includes(s)?this._params=Object.assign(Object.assign({},this._params),{domains:this._params.domains.filter(e=>e!=s),entities:this._params.entities.filter(e=>!(null==a?void 0:a.includes(e)))}):this._params=Object.assign(Object.assign({},this._params),{domains:[...this._params.domains,s]}),e.stopPropagation()}closeGroupByKey(e){this.shadowRoot.querySelector("mwc-list").childNodes.forEach(t=>{if(t.nodeType==Node.ELEMENT_NODE&&"MWC-LIST-ITEM"==t.tagName&&t.getAttribute("key")==e){const e=t,i=e.nextElementSibling,s=e.querySelector("ha-icon-button");i.style.height="0px",e.removeAttribute("expanded"),s.classList.remove("expanded")}})}async _toggleExpandGroup(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;const i=t.querySelector("ha-icon-button"),s=t.getAttribute("key");this.expandedGroups.includes(s)||(this.expandedGroups.forEach(e=>this.closeGroupByKey(e)),this.expandedGroups=[s],await this.requestUpdate());const a=t.nextElementSibling,o=a.scrollHeight;t.hasAttribute("expanded")?(t.removeAttribute("expanded"),i.classList.remove("expanded"),a.style.height="0px",setTimeout(()=>{this.expandedGroups=this.expandedGroups.filter(e=>e!=s)},300)):(t.setAttribute("expanded","true"),i.classList.add("expanded"),a.style.height=o+"px")}_renderOptions(){if(!this.options)return;let e=[...this.options];const t=this._filter&&this._filter.trim().length;if(t){const t=this._filter.toLowerCase().trim().split(" ");e=e.map(e=>sa(e,t)||(e=Object.assign(Object.assign({},e),{entities:(e.entities||[]).filter(e=>sa(e,t))})).entities.length?e:void 0).filter(e=>void 0!==e)}return e.length?Object.keys(e).map(i=>{var s,a;const o=e[i].key,n=null===(s=this._params)||void 0===s?void 0:s.domains.includes(o);let r=[...e[i].entities];"switch"==o&&(r=r.filter(e=>!this.scheduleEntities.includes(e.key)));const l=n?r.length:r.filter(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)}).length;return q`
        ...
        >
          ...
          <div slot="meta" class="meta">
            <ha-button
              ...
              size="small"
            >
              ${(null===(a=this._params)||void 0===a?void 0:a.domains.includes(o))||e[i].entities.every(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)})?ss("ui.components.media-browser.file_management.deselect_all",this.hass):ss("ui.components.subpage-data-table.select_all",this.hass)}
            </ha-button>
            <ha-icon-button .path="${Ls}" @click=${e=>{e.target.blur()}} class="chevron"></ha-icon-button>
          </div>
          <span>${e[i].name}</span>
          <span slot="secondary">${Gi("ui.panel.card_editor.fields.entities.included_number",this.hass,["{number}","{total}"],[l,r.length])}</span>
        </mwc-list-item>
      ...
      `}):q`
        <mwc-list-item disabled>
          ${ss("ui.components.entity.entity-picker.no_match",this.hass)}
        </mwc-list-item>
    ...
    `}};t([de({attribute:!1})],aa.prototype,"hass",void 0),t([ce()],aa.prototype,"_params",void 0),t([ce()],aa.prototype,"_search",void 0),t([ce()],aa.prototype,"_filter",void 0),t([ce()],aa.prototype,"_width",void 0),t([ce()],aa.prototype,"_height",void 0),t([ce()],aa.prototype,"expandedGroups",void 0),t([ce()],aa.prototype,"options",void 0),t([ce()],aa.prototype,"scheduleEntities",void 0),aa=t([re("dialog-select-entities")],aa);var oa=Object.freeze({__proto__:null,get DialogSelectEntities(){return aa}});let na=class extends oe{constructor(){super(...arguments),this.active=!1}render(){return q`
      ...
      `:q`
        <div class="trailing-icon" @click=${this._iconClick}>
          ${this.disabled?q`
            ...
            ></ha-icon>
          `:q`
          <ha-tooltip content="${ss("ui.common.remove",this.hass)}">
            <ha-icon icon="mdi:close"
            ></ha-icon>
          </ha-tooltip>
          `}
    ...
    `}};t([de({attribute:!1})],na.prototype,"hass",void 0),t([de({type:String})],na.prototype,"icon",void 0),t([de({type:Boolean})],na.prototype,"useStateIcon",void 0),t([de({type:Boolean})],na.prototype,"selectable",void 0),t([de({type:Boolean})],na.prototype,"removable",void 0),t([de({type:Boolean})],na.prototype,"toggleable",void 0),t([de({type:Boolean})],na.prototype,"active",void 0),t([de({type:String})],na.prototype,"badge",void 0),t([de({type:String})],na.prototype,"value",void 0),t([de({type:Boolean})],na.prototype,"disabled",void 0),na=t([re("scheduler-chip")],na);let ra=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?q`
    ...
    `}};t([de({attribute:!1})],ra.prototype,"hass",void 0),t([de({attribute:!1})],ra.prototype,"items",void 0),t([de({attribute:!1})],ra.prototype,"value",void 0),t([de({type:Boolean})],ra.prototype,"selectable",void 0),t([de({type:Boolean})],ra.prototype,"toggleable",void 0),t([de({type:Boolean})],ra.prototype,"removable",void 0),t([de({type:Boolean})],ra.prototype,"disabled",void 0),ra=t([re("scheduler-chip-set")],ra);let la=class extends oe{constructor(){super(...arguments),this.autofocus=!1,this.disabled=!1,this.hideClearIcon=!1,this._opened=!1,this._isOpening=!1,this._items=[],this._getItems=()=>{const e=(this.getItems?this.getItems():[]).sort((e,t)=>ts(e.primary,t.primary));return e.length||e.push({id:"___no_matching_items_found___",primary:Gi("ui.dialog.entity_picker.no_results",this.hass),icon:"mdi:cancel"}),e}}shouldUpdate(e){return!!(e.has("value")||e.has("label")||e.has("disabled"))||!(!e.has("_opened")&&this._opened)}willUpdate(e){e.has("_opened")&&this._opened&&(this._items=this._getItems())}render(){const e=!!this.value&&!this.disabled&&!this.hideClearIcon;return q`
          ...
          >
            ${this.value?this.valueRenderer?this.valueRenderer(this.value):q`<span slot="headline">${this.value}</span>`:q`
              <span slot="headline" class="placeholder">
                ${this.placeholder||Gi("ui.dialog.entity_picker.choose",this.hass)}
              </span>
            `}
            ${e?q`
                <ha-icon-button
    ...
    `}get _value(){return this.value||""}_renderHelper(){return this.helper?q`<ha-input-helper-text .disabled=${this.disabled}
        ...
        >`:H}_valueChanged(e){var t;e.stopPropagation(),this._comboBox.setTextFieldValue("");const i=null===(t=e.detail.value)||void 0===t?void 0:t.trim();"___no_matching_items_found___"!==i&&(this._items.find(e=>e.id==i)||this.allowCustomValue)&&i!==this._value&&this._setValue(i)}_filterChanged(e){if(!this._opened)return;let t=this._items;const i=e.target,s=e.detail.value.trim().split(" ").map(String).filter(e=>e.length).map(e=>e.trim());s.length&&(t=t.filter(e=>s.every(t=>{var i;return e.primary.includes(t)||(null===(i=e.secondary)||void 0===i?void 0:i.includes(t))}))),i.filteredItems=t}_clear(e){e.stopPropagation(),this._setValue(void 0)}_setValue(e){this.value=e,Ms(this,"value-changed",{value:e})}async focus(){var e;await this.updateComplete,await(null===(e=this._comboBox)||void 0===e?void 0:e.focus())}async open(){var e;this._opened=!0,this._isOpening=!0,await this.updateComplete,null===(e=this._comboBox)||void 0===e||e.focus(),this._comboBox.open(),this._comboBox.value=""}async _openedChanged(e){var t;const i=e.detail.value;e.stopPropagation(),this._isOpening?this._isOpening=!1:this._opened&&!i&&(this._opened=!1,await this.updateComplete,null===(t=this._field)||void 0===t||t.focus())}static get styles(){return[r`
        .container {
          position: relative;
          display: block;
        }
      ...
      `]}};t([de({attribute:!1})],la.prototype,"hass",void 0),t([de({type:Boolean})],la.prototype,"autofocus",void 0),t([de({type:Boolean})],la.prototype,"disabled",void 0),t([de({type:Boolean,attribute:"allow-custom-value"})],la.prototype,"allowCustomValue",void 0),t([de()],la.prototype,"label",void 0),t([de()],la.prototype,"value",void 0),t([de()],la.prototype,"helper",void 0),t([de()],la.prototype,"placeholder",void 0),t([de({type:String,attribute:"search-label"})],la.prototype,"searchLabel",void 0),t([de({attribute:"hide-clear-icon",type:Boolean})],la.prototype,"hideClearIcon",void 0),t([de({attribute:!1,type:Array})],la.prototype,"getItems",void 0),t([de({attribute:!1,type:Array})],la.prototype,"getAdditionalItems",void 0),t([de({attribute:!1})],la.prototype,"rowRenderer",void 0),t([de({attribute:!1})],la.prototype,"valueRenderer",void 0),t([de({attribute:"not-found-label",type:String})],la.prototype,"notFoundLabel",void 0),t([he(".textInput")],la.prototype,"_field",void 0),t([he("ha-combo-box")],la.prototype,"_comboBox",void 0),t([ce()],la.prototype,"_opened",void 0),la=t([re("scheduler-picker")],la);let da=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this.multipleMode=!1,this.scheduleEntities=[],this._valueRenderer=e=>{const t=e||"",i=this.hass.states[t];if(!i)return q`
        <ha-svg-icon
          slot="start"
          .path=${qs}
          style="margin: 0 4px"
      ...
      `;const s=Qi(t,i.attributes)||t,a=t;return q`
      <state-badge
        .hass=${this.hass}
        .stateObj=${i}
        slot="start"
    ...
    `},this._filteredItems=()=>{let e=Object.keys(this.hass.states);return this.domain&&(e=e.filter(e=>Yi(e)==this.domain)),this.multiple&&(e=e.filter(e=>{var t;return!(null===(t=this.value)||void 0===t?void 0:t.includes(e))})),this.config&&(e=e.filter(e=>((this.config.include||[]).some(t=>Xi(t,e))||Object.keys(this.config.customize||{}).some(t=>Xi(t,e)))&&!(this.config.exclude||[]).some(t=>Xi(t,e)))),e=e.filter(e=>!this.scheduleEntities.includes(e)),e.map(e=>{var t;return Object({id:e,primary:Qi(e,null===(t=this.hass.states[e])||void 0===t?void 0:t.attributes),secondary:e,state:this.hass.states[e]})})}}async firstUpdated(){this.scheduleEntities=Object.entries(await Ce(this.hass)).map(([,e])=>e.entity_id)}render(){var e;return q`
      ${this.renderChips()}
      ...
      `}
    `}renderChips(){if(!this.multiple)return H;let e=(this.value||[]).map(e=>{var t;return Object({name:Qi(e,null===(t=this.hass.states[e])||void 0===t?void 0:t.attributes),value:e,useStateIcon:!0})});return q`
      <div class="wrapper">
      <scheduler-chip-set
        .hass=${this.hass}
        .items=${e}
      ...
      `}_valueChanged(e){let t=e.detail.value;const i=e.currentTarget;t&&(this.value=[...this.value||[],t],this.multiple&&(i.value=""),Ms(this,"value-changed",{value:this.value}),e.stopPropagation())}_removeClick(e){const t=e.detail;this.value=(this.value||[]).filter(e=>e!==t),Ms(this,"value-changed",{value:this.value})}};da.styles=r`
    :host {
      display: flex;
  ...
  `,t([de({attribute:!1})],da.prototype,"hass",void 0),t([de()],da.prototype,"domain",void 0),t([de()],da.prototype,"config",void 0),t([de({type:Array})],da.prototype,"value",void 0),t([de({type:Boolean})],da.prototype,"multiple",void 0),t([de({type:Boolean})],da.prototype,"disabled",void 0),t([ce()],da.prototype,"multipleMode",void 0),t([ce()],da.prototype,"scheduleEntities",void 0),da=t([re("scheduler-entity-picker")],da);let ca=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
      <div
    ...
    `}};t([de()],ua.prototype,"disabled",void 0),t([ce()],ua.prototype,"_openedItem",void 0),t([ce()],ua.prototype,"_numItems",void 0),ua=t([re("scheduler-collapsible-group")],ua);let ha=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),Ms(this,"value-changed",{value:this.value})},s=()=>{let e=t.map(e=>Object({name:e,value:e}));return q`
      ...
      `}if(this.config.number){const e=this.config.number;let t=e.min||0,i=e.max||255,s="number"==typeof this.value?this.value:t;"number"==typeof e.scale_factor&&(s/=e.scale_factor),"number"==typeof(null==e?void 0:e.step)&&(s=Math.round(s/e.step)*e.step),s=fs(s);const a=t=>{let i=Number(t.target.value);"number"==typeof e.scale_factor&&(i*=e.scale_factor),"number"==typeof(null==e?void 0:e.step)&&(i=Math.round(i/e.step)*e.step),i=fs(i),this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}}))};return q`
        ...
        <ha-slider
          ...
          ?disabled=${this.disabled}
        ></ha-slider>
        <span class="value">${s} ${e.unit||""}</span>
        </div>
      ...
      `}if(this.config.boolean){let e={select:{options:[{value:"true",label:"True",icon:"mdi:check"},{value:"false",label:"False",icon:"mdi:close"}]}};const t=e=>{let t=ns(e.detail.value)?"true"===e.detail.value:void 0;e.stopPropagation(),this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))};return q`
      ...
      `}return q``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t],e.target.value=""}else if(e.detail){let t=e.detail.value;void 0===t&&(t=null),this.value=t}else this.value=e.target.value;Ms(this,"value-changed",{value:this.value})}};ha.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
  ...
  `,t([de({attribute:!1})],ha.prototype,"hass",void 0),t([de({attribute:!1})],ha.prototype,"config",void 0),t([de()],ha.prototype,"value",void 0),t([de()],ha.prototype,"disabled",void 0),ha=t([re("scheduler-combo-selector")],ha);let ma=class extends oe{constructor(){super(...arguments),this._config=He,this.title="",this.tagOptions=[]}setConfig(e){this._config=Object.assign(Object.assign({},He),e)}async firstUpdated(){this.title="string"==typeof this._config.title?this._config.title:"";const e=(await Ds(this.hass)).map(e=>e.name);e.sort(ts),this.tagOptions=e}render(){const e={number:{min:0,max:30,step:1,unit_of_measurement:Gi("ui.panel.card_editor.fields.time_step.unit_minutes",this.hass)}},t={select:{options:this.tagOptions,multiple:!0,custom_value:!0}};return q`
      <div class="card-config">
        ...
        <div class="two-columns">
          <div class="column">
            <ha-formfield label="${Gi("ui.panel.card_editor.fields.default_editor.options.single",this.hass)}">
              <ha-radio
                name="default_editor"
                value="${_e.Single}"
          ...
          <div class="column">
            <ha-formfield label="${Gi("ui.panel.card_editor.fields.default_editor.options.scheme",this.hass)}">
              <ha-radio
                name="default_editor"
                value="${_e.Scheme}"
        ...
        <div class="column">
          ...
          <ha-formfield label="${Gi("ui.panel.card_editor.fields.sort_by.options.relative_time",this.hass)}">
            <ha-radio
              name="sort_by"
              value="relative-time"
        ...
        <div class="column">
          ...
          <ha-formfield label="${Gi("ui.panel.card_editor.fields.sort_by.options.title",this.hass)}">
            <ha-radio
              name="sort_by"
              value="title"
              @change=${this._setSortBy}
        ...
        <div class="column">
          ...
          <ha-formfield label="${Gi("ui.panel.card_editor.fields.display_format_primary.options.default",this.hass)}">
            <ha-radio
        ...
        <div class="column">
          ...
          <ha-formfield label="${Gi("ui.panel.card_editor.fields.display_format_primary.options.entity_action",this.hass)}">
            <ha-radio
              name="display_format_primary"
              value="{entity}: {action}"
              @change=${this._setDisplayOptionsPrimary}
  ...
  `,t([de({attribute:!1})],ma.prototype,"hass",void 0),t([de()],ma.prototype,"_config",void 0),t([de()],ma.prototype,"title",void 0),t([de()],ma.prototype,"tagOptions",void 0),ma=t([re("scheduler-card-editor")],ma);const pa=r`
  ha-dialog {
...
`,(e,t,i,s)=>{var a;const o=e.service,n=null===(a=e.target)||void 0===a?void 0:a.entity_id,r=us(e,s);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const l=r.fields[t];if(null===ps(o,n,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(l.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&l.supported_features)>0}))return!1}return!0});var ga;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(ga||(ga={}));const va=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>e.every((i,s)=>{const a=Te(i.start,t),o=void 0===i.stop?a:Te(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>{if(i<=s)return!0;return Te(e.start,t)>=o})})?null:ga.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,ga.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{var s;const a=us(e,i);return(null==a?void 0:a.target)&&!(null===(s=e.target)||void 0===s?void 0:s.entity_id)?ga.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).filter(([s])=>_a(e,s,t,i)).every(([s,a])=>{var o,n;let r=ps(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,s,t,i);const l=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||a.optional;return!(!Object.keys(e.service_data).includes(s)&&!l)&&!(!ns(e.service_data[s])&&!l)})?ga.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},ya=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(fa),timeslots:e.entries[0].slots.map(ba),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},fa=e=>{switch(e){case ge.Monday:return"mon";case ge.Tuesday:return"tue";case ge.Wednesday:return"wed";case ge.Thursday:return"thu";case ge.Friday:return"fri";case ge.Saturday:return"sat";case ge.Sunday:return"sun";case ge.Workday:return"workday";case ge.Weekend:return"weekend";default:return"daily"}},ba=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>ka(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ve.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),ka=e=>{var t,i;const s=e=>Object.keys(e).filter(t=>ns(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>Object({service:e.service,service_data:s(e.service_data),entity_id:t}))}return{service:e.service,service_data:s(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:s(e.service_data)}},wa=(e,t,i)=>{const s={title:ss("state_badge.default.error",i),description:q`
    <b>Something went wrong!</b><br />
    ${e.body.message}<br /><br />
    ${e.error}<br /><br />
    Please <a href="https://github.com/nielsfaber/scheduler-card/issues">report</a> the bug.
  `,primaryButtonLabel:ss("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};Ms(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ya})),dialogParams:s})},xa=e=>{if(!Object.keys(e).includes("select")||!e.select){if(Object.keys(e).includes("number")&&e.number){const t=e.number.min;return void 0!==t?t:0}return Object.keys(e).includes("boolean")&&e.boolean?void 0:(Object.keys(e).includes("text")&&e.text,"")}e.select.options},$a=(e,t)=>{const i=us(e,t),s=Yi(e.service),a=Ji(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:"mdi:"+o;if(Object.keys(ms).includes(s)&&Object.keys(ms[s].services).includes(a)){if(void 0!==ms[s].attributes){let t=ms[s].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return ms[s].services[a]}return Object.keys(ms).includes(s)&&Object.keys(ms[s].services).includes("{entity_id}")?ms[s].services["{entity_id}"]:"mdi:flash";var o},ja=(e,t,i)=>{let s=Te("string"==typeof e?Ee(e):e,i),a=Te("string"==typeof t?Ee(t):t,i);return a>s?1:a<s?-1:0},Oa=e=>Ee(e.start),Sa=e=>{if(ns(e.stop)){const t=Ee(e.stop);return 0==t.hours&&0==t.minutes&&t.mode==we.Fixed?Object.assign(Object.assign({},t),{hours:24}):t}return ze(Oa(e),{minutes:1})},Ca=(e,t,i,s)=>{let a=t;if(i.stop)return[e,a]=Ca(e,t+1,{start:i.stop},s),[e,a-1];if(i.start){let o=Oa(e[t]),n=i.start;if(ja(o,n,s)<0){let i=Oa(e[t]);for(let s=t-1;s>=0;s--){if(e[s].actions.length){i=s==t-1?ze(Oa(e[s]),{minutes:1}):Sa(e[s]);break}i=Oa(e[s])}ja(i,n,s)<0&&(n=i),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:qe(n)})});for(let i=t-1;i>=0;i--){let t=ja(Oa(e[i]),n,s),o=ja(Sa(e[i]),n,s);if(t>0&&o<0){e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:qe(n)})});break}if(o>=0)break;t<=0&&(e=Object.assign(e,{[i]:null}),a-=1)}ns(e[t].stop)||(e=ns(e[t+1].stop)&&!e[t+1].actions.length?Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:qe(Sa(e[t]))})}):[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:qe(Sa(e[t])),stop:qe(Oa(e[t+1])),actions:[]}),...e.slice(t+1)])}else if(ja(o,n,s)>0){let i=ze(Sa(e[t]),{minutes:-1});if(!ns(e[t].stop))for(let s=t+1;s<e.length;s++){if(e[s].actions.length){i=s==t+1?ze(Sa(e[s]),{minutes:-1}):Oa(e[s]);break}i=Sa(e[s])}ja(i,n,s)>0&&Te(i,s)>0&&(n=i),ns((e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:qe(n)})}))[t-1].stop)?e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:qe(n)})}):(e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:qe(Sa(e[t-1])),stop:qe(n),actions:[]}),...e.slice(t)],a=t+1);for(let t=a+1;t<e.length;t++){let i=ja(Oa(e[t]),n,s),a=ja(Sa(e[t]),n,s);if(i>0&&a<0)e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:qe(n)})});else{if(i<0)break;a>=0&&(e=Object.assign(e,{[t]:null}))}}}}return[e=e.filter(ns),a]},za=(e,t)=>{const i=new Date(t),s=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let a=3600*e.hours+60*e.minutes-s;const o=a<0?-1:1;a=Math.abs(a);let n=Math.floor(a/3600),r=Math.round((a-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),Ae({hours:n,minutes:r})};let Aa=class extends oe{constructor(){super(),this.selectedSlot=null,this.timeout=0,this.large=!1,this.handleResize=this.handleResize.bind(this)}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){}render(){return q`
      <div class="bar">
    ...
    `}renderTimebar(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=[1,2,3,4,6,8,12],i=Le(this.hass.locale),s=i?130:100;let a=Math.ceil(24/(e/s));for(;!t.includes(a);)a++;const o=[0,...Array.from(Array(24/a-1).keys()).map(e=>(e+1)*a),24];return o.map((e,t)=>{let s=a/24*100;s=Math.floor(100*s)/100;let n={mode:we.Fixed,hours:e,minutes:0};return 0==t?q`
        <span class="left" style=${Ks({width:s/2+"%"})}>${qe(n,{seconds:!1,am_pm:i})}</span>
      `:t==o.length-1?q`
        <span class="right" style=${Ks({width:s/2+"%"})}>${qe(n,{seconds:!1,am_pm:i})}</span>
      `:q`
        <span style=${Ks({width:s+"%"})}>${qe(n,{seconds:!1,am_pm:i})}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,s)=>{let a=Te(i.start,this.hass),o=Te(i.stop||i.start,this.hass);!o&&a&&(o=86400);const n=(o-a)/86400*100,r=i.actions.length?xs(i.actions[0],this.hass,this.config.customize,!0):"",l=parseFloat(getComputedStyle(this).getPropertyValue("width")),d=5*r.length+10,c=s>0?15:0,u=s<e.length-1?15:0,h=n*l/100-c-u,m=e[s+1];return q`
        <div
          class="slot ${this.selectedSlot==s?"selected":""} ${i.actions.length?"":"empty"} ${void 0===i.stop?"short":""}"
          style="${Ks({width:t[s]+"px"})}"
          @click=${this._toggleSelectTimeslot}
          idx="${s}"
        >
          ${i.stop,""}
          ${i.actions.length?r&&(h>d/3||h>50)&&h>30?q`<span style="margin-left: ${c}px; margin-right: ${u}px">${r}</span>`:h>16?q`<ha-icon icon="${$a(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
    ...
    `}};t([de({attribute:!1})],Aa.prototype,"config",void 0),t([ce()],Aa.prototype,"schedule",void 0),t([ce()],Aa.prototype,"selectedSlot",void 0),t([de({type:Boolean})],Aa.prototype,"large",void 0),t([function(e){return ue({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}({passive:!0})],Aa.prototype,"_handleDragStart",null),Aa=t([re("scheduler-timeslot-editor")],Aa);const Ea=e=>{let t=60*e.hours+e.minutes;return t>240?e=Object.assign(Object.assign({},e),{hours:4,minutes:0}):t<-240&&(e=Object.assign(Object.assign({},e),{hours:-4,minutes:0})),e};let Ta=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=we.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1,this.large=!1,this.stepSize=10}set time(e){const t=Ee(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return q`
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return H;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=we.Fixed&&(e=Ea(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return q`
        <div class="mode">
    ...
    `}}_renderSuffix(){if(this.large){const e=()=>{let e=Ie(this.hours).am_pm;const t=Ie(this.hours).hours;this.hours=Ne(t,"AM"==e?Pe.PM:Pe.AM),this._valueChanged()},t=()=>{0!=this.hours?this.hours=-this.hours:this.minutes=-this.minutes,this._valueChanged()},i=()=>{this.mode=this.mode==we.Sunrise?we.Sunset:we.Sunrise,this._valueChanged()};return q`
      ...
      `:H}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=we.Fixed||this.mode==we.Fixed){const s=za({hours:this.hours,minutes:this.minutes},t),a=za({hours:this.hours,minutes:this.minutes},i),o=60*s.hours+s.minutes,n=60*a.hours+a.minutes;let r=e||Math.abs(o)<=Math.abs(n)?we.Sunrise:we.Sunset,l=r==we.Sunrise?s:a;return{mode:r,hours:l.hours,minutes:l.minutes}}{let e=this.mode==we.Sunrise?Ee(t):Ee(i);return e=ze(e,{hours:this.hours,minutes:this.minutes}),{mode:we.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Ie(this.hours).am_pm;t=Ne(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.target.value;if(Ie(this.hours).am_pm==t)return;const i=Ie(this.hours).hours;this.hours=Ne(i,"AM"==t?Pe.AM:Pe.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=ze(t,e),this.mode!=we.Fixed&&(t=Ea(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};Ms(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==we.Fixed?Ie(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==we.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};Ta.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([de({attribute:!1})],Ta.prototype,"hass",void 0),t([ce()],Ta.prototype,"hours",void 0),t([ce()],Ta.prototype,"minutes",void 0),t([ce()],Ta.prototype,"mode",void 0),t([de({type:Boolean})],Ta.prototype,"autoValidate",void 0),t([de({type:Boolean})],Ta.prototype,"required",void 0),t([de({type:Boolean})],Ta.prototype,"disabled",void 0),t([de({type:String})],Ta.prototype,"label",void 0),t([de({type:Boolean})],Ta.prototype,"useAmPm",void 0),t([de({type:Boolean})],Ta.prototype,"large",void 0),t([de({attribute:!1})],Ta.prototype,"stepSize",void 0),Ta=t([re("scheduler-time-picker")],Ta);let Ma=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![ge.Daily,ge.Weekend,ge.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        ...
        >
          ${ss("ui.common.ok",this.hass)}
        </ha-button>
      </ha-dialog>
    `:q``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[ge.Sunday,ge.Monday,ge.Tuesday,ge.Wednesday,ge.Thursday,ge.Friday,ge.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,Ss(this.hass))}else e=[ge.Daily,ge.Workday,ge.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.every(e=>![ge.Daily,ge.Weekend,ge.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>q`
        <mwc-list-item
          graphic="icon"
        ...
        >
          ...
          ${"Custom"==e?q`
            ...
            ${is(Gi("ui.dialog.weekday_picker.choose",this.hass))}
            ${t(e)?q`<span class="badge">${this.selectedWeekdays.length}</span>`:""}
            `:is(Os(e,"long",this.hass))}
    ...
    `}};t([de({attribute:!1})],Ma.prototype,"hass",void 0),t([ce()],Ma.prototype,"_params",void 0),t([ce()],Ma.prototype,"weekdayTypeCustomSelected",void 0),Ma=t([re("dialog-select-weekdays")],Ma);var Da=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return Ma}});const La=(e,t)=>((e,t)=>e<t?-1:e>t?1:0)(e.toLowerCase(),t.toLowerCase()),Pa=(e,t,i)=>{const s=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(e=>{if(!Object.keys(os).includes(t))return!1;let s=Object.keys(os[t]).includes(e);return!s&&Object.keys(os[t]).includes("{entity_id}")&&(s=((i.include||[]).some(i=>Xi(i,`${t}.${e}`))||Object.keys(i.customize||{}).some(i=>Xi(i,`${t}.${e}`)))&&!(i.exclude||[]).some(i=>Xi(i,`${t}.${e}`))),s}):[],a=t=>ss(`component.${t}.title`,e,!1)||t.replace(/_/g," "),o=i=>ss(`component.${t}.services.${i}.name`,e,!1)||!!e.services[t]&&!!e.services[t][i]&&e.services[t][i].name||i.replace(/_/g," "),n=i=>{let s=ss(`component.${t}.services.${i}.description`,e,!1);return s||(s=e.services[t][i].description),s||"script"!=t||(s=ss(`component.${t}.services.turn_on.description`,e,!1)),s};let r=s.map(i=>Object({key:i,name:`${a(t)}: ${o(i)}`,description:n(i),icon:Object.keys(ms).includes(t)&&Object.keys(ms[t].services).includes(i)?ms[t].services[i]:Vs(t),action:{service:i.includes(".")?i:`${t}.${i}`,service_data:{},target:e.services[t][i].target?{}:void 0}})),l=(d=i.customize||{},c=t,Object.keys(d).filter(e=>{var t;return null===(t=d[e].exclude_actions)||void 0===t?void 0:t.length}).filter(e=>!c||!c.includes(".")&&Xi(Yi(e),c)||Xi(e,c)).map(e=>d[e].exclude_actions).flat().filter(ns));var d,c;return l.length&&(r=r.filter(t=>!l.some(s=>La(Ji(t.action.service),s)>0||La(xs(t.action,e,i.customize),s)>0))),cs(i.customize||{},t).forEach(e=>{let i=e.service;for(;r.find(e=>e.key==i);)i+="_2";e.variables&&Object.entries(e.variables).forEach(([t,i])=>{let s=vs(i),a=xa(s);!ns(e.service_data[t])&&ns(a)&&(e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:a})}))}),r.push({key:i,name:`${a(t)}: ${Ia(e.name||o(Ji(e.service)))}`,description:Ia(e.name||""),icon:e.icon||Vs(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},target:e.target?e.target:void 0,name:e.name,icon:e.icon}})}),r},Ia=e=>{if(null!==/<.+?>/g.exec(e)){e=(new DOMParser).parseFromString(e,"text/html").body.textContent||""}let t;for(;t=/\[([^\]]+)\]/.exec(e);)e=e.replace(t[0],"");for(;t=/\{([^\}]+)\}/.exec(e);)e=e.replace(t[0],"");return e};let Na=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.lockDomain=!1}async showDialog(e){this._params=e,e.domainFilter&&(this.lockDomain=!0),await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title"),this.hass.loadBackendTranslation("services")}render(){return this._params?q`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
      ...
      >
        <div slot="heading">
          <ha-dialog-header>
            ...
            <ha-icon-button
              slot="navigationIcon"
              .label=${ss("ui.common.back",this.hass)}
              .path=${Ps}
    ...
    `:q``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("mwc-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_renderOptions(){var e;if(null===(e=this._params)||void 0===e?void 0:e.domainFilter)return this._renderDomainActions();const t=Fs(this.hass,this._params.cardConfig);return 1===t.length?(this._params=Object.assign(Object.assign({},this._params),{domainFilter:[t[0].key]}),this._renderDomainActions()):this._renderDomainList(t)}_renderDomainList(e){e.sort((e,t)=>ts(e.name,t.name)),this._filter&&(e=e.filter(e=>{const t=this._filter.toLowerCase().trim().split(" ");return t.every(t=>e.name.toLowerCase().includes(t))||t.every(t=>e.key.toLowerCase().includes(t))}));let t=[];for(var i=e.length;i<7;i++)t.push(0);return Object.keys(e).length?q`
      ...
      `:q`
          <mwc-list-item disabled>
            ${ss("ui.components.combo-box.no_match",this.hass)}
          </mwc-list-item>
        `}_renderDomainActions(){var e;let t=this._params.domainFilter.map(e=>Pa(this.hass,e,this._params.cardConfig)).flat();return(null===(e=this._params.entityFilter)||void 0===e?void 0:e.length)&&(t=t.filter(e=>{var t;return null===(t=this._params.entityFilter)||void 0===t?void 0:t.every(t=>!Object.keys(e.action.service_data).includes("entity_id")||e.action.service_data.entity_id==t)})),this._filter&&(t=t.filter(e=>{const t=this._filter.toLowerCase().trim().split(" ");return t.every(t=>e.name.toLowerCase().includes(t))||t.every(t=>e.key.toLowerCase().includes(t))})),Object.keys(t).length?Object.keys(t).map(e=>q`
        <mwc-list-item
          graphic="icon"
    ...
    `}};t([de({attribute:!1})],Na.prototype,"hass",void 0),t([ce()],Na.prototype,"_params",void 0),t([ce()],Na.prototype,"_search",void 0),t([ce()],Na.prototype,"_filter",void 0),t([ce()],Na.prototype,"_width",void 0),t([ce()],Na.prototype,"_height",void 0),t([ce()],Na.prototype,"lockDomain",void 0),Na=t([re("dialog-select-action")],Na);var qa=Object.freeze({__proto__:null,get DialogSelectAction(){return Na}});let Ra=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return q`
      ${this.showPrefix?q`
    ...
    `}};t([de({type:Boolean})],Ra.prototype,"showPrefix",void 0),Ra=t([re("scheduler-settings-row")],Ra);let Ha=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this.large=!1,this.selectedEntry=0}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return q`
      ...
      <div class="editor-header">
        <div class="weekdays">
          <span>
            ...
            ${zs(e.weekdays,"short",this.hass)}
          </span>
          <ha-icon-button .path=${Ns} @click=${e=>this._showWeekdayDialog(e,t)}></ha-icon-button>
        </div>
        <div class="weekdays-actions">
        <ha-button appearance="plain" size="small" @click=${this.toggleViewMode}>
          ${this.viewMode==_e.Scheme?Gi("ui.panel.editor.toggle_single_mode",this.hass):Gi("ui.panel.editor.toggle_scheme_mode",this.hass)}
    ...
    `}toggleViewMode(){const e=this.viewMode==_e.Scheme?_e.Single:_e.Scheme;this.dispatchEvent(new CustomEvent("setViewMode",{detail:e}))}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return q``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=Te(e,this.hass),s=(Te(t,this.hass)||86400)-i;return q`
      <div class="actions">
        <ha-icon-button .path=${Ps} @click=${e=>{this._updateSelectedSlot(this.selectedSlot-1),e.target.blur()}} ?disabled=${null===this.selectedSlot||this.selectedSlot<1}>
        </ha-icon-button> 
        ...
        <ha-icon-button .path=${Rs} @click=${this._removeTimeslot} ?disabled=${this.schedule.entries[this.selectedEntry].slots.length<=2}>
        </ha-icon-button> 
      </div>
    ...
    `;const o=Yi(a.service),n=us(a,this.config.customize),r=ns(null===(e=null==n?void 0:n.target)||void 0===e?void 0:e.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&ns(null===(i=null===(t=us(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return q``;const l=Object.keys(n.fields||{}).filter(e=>_a(a,e,this.hass,this.config.customize));let d="",c=[(null===(t=a.target)||void 0===t?void 0:t.entity_id)||[]].flat();return!c.length&&["notify","script"].includes(o)&&(c=[a.service]),c.length&&(d+=c.map(e=>{var t;return Qi(e,null===(t=this.hass.states[e])||void 0===t?void 0:t.attributes)}).join(", "),d+=": "),d+=xs(a,this.hass,this.config.customize,!1,!0),q`
      <scheduler-collapsible-section
        ?expanded=${!0}
        ?disabled=${!0}
      >
        <div slot="header" class="header">
          <ha-icon slot="icon" icon="${$a(a,this.config.customize)}"></ha-icon>
          <span>${is(d)}</span>
        </div>
        <ha-icon-button slot="contextMenu" .path=${Rs} @click=${this._removeAction}></ha-icon-button>
        <div slot="content">

          ${n.target?q`
          <scheduler-settings-row>
            <span slot="heading">${ss("ui.components.entity.entity-picker.entity",this.hass)}</span>
          ...
          ${l.map(e=>{var t;const i=ps(a.service,null===(t=a.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let s=n.fields[e].optional||(i.number||{}).optional;const o=!s||Object.keys(a.service_data).includes(e);return q`
  ...
  mwc-checkbox {
    ...
    `}};t([de({attribute:!1})],Za.prototype,"hass",void 0),t([ce()],Za.prototype,"_params",void 0),t([ce()],Za.prototype,"_search",void 0),t([ce()],Za.prototype,"_filter",void 0),t([ce()],Za.prototype,"_width",void 0),t([ce()],Za.prototype,"_height",void 0),Za=t([re("dialog-select-condition")],Za);var Ka=Object.freeze({__proto__:null,get DialogSelectCondition(){return Za}});let Ga=class extends oe{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[]}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||Fa(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||Fa(new Date);const i=(await Ds(this.hass)).map(e=>e.name),s=[...this.config.tags].flat();this.tags=[...i,...s.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return q`
      ...
      <div class="period">
        ...
        <ha-date-input
          ...
          .label=${ss("ui.components.date-range-picker.start_date",this.hass)}
        ...
        <ha-date-input
          .locale=${this.hass.locale}
          value=${this.endDate}
          .label=${ss("ui.components.date-range-picker.end_date",this.hass)}
      ...
      <span class="header">${ss("ui.common.name",this.hass)}:</span>
      <div class="period">
        <ha-textfield
          value=${this.schedule.name||""}
          placeholder=${this.schedule.name?"":ss("ui.common.name",this.hass)}
      ...
      >
        ...
        ${ss("ui.components.calendar.event.repeat.label",this.hass)}
      </ha-button>
      <ha-button
      ...
      >
        ...
        ${ss("ui.dialogs.more_info_control.vacuum.stop",this.hass)}
      </ha-button>
      <ha-button
    ...
    `}renderConditions(){let e=this.schedule.entries[0].slots[0].conditions.items;return this.conditionIdx==e.length&&(e=[...e,{}]),e.map((e,t)=>{const i=this.selectedDomain||Yi(e.entity_id||""),s=Qs(this.selectedEntity||i,this.hass),a=s&&s.hasOwnProperty("number")?[ye.Above,ye.Below]:[ye.Equal,ye.Unequal],o={[ye.Equal]:"mdi:equal",[ye.Unequal]:"mdi:not-equal-variant",[ye.Above]:"mdi:greater-than",[ye.Below]:"mdi:less-than"},n={[ye.Equal]:"ui.panel.options.conditions.types.equal_to",[ye.Unequal]:"ui.panel.options.conditions.types.unequal_to",[ye.Above]:"ui.panel.options.conditions.types.above",[ye.Below]:"ui.panel.options.conditions.types.below"};return this.conditionIdx!==t||this.selectedMatchType||(this.selectedMatchType=a[0]),q`
      <scheduler-collapsible-section idx="${t}">
        ...
        >
          ...
          <mwc-list-item graphic="icon">
            ${ss("ui.panel.lovelace.editor.card.conditional.change_type",this.hass)}
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${ss("ui.components.selectors.selector.types.entity",this.hass)}
          </span>
          <scheduler-entity-picker
            .hass=${this.hass}
            .config=${this.config}
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${is(Gi(n[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
            <ha-button-menu
            ...
            >
              ...
              ${a.map(i=>q`
                <mwc-list-item graphic="icon" ?noninteractive=${this.conditionIdx==t?this.selectedMatchType==i:e.match_type==i}>
                  ${is(Gi(n[i],this.hass,["{entity}","{value}"],["",""]))}
    ...
    `}};t([de({attribute:!1})],Ga.prototype,"hass",void 0),t([de({attribute:!1})],Ga.prototype,"config",void 0),t([ce()],Ga.prototype,"schedule",void 0),t([ce()],Ga.prototype,"conditionIdx",void 0),t([ce()],Ga.prototype,"selectedDomain",void 0),t([ce()],Ga.prototype,"selectedEntity",void 0),t([ce()],Ga.prototype,"selectedMatchType",void 0),t([ce()],Ga.prototype,"conditionValue",void 0),t([ce()],Ga.prototype,"conditionValid",void 0),t([ce()],Ga.prototype,"startDate",void 0),t([ce()],Ga.prototype,"endDate",void 0),t([de()],Ga.prototype,"tags",void 0),Ga=t([re("scheduler-options-panel")],Ga);let Ja=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          <ha-icon-button
            slot="navigationIcon"
    ...
    `}};t([de({attribute:!1})],Ja.prototype,"hass",void 0),t([ce()],Ja.prototype,"_params",void 0),Ja=t([re("scheduler-generic-dialog")],Ja);var Ya=Object.freeze({__proto__:null,get GenericDialog(){return Ja}});let Qa=class extends oe{constructor(){super(...arguments),this.large=!1,this.selectedEntry=0,this.selectedSlot=null,this._panel="main",this._viewMode=_e.Single}set viewMode(e){if(this._viewMode=e,e==_e.Single){let e=this.schedule.entries[this.selectedEntry].slots.findIndex(e=>e.actions.length);this.selectedSlot=e>=0?e:1}}shouldUpdate(e){return 1!=e.size||!e.has("hass")||!ns(this.hass)}async showDialog(e){var t;this._params=e,this.schedule=e.schedule,this._panel="main",this.large=!1;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length&&ns(e.stop)).length>0||this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1||this.schedule.entries[this.selectedEntry].slots.length>3;let s=this.schedule.entries[this.selectedEntry].slots.findIndex(e=>e.actions.length);this.selectedSlot=s>=0?s:null,this.viewMode=i?_e.Scheme:(null===(t=this._params)||void 0===t?void 0:t.cardConfig.default_editor)||_e.Single,await this.updateComplete}async closeDialog(){this._params=void 0}willUpdate(){this.hass.loadBackendTranslation("config")}render(){var e;return this._params?q`
      <ha-dialog open @closed=${this.closeDialog} .heading=${!0} hideActions scrimClickAction="">
        ...
        <div class="buttons">
          ...
          <ha-button appearance="plain" @click=${this._handleSaveClick}>
            ${ss("ui.common.save",this.hass)}
          </ha-button>
        </div>
      </ha-dialog>
    `:q``}_updateSchedule(e){let t=Object.keys(e.detail);if(t.includes("schedule")){let t=e.detail.schedule;this.schedule=t}t.includes("selectedSlot")&&(this.selectedSlot=e.detail.selectedSlot)}async _handleSaveClick(e){const t=va(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const s={cancel:()=>i(!1),confirm:()=>i(!0),title:ss("state_badge.default.error",this.hass),description:Gi("ui.panel.editor.validation_errors."+t,this.hass),primaryButtonLabel:ss("ui.common.ok",this.hass)};Ms(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ya})),dialogParams:s})});else if(this.schedule.schedule_id){const t=Re(await Ts(this.hass,this.schedule.schedule_id),this.hass);if(pe(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Gi("ui.dialog.enable_schedule.title",this.hass),description:Gi("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:ss("ui.common.yes",this.hass),secondaryButtonLabel:ss("ui.common.no",this.hass),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};Ms(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ya})),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=ya(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>wa(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=ya(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>wa(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Gi("ui.dialog.confirm_delete.title",this.hass),description:Gi("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:ss("ui.common.ok",this.hass),secondaryButtonLabel:ss("ui.common.cancel",this.hass)};Ms(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ya})),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>wa(e,this,this.hass)).then(()=>{this.closeDialog()})})}_setViewMode(e){let t=e.detail;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1;if(t!=_e.Scheme){if(t==_e.Single&&!i){let e=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>{let t=e.slots.findIndex(e=>e.actions.length);return t<0&&(t=Math.floor(e.slots.length/2)),Object(Object.assign(Object.assign({},e),{slots:e.slots.map((e,i)=>i==t?Object.assign(Object.assign({},e),{stop:void 0}):null).filter(ns)}))})});return this.schedule=Re(e,this.hass),void(this.viewMode=t)}new Promise(t=>{const i={title:Gi("ui.dialog.confirm_migrate.title",this.hass),description:Gi("ui.dialog.confirm_migrate.description",this.hass),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};Ms(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ya})),dialogParams:i})}).then(e=>{e&&(this.schedule=(e=>{const t=e=>{let t=e.findIndex(e=>e.actions.length);t<0&&(t=Math.floor(e.length/2));let i=Object.assign(Object.assign({},e[t]),{stop:void 0});const s=i.conditions,a=i.start;return e=[{start:"00:00:00",stop:a,actions:[],conditions:s},i,{start:qe(ze(Ee(a),{minutes:1})),stop:"00:00:00",actions:[],conditions:s}]};return e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object(Object.assign(Object.assign({},e),{slots:t(e.slots)})))})})(this.schedule),this.viewMode=t)})}else this.viewMode=t}};Qa.styles=pa,t([de({attribute:!1})],Qa.prototype,"hass",void 0),t([ce()],Qa.prototype,"_params",void 0),t([de({type:Boolean,reflect:!0})],Qa.prototype,"large",void 0),t([ce()],Qa.prototype,"schedule",void 0),t([ce()],Qa.prototype,"selectedEntry",void 0),t([ce()],Qa.prototype,"selectedSlot",void 0),t([ce()],Qa.prototype,"_panel",void 0),t([ce()],Qa.prototype,"_viewMode",void 0),Qa=t([re("dialog-scheduler-editor")],Qa);var Xa=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return Qa}});
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */class eo extends Zs{constructor(e){if(super(e),this.et=H,e.type!==Us)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===H||null==e)return this.ft=void 0,this.et=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}eo.directiveName="unsafeHTML",eo.resultType=1;const to=Ws(eo);var io=window&&window.__assign||function(){return(io=Object.assign||function(e){for(var t,i=1,s=arguments.length;i<s;i++)for(var a in t=arguments[i])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e}).apply(this,arguments)};var so={second:45,minute:45,hour:22,day:5};const ao=(e,t,i)=>{if(i===De.am_pm||!i&&t.time_format===De.am_pm){const t=Ie(e.getHours()).am_pm;return`${Ie(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===De.twenty_four||!i&&t.time_format===De.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:Le(t)}):Le(t)?ao(e,t,De.am_pm):ao(e,t,De.twenty_four)};let oo=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},s=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return Va[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}, ${s(e,"year")}`}(e,this._hass.locale):s>7?a=Gi("ui.components.date.next_week_day",this._hass,"{weekday}",Os(e,"long",this._hass)):1==s?a=Gi("ui.components.date.tomorrow",this._hass):s>0&&(a=Os(e,"long",this._hass));let o=Gi("ui.components.time.absolute",this._hass,"{time}",ao(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Gi("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Gi("ui.components.time.at_midnight",this._hass)),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=ss("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=ss("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=io(io({},so),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var l=new Date(e),d=new Date(t),c=l.getFullYear()-d.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+l.getMonth()-d.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var h=a/604800;return{value:Math.round(h),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return q``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),q`
      ${is(this.relativeTime(this.datetime))}
    `}};t([de()],oo.prototype,"_hass",void 0),t([de()],oo.prototype,"datetime",void 0),oo=t([re("scheduler-relative-time")],oo);let no=class extends oe{render(){var e;try{const t=this.hass.states[this.schedule.entity_id];if(!t)return q``;const i="off"==t.state,s=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let a=$a(s,this.config.customize);if("entity"==this.config.display_options.icon){let t=[(null===(e=s.target)||void 0===e?void 0:e.entity_id)||[]].flat().shift();["script","notify"].includes(Yi(s.service))&&(t=s.service),t&&(a=ta(t,this.config.customize,this.hass))}return q`
      <ha-icon
        icon="${a}"
    ...
    `}catch(e){return q`
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return q`
        ...
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){let t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return q`
          ...
          </div>`}return to(e)};return As(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>q`${t(e)}<br/>`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
    ...
    `}};t([de()],no.prototype,"hass",void 0),t([de()],no.prototype,"schedule_id",void 0),t([de()],no.prototype,"schedule",void 0),t([de()],no.prototype,"config",void 0),no=t([re("scheduler-item-row")],no),e.SchedulerCard=class extends oe{constructor(){super(...arguments),this._config=He,this.showDiscovered=!1,this.translationsLoaded=!1,this.connectionError=!1}setConfig(e){e=(e=>{let t=[];if(Ue(e,"include")&&!Ge(e.include)&&t.push("'include' must be a list of strings"),Ue(e,"exclude")&&!Ge(e.exclude)&&t.push("'exclude' must be a list of strings"),Ue(e,"discover_existing")&&!We(e.discover_existing)&&t.push("'discover_existing' must be a boolean"),!Ue(e,"title")||We(e.title)||Ze(e.title)||t.push("'title' must be a boolean or string"),Ue(e,"time_step")&&("number"!=typeof e.time_step||Number(e.time_step)<1||Number(e.time_step)>30)&&t.push("'time_step' must be a number between 1 and 30"),Ue(e,"show_header_toggle")&&!We(e.show_header_toggle)&&t.push("'show_header_toggle' must be a boolean"),Ue(e,"show_add_button")&&!We(e.show_add_button)&&t.push("'show_add_button' must be a boolean"),Ue(e,"display_options")&&(Ke(e.display_options)?(!Ue(e.display_options,"primary_info")||Ze(e.display_options.primary_info)||Ge(e.display_options.primary_info)||t.push("in 'display_options': 'primary_info' must be a string or list of strings"),!Ue(e.display_options,"secondary_info")||Ze(e.display_options.secondary_info)||Ge(e.display_options.secondary_info)||t.push("in 'display_options': 'secondary_info' must be a string or list of strings"),!Ue(e.display_options,"icon")||Ze(e.display_options.icon)&&["action","entity"].includes(e.display_options.icon)||t.push("in 'display_options': 'icon' must be a set to either 'action' or 'entity' ")):t.push("'display_options' must be a struct")),!Ue(e,"sort_by")||Ze(e.sort_by)||Ge(e.sort_by)||t.push("'sort_by' must be a string or list of strings"),Ue(e,"customize")&&!Ke(e.customize)&&t.push("'customize' must be a struct"),!Ue(e,"tags")||Ze(e.tags)||Ge(e.tags)||t.push("'tags' must be a string or list of strings"),!Ue(e,"exclude_tags")||Ze(e.tags)||Ge(e.tags)||t.push("'exclude_tags' must be a string or list of strings"),t.length)throw new Error(`Invalid configuration provided (${t.length} error${t.length>1?"s":""}): ${t.join(", ")}.`);return e})(e),this._config=Object.assign(Object.assign({},He),e)}firstUpdated(){(async()=>{await(async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider")&&customElements.get("ha-combo-box"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.automation.load()})()})();document.querySelector("home-assistant")._loadFragmentTranslations(this.hass.language,"config")}willUpdate(){this.hass.loadBackendTranslation("services")}__checkSubscribed(){void 0===this.__unsubs&&this.isConnected&&void 0!==this.hass&&(this.__unsubs=this.hassSubscribe())}connectedCallback(){super.connectedCallback(),this.__checkSubscribed()}disconnectedCallback(){if(super.disconnectedCallback(),this.__unsubs){for(;this.__unsubs.length;){const e=this.__unsubs.pop();e instanceof Promise?e.then(e=>e()):e()}this.__unsubs=void 0}}updated(e){super.updated(e),e.has("hass")&&this.__checkSubscribed()}hassSubscribe(){return this.loadSchedules(),[this.hass.connection.subscribeMessage(e=>this.handleScheduleItemUpdated(e),{type:"scheduler_updated"})]}shouldUpdate(e){const t=e.get("hass"),i=e.get("_config");if(i&&this._config){Object.keys(i).filter(e=>i[e]!==this._config[e]).some(e=>["tags","discover_existing","sort_by","display_options"].includes(e))&&(async()=>{await this.loadSchedules()})()}return!this.translationsLoaded&&ss("component.input_boolean.services.turn_on.name",this.hass,!1).length&&ss("ui.panel.config.automation.editor.conditions.type.sun.sunrise",this.hass,!1).length?(this.translationsLoaded=!0,!0):!t||1!=e.size||!this.schedules||Object.values(this.schedules).some(e=>JSON.stringify(t.states[e.entity_id])!==JSON.stringify(this.hass.states[e.entity_id]))}render(){let e=Object.assign({},this.schedules),t=Object.keys(this.schedules||{}).filter(t=>es(e[t],this._config));const i=Object.entries(e).filter(([e])=>!!this.showDiscovered||t.includes(e)).some(([,e])=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")});return q`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${this._config.title?"string"==typeof this._config.title?this._config.title:Gi("ui.panel.common.title",this.hass):""}
          </div>
      ...
      ${Object.keys(e).length>t.length&&!1!==this._config.discover_existing?this.showDiscovered?q`
        ...
        <div class="card-actions">
          ...
          <ha-button appearance="plain" variant="warning" @click=${this._retryConnection}
            >${ss("ui.common.refresh",this.hass)}
          </ha-button>
            `:q`
          <ha-button appearance="plain" @click=${this._addClick}
            >${ss("ui.common.add",this.hass)}
          </ha-button>
          `}
        </div>`:""}
      </ha-card>
    `}async loadSchedules(){Ce(this.hass).then(e=>{this.schedules=Es(e,this._config,this.hass)}).catch(e=>{this.schedules={},this.connectionError=!0})}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let s=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(s+=1);const a=(([this._config.display_options.secondary_info||[]].flat().length||2)+1)/2;this.schedules&&(s+=this.showDiscovered?Object.keys(this.schedules).length*a:Object.values(this.schedules).filter(e=>es(e,this._config)).length*a),clearInterval(i),e(Math.round(s))},50)})}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?Ts(this.hass,e.schedule_id).then(t=>{const i=this.schedules[e.schedule_id];let s=Object.assign({},this.schedules);t&&(this._config.discover_existing||es(t,this._config))?s=i?i.timestamps[i.next_entries[0]||0]==t.timestamps[t.next_entries[0]||0]?Object.assign(Object.assign({},s),{[e.schedule_id]:t}):Es(Object.assign(Object.assign({},s),{[e.schedule_id]:t}),this._config,this.hass):Es(Object.assign(Object.assign({},s),{[e.schedule_id]:t}),this._config,this.hass):i&&(s=Object.fromEntries(Object.entries(s).filter(([t])=>t!=e.schedule_id))),this.schedules=Object.assign({},s)}):this.schedules=Object.fromEntries(Object.entries(this.schedules||{}).filter(([t])=>t!==e.schedule_id))}_handleEditClick(e){if(!this.schedules)return;const t=e.detail.schedule_id,i={schedule:Re(this.schedules[t],this.hass),cardConfig:this._config,editItem:t};Ms(e.target,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return Xa})),dialogParams:i})}_addClick(e){const t=[this._config.tags||[]].flat().filter(e=>!["none","disabled","enabled"].includes(e));let i=this._config.default_editor==_e.Scheme?JSON.parse(JSON.stringify(Fe)):JSON.parse(JSON.stringify(Be));const s={schedule:Object.assign(Object.assign({},i),{tags:1==t.length?t:[]}),cardConfig:this._config};Ms(this,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return Xa})),dialogParams:s})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked;Object.values(this.schedules).filter(e=>this.showDiscovered||es(e,this._config)).forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}static getConfigElement(){return document.createElement("scheduler-card-editor")}},e.SchedulerCard.styles=r`
    .card-header {
      display: flex;
      justify-content: space-between;
    }
