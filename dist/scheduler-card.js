...
/**
    ...
    `:q``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("mwc-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_toggleSelectEntity(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;t.querySelector("ha-checkbox");const i=t.getAttribute("key");this._params.entities.includes(i)?this._params=Object.assign(Object.assign({},this._params),{entities:this._params.entities.filter(e=>e!=i)}):this._params=Object.assign(Object.assign({},this._params),{entities:[...this._params.entities,i]})}_toggleSelectDomain(e){var t;let i=e.target;for(;"MWC-LIST-ITEM"!=i.tagName;)i=i.parentElement;const a=i.getAttribute("key"),s=null===(t=this.options)||void 0===t?void 0:t.find(e=>e.key==a).entities.map(e=>e.key);this._params.domains.includes(a)?this._params=Object.assign(Object.assign({},this._params),{domains:this._params.domains.filter(e=>e!=a),entities:this._params.entities.filter(e=>!(null==s?void 0:s.includes(e)))}):this._params=Object.assign(Object.assign({},this._params),{domains:[...this._params.domains,a]}),e.stopPropagation()}closeGroupByKey(e){this.shadowRoot.querySelector("mwc-list").childNodes.forEach(t=>{if(t.nodeType==Node.ELEMENT_NODE&&"MWC-LIST-ITEM"==t.tagName&&t.getAttribute("key")==e){const e=t,i=e.nextElementSibling,a=e.querySelector("ha-icon-button");i.style.height="0px",e.removeAttribute("expanded"),a.classList.remove("expanded")}})}async _toggleExpandGroup(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;const i=t.querySelector("ha-icon-button"),a=t.getAttribute("key");this.expandedGroups.includes(a)||(this.expandedGroups.forEach(e=>this.closeGroupByKey(e)),this.expandedGroups=[a],await this.requestUpdate());const s=t.nextElementSibling,o=s.scrollHeight;t.hasAttribute("expanded")?(t.removeAttribute("expanded"),i.classList.remove("expanded"),s.style.height="0px",setTimeout(()=>{this.expandedGroups=this.expandedGroups.filter(e=>e!=a)},300)):(t.setAttribute("expanded","true"),i.classList.add("expanded"),s.style.height=o+"px")}_renderOptions(){if(!this.options)return;let e=[...this.options];const t=this._filter&&this._filter.trim().length;if(t){const t=this._filter.toLowerCase().trim().split(" ");e=e.map(e=>ls(e,t)||(e=Object.assign(Object.assign({},e),{entities:(e.entities||[]).filter(e=>ls(e,t))})).entities.length?e:void 0).filter(e=>void 0!==e)}return e.length?Object.keys(e).map(i=>{var a,s;const o=e[i].key,n=null===(a=this._params)||void 0===a?void 0:a.domains.includes(o);let r=[...e[i].entities];"switch"==o&&(r=r.filter(e=>!this.scheduleEntities.includes(e.key)));const l=n?r.length:r.filter(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)}).length;return q`
        ...
        >
          ...
          <div slot="meta" class="meta">
            ...
            <ha-icon-button .path="${Ha}" @click=${e=>{e.target.blur()}} class="chevron"></ha-icon-button>
          </div>
          <span>${e[i].name}</span>
    ...
    `}};t([de({attribute:!1})],ds.prototype,"hass",void 0),t([ce()],ds.prototype,"_params",void 0),t([ce()],ds.prototype,"_search",void 0),t([ce()],ds.prototype,"_filter",void 0),t([ce()],ds.prototype,"_width",void 0),t([ce()],ds.prototype,"_height",void 0),t([ce()],ds.prototype,"expandedGroups",void 0),t([ce()],ds.prototype,"options",void 0),t([ce()],ds.prototype,"scheduleEntities",void 0),ds=t([re("dialog-select-entities")],ds);var cs=Object.freeze({__proto__:null,get DialogSelectEntities(){return ds}});let us=class extends oe{constructor(){super(...arguments),this.active=!1}render(){return q`
    ...
    `}};t([de({attribute:!1})],us.prototype,"hass",void 0),t([de({type:String})],us.prototype,"icon",void 0),t([de({type:Boolean})],us.prototype,"useStateIcon",void 0),t([de({type:Boolean})],us.prototype,"selectable",void 0),t([de({type:Boolean})],us.prototype,"removable",void 0),t([de({type:Boolean})],us.prototype,"toggleable",void 0),t([de({type:Boolean})],us.prototype,"active",void 0),t([de({type:String})],us.prototype,"badge",void 0),t([de({type:String})],us.prototype,"value",void 0),t([de({type:Boolean})],us.prototype,"disabled",void 0),us=t([re("scheduler-chip")],us);let hs=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?q`
    ...
    `}};t([de({attribute:!1})],hs.prototype,"hass",void 0),t([de({attribute:!1})],hs.prototype,"items",void 0),t([de({attribute:!1})],hs.prototype,"value",void 0),t([de({type:Boolean})],hs.prototype,"selectable",void 0),t([de({type:Boolean})],hs.prototype,"toggleable",void 0),t([de({type:Boolean})],hs.prototype,"removable",void 0),t([de({type:Boolean})],hs.prototype,"disabled",void 0),hs=t([re("scheduler-chip-set")],hs);let ms=class extends oe{constructor(){super(...arguments),this.autofocus=!1,this.disabled=!1,this.hideClearIcon=!1,this._opened=!1,this._isOpening=!1,this._items=[],this._getItems=()=>{const e=(this.getItems?this.getItems():[]).sort((e,t)=>sa(e.primary,t.primary));return e.length||e.push({id:"___no_matching_items_found___",primary:Qi("ui.dialog.entity_picker.no_results",this.hass),icon:"mdi:cancel"}),e}}shouldUpdate(e){return!!(e.has("value")||e.has("label")||e.has("disabled"))||!(!e.has("_opened")&&this._opened)}willUpdate(e){e.has("_opened")&&this._opened&&(this._items=this._getItems())}render(){const e=!!this.value&&!this.disabled&&!this.hideClearIcon;return q`
    ...
    `}get _value(){return this.value||""}_renderHelper(){return this.helper?q`<ha-input-helper-text .disabled=${this.disabled}
        ...
        >`:H}_valueChanged(e){var t;e.stopPropagation(),this._comboBox.setTextFieldValue("");const i=null===(t=e.detail.value)||void 0===t?void 0:t.trim();"___no_matching_items_found___"!==i&&(this._items.find(e=>e.id==i)||this.allowCustomValue)&&i!==this._value&&this._setValue(i)}_filterChanged(e){if(!this._opened)return;let t=this._items;const i=e.target,a=e.detail.value.trim().split(" ").map(String).filter(e=>e.length).map(e=>e.trim());a.length&&(t=t.filter(e=>a.every(t=>{var i;return e.primary.includes(t)||(null===(i=e.secondary)||void 0===i?void 0:i.includes(t))}))),i.filteredItems=t}_clear(e){e.stopPropagation(),this._setValue(void 0)}_setValue(e){this.value=e,qa(this,"value-changed",{value:e})}async focus(){var e;await this.updateComplete,await(null===(e=this._comboBox)||void 0===e?void 0:e.focus())}async open(){var e;this._opened=!0,this._isOpening=!0,await this.updateComplete,null===(e=this._comboBox)||void 0===e||e.focus(),this._comboBox.open(),this._comboBox.value=""}async _openedChanged(e){var t;const i=e.detail.value;e.stopPropagation(),this._isOpening?this._isOpening=!1:this._opened&&!i&&(this._opened=!1,await this.updateComplete,null===(t=this._field)||void 0===t||t.focus())}static get styles(){return[r`
        .container {
          position: relative;
          display: block;
        }
      ...
      `]}};t([de({attribute:!1})],ms.prototype,"hass",void 0),t([de({type:Boolean})],ms.prototype,"autofocus",void 0),t([de({type:Boolean})],ms.prototype,"disabled",void 0),t([de({type:Boolean,attribute:"allow-custom-value"})],ms.prototype,"allowCustomValue",void 0),t([de()],ms.prototype,"label",void 0),t([de()],ms.prototype,"value",void 0),t([de()],ms.prototype,"helper",void 0),t([de()],ms.prototype,"placeholder",void 0),t([de({type:String,attribute:"search-label"})],ms.prototype,"searchLabel",void 0),t([de({attribute:"hide-clear-icon",type:Boolean})],ms.prototype,"hideClearIcon",void 0),t([de({attribute:!1,type:Array})],ms.prototype,"getItems",void 0),t([de({attribute:!1,type:Array})],ms.prototype,"getAdditionalItems",void 0),t([de({attribute:!1})],ms.prototype,"rowRenderer",void 0),t([de({attribute:!1})],ms.prototype,"valueRenderer",void 0),t([de({attribute:"not-found-label",type:String})],ms.prototype,"notFoundLabel",void 0),t([he(".textInput")],ms.prototype,"_field",void 0),t([he("ha-combo-box")],ms.prototype,"_comboBox",void 0),t([ce()],ms.prototype,"_opened",void 0),ms=t([re("scheduler-picker")],ms);let ps=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this.multipleMode=!1,this.scheduleEntities=[],this._valueRenderer=e=>{Array.isArray(e)&&(e=e.length?e.pop():"");const t=e||"",i=this.hass.states[t];if(!i)return q`
        <ha-svg-icon
          slot="start"
          .path=${Ua}
          style="margin: 0 4px"
    ...
    `}renderChips(){if(!this.multiple)return H;let e=(this.value||[]).map(e=>{const t=this._parseEntityItem(e);return{name:t.primary,value:e,useStateIcon:!t.icon,icon:t.icon}});return q`
      ...
      <ha-icon-button
        ...
        .path=${this.multipleMode?"M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z":Ha}
        slot="end"
      ></ha-icon-button>
      `:H}
      </div>
      </div>
      `}_valueChanged(e){let t=e.detail.value;const i=e.currentTarget;t&&(this.value=[...this.value||[],t],this.multiple&&(i.value=""),qa(this,"value-changed",{value:this.value}),e.stopPropagation())}_removeClick(e){const t=e.detail;this.value=(this.value||[]).filter(e=>e!==t),qa(this,"value-changed",{value:this.value})}_parseEntityItem(e){var t,i,a,s;const o=Object.entries((null===(t=this.config)||void 0===t?void 0:t.customize)||{}).filter(([t,i])=>ia(t,e)).map(([e,t])=>t),n=null===(i=o.find(e=>"name"in e))||void 0===i?void 0:i.name,r=null===(a=o.find(e=>"icon"in e))||void 0===a?void 0:a.icon;return{id:e,primary:n||ta(e,null===(s=this.hass.states[e])||void 0===s?void 0:s.attributes),secondary:e,icon:r}}};ps.styles=r`
    :host {
      display: flex;
  ...
  `,t([de({attribute:!1})],ps.prototype,"hass",void 0),t([de()],ps.prototype,"domain",void 0),t([de()],ps.prototype,"config",void 0),t([de({type:Array})],ps.prototype,"value",void 0),t([de({type:Boolean})],ps.prototype,"multiple",void 0),t([de({type:Boolean})],ps.prototype,"disabled",void 0),t([ce()],ps.prototype,"multipleMode",void 0),t([ce()],ps.prototype,"scheduleEntities",void 0),ps=t([re("scheduler-entity-picker")],ps);let _s=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
      <div
    ...
    `}};t([de()],gs.prototype,"disabled",void 0),t([ce()],gs.prototype,"_openedItem",void 0),t([ce()],gs.prototype,"_numItems",void 0),gs=t([re("scheduler-collapsible-group")],gs);let vs=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),qa(this,"value-changed",{value:this.value})},a=()=>{let e=t.map(e=>Object({name:e,value:e}));return q`
      ...
      `}if(this.config.number){const e=this.config.number;let t=e.min||0,i=e.max||255,a="number"==typeof this.value?this.value:t;"number"==typeof e.scale_factor&&(a/=e.scale_factor),"number"==typeof(null==e?void 0:e.step)&&(a=Math.round(a/e.step)*e.step),a=pa(a);const s=t=>{let i=Number(t.target.value);"number"==typeof e.scale_factor&&(i*=e.scale_factor),"number"==typeof(null==e?void 0:e.step)&&(i=Math.round(i/e.step)*e.step),i=pa(i),this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}})),t.stopPropagation()};return q`
      ...
      `}return q``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t],e.target.value=""}else if(e.detail){let t=e.detail.value;void 0===t&&(t=null),this.value=t}else this.value=e.target.value;qa(this,"value-changed",{value:this.value})}};vs.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
  ...
  `,t([de({attribute:!1})],ys.prototype,"hass",void 0),t([de()],ys.prototype,"_config",void 0),t([de()],ys.prototype,"title",void 0),t([de()],ys.prototype,"tagOptions",void 0),ys=t([re("scheduler-card-editor")],ys);const fs=r`
  ha-dialog {
...
`,(e,t,i,a)=>{var s;const o=e.service,n=null===(s=e.target)||void 0===s?void 0:s.entity_id,r=ma(e,a);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const l=r.fields[t];if(null===ya(o,n,t,i,a))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(l.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&l.supported_features)>0}))return!1}return!0});var ks;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(ks||(ks={}));const ws=(e,t,i)=>{let a=[];a=[...a,...e.entries.map(e=>((e,t)=>e.every((i,a)=>{const s=Te(i.start,t),o=void 0===i.stop?s:Te(i.stop,t)||86400;return!(s>o)&&e.every((e,i)=>{if(i<=a)return!0;return Te(e.start,t)>=o})})?null:ks.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let s=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return s.length||(a=[...a,ks.MissingAction]),a=[...a,...s.map(e=>((e,t,i)=>{var a;const s=ma(e,i);return(null==s?void 0:s.target)&&!(null===(a=e.target)||void 0===a?void 0:a.entity_id)?ks.MissingTargetEntity:(null==s?void 0:s.fields)&&!Object.entries(s.fields).filter(([a])=>bs(e,a,t,i)).every(([a,s])=>{var o,n;let r=ya(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,a,t,i);const l=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||s.optional;return!(!Object.keys(e.service_data).includes(a)&&!l)&&!(!Ue(e.service_data[a])&&!l)})?ks.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],a.length?a.shift():null},xs=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map($s),timeslots:e.entries[0].slots.map(js),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},$s=e=>{switch(e){case ge.Monday:return"mon";case ge.Tuesday:return"tue";case ge.Wednesday:return"wed";case ge.Thursday:return"thu";case ge.Friday:return"fri";case ge.Saturday:return"sat";case ge.Sunday:return"sun";case ge.Workday:return"workday";case ge.Weekend:return"weekend";default:return"daily"}},js=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>Os(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ve.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),Os=e=>{var t,i;const a=e=>Object.keys(e).filter(t=>Ue(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>Object({service:e.service,service_data:a(e.service_data),entity_id:t}))}return{service:e.service,service_data:a(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:a(e.service_data)}},zs=(e,t,i)=>{const a={title:na("state_badge.default.error",i),description:q`
    <b>Something went wrong!</b><br />
    ${e.body.message}<br /><br />
    ${e.error}<br /><br />
    Please <a href="https://github.com/nielsfaber/scheduler-card/issues">report</a> the bug.
  `,primaryButtonLabel:na("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};qa(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return io})),dialogParams:a})},Ss=e=>{if(!Object.keys(e).includes("select")||!e.select){if(Object.keys(e).includes("number")&&e.number){const t=e.number.min;return void 0!==t?t:0}return Object.keys(e).includes("boolean")&&e.boolean?void 0:(Object.keys(e).includes("text")&&e.text,"")}e.select.options},Cs=(e,t)=>{const i=ma(e,t),a=ea(e.service),s=Xi(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:"mdi:"+o;if(Object.keys(va).includes(a)&&Object.keys(va[a].services).includes(s)){if(void 0!==va[a].attributes){let t=va[a].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return va[a].services[s]}return Object.keys(va).includes(a)&&Object.keys(va[a].services).includes("{entity_id}")?va[a].services["{entity_id}"]:"mdi:flash";var o},As=(e,t,i)=>{let a=Te("string"==typeof e?Ee(e):e,i),s=Te("string"==typeof t?Ee(t):t,i);return s>a?1:s<a?-1:0},Es=e=>Ee(e.start),Ts=e=>{if(Ue(e.stop)){const t=Ee(e.stop);return 0==t.hours&&0==t.minutes&&t.mode==we.Fixed?Object.assign(Object.assign({},t),{hours:24}):t}return Ce(Es(e),{minutes:1})},Ms=(e,t,i,a)=>{let s=t;if(i.stop)return[e,s]=Ms(e,t+1,{start:i.stop},a),[e,s-1];if(i.start){let o=Es(e[t]),n=i.start;if(As(o,n,a)<0){let i=Es(e[t]);for(let a=t-1;a>=0;a--){if(e[a].actions.length){i=a==t-1?Ce(Es(e[a]),{minutes:1}):Ts(e[a]);break}i=Es(e[a])}As(i,n,a)<0&&(n=i),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:qe(n)})});for(let i=t-1;i>=0;i--){let t=As(Es(e[i]),n,a),o=As(Ts(e[i]),n,a);if(t>0&&o<0){e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:qe(n)})});break}if(o>=0)break;t<=0&&(e=Object.assign(e,{[i]:null}),s-=1)}Ue(e[t].stop)||(e=Ue(e[t+1].stop)&&!e[t+1].actions.length?Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:qe(Ts(e[t]))})}):[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:qe(Ts(e[t])),stop:qe(Es(e[t+1])),actions:[]}),...e.slice(t+1)])}else if(As(o,n,a)>0){let i=Ce(Ts(e[t]),{minutes:-1});if(!Ue(e[t].stop))for(let a=t+1;a<e.length;a++){if(e[a].actions.length){i=a==t+1?Ce(Ts(e[a]),{minutes:-1}):Es(e[a]);break}i=Ts(e[a])}As(i,n,a)>0&&Te(i,a)>0&&(n=i),Ue((e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:qe(n)})}))[t-1].stop)?e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:qe(n)})}):(e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:qe(Ts(e[t-1])),stop:qe(n),actions:[]}),...e.slice(t)],s=t+1);for(let t=s+1;t<e.length;t++){let i=As(Es(e[t]),n,a),s=As(Ts(e[t]),n,a);if(i>0&&s<0)e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:qe(n)})});else{if(i<0)break;s>=0&&(e=Object.assign(e,{[t]:null}))}}}}return[e=e.filter(Ue),s]},Ds=(e,t)=>{const i=new Date(t),a=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let s=3600*e.hours+60*e.minutes-a;const o=s<0?-1:1;s=Math.abs(s);let n=Math.floor(s/3600),r=Math.round((s-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),Ae({hours:n,minutes:r})};let Ls=class extends oe{constructor(){super(),this.selectedSlot=null,this.timeout=0,this.large=!1,this.handleResize=this.handleResize.bind(this)}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){}render(){return q`
      <div class="bar">
    ...
    `}renderTimebar(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=[1,2,3,4,6,8,12],i=Le(this.hass.locale),a=i?130:100;let s=Math.ceil(24/(e/a));for(;!t.includes(s);)s++;const o=[0,...Array.from(Array(24/s-1).keys()).map(e=>(e+1)*s),24];return o.map((e,t)=>{let a=s/24*100;a=Math.floor(100*a)/100;let n={mode:we.Fixed,hours:e,minutes:0};return 0==t?q`
        <span class="left" style=${es({width:a/2+"%"})}>${qe(n,{seconds:!1,am_pm:i})}</span>
      `:t==o.length-1?q`
        <span class="right" style=${es({width:a/2+"%"})}>${qe(n,{seconds:!1,am_pm:i})}</span>
      `:q`
        <span style=${es({width:a+"%"})}>${qe(n,{seconds:!1,am_pm:i})}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,a)=>{let s=Te(i.start,this.hass),o=Te(i.stop||i.start,this.hass);!o&&s&&(o=86400);const n=(o-s)/86400*100,r=i.actions.length?Oa(i.actions[0],this.hass,this.config.customize,!0,!0):"",l=parseFloat(getComputedStyle(this).getPropertyValue("width")),d=5*r.length+10,c=a>0?15:0,u=a<e.length-1?15:0,h=n*l/100-c-u,m=e[a+1];return q`
        <div
          class="slot ${this.selectedSlot==a?"selected":""} ${i.actions.length?"":"empty"} ${void 0===i.stop?"short":""}"
          style="${es({width:t[a]+"px"})}"
          @click=${this._toggleSelectTimeslot}
          idx="${a}"
        >
          ${i.stop,""}
          ${i.actions.length?r&&(h>d/3||h>50)&&h>30?q`<span style="margin-left: ${c}px; margin-right: ${u}px">${r}</span>`:h>16?q`<ha-icon icon="${Cs(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
    ...
    `}};t([de({attribute:!1})],Ls.prototype,"config",void 0),t([ce()],Ls.prototype,"schedule",void 0),t([ce()],Ls.prototype,"selectedSlot",void 0),t([de({type:Boolean})],Ls.prototype,"large",void 0),t([function(e){return ue({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}({passive:!0})],Ls.prototype,"_handleDragStart",null),Ls=t([re("scheduler-timeslot-editor")],Ls);const Ns=e=>{let t=60*e.hours+e.minutes;return t>240?e=Object.assign(Object.assign({},e),{hours:4,minutes:0}):t<-240&&(e=Object.assign(Object.assign({},e),{hours:-4,minutes:0})),e};let Ps=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=we.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1,this.large=!1,this.stepSize=10}set time(e){const t=Ee(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return q`
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return H;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=we.Fixed&&(e=Ns(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return q`
        <div class="mode">
    ...
    `}}_renderSuffix(){if(this.large){const e=()=>{let e=Pe(this.hours).am_pm;const t=Pe(this.hours).hours;this.hours=Ie(t,"AM"==e?Ne.PM:Ne.AM),this._valueChanged()},t=()=>{0!=this.hours?this.hours=-this.hours:this.minutes=-this.minutes,this._valueChanged()},i=()=>{this.mode=this.mode==we.Sunrise?we.Sunset:we.Sunrise,this._valueChanged()};return q`
      ...
      `:H}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=we.Fixed||this.mode==we.Fixed){const a=Ds({hours:this.hours,minutes:this.minutes},t),s=Ds({hours:this.hours,minutes:this.minutes},i),o=60*a.hours+a.minutes,n=60*s.hours+s.minutes;let r=e||Math.abs(o)<=Math.abs(n)?we.Sunrise:we.Sunset,l=r==we.Sunrise?a:s;return{mode:r,hours:l.hours,minutes:l.minutes}}{let e=this.mode==we.Sunrise?Ee(t):Ee(i);return e=Ce(e,{hours:this.hours,minutes:this.minutes}),{mode:we.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Pe(this.hours).am_pm;t=Ie(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.target.value;if(Pe(this.hours).am_pm==t)return;const i=Pe(this.hours).hours;this.hours=Ie(i,"AM"==t?Ne.AM:Ne.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=Ce(t,e),this.mode!=we.Fixed&&(t=Ns(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};qa(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==we.Fixed?Pe(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==we.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};Ps.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([de({attribute:!1})],Ps.prototype,"hass",void 0),t([ce()],Ps.prototype,"hours",void 0),t([ce()],Ps.prototype,"minutes",void 0),t([ce()],Ps.prototype,"mode",void 0),t([de({type:Boolean})],Ps.prototype,"autoValidate",void 0),t([de({type:Boolean})],Ps.prototype,"required",void 0),t([de({type:Boolean})],Ps.prototype,"disabled",void 0),t([de({type:String})],Ps.prototype,"label",void 0),t([de({type:Boolean})],Ps.prototype,"useAmPm",void 0),t([de({type:Boolean})],Ps.prototype,"large",void 0),t([de({attribute:!1})],Ps.prototype,"stepSize",void 0),Ps=t([re("scheduler-time-picker")],Ps);let Is=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![ge.Daily,ge.Weekend,ge.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
    ...
    `:q``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[ge.Sunday,ge.Monday,ge.Tuesday,ge.Wednesday,ge.Thursday,ge.Friday,ge.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,Aa(this.hass))}else e=[ge.Daily,ge.Workday,ge.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.every(e=>![ge.Daily,ge.Weekend,ge.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>q`
        <mwc-list-item
          graphic="icon"
    ...
    `}};t([de({attribute:!1})],Is.prototype,"hass",void 0),t([ce()],Is.prototype,"_params",void 0),t([ce()],Is.prototype,"weekdayTypeCustomSelected",void 0),Is=t([re("dialog-select-weekdays")],Is);var qs=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return Is}});const Rs=(e,t)=>((e,t)=>e<t?-1:e>t?1:0)(e.toLowerCase(),t.toLowerCase()),Hs=(e,t,i)=>{const a=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(a=>{if(!Object.keys(da).includes(t))return!1;let s=Object.keys(da[t]).includes(a);return!s&&Object.keys(da[t]).includes("{entity_id}")&&(s=((i.include||[]).some(e=>ia(e,`${t}.${a}`))||Object.keys(i.customize||{}).some(e=>ia(e,`${t}.${a}`)))&&!(i.exclude||[]).some(e=>ia(e,`${t}.${a}`)),s&&(s=Object.keys(e.states).includes(`${t}.${a}`))),s}):[],s=t=>na(`component.${t}.title`,e,!1)||t.replace(/_/g," "),o=i=>na(`component.${t}.services.${i}.name`,e,!1)||!!e.services[t]&&!!e.services[t][i]&&e.services[t][i].name||i.replace(/_/g," "),n=i=>{let a=na(`component.${t}.services.${i}.description`,e,!1);return a||(a=e.services[t][i].description),a||"script"!=t||(a=na(`component.${t}.services.turn_on.description`,e,!1)),a};let r=a.map(i=>Object({key:i,name:`${s(t)}: ${o(i)}`,description:n(i),icon:Object.keys(va).includes(t)&&Object.keys(va[t].services).includes(i)?va[t].services[i]:Ka(t),action:{service:i.includes(".")?i:`${t}.${i}`,service_data:{},target:e.services[t][i].target?{}:void 0}})),l=(d=i.customize||{},c=t,Object.keys(d).filter(e=>{var t;return null===(t=d[e].exclude_actions)||void 0===t?void 0:t.length}).filter(e=>!c||!c.includes(".")&&ia(ea(e),c)||ia(e,c)).map(e=>d[e].exclude_actions).flat().filter(Ue));var d,c;return l.length&&(r=r.filter(t=>!l.some(a=>Rs(Xi(t.action.service),a)>0||Rs(Oa(t.action,e,i.customize),a)>0))),ha(i.customize||{},t).forEach(e=>{let i=e.service;for(;r.find(e=>e.key==i);)i+="_2";e.variables&&Object.entries(e.variables).forEach(([t,i])=>{let a=ka(i),s=Ss(a);!Ue(e.service_data[t])&&Ue(s)&&(e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:s})}))}),r.push({key:i,name:`${s(t)}: ${Vs(e.name||o(Xi(e.service)))}`,description:Vs(e.name||""),icon:e.icon||Ka(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},target:e.target?e.target:void 0,name:e.name,icon:e.icon}})}),r},Vs=e=>{if(null!==/<.+?>/g.exec(e)){e=(new DOMParser).parseFromString(e,"text/html").body.textContent||""}let t;for(;t=/\[([^\]]+)\]/.exec(e);)e=e.replace(t[0],"");for(;t=/\{([^\}]+)\}/.exec(e);)e=e.replace(t[0],"");return e};let Fs=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.lockDomain=!1}async showDialog(e){this._params=e,e.domainFilter&&(this.lockDomain=!0),await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title"),this.hass.loadBackendTranslation("services")}render(){return this._params?q`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
    ...
    `}};t([de({attribute:!1})],Fs.prototype,"hass",void 0),t([ce()],Fs.prototype,"_params",void 0),t([ce()],Fs.prototype,"_search",void 0),t([ce()],Fs.prototype,"_filter",void 0),t([ce()],Fs.prototype,"_width",void 0),t([ce()],Fs.prototype,"_height",void 0),t([ce()],Fs.prototype,"lockDomain",void 0),Fs=t([re("dialog-select-action")],Fs);var Bs=Object.freeze({__proto__:null,get DialogSelectAction(){return Fs}});let Us=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return q`
      ${this.showPrefix?q`
    ...
    `}};t([de({type:Boolean})],Us.prototype,"showPrefix",void 0),Us=t([re("scheduler-settings-row")],Us);let Ws=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this.large=!1,this.selectedEntry=0}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return q`
    ...
    `}toggleViewMode(){const e=this.viewMode==_e.Scheme?_e.Single:_e.Scheme;this.dispatchEvent(new CustomEvent("setViewMode",{detail:e}))}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return q``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=Te(e,this.hass),a=(Te(t,this.hass)||86400)-i;return q`
      <div class="actions">
        <ha-icon-button .path=${Va} @click=${e=>{this._updateSelectedSlot(this.selectedSlot-1),e.target.blur()}} ?disabled=${null===this.selectedSlot||this.selectedSlot<1}>
        </ha-icon-button> 
        ...
        <ha-icon-button .path=${Wa} @click=${this._removeTimeslot} ?disabled=${this.schedule.entries[this.selectedEntry].slots.length<=2}>
        </ha-icon-button> 
      </div>
    ...
    `;const n=ma(o,this.config.customize),r=(null===(e=n.target)||void 0===e?void 0:e.domain)||ea(o.service),l=Ue(null===(t=null==n?void 0:n.target)||void 0===t?void 0:t.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&Ue(null===(i=null===(t=ma(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return q``;const d=Object.keys(n.fields||{}).filter(e=>bs(o,e,this.hass,this.config.customize));let c="",u=[(null===(i=o.target)||void 0===i?void 0:i.entity_id)||[]].flat();return!u.length&&["notify","script"].includes(r)&&(u=[o.service]),u.length&&(c+=u.map(e=>Ma(e,this.hass,this.config.customize)).join(", "),c+=": "),c+=Oa(o,this.hass,this.config.customize,!1,!0),q`
      <scheduler-collapsible-section
        ?expanded=${!0}
        ?disabled=${!0}
      >
        <div slot="header" class="header">
          <ha-icon slot="icon" icon="${Cs(o,this.config.customize)}"></ha-icon>
          <span>${oa(c)}</span>
        </div>
        <ha-icon-button slot="contextMenu" .path=${Wa} @click=${this._removeAction}></ha-icon-button>
        <div slot="content">
          ...
          ${d.map(e=>{var t;const i=ya(o.service,null===(t=o.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let a=n.fields[e].optional||(i.number||{}).optional;const s=!a||Object.keys(o.service_data).includes(e);return q`
  ...
  mwc-checkbox {
    ...
    `}};t([de({attribute:!1})],Ws.prototype,"hass",void 0),t([de({attribute:!1})],Ws.prototype,"config",void 0),t([de({attribute:!1})],Ws.prototype,"viewMode",void 0),t([de({attribute:!1})],Ws.prototype,"selectedSlot",void 0),t([de({type:Boolean})],Ws.prototype,"large",void 0),t([ce()],Ws.prototype,"schedule",void 0),t([ce()],Ws.prototype,"selectedEntry",void 0),Ws=t([re("scheduler-main-panel")],Ws);const Zs=["January","February","March","April","May","June","July","August","September","October","November","December"];function Ks(e){return e.toISOString().split("T")[0]}function Gs(e){let t=new Date;const i=(e||"").match(/^([0-9]{4})-([0-9]{2})-([0-9]{2})/);null!==i&&t.setFullYear(Number(i[1]),Number(i[2])-1,Number(i[3]));const a=(e||"").match(/([0-9]{2}):([0-9]{2})(:([0-9]{2}))?$/);return null!==a&&t.setHours(Number(a[1]),Number(a[2]),a.length>4?Number(a[4]):t.getSeconds()),t}const Js=(e,t)=>"select"in t&&null!==t.select?((e,t)=>{var i;return((null===(i=t.select)||void 0===i?void 0:i.options)||[]).some(t=>"object"==typeof t?t.value==e:t==e)})(String(e),t):"number"in t&&null!==t.number?((e,t)=>{var i,a;return!isNaN(e)&&(!(void 0!==(null===(i=t.number)||void 0===i?void 0:i.min)&&e<t.number.min)&&!(void 0!==(null===(a=t.number)||void 0===a?void 0:a.max)&&e>t.number.max))})(Number(e),t):!("text"in t)||null===t.text||String(e).length>0,Ys=e=>null==e||Array.isArray(e)?e:[e];let Qs=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0}async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title")}render(){return this._params?q`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
    ...
    `}};t([de({attribute:!1})],Qs.prototype,"hass",void 0),t([ce()],Qs.prototype,"_params",void 0),t([ce()],Qs.prototype,"_search",void 0),t([ce()],Qs.prototype,"_filter",void 0),t([ce()],Qs.prototype,"_width",void 0),t([ce()],Qs.prototype,"_height",void 0),Qs=t([re("dialog-select-condition")],Qs);var Xs=Object.freeze({__proto__:null,get DialogSelectCondition(){return Qs}});let eo=class extends oe{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[]}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||Ks(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||Ks(new Date);const i=(await Ra(this.hass)).map(e=>e.name),a=[...this.config.tags].flat();this.tags=[...i,...a.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return q`
      ...
      <scheduler-collapsible-section idx="${t}">
        ...
        <scheduler-settings-row>
          ...
          <scheduler-entity-picker
            ...
            .domain=${a}
            @value-changed=${this._selectEntity}
            .value=${this.conditionIdx==t?Ys(this.selectedEntity):Ys(e.entity_id)}
            ?multiple=${!1}
          >
          </scheduler-entity-picker>
        </scheduler-settings-row>
    ...
    `}};t([de({attribute:!1})],eo.prototype,"hass",void 0),t([de({attribute:!1})],eo.prototype,"config",void 0),t([ce()],eo.prototype,"schedule",void 0),t([ce()],eo.prototype,"conditionIdx",void 0),t([ce()],eo.prototype,"selectedDomain",void 0),t([ce()],eo.prototype,"selectedEntity",void 0),t([ce()],eo.prototype,"selectedMatchType",void 0),t([ce()],eo.prototype,"conditionValue",void 0),t([ce()],eo.prototype,"conditionValid",void 0),t([ce()],eo.prototype,"startDate",void 0),t([ce()],eo.prototype,"endDate",void 0),t([de()],eo.prototype,"tags",void 0),eo=t([re("scheduler-options-panel")],eo);let to=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          <ha-icon-button
            slot="navigationIcon"
    ...
    `:q``}_updateSchedule(e){let t=Object.keys(e.detail);if(t.includes("schedule")){let t=e.detail.schedule;this.schedule=t}t.includes("selectedSlot")&&(this.selectedSlot=e.detail.selectedSlot)}async _handleSaveClick(e){const t=ws(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const a={cancel:()=>i(!1),confirm:()=>i(!0),title:na("state_badge.default.error",this.hass),description:Qi("ui.panel.editor.validation_errors."+t,this.hass),primaryButtonLabel:na("ui.common.ok",this.hass)};qa(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return io})),dialogParams:a})});else if(this.schedule.schedule_id){const t=Re(await Ia(this.hass,this.schedule.schedule_id),this.hass);if(pe(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Qi("ui.dialog.enable_schedule.title",this.hass),description:Qi("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:na("ui.common.yes",this.hass),secondaryButtonLabel:na("ui.common.no",this.hass),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};qa(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return io})),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=xs(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>zs(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=xs(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>zs(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Qi("ui.dialog.confirm_delete.title",this.hass),description:Qi("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:na("ui.common.ok",this.hass),secondaryButtonLabel:na("ui.common.cancel",this.hass)};qa(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return io})),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>zs(e,this,this.hass)).then(()=>{this.closeDialog()})})}_setViewMode(e){let t=e.detail;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1;if(t!=_e.Scheme){if(t==_e.Single&&!i){let e=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>{let t=e.slots.findIndex(e=>e.actions.length);return t<0&&(t=Math.floor(e.slots.length/2)),Object(Object.assign(Object.assign({},e),{slots:e.slots.map((e,i)=>i==t?Object.assign(Object.assign({},e),{stop:void 0}):null).filter(Ue)}))})});return this.schedule=Re(e,this.hass),void(this.viewMode=t)}new Promise(t=>{const i={title:Qi("ui.dialog.confirm_migrate.title",this.hass),description:Qi("ui.dialog.confirm_migrate.description",this.hass),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};qa(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return io})),dialogParams:i})}).then(e=>{e&&(this.schedule=(e=>{const t=e=>{let t=e.findIndex(e=>e.actions.length);t<0&&(t=Math.floor(e.length/2));let i=Object.assign(Object.assign({},e[t]),{stop:void 0});const a=i.conditions,s=i.start;return e=[{start:"00:00:00",stop:s,actions:[],conditions:a},i,{start:qe(Ce(Ee(s),{minutes:1})),stop:"00:00:00",actions:[],conditions:a}]};return e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object(Object.assign(Object.assign({},e),{slots:t(e.slots)})))})})(this.schedule),this.viewMode=t)})}else this.viewMode=t}};ao.styles=fs,t([de({attribute:!1})],ao.prototype,"hass",void 0),t([ce()],ao.prototype,"_params",void 0),t([de({type:Boolean,reflect:!0})],ao.prototype,"large",void 0),t([ce()],ao.prototype,"schedule",void 0),t([ce()],ao.prototype,"selectedEntry",void 0),t([ce()],ao.prototype,"selectedSlot",void 0),t([ce()],ao.prototype,"_panel",void 0),t([ce()],ao.prototype,"_viewMode",void 0),ao=t([re("dialog-scheduler-editor")],ao);var so=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return ao}});
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */class oo extends Xa{constructor(e){if(super(e),this.et=H,e.type!==Ya)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===H||null==e)return this.ft=void 0,this.et=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}oo.directiveName="unsafeHTML",oo.resultType=1;const no=Qa(oo);var ro=window&&window.__assign||function(){return(ro=Object.assign||function(e){for(var t,i=1,a=arguments.length;i<a;i++)for(var s in t=arguments[i])Object.prototype.hasOwnProperty.call(t,s)&&(e[s]=t[s]);return e}).apply(this,arguments)};var lo={second:45,minute:45,hour:22,day:5};const co=(e,t,i)=>{if(i===De.am_pm||!i&&t.time_format===De.am_pm){const t=Pe(e.getHours()).am_pm;return`${Pe(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===De.twenty_four||!i&&t.time_format===De.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:Le(t)}):Le(t)?co(e,t,De.am_pm):co(e,t,De.twenty_four)};let uo=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const a=i>=0?"past":"future";i=Math.abs(i);const s=Math.round(i);if("future"==a&&s>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),a=Math.floor((e.valueOf()-i.valueOf())/864e5);let s="";a>14?s=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},a=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return Zs[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${a(e,"month")} ${a(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${a(e,"month")} ${a(e,"day")}, ${a(e,"year")}`}(e,this._hass.locale):a>7?s=Qi("ui.components.date.next_week_day",this._hass,"{weekday}",Ca(e,"long",this._hass)):1==a?s=Qi("ui.components.date.tomorrow",this._hass):a>0&&(s=Ca(e,"long",this._hass));let o=Qi("ui.components.time.absolute",this._hass,"{time}",co(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Qi("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Qi("ui.components.time.at_midnight",this._hass)),String(s+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=na("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=na("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var a=ro(ro({},lo),i||{}),s=(+e-+t)/1e3;if(Math.abs(s)<a.second)return{value:Math.round(s),unit:"second"};var o=s/60;if(Math.abs(o)<a.minute)return{value:Math.round(o),unit:"minute"};var n=s/3600;if(Math.abs(n)<a.hour)return{value:Math.round(n),unit:"hour"};var r=s/86400;if(Math.abs(r)<a.day)return{value:Math.round(r),unit:"day"};var l=new Date(e),d=new Date(t),c=l.getFullYear()-d.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+l.getMonth()-d.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var h=s/604800;return{value:Math.round(h),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return q``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),q`
      ${oa(this.relativeTime(this.datetime))}
    `}};t([de()],uo.prototype,"_hass",void 0),t([de()],uo.prototype,"datetime",void 0),uo=t([re("scheduler-relative-time")],uo);let ho=class extends oe{render(){var e;try{const t=this.hass.states[this.schedule.entity_id];if(!t)return q``;const i="off"==t.state,a=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let s=Cs(a,this.config.customize);if("entity"==this.config.display_options.icon){let t=[(null===(e=a.target)||void 0===e?void 0:e.entity_id)||[]].flat().shift();["script","notify"].includes(ea(a.service))&&(t=a.service),t&&(s=ns(t,this.config.customize,this.hass))}return q`
      <ha-icon
        icon="${s}"
    ...
    `}catch(e){return q`
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return q`
        ...
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){let t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return q`
          ...
          </div>`}return no(e)};return Da(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>q`${t(e)}<br/>`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
    ...
    `}async loadSchedules(){Se(this.hass).then(e=>{this.schedules=Pa(e,this._config,this.hass)}).catch(e=>{this.schedules=[],this.connectionError=!0})}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let a=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(a+=1);const s=(([this._config.display_options.secondary_info||[]].flat().length||2)+1)/2;this.schedules&&(a+=this.showDiscovered?Object.keys(this.schedules).length*s:Object.values(this.schedules).filter(e=>aa(e,this._config)).length*s),clearInterval(i),e(Math.round(a))},50)})}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?Ia(this.hass,e.schedule_id).then(t=>{const i=this.schedules.findIndex(t=>t.schedule_id==e.schedule_id),a=i>=0?this.schedules[i]:null;let s=[...this.schedules||[]];t&&(this._config.discover_existing||aa(t,this._config))?a?a.timestamps[a.next_entries[0]||0]==t.timestamps[t.next_entries[0]||0]?s=Object.assign(s,{[i]:t}):(s=Object.assign(s,{[i]:t}),s=Pa(s,this._config,this.hass)):s=Pa([...s,t],this._config,this.hass):a&&(s=s.filter(t=>t.schedule_id!==e.schedule_id)),this.schedules=[...s]}):this.schedules=(this.schedules||[]).filter(t=>t.schedule_id!==e.schedule_id)}_handleEditClick(e,t){if(!this.schedules)return;const i={schedule:Re(t,this.hass),cardConfig:this._config,editItem:t.schedule_id};qa(e.target,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return so})),dialogParams:i})}_addClick(e){const t=[this._config.tags||[]].flat().filter(e=>!["none","disabled","enabled"].includes(e));let i=this._config.default_editor==_e.Scheme?JSON.parse(JSON.stringify(Fe)):JSON.parse(JSON.stringify(Be));const a={schedule:Object.assign(Object.assign({},i),{tags:1==t.length?t:[]}),cardConfig:this._config};qa(this,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return so})),dialogParams:a})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked;Object.values(this.schedules).filter(e=>this.showDiscovered||aa(e,this._config)).forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}static getConfigElement(){return document.createElement("scheduler-card-editor")}},e.SchedulerCard.styles=r`
    .card-header {
      display: flex;
      justify-content: space-between;
    }
