        ...
        <div slot="content">
          ...
          ${l.map(e=>{var t;const i=us(o.service,null===(t=o.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let s=n.fields[e].optional||(i.number||{}).optional;const a=!s||Object.keys(o.service_data).includes(e);return q`
            <scheduler-settings-row ?showPrefix=${s}>
              ...
              `:""}
              <span slot="heading">
                ${((e,t,i,s)=>{var a,o;const n=Wi(e.service),r=Bi(e.service);let d=Xi(`component.${n}.services.${r}.fields.${t}.name`,i,!1);!d&&i.services[n]&&i.services[n][e.service]&&i.services[n][e.service].fields&&i.services[n][e.service].fields[t]&&(d=String(i.services[n][e.service].fields[t].name));const l=["script","notify"].includes(n)?[e.service]:[(null===(a=e.target)||void 0===a?void 0:a.entity_id)||[]].flat(),c=l.length?l[0]:(null===(o=e.target)||void 0===o?void 0:o.domain)||n;let u=os(s||{},c);if(u.length){let i=u.map(i=>{if(i.service!=e.service||!Object.keys(i.variables||{}).includes(t))return null;return(i.variables||{})[t].name}).filter(Be);if(i.length)return i[0]}return d||(d=t.replace(/_/g," ")),d})(o,e,this.hass,this.config.customize)}
              </span>
              <scheduler-combo-selector
                .hass=${this.hass}
                .config=${i}
