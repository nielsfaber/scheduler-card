      ...
      <div class="tooltip-container center">
        <div class="tooltip ${this.activeMarker==e?"active":""}" @click=${this._selectMarker}>
          ${t?N`
                ...
                ${t.sign} ${ea(ta(t.offset),ct(this.hass),Xs.twenty_four)}
