...
const Da=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}{constructor(e){var t;if(super(e),e.type!==Ta||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`},"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ht){this.ht=new Set;for(const e in t)this.ht.add(e);return this.render(t)}this.ht.forEach(e=>{null==t[e]&&(this.ht.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")});for(const e in t){const a=t[e];if(null!=a){this.ht.add(e);const t="string"==typeof a&&a.endsWith(" !important");e.includes("-")||t?i.setProperty(e,t?a.slice(0,-11):a,t?"important":""):i[e]=a}}return R}}),Ma={alarm_control_panel:{disarmed:"mdi:lock-open-variant-outline",armed_away:"mdi:exit-run",armed_home:"mdi:home-outline",armed_night:"mdi:power-sleep",armed_custom_bypass:"mdi:security",armed_vacation:"mdi:shield-airplane",triggered:"mdi:alarm-light-outline"},binary_sensor:{battery:{on:"mdi:battery-outline",off:"mdi:battery"},battery_charging:{on:"mdi:battery-charging",off:"mdi:battery"},cold:{on:"mdi:snowflake",off:"mdi:thermometer"},connectivity:{on:"mdi:server-network",off:"mdi:server-network-off"},door:{on:"mdi:door-open",off:"mdi:door-closed"},garage_door:{on:"mdi:garage-open",off:"mdi:garage"},power:{on:"mdi:power-plug",off:"mdi:power-plug-off"},gas:{on:"mdi:alert-circle",off:"mdi:check-circle"},problem:{on:"mdi:alert-circle",off:"mdi:check-circle"},safety:{on:"mdi:alert-circle",off:"mdi:check-circle"},tamper:{on:"mdi:alert-circle",off:"mdi:check-circle"},smoke:{on:"mdi:smoke",off:"mdi:check-circle"},heat:{on:"mdi:fire",off:"mdi:thermometer"},light:{on:"mdi:brightness-7",off:"mdi:brightness-5"},lock:{on:"mdi:lock-open",off:"mdi:lock"},moisture:{on:"mdi:water",off:"mdi:water-off"},motion:{on:"mdi:run",off:"mdi:walk"},occupancy:{on:"mdi:home",off:"mdi:home-outline"},opening:{on:"mdi:square-outline",off:"mdi:square"},plug:{on:"mdi:power-plug",off:"mdi:power-plug-off"},presence:{on:"mdi:home",off:"mdi:home-outline"},running:{on:"mdi:play",off:"mdi:stop"},sound:{on:"mdi:music-note",off:"mdi:music-note-off"},update:{on:"mdi:package-up",off:"mdi:package"},vibration:{on:"mdi:vibrate",off:"mdi:crop-portrait"},window:{on:"mdi:window-open",off:"mdi:window-closed"},_:{on:"mdi:checkbox-marked-circle",off:"mdi:radiobox-blank"}},calendar:{on:"mdi:flash",off:"mdi:flash-off"},cover:{garage:{closed:"mdi:garage",open:"mdi:garage-open"},door:{closed:"mdi:door-closed",open:"mdi:door-open"},blind:{closed:"mdi:blinds",open:"mdi:blinds-open"},window:{closed:"mdi:window-closed",open:"mdi:window-open"},_:{closed:"mdi:window-shutter",open:"mdi:window-shutter-open"}},climate:{off:"mdi:power-off",heat:"mdi:fire",cool:"mdi:snowflake",heat_cool:"mdi:thermometer",auto:"mdi:autorenew",dry:"mdi:water-percent",fan_only:"mdi:fan"},device_tracker:{home:"mdi:home-outline",not_home:"mdi:exit-run"},fan:{on:"mdi:power",off:"mdi:power-off"},humidifier:{on:"mdi:power",off:"mdi:power-off"},input_boolean:{on:"mdi:flash",off:"mdi:flash-off"},light:{on:"mdi:lightbulb",off:"mdi:lightbulb-off"},lock:{unlocked:"mdi:lock-open-variant-outline",locked:"mdi:lock-outline"},person:{home:"mdi:home-outline",not_home:"mdi:exit-run"},sun:{below_horizon:"mdi:weather-sunny-off",above_horizon:"mdi:weather-sunny"},switch:{on:"mdi:flash",off:"mdi:flash-off"},timer:{active:"mdi:play",paused:"mdi:pause",idle:"mdi:sleep"},water_heater:{off:"mdi:power-off",eco:"mdi:leaf",electric:"mdi:lightning-bolt",gas:"mdi:fire",heat_pump:"mdi:hvac",high_demand:"mdi:water-plus-outline",performance:"mdi:rocket-launch-outline"}},La=(e,t,i)=>{const a=Ki(e);if(!Object.keys(Ma).includes(a))return;let s=Ma[a];if("object"==typeof Object.values(s)[0]){const t=i.states[e],a=null==t?void 0:t.attributes.device_class;s=a&&Object.keys(s).includes(a)?s[a]:s._}return Object.keys(s).includes(t)?s[t]:void 0},Pa=["alarm_control_panel","binary_sensor","climate","calendar","cover","device_tracker","fan","humidifier","input_boolean","input_number","input_select","light","lock","number","person","proximity","select","sensor","sun","switch","timer","water_heater"],Ia=(e,t)=>{const i=Object.keys(t.states).includes(e)?t.states[e]:void 0,a=Ki(e),s=(null==i?void 0:i.attributes)||{},o=i=>null==i?void 0:i.map(i=>Object({value:i,icon:La(e,i,t)}));switch(a){case"alarm_control_panel":let e=["disarmed","triggered"];return 2&(s.supported_features||0)&&(e=[...e,"armed_away"]),1&(s.supported_features||0)&&(e=[...e,"armed_home"]),4&(s.supported_features||0)&&(e=[...e,"armed_night"]),16&(s.supported_features||0)&&(e=[...e,"armed_custom_bypass"]),32&(s.supported_features||0)&&(e=[...e,"armed_vacation"]),la({options:o(e),translation_key:"component.alarm_control_panel.entity_component._.state.${value}"});case"binary_sensor":return la({options:o(["on","off"]),translation_key:"component.binary_sensor.entity_component.${deviceClass}.state.${value}"});case"climate":return la({options:o(s.hvac_modes),translation_key:"component.climate.entity_component._.state.${value}"});case"calendar":case"fan":case"humidifier":case"input_boolean":case"light":case"switch":return la({options:o(["on","off"]),translation_key:"component.switch.entity_component._.state.${value}"});case"cover":return la({options:o(["open","closed"]),translation_key:"component.cover.entity_component._.state.${value}"});case"device_tracker":return la({options:o(["home","not_home"]),translation_key:"component.device_tracker.entity_component._.state.${value}"});case"input_number":case"number":return da({min:s.min,max:s.max,step:s.step,mode:s.mode,unit_of_measurement:s.unit_of_measurement});case"input_select":case"select":return la({options:s.options});case"lock":return la({options:o(["locked","unlocked"]),translation_key:"component.lock.entity_component._.state.${value}"});case"person":const a=Object.keys(t.states).filter(e=>"zone"==Ki(e)).map(Zi);return la({options:[...new Set(["home","not_home",...a])]});case"proximity":return da({mode:"box",unit_of_measurement:s.unit_of_measurement});case"sensor":return isNaN(Number(null==i?void 0:i.state))?{text:{}}:da({mode:"box",unit_of_measurement:s.unit_of_measurement});case"sun":return la({options:o(["above_horizon","below_horizon"]),translation_key:"component.sun.entity_component._.state.${value}"});case"timer":return la({options:o(["active","paused","idle"]),translation_key:"component.timer.entity_component._.state.${value}"});case"water_heater":case"climate":return la({options:o(s.operation_list),translation_key:"component.climate.entity_component._.state.${value}"});default:return{text:{}}}},Na=e=>Pa.includes(e),qa=(e,t)=>{let i=Object.keys(e.states).map(e=>Ki(e)).reduce((e,t)=>e.includes(t)?e:[...e,t],[]).filter(Na);return i=i.filter(e=>((t.include||[]).some(t=>Ji(Ki(t),e))||Object.keys(t.customize||{}).some(t=>Ji(Ki(t),e)))&&!(t.exclude||[]).some(t=>Ji(t,e))),i.map(t=>Object({key:t,name:ea(`component.${t}.title`,e,!1)||t.replace(/_/g," "),description:"",icon:za(t)}))},Ra=(e,t)=>{if(!Object.keys(t.states).includes(e))return"mdi:help";const i=t.states[e];if(i.attributes.icon)return i.attributes.icon;const a=Ki(e);return za(a)},Ha=(e,t)=>{if(["script","notify"].includes(e)){let i=Object.keys(t.services[e]).map(i=>{var a;return Object({key:`${e}.${i}`,name:t.states[`${e}.${i}`]?Gi(`${e}.${i}`,null===(a=t.states[`${e}.${i}`])||void 0===a?void 0:a.attributes):t.services[e][i].name,description:"",icon:t.states[`${e}.${i}`]?Ra(`${e}.${i}`,t):za(e)})});return i.sort((e,t)=>Qi(e.name,t.name)),i}{let i=Object.keys(t.states).filter(t=>Ki(t)==e).map(e=>{var i;return Object({key:e,name:Gi(e,null===(i=t.states[e])||void 0===i?void 0:i.attributes),description:"",icon:Ra(e,t)})});return i.sort((e,t)=>Qi(e.name,t.name)),i}},Va=(e,t)=>t.every(t=>e.name.toLowerCase().includes(t))||t.every(t=>e.key.toLowerCase().includes(t));let Fa=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.expandedGroups=[]}async showDialog(e){this._params=e,this.loadOptions(),await this.updateComplete}async closeDialog(){this._params&&this._params.confirm({domains:this._params.domains,entities:this._params.entities}),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}loadOptions(){let e=(e=>{let t=Ea(e,{include:["*"]}),i=qa(e,{include:["*"]});return i=i.filter(e=>!t.map(e=>e.key).includes(e.key)),t=[...t,...i],t.sort((e,t)=>Qi(e.name,t.name)),t})(this.hass);this.options=e.map(e=>Object(Object.assign(Object.assign({},e),{entities:Ha(e.key,this.hass)})))}shouldUpdate(e){return!!(e.has("_params")||e.has("expandedGroups")||e.has("_filter"))}render(){return this._params?q`
        ...
        <div slot="heading">
          <ha-dialog-header>
            <ha-icon-button
              slot="navigationIcon"
              dialogAction="cancel"
              .label=${ea("ui.dialogs.more_info_control.dismiss",this.hass)}
              .path=${ja}
            ></ha-icon-button>
            <span slot="title">
              ${Wi("ui.dialog.entity_picker.title",this.hass)}
            </span>
          </ha-dialog-header>

          <ha-textfield
            dialogInitialFocus
            .placeholder=${ea("ui.common.search",this.hass)}
            aria-label=${ea("ui.common.search",this.hass)}
            ...
            <div class="trailing" slot="trailingIcon">
              ${this._search&&q`
                <ha-icon-button
                  ...
                  .label=${ea("ui.common.clear",this.hass)}
                  .path=${ja}
                  class="clear-button"
                ></ha-icon-button>
              `}
    ...
    `:q``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("mwc-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_toggleSelectEntity(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;t.querySelector("ha-checkbox");const i=t.getAttribute("key");this._params.entities.includes(i)?this._params=Object.assign(Object.assign({},this._params),{entities:this._params.entities.filter(e=>e!=i)}):this._params=Object.assign(Object.assign({},this._params),{entities:[...this._params.entities,i]})}_toggleSelectDomain(e){var t;let i=e.target;for(;"MWC-LIST-ITEM"!=i.tagName;)i=i.parentElement;const a=i.getAttribute("key"),s=null===(t=this.options)||void 0===t?void 0:t.find(e=>e.key==a).entities.map(e=>e.key);this._params.domains.includes(a)?this._params=Object.assign(Object.assign({},this._params),{domains:this._params.domains.filter(e=>e!=a),entities:this._params.entities.filter(e=>!(null==s?void 0:s.includes(e)))}):this._params=Object.assign(Object.assign({},this._params),{domains:[...this._params.domains,a]}),e.stopPropagation()}closeGroupByKey(e){this.shadowRoot.querySelector("mwc-list").childNodes.forEach(t=>{if(t.nodeType==Node.ELEMENT_NODE&&"MWC-LIST-ITEM"==t.tagName&&t.getAttribute("key")==e){const e=t,i=e.nextElementSibling,a=e.querySelector("ha-icon-button");i.style.height="0px",e.removeAttribute("expanded"),a.classList.remove("expanded")}})}async _toggleExpandGroup(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;const i=t.querySelector("ha-icon-button"),a=t.getAttribute("key");this.expandedGroups.includes(a)||(this.expandedGroups.forEach(e=>this.closeGroupByKey(e)),this.expandedGroups=[a],await this.requestUpdate());const s=t.nextElementSibling,o=s.scrollHeight;t.hasAttribute("expanded")?(t.removeAttribute("expanded"),i.classList.remove("expanded"),s.style.height="0px",setTimeout(()=>{this.expandedGroups=this.expandedGroups.filter(e=>e!=a)},300)):(t.setAttribute("expanded","true"),i.classList.add("expanded"),s.style.height=o+"px")}_renderOptions(){if(!this.options)return;let e=[...this.options];const t=this._filter&&this._filter.trim().length;if(t){const t=this._filter.toLowerCase().trim().split(" ");e=e.map(e=>Va(e,t)||(e=Object.assign(Object.assign({},e),{entities:(e.entities||[]).filter(e=>Va(e,t))})).entities.length?e:void 0).filter(e=>void 0!==e)}return e.length?Object.keys(e).map(i=>{var a,s;const o=e[i].key,n=Ha(o,this.hass),r=(null===(a=this._params)||void 0===a?void 0:a.domains.includes(o))?n.length:e[i].entities.filter(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)}).length;return q`
        ...
        >
          ...
          <div slot="meta" class="meta">
            <ha-button
              ...
              size="small"
            >
              ${(null===(s=this._params)||void 0===s?void 0:s.domains.includes(o))||e[i].entities.every(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)})?ea("ui.components.media-browser.file_management.deselect_all",this.hass):ea("ui.components.subpage-data-table.select_all",this.hass)}
            </ha-button>
            <ha-icon-button .path="${"M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z"}" @click=${e=>{e.target.blur()}} class="chevron"></ha-icon-button>
          </div>
          <span>${e[i].name}</span>
          <span slot="secondary">${Wi("ui.panel.card_editor.fields.entities.included_number",this.hass,["{number}","{total}"],[r,n.length])}</span>
        </mwc-list-item>
      ...
      `}):q`
        <mwc-list-item disabled>
          ${ea("ui.components.entity.entity-picker.no_match",this.hass)}
        </mwc-list-item>
    ...
    `}};t([de({attribute:!1})],Fa.prototype,"hass",void 0),t([ce()],Fa.prototype,"_params",void 0),t([ce()],Fa.prototype,"_search",void 0),t([ce()],Fa.prototype,"_filter",void 0),t([ce()],Fa.prototype,"_width",void 0),t([ce()],Fa.prototype,"_height",void 0),t([ce()],Fa.prototype,"expandedGroups",void 0),t([ce()],Fa.prototype,"options",void 0),Fa=t([re("dialog-select-entities")],Fa);var Ba=Object.freeze({__proto__:null,get DialogSelectEntities(){return Fa}});let Ua=class extends oe{constructor(){super(...arguments),this.active=!1}render(){return q`
      ...
      `:q`
        <div class="trailing-icon" @click=${this._iconClick}>
          ${this.disabled?q`
            ...
            ></ha-icon>
          `:q`
          <ha-tooltip content="${ea("ui.common.remove",this.hass)}">
            <ha-icon icon="mdi:close"
            ></ha-icon>
          </ha-tooltip>
          `}
    ...
    `}};t([de({attribute:!1})],Ua.prototype,"hass",void 0),t([de({type:String})],Ua.prototype,"icon",void 0),t([de({type:Boolean})],Ua.prototype,"useStateIcon",void 0),t([de({type:Boolean})],Ua.prototype,"selectable",void 0),t([de({type:Boolean})],Ua.prototype,"removable",void 0),t([de({type:Boolean})],Ua.prototype,"toggleable",void 0),t([de({type:Boolean})],Ua.prototype,"active",void 0),t([de({type:String})],Ua.prototype,"badge",void 0),t([de({type:String})],Ua.prototype,"value",void 0),t([de({type:Boolean})],Ua.prototype,"disabled",void 0),Ua=t([re("scheduler-chip")],Ua);let Wa=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?q`
    ...
    `}};t([de({attribute:!1})],Wa.prototype,"hass",void 0),t([de({attribute:!1})],Wa.prototype,"items",void 0),t([de({attribute:!1})],Wa.prototype,"value",void 0),t([de({type:Boolean})],Wa.prototype,"selectable",void 0),t([de({type:Boolean})],Wa.prototype,"toggleable",void 0),t([de({type:Boolean})],Wa.prototype,"removable",void 0),t([de({type:Boolean})],Wa.prototype,"disabled",void 0),Wa=t([re("scheduler-chip-set")],Wa);let Za=class extends oe{constructor(){super(...arguments),this.autofocus=!1,this.disabled=!1,this.hideClearIcon=!1,this._opened=!1,this._isOpening=!1,this._items=[],this._getItems=()=>{const e=(this.getItems?this.getItems():[]).sort((e,t)=>Qi(e.primary,t.primary));return e.length||e.push({id:"___no_matching_items_found___",primary:Wi("ui.dialog.entity_picker.no_results",this.hass),icon:"mdi:cancel"}),e}}shouldUpdate(e){return!!(e.has("value")||e.has("label")||e.has("disabled"))||!(!e.has("_opened")&&this._opened)}willUpdate(e){e.has("_opened")&&this._opened&&(this._items=this._getItems())}render(){const e=!!this.value&&!this.disabled&&!this.hideClearIcon;return q`
          ...
          >
            ${this.value?this.valueRenderer?this.valueRenderer(this.value):q`<span slot="headline">${this.value}</span>`:q`
              <span slot="headline" class="placeholder">
                ${this.placeholder||Wi("ui.dialog.entity_picker.choose",this.hass)}
              </span>
            `}
            ${e?q`
                <ha-icon-button
    ...
    `}get _value(){return this.value||""}_renderHelper(){return this.helper?q`<ha-input-helper-text .disabled=${this.disabled}
        ...
        >`:H}_valueChanged(e){var t;e.stopPropagation(),this._comboBox.setTextFieldValue("");const i=null===(t=e.detail.value)||void 0===t?void 0:t.trim();"___no_matching_items_found___"!==i&&(this._items.find(e=>e.id==i)||this.allowCustomValue)&&i!==this._value&&this._setValue(i)}_filterChanged(e){if(!this._opened)return;let t=this._items;const i=e.target,a=e.detail.value.trim().split(" ").map(String).filter(e=>e.length).map(e=>e.trim());a.length&&(t=t.filter(e=>a.every(t=>{var i;return e.primary.includes(t)||(null===(i=e.secondary)||void 0===i?void 0:i.includes(t))}))),i.filteredItems=t}_clear(e){e.stopPropagation(),this._setValue(void 0)}_setValue(e){this.value=e,wa(this,"value-changed",{value:e})}async focus(){var e;await this.updateComplete,await(null===(e=this._comboBox)||void 0===e?void 0:e.focus())}async open(){var e;this._opened=!0,this._isOpening=!0,await this.updateComplete,null===(e=this._comboBox)||void 0===e||e.focus(),this._comboBox.open(),this._comboBox.value=""}async _openedChanged(e){var t;const i=e.detail.value;e.stopPropagation(),this._isOpening?this._isOpening=!1:this._opened&&!i&&(this._opened=!1,await this.updateComplete,null===(t=this._field)||void 0===t||t.focus())}static get styles(){return[r`
        .container {
          position: relative;
          display: block;
        }
      ...
      `]}};t([de({attribute:!1})],Za.prototype,"hass",void 0),t([de({type:Boolean})],Za.prototype,"autofocus",void 0),t([de({type:Boolean})],Za.prototype,"disabled",void 0),t([de({type:Boolean,attribute:"allow-custom-value"})],Za.prototype,"allowCustomValue",void 0),t([de()],Za.prototype,"label",void 0),t([de()],Za.prototype,"value",void 0),t([de()],Za.prototype,"helper",void 0),t([de()],Za.prototype,"placeholder",void 0),t([de({type:String,attribute:"search-label"})],Za.prototype,"searchLabel",void 0),t([de({attribute:"hide-clear-icon",type:Boolean})],Za.prototype,"hideClearIcon",void 0),t([de({attribute:!1,type:Array})],Za.prototype,"getItems",void 0),t([de({attribute:!1,type:Array})],Za.prototype,"getAdditionalItems",void 0),t([de({attribute:!1})],Za.prototype,"rowRenderer",void 0),t([de({attribute:!1})],Za.prototype,"valueRenderer",void 0),t([de({attribute:"not-found-label",type:String})],Za.prototype,"notFoundLabel",void 0),t([he(".textInput")],Za.prototype,"_field",void 0),t([he("ha-combo-box")],Za.prototype,"_comboBox",void 0),t([ce()],Za.prototype,"_opened",void 0),Za=t([re("scheduler-picker")],Za);let Ka=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this._valueRenderer=e=>{const t=e||"",i=this.hass.states[t];if(!i)return q`
        <ha-svg-icon
          slot="start"
          .path=${Ca}
          style="margin: 0 4px"
      ...
      `;const a=Gi(t,i.attributes)||t,s=t;return q`
      <state-badge
        .hass=${this.hass}
        .stateObj=${i}
        slot="start"
    ...
    `},this._filteredItems=()=>{let e=Object.keys(this.hass.states);return this.domain&&(e=e.filter(e=>Ki(e)==this.domain)),this.multiple&&(e=e.filter(e=>{var t;return!(null===(t=this.value)||void 0===t?void 0:t.includes(e))})),this.config&&(e=e.filter(e=>((this.config.include||[]).some(t=>Ji(t,e))||Object.keys(this.config.customize||{}).some(t=>Ji(t,e)))&&!(this.config.exclude||[]).some(t=>Ji(t,e)))),e.map(e=>{var t;return Object({id:e,primary:Gi(e,null===(t=this.hass.states[e])||void 0===t?void 0:t.attributes),secondary:e,state:this.hass.states[e]})})}}render(){return q`
      ${this.renderChips()}
    ...
    `}renderChips(){if(!this.multiple)return H;let e=(this.value||[]).map(e=>{var t;return Object({name:Gi(e,null===(t=this.hass.states[e])||void 0===t?void 0:t.attributes),value:e,useStateIcon:!0})});return q`
      <scheduler-chip-set
        .hass=${this.hass}
        .items=${e}
        removable
        ...
        ?disabled=${this.disabled}
      >
      </scheduler-chip-set>`}_valueChanged(e){let t=e.detail.value;const i=e.currentTarget;t&&(this.value=[...this.value||[],t],this.multiple&&(i.value=""),wa(this,"value-changed",{value:this.value}),e.stopPropagation())}_removeClick(e){const t=e.detail;this.value=(this.value||[]).filter(e=>e!==t),wa(this,"value-changed",{value:this.value})}};Ka.styles=r`
    :host {
      display: flex;
  ...
  `,t([de({attribute:!1})],Ka.prototype,"hass",void 0),t([de()],Ka.prototype,"domain",void 0),t([de()],Ka.prototype,"config",void 0),t([de({type:Array})],Ka.prototype,"value",void 0),t([de({type:Boolean})],Ka.prototype,"multiple",void 0),t([de({type:Boolean})],Ka.prototype,"disabled",void 0),Ka=t([re("scheduler-entity-picker")],Ka);let Ga=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
      <div
    ...
    `}};t([de()],Ja.prototype,"disabled",void 0),t([ce()],Ja.prototype,"_openedItem",void 0),t([ce()],Ja.prototype,"_numItems",void 0),Ja=t([re("scheduler-collapsible-group")],Ja);let Ya=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),wa(this,"value-changed",{value:this.value})},a=()=>{let e=t.map(e=>Object({name:e,value:e}));return q`
      ...
      `}if(this.config.text){this.config.text;return q`
          <ha-textfield
            ...
            ?disabled=${this.disabled}
          ></ha-textfield>      
      `}return q``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t],e.target.value=""}else if(e.detail){let t=e.detail.value;if(void 0===t)return;this.value=t}else this.value=e.target.value;wa(this,"value-changed",{value:this.value})}};Ya.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
  ...
  `,t([de({attribute:!1})],Ya.prototype,"hass",void 0),t([de({attribute:!1})],Ya.prototype,"config",void 0),t([de()],Ya.prototype,"value",void 0),t([de()],Ya.prototype,"disabled",void 0),Ya=t([re("scheduler-combo-selector")],Ya);let Qa=class extends oe{constructor(){super(...arguments),this._config=qe,this.title="",this.tagOptions=[]}setConfig(e){this._config=Object.assign(Object.assign({},qe),e)}async firstUpdated(){this.title="string"==typeof this._config.title?this._config.title:"";const e=(await xa(this.hass)).map(e=>e.name);e.sort(Qi),this.tagOptions=e}render(){const e={select:{options:this.tagOptions,multiple:!0,custom_value:!0}};return q`
      <div class="card-config">

        <ha-button @click=${this._showIncludedEntitiesDialog} outlined>
          ${Wi("ui.panel.card_editor.fields.entities.button_label",this.hass)}
          <ha-svg-icon
            slot="trailingIcon"
        ...
        <scheduler-settings-row ?showPrefix=${!0}>
          ...
          <span slot="heading">${Wi("ui.panel.card_editor.fields.title.heading",this.hass)}</span>

          <ha-textfield
            .value=${this.title}
            @input=${this._setTitle}
            .placeholder=${Wi("ui.panel.common.title",this.hass)}
        ...
        <div class="column">
          <ha-formfield label="${Wi("ui.panel.card_editor.fields.discover_existing.heading",this.hass)}">
            <ha-switch
        ...
        <div class="column">
          <ha-formfield label="${Wi("ui.panel.card_editor.fields.show_header_toggle.heading",this.hass)}">
            <ha-switch
          ...
          <span slot="heading">${Wi("ui.panel.card_editor.fields.sort_by.heading",this.hass)}</span>

        <div class="two-columns">
        <div class="column">

          <ha-formfield label="${Wi("ui.panel.card_editor.fields.sort_by.options.relative_time",this.hass)}">
            <ha-radio
              name="sort_by"
              value="relative-time"
        ...
        <div class="column">
          ...
          <ha-formfield label="${Wi("ui.panel.card_editor.fields.sort_by.options.title",this.hass)}">
            <ha-radio
              name="sort_by"
              value="title"
              @change=${this._setSortBy}
          ...
          <span>${Wi("ui.panel.card_editor.fields.display_format_primary.heading",this.hass)}</span>


        <div class="two-columns">
        <div class="column">

          <ha-formfield label="${Wi("ui.panel.card_editor.fields.display_format_primary.options.default",this.hass)}">
            <ha-radio
        ...
        <div class="column">
          ...
          <ha-formfield label="${Wi("ui.panel.card_editor.fields.display_format_primary.options.entity_action",this.hass)}">
            <ha-radio
              name="display_format_primary"
              value="{entity}: {action}"
              @change=${this._setDisplayOptionsPrimary}
          ...
          <span>${Wi("ui.panel.card_editor.fields.display_format_secondary.heading",this.hass)}</span>

        <div class="two-columns">
        <div class="column">
          <ha-formfield label="${Wi("ui.panel.card_editor.fields.display_format_secondary.options.relative_time",this.hass)}">
            <ha-checkbox
              value="relative-time"
          ...
          <ha-formfield label="${Wi("ui.panel.card_editor.fields.display_format_secondary.options.time",this.hass)}">
            <ha-checkbox
              value="time"
              @change=${this._setDisplayOptionsSecondary}
        ...
        <div class="column">
          <ha-formfield label="${Wi("ui.panel.card_editor.fields.display_format_secondary.options.days",this.hass)}">
            <ha-checkbox
              value="days"
              @change=${this._setDisplayOptionsSecondary}
          ...
          <ha-formfield label="${Wi("ui.panel.card_editor.fields.display_format_secondary.options.additional_tasks",this.hass)}">
            <ha-checkbox
        ...
        <scheduler-settings-row>
          <span slot="heading">${Wi("ui.panel.card_editor.fields.tags.heading",this.hass)}</span>
    ...
    `}_setEnableTitle(e){e.target.checked?this.title.length?this._updateConfig({title:this.title}):this._updateConfig({title:!0}):this._updateConfig({title:!1})}_setTitle(e){const t=e.target.value;this.title=t,t!==Wi("ui.panel.common.title",this.hass)&&t.length?this._updateConfig({title:t}):this._updateConfig({title:!0})}_setSortBy(e){var t;const i=e.target.value;let a=[(null===(t=this._config)||void 0===t?void 0:t.sort_by)||qe.sort_by].flat();a=a.filter(e=>"state"==e),a.includes(i)||(a=[...a,i]),this._updateConfig({sort_by:a})}_setDisplayOptionsPrimary(e){var t;const i=e.target.value,a=Object.assign(Object.assign({},(null===(t=this._config)||void 0===t?void 0:t.display_options)||qe.display_options),{primary_info:i});this._updateConfig({display_options:a})}_setDisplayOptionsSecondary(e){var t;const i=e.target.value,a=e.target.checked;let s=Object.assign({},(null===(t=this._config)||void 0===t?void 0:t.display_options)||qe.display_options),o=[s.secondary_info||[]].flat();o=a?Array.from(new Set([...o,i])):o.filter(e=>e!==i),o.sort((e,t)=>{const i={"relative-time":1,time:o.includes("relative-time")?3:2,days:o.includes("relative-time")?2:3,"additional-tasks":4},a=Object.keys(i).includes(e)?i[e]:5,s=Object.keys(i).includes(t)?i[t]:5;return a>s?1:a<s?-1:0}),s=Object.assign(Object.assign({},s),{secondary_info:[...o]}),this._updateConfig({display_options:s})}async _showIncludedEntitiesDialog(e){let t=this._config.include.filter(e=>!e.includes(".")),i=this._config.include.filter(e=>e.includes("."));await new Promise(a=>{const s={cancel:()=>a(null),confirm:e=>a(e),domains:t,entities:i};wa(e.target,"show-dialog",{dialogTag:"dialog-select-entities",dialogImport:()=>Promise.resolve().then((function(){return Ba})),dialogParams:s})}).then(e=>{e&&this._updateConfig({include:[...e.domains,...e.entities]})})}_updateConfig(e){this._config&&(this._config=Object.assign(Object.assign({},this._config),e),wa(this,"config-changed",{config:this._config}))}};Qa.styles=r`
    div.entities-list {
      max-height: 500px;
      overflow: auto;
    }
  ...
  `,t([de({attribute:!1})],Qa.prototype,"hass",void 0),t([de()],Qa.prototype,"_config",void 0),t([de()],Qa.prototype,"title",void 0),t([de()],Qa.prototype,"tagOptions",void 0),Qa=t([re("scheduler-card-editor")],Qa);const Xa=r`
  ha-dialog {
...
`,(e,t,i,a)=>{var s;const o=e.service,n=null===(s=e.target)||void 0===s?void 0:s.entity_id,r=oa(e,a);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const l=r.fields[t];if(null===ca(o,n,t,i,a))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(l.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return 1==((i.states[e].attributes.supported_features||0)&l.supported_features)}))return!1}return!0});var ts;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(ts||(ts={}));const is=(e,t,i)=>{let a=[];a=[...a,...e.entries.map(e=>((e,t)=>e.every((i,a)=>{const s=ze(i.start,t),o=void 0===i.stop?s:ze(i.stop,t)||86400;return!(s>o)&&e.every((e,i)=>{if(i<=a)return!0;return ze(e.start,t)>=o})})?null:ts.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let s=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return s.length||(a=[...a,ts.MissingAction]),a=[...a,...s.map(e=>((e,t,i)=>{var a;const s=oa(e,i);return(null==s?void 0:s.target)&&!(null===(a=e.target)||void 0===a?void 0:a.entity_id)?ts.MissingTargetEntity:(null==s?void 0:s.fields)&&!Object.entries(s.fields).filter(([a])=>es(e,a,t,i)).every(([t,i])=>!(!Object.keys(e.service_data).includes(t)&&!i.optional))?ts.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],a.length?a.shift():null},as=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(ss),timeslots:e.entries[0].slots.map(os),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},ss=e=>{switch(e){case _e.Monday:return"mon";case _e.Tuesday:return"tue";case _e.Wednesday:return"wed";case _e.Thursday:return"thu";case _e.Friday:return"fri";case _e.Saturday:return"sat";case _e.Sunday:return"sun";case _e.Workday:return"workday";case _e.Weekend:return"weekend";default:return"daily"}},os=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>ns(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ge.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),ns=e=>{var t,i;if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>Object({service:e.service,service_data:e.service_data,entity_id:t}))}return{service:e.service,service_data:e.service_data,entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:e.service_data}},rs=(e,t,i)=>{const a={title:ea("state_badge.default.error",i),description:q`
  ...
  `,primaryButtonLabel:ea("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};wa(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return zs})),dialogParams:a})},ls=e=>{let t=e.locale.first_weekday;if(t&&"language"!=t)return ds.map(e=>e.toLowerCase()).findIndex(e=>e==t);if("weekInfo"in Intl.Locale.prototype)return new Intl.Locale(e.locale.language).weekInfo.firstDay%7;{const t="AEAFBHDJDZEGIQIRJOKWLYOMQASDSY".match(/../g),i="AGARASAUBDBRBSBTBWBZCACNCODMDOETGTGUHKHNIDILINJMJPKEKHKRLAMHMMMOMTMXMZNINPPAPEPHPKPRPTPYSASGSVTHTTTWUMUSVEVIWSYEZAZW".match(/../g),a=["ar","arq","arz","fa"],s="amasbndzengnguhehiidjajvkmknkolomhmlmrmtmyneomorpapssdsmsnsutatethtnurzhzu".match(/../g),o=e.locale.language.match(/^([a-z]{2,3})(?:-([a-z]{3})(?=$|-))?(?:-([a-z]{4})(?=$|-))?(?:-([a-z]{2}|\d{3})(?=$|-))?/i);return o[1]?i.includes(o[4])?0:t.includes(o[4])?6:1:s.includes(o[1])?0:a.includes(o[1])?6:1}},ds=[_e.Sunday,_e.Monday,_e.Tuesday,_e.Wednesday,_e.Thursday,_e.Friday,_e.Saturday],cs={alarm_control_panel:{services:{alarm_arm_away:"mdi:shield-lock",alarm_arm_home:"mdi:shield-home",alarm_arm_night:"mdi:shield-moon",alarm_custom_bypass:"mdi:security",alarm_disarm:"mdi:shield-off",alarm_trigger:"mdi:bell-ring",alarm_arm_vacation:"mdi:shield-airplane"}},automation:{services:{turn_on:"mdi:robot",turn_off:"mdi:robot-off",trigger:"mdi:play"}},button:{services:{press:"mdi:gesture-tap-button"}},climate:{services:{set_temperature:"mdi:thermometer",set_hvac_mode:"mdi:cog-transfer-outline",set_preset_mode:"mdi:cloud-download-outline",set_fan_mode:"mdi:fan",set_humidity:"mdi:water-percent",set_swing_mode:"mdi:arrow-oscillating"},attributes:{hvac_mode:{cool:"mdi:snowflake",dry:"mdi:water-percent",fan_only:"mdi:fan",heat:"mdi:fire",heat_cool:"mdi:thermometer",off:"mdi:power"},preset_mode:{activity:"mdi:motion-sensor",away:"mdi:account-arrow-right",boost:"mdi:rocket-launch",comfort:"mdi:sofa",eco:"mdi:leaf",home:"mdi:home",sleep:"mdi:bed"},fan_mode:{diffuse:"mdi:weather-windy",focus:"mdi:target",high:"mdi:speedometer",low:"mdi:speedometer-slow",medium:"mdi:speedometer-medium",middle:"mdi:speedometer-medium",off:"mdi:fan-off",on:"mdi:fan"},swing_mode:{both:"mdi:arrow-all",horizontal:"mdi:arrow-left-right",off:"mdi:arrow-oscillating-off",on:"mdi:arrow-oscillating",vertical:"mdi:arrow-up-down"}}},cover:{services:{close_cover:"mdi:arrow-down-box",close_cover_tilt:"mdi:arrow-bottom-left",open_cover:"mdi:arrow-up-box",open_cover_tilt:"mdi:arrow-top-right",set_cover_position:"mdi:arrow-down-box",set_cover_tilt_position:"mdi:arrow-top-right"}},fan:{services:{oscillate:"mdi:arrow-oscillating",set_percentage:"mdi:fan",set_preset_mode:"mdi:fan-auto",turn_off:"mdi:fan-off",turn_on:"mdi:fan"}},humidifier:{services:{set_humidity:"mdi:water-percent",set_mode:"mdi:air-humidifier",turn_off:"mdi:air-humidifier-off",turn_on:"mdi:air-humidifier"},attributes:{mode:{auto:"mdi:refresh-auto",away:"mdi:account-arrow-right",baby:"mdi:baby-carriage",boost:"mdi:rocket-launch",comfort:"mdi:sofa",eco:"mdi:leaf",home:"mdi:home",normal:"mdi:water-percent",sleep:"mdi:power-sleep"}}},input_boolean:{services:{turn_off:"mdi:toggle-switch-off",turn_on:"mdi:toggle-switch"}},input_button:{services:{press:"mdi:gesture-tap-button"}},input_number:{services:{set_value:"mdi:counter"}},input_select:{services:{select_option:"mdi:counter"}},lawn_mower:{services:{dock:"mdi:home-import-outline",start_mowing:"mdi:play"}},light:{services:{turn_off:"mdi:lightbulb-off",turn_on:"mdi:lightbulb-on"}},lock:{services:{lock:"mdi:lock",unlock:"mdi:lock-open"}},media_player:{services:{media_play:"mdi:play",media_stop:"mdi:stop",play_media:"mdi:play",select_source:"mdi:import",turn_off:"mdi:power",turn_on:"mdi:power"}},notify:{services:{"{entity_id}":"mdi:message-alert"}},scene:{services:{turn_on:"mdi:play"}},script:{services:{turn_on:"mdi:flash",turn_off:"mdi:flash-off","{entity_id}":"mdi:play"}},select:{services:{select_option:"mdi:counter"}},switch:{services:{turn_off:"mdi:toggle-switch-variant-off",turn_on:"mdi:toggle-switch-variant"}},vacuum:{services:{send_command:"mdi:send",start:"mdi:play",turn_off:"mdi:stop",turn_on:"mdi:play"}},water_heater:{services:{set_away_mode:"mdi:account-arrow-right",set_operation_mode:"mdi:water-boiler",set_temperature:"mdi:thermometer",turn_off:"mdi:water-boiler-off",turn_on:"mdi:water-boiler"},attributes:{operation_mode:{eco:"mdi:leaf",electric:"mdi:lightning-bolt",gas:"mdi:fire-circle",heat_pump:"mdi:heat-wave",high_demand:"mdi:finance",off:"mdi:power",performance:"mdi:rocket-launch"}}}},us=(e,t)=>{const i=oa(e,t),a=Ki(e.service),s=Zi(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:"mdi:"+o;var o;if(!Object.keys(cs).includes(a)||!Object.keys(cs[a].services).includes(s))return"mdi:flash";if(void 0!==cs[a].attributes){let t=cs[a].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return cs[a].services[s]},hs=(e,t)=>{const i=new Date(t),a=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let s=3600*e.hours+60*e.minutes-a;const o=s<0?-1:1;s=Math.abs(s);let n=Math.floor(s/3600),r=Math.round((s-3600*n)/60);return o<0&&(n>0?n=-n:r=-r),Se({hours:n,minutes:r})};let ms=class extends oe{constructor(){super(),this.selectedSlot=null,this.timeout=0,this.large=!1,this.handleResize=this.handleResize.bind(this)}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){}render(){return q`
    ...
    `}renderTimebar(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=[1,2,3,4,6,8,12],i=De(this.hass.locale),a=i?130:100;let s=Math.ceil(24/(e/a));for(;!t.includes(s);)s++;const o=[0,...Array.from(Array(24/s-1).keys()).map(e=>(e+1)*s),24];return o.map((e,t)=>{let a=s/24*100;a=Math.floor(100*a)/100;let n={mode:ke.Fixed,hours:e,minutes:0};return 0==t?q`
        <span class="left" style=${Da({width:a/2+"%"})}>${Ie(n,{seconds:!1,am_pm:i})}</span>
      `:t==o.length-1?q`
        <span class="right" style=${Da({width:a/2+"%"})}>${Ie(n,{seconds:!1,am_pm:i})}</span>
      `:q`
        <span style=${Da({width:a+"%"})}>${Ie(n,{seconds:!1,am_pm:i})}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,a)=>{let s=ze(i.start,this.hass),o=ze(i.stop||i.start,this.hass);!o&&s&&(o=86400);const n=(o-s)/86400*100,r=i.actions.length?_a(i.actions[0],this.hass,this.config.customize,!0):"",l=parseFloat(getComputedStyle(this).getPropertyValue("width")),d=5*r.length+10,c=a>0?15:0,u=a<e.length-1?15:0,h=n*l/100-c-u,m=e[a+1];return q`
        <div
          class="slot ${this.selectedSlot==a?"selected":""} ${i.actions.length?"":"empty"} ${void 0===i.stop?"short":""}"
          style="${Da({width:t[a]+"px"})}"
          @click=${this._toggleSelectTimeslot}
          idx="${a}"
        >
          ${i.stop,""}
          ${i.actions.length?r&&(h>d/3||h>50)&&h>30?q`<span style="margin-left: ${c}px; margin-right: ${u}px">${r}</span>`:h>16?q`<ha-icon icon="${us(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
        ...
        `:""}
      `})}computeSlotWidths(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=this.schedule.slots;let i=e-3*(t.length-1);const a=t.map(e=>{let t=ze(e.start,this.hass),i=ze(e.stop||e.start,this.hass);return!i&&t&&(i=86400),(i-t)/86400}),s=Math.round(5/i*100)/100;i-=5*a.filter(e=>e<s).length;let o=i;return a.map(e=>{let t=e<s?5:Math.round(e*i);return t>o&&(t=o),o-=t,t})}_toggleSelectTimeslot(e){let t=e.target;"div"!=t.tagName.toLowerCase()&&(t=t.parentElement);const i=Number(t.getAttribute("idx"));this.selectedSlot=this.selectedSlot!==i?i:null;const a=new CustomEvent("update",{detail:{selectedSlot:this.selectedSlot}});this.dispatchEvent(a),e.stopPropagation()}_handleDragStart(e){let t=e.target;for(;"DIV"!==t.tagName;)t=t.parentElement;const i=t.parentElement.getBoundingClientRect(),a=Number(t.getAttribute("idx"));let s=a>0?ze(this.schedule.slots[a-1].stop||this.schedule.slots[a-1].start,this.hass)+900:900,o=(ze(this.schedule.slots[a+1].stop||this.schedule.slots[a+1].start,this.hass)||86400)-900;void 0===this.schedule.slots[a+1].stop&&(o=(ze(this.schedule.slots[a+2].stop||this.schedule.slots[a+2].start,this.hass)||86400)-900);const n=Ae(this.schedule.slots[a+1].start).mode;if([ke.Sunrise,ke.Sunset].includes(n)){let e=Ae(this.schedule.slots[a+1].start),t=ze(Object.assign(Object.assign({},e),{hours:4,minutes:0}),this.hass),i=ze(Object.assign(Object.assign({},e),{hours:-4,minutes:0}),this.hass);i>s&&(s=i),t<o&&(o=t)}let r=e=>{let t;t="undefined"!=typeof TouchEvent&&e instanceof TouchEvent?e.changedTouches[0].pageX:e.pageX,t-=i.left,t>i.width&&(t=i.width),t<0&&(t=0);let r=Math.round(t/i.width*86400);r<s?r=s:r>o&&(r=o);const l=Math.floor(r/3600),d=Math.round((r-3600*l)/60);let c={mode:ke.Fixed,hours:l,minutes:d};if([ke.Sunrise,ke.Sunset].includes(n)){const e=n==ke.Sunrise?this.hass.states["sun.sun"].attributes.next_rising:this.hass.states["sun.sun"].attributes.next_setting,t=hs(c,e);c={mode:n,hours:t.hours,minutes:t.minutes}}c=Se(c,15);const u=Ie(c);let h=[...this.schedule.slots];if(h=Object.assign(h,{[a]:Object.assign(Object.assign({},h[a]),{stop:u}),[a+1]:Object.assign(Object.assign({},h[a+1]),{start:Ie(c)})}),void 0===h[a+1].stop){const e=Ie(Ce(c,{minutes:1}));h=Object.assign(h,{[a+2]:Object.assign(Object.assign({},h[a+2]),{start:e})})}this.schedule=Object.assign(Object.assign({},this.schedule),{slots:h});const m=new CustomEvent("update",{detail:{slots:h}});this.dispatchEvent(m)};const l=()=>{window.removeEventListener("mousemove",r),window.removeEventListener("touchmove",r),window.removeEventListener("mouseup",l),window.removeEventListener("touchend",l),window.removeEventListener("blur",l),r=()=>{}};window.addEventListener("mouseup",l),window.addEventListener("touchend",l),window.addEventListener("blur",l),window.addEventListener("mousemove",r),window.addEventListener("touchmove",r)}static get styles(){return r`
      :host {
        display: block;
        max-width: 100%;
        overflow: hidden;
    ...
    `}};t([de({attribute:!1})],ms.prototype,"hass",void 0),t([de({attribute:!1})],ms.prototype,"config",void 0),t([ce()],ms.prototype,"schedule",void 0),t([ce()],ms.prototype,"selectedSlot",void 0),t([de({type:Boolean})],ms.prototype,"large",void 0),t([function(e){return ue({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}({passive:!0})],ms.prototype,"_handleDragStart",null),ms=t([re("scheduler-timeslot-editor")],ms);let ps=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=ke.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1}set time(e){this.hours=Number(e.split(":")[0]),this.minutes=Number(e.split(":")[1]);const t=Ae(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return q`
      <div class="time-input-wrap">
        ...
        <ha-textfield
          ...
          maxlength="2"
          max=${this.mode==ke.Fixed?this.useAmPm?12:23:4}
          min=${this.mode==ke.Fixed?0:-4}
          .disabled=${this.disabled}
          suffix=":"
          class="hasSuffix"
        ...
        ${this.useAmPm&&this.mode==ke.Fixed?q`
          <ha-select
            .required=${this.required}
    ...
    `}convertTimeMode(e){let t={mode:ke.Fixed,hours:this.hours,minutes:this.minutes};if([ke.Sunrise,ke.Sunset].includes(this.mode)){const e=this.mode==ke.Sunrise?this.hass.states["sun.sun"].attributes.next_rising:this.hass.states["sun.sun"].attributes.next_setting;let i=Ae(e);i=Ce(i,{hours:this.hours,minutes:this.minutes}),t=Object.assign(Object.assign({},t),{hours:i.hours,minutes:i.minutes})}if([ke.Sunrise,ke.Sunset].includes(e)){const t=e==ke.Sunrise?this.hass.states["sun.sun"].attributes.next_rising:this.hass.states["sun.sun"].attributes.next_setting,i=hs({hours:this.hours,minutes:this.minutes},t);return{mode:e,hours:i.hours,minutes:i.minutes}}return t}_renderTimeModeOptions(){if(!this.hass.states["sun.sun"])return q``;let e=[ke.Fixed,ke.Sunrise,ke.Sunset];const t={[ke.Fixed]:ea("ui.components.selectors.selector.types.time",this.hass),[ke.Sunrise]:ea("ui.panel.config.automation.editor.triggers.type.sun.sunrise",this.hass),[ke.Sunset]:ea("ui.panel.config.automation.editor.triggers.type.sun.sunset",this.hass)},i={[ke.Fixed]:"mdi:clock-outline",[ke.Sunrise]:"mdi:weather-sunset-up",[ke.Sunset]:"mdi:weather-sunset-down"},a={[ke.Fixed]:"M12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22C6.47,22 2,17.5 2,12A10,10 0 0,1 12,2M12.5,7V12.25L17,14.92L16.25,16.15L11,13V7H12.5Z",[ke.Sunrise]:"M3,12H7A5,5 0 0,1 12,7A5,5 0 0,1 17,12H21A1,1 0 0,1 22,13A1,1 0 0,1 21,14H3A1,1 0 0,1 2,13A1,1 0 0,1 3,12M15,12A3,3 0 0,0 12,9A3,3 0 0,0 9,12H15M12,2L14.39,5.42C13.65,5.15 12.84,5 12,5C11.16,5 10.35,5.15 9.61,5.42L12,2M3.34,7L7.5,6.65C6.9,7.16 6.36,7.78 5.94,8.5C5.5,9.24 5.25,10 5.11,10.79L3.34,7M20.65,7L18.88,10.79C18.74,10 18.47,9.23 18.05,8.5C17.63,7.78 17.1,7.15 16.5,6.64L20.65,7M12.71,16.3L15.82,19.41C16.21,19.8 16.21,20.43 15.82,20.82C15.43,21.21 14.8,21.21 14.41,20.82L12,18.41L9.59,20.82C9.2,21.21 8.57,21.21 8.18,20.82C7.79,20.43 7.79,19.8 8.18,19.41L11.29,16.3C11.5,16.1 11.74,16 12,16C12.26,16 12.5,16.1 12.71,16.3Z",[ke.Sunset]:"M3,12H7A5,5 0 0,1 12,7A5,5 0 0,1 17,12H21A1,1 0 0,1 22,13A1,1 0 0,1 21,14H3A1,1 0 0,1 2,13A1,1 0 0,1 3,12M15,12A3,3 0 0,0 12,9A3,3 0 0,0 9,12H15M12,2L14.39,5.42C13.65,5.15 12.84,5 12,5C11.16,5 10.35,5.15 9.61,5.42L12,2M3.34,7L7.5,6.65C6.9,7.16 6.36,7.78 5.94,8.5C5.5,9.24 5.25,10 5.11,10.79L3.34,7M20.65,7L18.88,10.79C18.74,10 18.47,9.23 18.05,8.5C17.63,7.78 17.1,7.15 16.5,6.64L20.65,7M12.71,20.71L15.82,17.6C16.21,17.21 16.21,16.57 15.82,16.18C15.43,15.79 14.8,15.79 14.41,16.18L12,18.59L9.59,16.18C9.2,15.79 8.57,15.79 8.18,16.18C7.79,16.57 7.79,17.21 8.18,17.6L11.29,20.71C11.5,20.9 11.74,21 12,21C12.26,21 12.5,20.9 12.71,20.71Z"},s=e=>{if(e==ke.Fixed)return!1;const t=this.convertTimeMode(e);return Math.abs(60*t.hours)+Math.abs(t.minutes)>240};return q`
      <ha-button-menu
    ...
    `}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Le(this.hours).am_pm;t=Pe(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.target.value,i=Le(this.hours).hours;this.hours=Pe(i,"AM"==t?Me.AM:Me.PM),this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};wa(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==ke.Fixed?Le(this.hours).hours:this.hours;return e?"-"+Math.abs(t).toFixed():this.mode!=ke.Fixed?"+"+Math.abs(t).toFixed():t.toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}_handleMenuAction(e,t){const i=e.detail.index,a=(t=t.filter(e=>e!=this.mode))[i],s=this.convertTimeMode(a);this.hours=s.hours,this.minutes=s.minutes,this.mode=a,e.preventDefault();const o=e.target;setTimeout(()=>{o.firstElementChild.blur()},50);const n={mode:this.mode,hours:this.hours,minutes:this.minutes};wa(this,"value-changed",{value:n})}};ps.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([de({attribute:!1})],ps.prototype,"hass",void 0),t([ce()],ps.prototype,"hours",void 0),t([ce()],ps.prototype,"minutes",void 0),t([ce()],ps.prototype,"mode",void 0),t([de({type:Boolean})],ps.prototype,"autoValidate",void 0),t([de({type:Boolean})],ps.prototype,"required",void 0),t([de({type:Boolean})],ps.prototype,"disabled",void 0),t([de({type:String})],ps.prototype,"label",void 0),t([de({type:Boolean})],ps.prototype,"useAmPm",void 0),ps=t([re("scheduler-time-picker")],ps);let _s=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![_e.Daily,_e.Weekend,_e.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          ...
          `};
          <span slot="title">
              ${Wi("ui.dialog.weekday_picker.title",this.hass)}
          </span>
        </ha-dialog-header>
        <div class="wrapper">
          <mwc-list>
        ...
        >
          ${ea("ui.common.ok",this.hass)}
        </ha-button>
      </ha-dialog>
    `:q``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[_e.Sunday,_e.Monday,_e.Tuesday,_e.Wednesday,_e.Thursday,_e.Friday,_e.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,ls(this.hass))}else e=[_e.Daily,_e.Workday,_e.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.every(e=>![_e.Daily,_e.Weekend,_e.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>q`
        <mwc-list-item
          graphic="icon"
      ...
      >
        <div slot="heading">
          <ha-dialog-header>
            ...
            <ha-icon-button
              slot="navigationIcon"
              .label=${ea("ui.common.back",this.hass)}
              .path=${$a}
              @click=${this._clearDomain}
            ></ha-icon-button>
            `}
            <span slot="title">
              ${Wi("ui.dialog.action_picker.title",this.hass)}
            </span>
          </ha-dialog-header>
    ...
    `:q``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("mwc-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_renderOptions(){var e,t;if(null===(e=this._params)||void 0===e?void 0:e.domainFilter){let e=this._params.domainFilter.map(e=>((e,t,i)=>{const a=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(e=>{if(!Object.keys(ia).includes(t))return!1;let i=Object.keys(ia[t]).includes(e);return!i&&Object.keys(ia[t]).includes("{entity_id}")&&(i=!["turn_on","turn_off","reload","toggle","test"].includes(e)),i}):[],s=t=>ea(`component.${t}.title`,e,!1)||t.replace(/_/g," "),o=i=>ea(`component.${t}.services.${i}.description`,e,!1)||e.services[t][i].description;let n=a.map(i=>{return Object({key:i,name:`${s(t)}: ${a=i,ea(`component.${t}.services.${a}.name`,e,!1)||e.services[t][a].name||a.replace(/_/g," ")}`,description:o(i),icon:za(t),action:{service:i.includes(".")?i:`${t}.${i}`,service_data:{},target:e.services[t][i].target?{}:void 0}});var a});return sa(i||{},t).forEach(e=>{let i=e.service;for(;n.find(e=>e.key==i);)i+="_2";n.push({key:i,name:e.name||"",description:e.name||"",icon:e.icon||za(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},target:e.target?e.target:void 0,name:e.name,icon:e.icon}})}),n})(this.hass,e,this._params.cardConfig.customize)).flat();return(null===(t=this._params.entityFilter)||void 0===t?void 0:t.length)&&(e=e.filter(e=>{var t;return null===(t=this._params.entityFilter)||void 0===t?void 0:t.every(t=>!Object.keys(e.action.service_data).includes("entity_id")||e.action.service_data.entity_id==t)})),Object.keys(e).map(t=>q`
        <mwc-list-item
          graphic="icon"
    ...
    `)}{let e=Ea(this.hass,this._params.cardConfig);e.sort((e,t)=>Qi(e.name,t.name)),this._filter&&(e=e.filter(e=>{const t=this._filter.toLowerCase().trim().split(" ");return t.every(t=>e.name.toLowerCase().includes(t))||t.every(t=>e.key.toLowerCase().includes(t))}));let t=[];for(var i=e.length;i<7;i++)t.push(0);return q`
    ...
    `}};t([de({attribute:!1})],vs.prototype,"hass",void 0),t([ce()],vs.prototype,"_params",void 0),t([ce()],vs.prototype,"_search",void 0),t([ce()],vs.prototype,"_filter",void 0),t([ce()],vs.prototype,"_width",void 0),t([ce()],vs.prototype,"_height",void 0),t([ce()],vs.prototype,"lockDomain",void 0),vs=t([re("dialog-select-action")],vs);var ys=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return vs}});let bs=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return q`
      ${this.showPrefix?q`
    ...
    `}};t([de({type:Boolean})],bs.prototype,"showPrefix",void 0),bs=t([re("scheduler-settings-row")],bs);let fs=class extends oe{constructor(){super(...arguments),this.selectedEntry=0,this.selectedSlot=null,this.large=!1}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return q`
    ${this.schedule.entries.map((e,t)=>q`

      <div class="editor-header">
      <div class="weekdays">
        <span>
          ${Wi("ui.panel.editor.repeated_days",this.hass)}:
          ${((e,t,i)=>{const a=ls(i);let s=((e,t)=>e.concat(e).slice(t,t+e.length))(ds,a);e.sort((e,t)=>s.findIndex(t=>t==e)-s.findIndex(e=>e==t));const o=e.filter(e=>s.includes(e)).map(e=>s.findIndex(t=>t==e)),n=(e=>{const t=[];for(let i=0;i<e.length-1;i++){let a=i+1;for(;e[a]-e[a-1]==1;)a++;t.push(a-i)}return t})(o),r=Math.max(...n);if(o.length){if(6==o.length){const e=[0,1,2,3,4,5,6].filter(e=>!o.includes(e)),a=ya(s[e.pop()],t,i);return Wi("ui.components.date.repeated_days_except",i,"{excludedDays}",a)}const e=o.map(e=>ya(s[e],t,i));if(o.length>=3&&r>=3){const t=n.reduce((e,t,i)=>t==r?i:e,0);e.splice(t,r,Wi("ui.components.date.days_range",i,["{startDay}","{endDay}"],[e[t],e[t+r-1]]))}const a=e.length>1?`${e.slice(0,-1).join(", ")} ${ea("ui.common.and",i)} ${e.pop()}`:""+e.pop();return o.length>=3&&r>=3?a:Wi("ui.components.date.repeated_days",i,"{days}",a)}return e.map(e=>ya(e,t,i)).join(", ")})(e.weekdays,"short",this.hass)}
        </span>
        <ha-icon-button .path=${Oa} @click=${e=>this._showWeekdayDialog(e,t)}></ha-icon-button>
      </div>
    ...
    ${this.renderSlot()}
    `}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return q``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=ze(e,this.hass),a=(ze(t,this.hass)||86400)-i;return q`
      <div class="actions">
        <ha-icon-button .path=${$a} @click=${()=>{this.selectedSlot=this.selectedSlot-1}} ?disabled=${null===this.selectedSlot||this.selectedSlot<1}>
        </ha-icon-button> 
        ...
        <ha-icon-button .path=${Sa} @click=${this._removeTimeslot} ?disabled=${this.schedule.entries[this.selectedEntry].slots.length<=2}>
        </ha-icon-button> 
      </div>
    `}renderSlot(){if(null===this.selectedEntry||null===this.selectedSlot)return q`
        <div class="slot-placeholder"> 
          ${Wi("ui.panel.editor.select_timeslot",this.hass)}
        </div>
      ...
      <div class="two-column">
        <div class="column">
          <scheduler-time-picker
            .hass=${this.hass}
            label="${Wi("ui.panel.editor.start_time",this.hass)}:"
        ...
        <div class="column">
          ...
          <scheduler-time-picker
            .hass=${this.hass}
            label="${Wi("ui.panel.editor.stop_time",this.hass)}:"
      ...
      ${Wi("ui.panel.editor.action",this.hass)}:
      ${this._renderActionConfig()}
    `}_renderActionConfig(){var e,t,i;const a=Object.assign({},this.schedule.entries[this.selectedEntry].slots[this.selectedSlot]),s=a.actions.length?a.actions[0]:void 0;if(!s)return q`
      <div>
        <ha-button appearance="plain"
          @click=${this._showActionDialog}
        >
          <ha-icon slot="start" icon="mdi:plus"></ha-icon>
          ${Wi("ui.panel.editor.add_action",this.hass)}
        </ha-button>
      </div>
    `;const o=Ki(s.service),n=oa(s,this.config.customize),r=na(null===(e=null==n?void 0:n.target)||void 0===e?void 0:e.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&na(null===(i=null===(t=oa(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return q``;const l=Object.keys(n.fields||{}).filter(e=>es(s,e,this.hass,this.config.customize));let d="",c=[(null===(t=s.target)||void 0===t?void 0:t.entity_id)||[]].flat();return c.length&&(d+=c.map(e=>{var t;return Gi(e,null===(t=this.hass.states[e])||void 0===t?void 0:t.attributes)}).join(", "),d+=": "),d+=_a(s,this.hass,this.config.customize),q`
      <scheduler-collapsible-section
        ?expanded=${!0}
        ?disabled=${!0}
      >
        <div slot="header" class="header">
          <ha-icon slot="icon" icon="${us(s,this.config.customize)}"></ha-icon>
          <span>${Xi(d)}</span>
        </div>
        <ha-icon-button slot="contextMenu" .path=${Sa} @click=${this._removeAction}></ha-icon-button>
        <div slot="content">

          ${n.target?q`
          <scheduler-settings-row>
            <span slot="heading">${ea("ui.components.entity.entity-picker.entity",this.hass)}</span>
            <scheduler-entity-picker
              .hass=${this.hass}
              .config=${this.config}
              .domain=${o}
              @value-changed=${this._selectEntity}
              .value=${[(null===(i=s.target)||void 0===i?void 0:i.entity_id)||[]].flat()}
              ?multiple=${!0}
              ?disabled=${r}
            >
            </scheduler-entity-picker>
          ...
          ${l.map(e=>{var t;const i=ca(s.service,null===(t=s.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let a=n.fields[e].optional||(i.number||{}).optional;const o=!a||Object.keys(s.service_data).includes(e);return q`
            <scheduler-settings-row ?showPrefix=${a}>
              ...
              `:""}
              <span slot="heading">
                ${((e,t,i,a)=>{const s=Ki(e.service),o=Zi(e.service);let n=ea(`component.${s}.services.${o}.fields.${t}.name`,i,!1);!n&&i.services[s]&&i.services[s][e.service]&&i.services[s][e.service].fields&&i.services[s][e.service].fields[t]&&(n=String(i.services[s][e.service].fields[t].name));const r=Object.entries(a||{}).filter(([t])=>t==s||t==e.service).map(([t,i])=>(i.actions||[]).filter(t=>aa(t,e))).flat().find(e=>Object.keys(e.variables).includes(t));return r&&(n=r.variables[t].name||""),n||(n=t.replace(/_/g," ")),n})(s,e,this.hass,this.config.customize)}
              </span>
              <scheduler-combo-selector
                .hass=${this.hass}
                .config=${i}
                ?disabled=${!o}
                .value=${Object.keys(s.service_data).includes(e)?s.service_data[e]:void 0}
  ...
  scheduler-collapsible-section .header span {
    ...
    `}};t([de({attribute:!1})],fs.prototype,"hass",void 0),t([de({attribute:!1})],fs.prototype,"config",void 0),t([ce()],fs.prototype,"schedule",void 0),t([ce()],fs.prototype,"selectedEntry",void 0),t([ce()],fs.prototype,"selectedSlot",void 0),t([de({type:Boolean})],fs.prototype,"large",void 0),fs=t([re("scheduler-main-panel")],fs);const ks=["January","February","March","April","May","June","July","August","September","October","November","December"];function ws(e){return e.toISOString().split("T")[0]}function xs(e){let t=new Date;const i=(e||"").match(/^([0-9]{4})-([0-9]{2})-([0-9]{2})/);null!==i&&t.setFullYear(Number(i[1]),Number(i[2])-1,Number(i[3]));const a=(e||"").match(/([0-9]{2}):([0-9]{2})(:([0-9]{2}))?$/);return null!==a&&t.setHours(Number(a[1]),Number(a[2]),a.length>4?Number(a[4]):t.getSeconds()),t}const $s=(e,t)=>"select"in t&&null!==t.select?((e,t)=>{var i;return((null===(i=t.select)||void 0===i?void 0:i.options)||[]).some(t=>"object"==typeof t?t.value==e:t==e)})(String(e),t):"number"in t&&null!==t.number?((e,t)=>{var i,a;return isNaN(e)||void 0!==(null===(i=t.number)||void 0===i?void 0:i.min)&&e<t.number.min||void 0!==(null===(a=t.number)||void 0===a?void 0:a.max)&&t.number.max,!1})(Number(e),t):!("text"in t)||null===t.text||String(e).length>0,js=e=>null==e||Array.isArray(e)?e:[e];let Os=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0}async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title")}render(){return this._params?q`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
      ...
      >
        <div slot="heading">
          <ha-dialog-header>
            ...
            ></ha-icon-button>
            <span slot="title">
              ${Wi("ui.panel.options.conditions.add_condition",this.hass)}
            </span>
          </ha-dialog-header>
    ...
    `}};t([de({attribute:!1})],Os.prototype,"hass",void 0),t([ce()],Os.prototype,"_params",void 0),t([ce()],Os.prototype,"_search",void 0),t([ce()],Os.prototype,"_filter",void 0),t([ce()],Os.prototype,"_width",void 0),t([ce()],Os.prototype,"_height",void 0),Os=t([re("dialog-select-condition")],Os);var Cs=Object.freeze({__proto__:null,get DialogSelectCondition(){return Os}});let Ss=class extends oe{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[]}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||ws(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||ws(new Date);const i=(await xa(this.hass)).map(e=>e.name),a=[...this.config.tags].flat();this.tags=[...i,...a.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return q`
      <div class="header first">
        <span>${Wi("ui.panel.options.conditions.header",this.hass)}:</span>
        ...
        >
          ...
          <mwc-list-item graphic="icon" ?disabled=${this.schedule.entries[0].slots[0].conditions.items.length<2}>
            ${this.schedule.entries[0].slots[0].conditions.type==ge.Or?q`<ha-icon icon="mdi:check" slot="graphic"></ha-icon>`:""}
            ${Wi("ui.panel.options.conditions.options.logic_or",this.hass)}
          </mwc-list-item>
          <mwc-list-item graphic="icon" ?disabled=${this.schedule.entries[0].slots[0].conditions.items.length<2}>
            ${this.schedule.entries[0].slots[0].conditions.type==ge.And?q`<ha-icon icon="mdi:check" slot="graphic"></ha-icon>`:""}
            ${Wi("ui.panel.options.conditions.options.logic_and",this.hass)}
          </mwc-list-item>
          <mwc-list-item graphic="icon">

            ${this.schedule.entries[0].slots[0].conditions.track_changes?q`<ha-icon icon="mdi:check" slot="graphic"></ha-icon>`:""}
            ${Wi("ui.panel.options.conditions.options.track_changes",this.hass)}
          </mwc-list-item>
        </ha-button-menu>
        `:""}
        </div>
      ...
      <span class="header">${Wi("ui.panel.options.period.header",this.hass)}:</span>
      <div class="period">
        <ha-checkbox
        ...
        <span>${Wi("ui.panel.options.period.start_date",this.hass)}</span>
        <ha-date-input
          .locale=${this.hass.locale}
          value=${this.startDate}
          .label=${ea("ui.components.date-range-picker.start_date",this.hass)}
          @value-changed=${this._setStartDate}
          ?disabled=${!this.schedule.start_date}
        >
        </ha-date-input>
        <span>${Wi("ui.panel.options.period.end_date",this.hass)}</span>
        <ha-date-input
          .locale=${this.hass.locale}
          value=${this.endDate}
          .label=${ea("ui.components.date-range-picker.end_date",this.hass)}
      ...
      <span class="header">${ea("ui.common.name",this.hass)}:</span>
      <div class="period">
        <ha-textfield
          value=${this.schedule.name||""}
          placeholder=${this.schedule.name?"":ea("ui.common.name",this.hass)}
          @input=${this.updateName}
        ></ha-textfield>
      </div>

      <span class="header">${Wi("ui.panel.options.tags",this.hass)}:</span>
      <div>
        <scheduler-combo-selector
          .hass=${this.hass}
          .config=${e}
      ...
      <span class="header">${Wi("ui.panel.options.repeat_type",this.hass)}:</span>
      <ha-button
      ...
      >
        ...
        ${ea("ui.components.calendar.event.repeat.label",this.hass)}
      </ha-button>
      <ha-button
      ...
      >
        ...
        ${ea("ui.dialogs.more_info_control.vacuum.stop",this.hass)}
      </ha-button>
      <ha-button
      ...
      >
        ...
        ${ea("ui.common.delete",this.hass)}
      </ha-button>
    `}renderConditions(){let e=this.schedule.entries[0].slots[0].conditions.items;return this.conditionIdx==e.length&&(e=[...e,{}]),e.map((e,t)=>{const i=this.selectedDomain||Ki(e.entity_id||""),a=Ia(this.selectedEntity||i,this.hass),s=a&&a.hasOwnProperty("number")?[ve.Above,ve.Below]:[ve.Equal,ve.Unequal],o={[ve.Equal]:"mdi:equal",[ve.Unequal]:"mdi:not-equal-variant",[ve.Above]:"mdi:greater-than",[ve.Below]:"mdi:less-than"},n={[ve.Equal]:"ui.panel.options.conditions.types.equal_to",[ve.Unequal]:"ui.panel.options.conditions.types.unequal_to",[ve.Above]:"ui.panel.options.conditions.types.above",[ve.Below]:"ui.panel.options.conditions.types.below"};return this.conditionIdx!==t||this.selectedMatchType||(this.selectedMatchType=s[0]),q`
      <scheduler-collapsible-section idx="${t}">
        <div slot="header">
          ${e.entity_id&&void 0!==e.value?q`
          <ha-icon slot="icon" icon="${Ra(e.entity_id,this.hass)}"></ha-icon>
          ${Xi(Wi(n[e.match_type],this.hass,["{entity}","{value}"],[(r=e.entity_id,l=this.hass,(Object.keys(l.states).includes(r)&&l.states[r].attributes.friendly_name?l.states[r].attributes.friendly_name:Zi(r).replace(/_/g," "))||""),e.value||""]))}
          `:Wi("ui.panel.options.conditions.add_condition",this.hass)}
        </div>
        <ha-button-menu
          slot="contextMenu" 
        ...
        >
          ...
          <mwc-list-item graphic="icon">
            ${ea("ui.panel.lovelace.editor.card.conditional.change_type",this.hass)}
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${ea("ui.components.selectors.selector.types.entity",this.hass)}
          </span>
          <scheduler-entity-picker
            .hass=${this.hass}
            .config=${this.config}
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${Xi(Wi(n[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
            <ha-button-menu
              @action=${e=>this._selectMatchType(e,s)}
              @closed=${e=>{e.stopPropagation()}}
              fixed
            >
              <ha-icon-button slot="trigger" .path=${Oa}>
              </ha-icon-button>
              ${s.map(i=>q`
                <mwc-list-item graphic="icon" ?noninteractive=${this.conditionIdx==t?this.selectedMatchType==i:e.match_type==i}>
                  ${Xi(Wi(n[i],this.hass,["{entity}","{value}"],["",""]))}
    ...
    `}};t([de({attribute:!1})],Ss.prototype,"hass",void 0),t([de({attribute:!1})],Ss.prototype,"config",void 0),t([ce()],Ss.prototype,"schedule",void 0),t([ce()],Ss.prototype,"conditionIdx",void 0),t([ce()],Ss.prototype,"selectedDomain",void 0),t([ce()],Ss.prototype,"selectedEntity",void 0),t([ce()],Ss.prototype,"selectedMatchType",void 0),t([ce()],Ss.prototype,"conditionValue",void 0),t([ce()],Ss.prototype,"conditionValid",void 0),t([ce()],Ss.prototype,"startDate",void 0),t([ce()],Ss.prototype,"endDate",void 0),t([de()],Ss.prototype,"tags",void 0),Ss=t([re("scheduler-options-panel")],Ss);let As=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          <ha-icon-button
            slot="navigationIcon"
    ...
    `}};t([de({attribute:!1})],As.prototype,"hass",void 0),t([ce()],As.prototype,"_params",void 0),As=t([re("scheduler-generic-dialog")],As);var zs=Object.freeze({__proto__:null,get GenericDialog(){return As}});let Es=class extends oe{constructor(){super(...arguments),this.large=!1,this.selectedEntry=0,this.selectedSlot=0,this._panel="main"}async showDialog(e){this._params=e,this.schedule=e.schedule,this._panel="main",this.large=!1,await this.updateComplete}async closeDialog(){this._params=void 0}willUpdate(){this.hass.loadBackendTranslation("config")}render(){var e;return this._params?q`
      <ha-dialog open @closed=${this.closeDialog} .heading=${!0} hideActions scrimClickAction="">
        <ha-dialog-header slot="heading">
          ...
          <span slot="title" @click=${()=>this.large=!this.large}>
            ${this._params.editItem?this.schedule.name?null===(e=this.schedule)||void 0===e?void 0:e.name:Wi("ui.panel.common.default_name",this.hass,"{id}",this._params.editItem):Wi("ui.panel.common.new_schedule",this.hass)}
          </span>
        ...
        <div class="buttons">
          ...
          <ha-button appearance="plain" @click=${this._handleSaveClick}>
            ${ea("ui.common.save",this.hass)}
          </ha-button>
        </div>
      </ha-dialog>
    `:q``}_updateSchedule(e){let t=e.detail.schedule;t&&(this.schedule=t)}async _handleSaveClick(e){const t=is(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const a={cancel:()=>i(!1),confirm:()=>i(!0),title:ea("state_badge.default.error",this.hass),description:Wi("ui.panel.editor.validation_errors."+t,this.hass),primaryButtonLabel:ea("ui.common.ok",this.hass)};wa(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return zs})),dialogParams:a})});else if(this.schedule.schedule_id){const t=Ne(await ka(this.hass,this.schedule.schedule_id),this.hass);if(pe(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Wi("ui.dialog.enable_schedule.title",this.hass),description:Wi("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:ea("ui.common.yes",this.hass),secondaryButtonLabel:ea("ui.common.no",this.hass),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};wa(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return zs})),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=as(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>rs(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=as(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>rs(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Wi("ui.dialog.confirm_delete.title",this.hass),description:Wi("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:ea("ui.common.ok",this.hass),secondaryButtonLabel:ea("ui.common.cancel",this.hass)};wa(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return zs})),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>rs(e,this,this.hass)).then(()=>{this.closeDialog()})})}};Es.styles=Xa,t([de({attribute:!1})],Es.prototype,"hass",void 0),t([ce()],Es.prototype,"_params",void 0),t([de({type:Boolean,reflect:!0})],Es.prototype,"large",void 0),t([ce()],Es.prototype,"schedule",void 0),t([ce()],Es.prototype,"selectedEntry",void 0),t([ce()],Es.prototype,"selectedSlot",void 0),t([ce()],Es.prototype,"_panel",void 0),Es=t([re("dialog-scheduler-editor")],Es);var Ts=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return Es}}),Ds=window&&window.__assign||function(){return(Ds=Object.assign||function(e){for(var t,i=1,a=arguments.length;i<a;i++)for(var s in t=arguments[i])Object.prototype.hasOwnProperty.call(t,s)&&(e[s]=t[s]);return e}).apply(this,arguments)};var Ms={second:45,minute:45,hour:22,day:5};const Ls=(e,t,i)=>{if(i===Te.am_pm||!i&&t.time_format===Te.am_pm){const t=Le(e.getHours()).am_pm;return`${Le(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===Te.twenty_four||!i&&t.time_format===Te.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:De(t)}):De(t)?Ls(e,t,Te.am_pm):Ls(e,t,Te.twenty_four)};let Ps=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const a=i>=0?"past":"future";i=Math.abs(i);const s=Math.round(i);if("future"==a&&s>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),a=Math.floor((e.valueOf()-i.valueOf())/864e5);let s="";a>14?s=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},a=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return ks[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${a(e,"month")} ${a(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${a(e,"month")} ${a(e,"day")}, ${a(e,"year")}`}(e,this._hass.locale):a>7?s=Wi("ui.components.date.next_week_day",this._hass,"{weekday}",ya(e,"long",this._hass)):1==a?s=Wi("ui.components.date.tomorrow",this._hass):a>0&&(s=ya(e,"long",this._hass));let o=Wi("ui.components.time.absolute",this._hass,"{time}",Ls(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Wi("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Wi("ui.components.time.at_midnight",this._hass)),String(s+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=ea("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=ea("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var a=Ds(Ds({},Ms),i||{}),s=(+e-+t)/1e3;if(Math.abs(s)<a.second)return{value:Math.round(s),unit:"second"};var o=s/60;if(Math.abs(o)<a.minute)return{value:Math.round(o),unit:"minute"};var n=s/3600;if(Math.abs(n)<a.hour)return{value:Math.round(n),unit:"hour"};var r=s/86400;if(Math.abs(r)<a.day)return{value:Math.round(r),unit:"day"};var l=new Date(e),d=new Date(t),c=l.getFullYear()-d.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+l.getMonth()-d.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var h=s/604800;return{value:Math.round(h),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return q``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),q`
      ${Xi(this.relativeTime(this.datetime))}
    `}};t([de()],Ps.prototype,"_hass",void 0),t([de()],Ps.prototype,"datetime",void 0),Ps=t([re("scheduler-relative-time")],Ps);let Is=class extends oe{render(){const e=this.hass.states[this.schedule.entity_id];if(!e)return q``;const t="off"==e.state,i=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];return q`
      <ha-icon
        icon="${us(i,this.config.customize)}"
      >
      </ha-icon>
      ...
      >
        ${ba(this.schedule,this.config.display_options.primary_info,this.hass,this.config.customize)}
        <div class="secondary">
        ${ba(this.schedule,this.config.display_options.secondary_info,this.hass,this.config.customize)}
        </div>
      </div>
      <div class="state">
        <ha-entity-toggle
    ...
    `}};t([de()],Is.prototype,"hass",void 0),t([de()],Is.prototype,"schedule_id",void 0),t([de()],Is.prototype,"schedule",void 0),t([de()],Is.prototype,"config",void 0),Is=t([re("scheduler-item-row")],Is),e.SchedulerCard=class extends oe{constructor(){super(...arguments),this._config=qe,this.showDiscovered=!1,this.translationsLoaded=!1}setConfig(e){e=(e=>{let t=[];if(Ve(e,"include")&&!We(e.include)&&t.push("'include' must be a list of strings"),Ve(e,"exclude")&&!We(e.exclude)&&t.push("'exclude' must be a list of strings"),Ve(e,"discover_existing")&&!Fe(e.discover_existing)&&t.push("'discover_existing' must be a boolean"),!Ve(e,"title")||Fe(e.title)||Be(e.title)||t.push("'title' must be a boolean or string"),Ve(e,"show_header_toggle")&&!Fe(e.show_header_toggle)&&t.push("'show_header_toggle' must be a boolean"),Ve(e,"show_add_button")&&!Fe(e.show_add_button)&&t.push("'show_add_button' must be a boolean"),Ve(e,"display_options")&&(Ue(e.display_options)?(!Ve(e.display_options,"primary_info")||Be(e.display_options.primary_info)||We(e.display_options.primary_info)||t.push("in 'display_options': 'primary_info' must be a string or list of strings"),!Ve(e.display_options,"secondary_info")||Be(e.display_options.secondary_info)||We(e.display_options.secondary_info)||t.push("in 'display_options': 'secondary_info' must be a string or list of strings"),Ve(e.display_options,"icon")&&!Be(e.display_options.icon)&&t.push("in 'display_options': 'icon' must be a string ")):t.push("'display_options' must be a struct")),!Ve(e,"sort_by")||Be(e.sort_by)||We(e.sort_by)||t.push("'sort_by' must be a string or list of strings"),Ve(e,"customize")&&!Ue(e.customize)&&t.push("'customize' must be a struct"),!Ve(e,"tags")||Be(e.tags)||We(e.tags)||t.push("'tags' must be a string or list of strings"),!Ve(e,"exclude_tags")||Be(e.tags)||We(e.tags)||t.push("'exclude_tags' must be a string or list of strings"),t.length)throw new Error(`Invalid configuration provided (${t.length} error${t.length>1?"s":""}): ${t.join(", ")}.`);return e})(e),this._config=Object.assign(Object.assign({},qe),e)}firstUpdated(){(async()=>{await(async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider")&&customElements.get("ha-combo-box"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.automation.load()})()})();document.querySelector("home-assistant")._loadFragmentTranslations(this.hass.language,"config")}willUpdate(){this.hass.loadBackendTranslation("services")}__checkSubscribed(){void 0===this.__unsubs&&this.isConnected&&void 0!==this.hass&&(this.__unsubs=this.hassSubscribe())}connectedCallback(){super.connectedCallback(),this.__checkSubscribed()}disconnectedCallback(){if(super.disconnectedCallback(),this.__unsubs){for(;this.__unsubs.length;){const e=this.__unsubs.pop();e instanceof Promise?e.then(e=>e()):e()}this.__unsubs=void 0}}updated(e){super.updated(e),e.has("hass")&&this.__checkSubscribed()}hassSubscribe(){return this.loadSchedules(),[this.hass.connection.subscribeMessage(e=>this.handleScheduleItemUpdated(e),{type:"scheduler_updated"})]}shouldUpdate(e){const t=e.get("hass"),i=e.get("_config");if(i&&this._config){Object.keys(i).filter(e=>i[e]!==this._config[e]).some(e=>["tags","discover_existing","sort_by","display_options"].includes(e))&&(async()=>{await this.loadSchedules()})()}return!this.translationsLoaded&&ea("component.input_boolean.services.turn_on.name",this.hass,!1).length&&ea("ui.panel.config.automation.editor.conditions.type.sun.sunrise",this.hass,!1).length?(this.translationsLoaded=!0,!0):!t||1!=e.size||!this.schedules||Object.values(this.schedules).some(e=>JSON.stringify(t.states[e.entity_id])!==JSON.stringify(this.hass.states[e.entity_id]))}render(){let e=Object.assign({},this.schedules),t=Object.keys(this.schedules||{}).filter(t=>Yi(e[t],this._config));const i=Object.entries(e).filter(([e])=>!!this.showDiscovered||t.includes(e)).some(([,e])=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")});return q`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${this._config.title?"string"==typeof this._config.title?this._config.title:Wi("ui.panel.common.title",this.hass):""}
          </div>
      ...
      ${Object.keys(e).length>t.length?this.showDiscovered?q`
          ...
          ${Object.keys(e).filter(e=>!t.includes(e)).map(e=>q`
              ...
              <div>
                ...
                >
                  ${Wi("ui.panel.overview.hide_excluded",this.hass)}
                </ha-button>
              </div>
            `:q`
              <div>
                ...
                >
                  +
                  ${Wi("ui.panel.overview.excluded_items",this.hass,"{number}",Object.keys(e).length-t.length)}
                </ha-button>
              </div>
            `:""}
        </div>
    ...
    `}async loadSchedules(){var e;(e=this.hass,e.callWS({type:"scheduler"}).then(e=>Object.fromEntries(e.map(e=>[e.schedule_id,je(e)])))).then(e=>{this.schedules=fa(e,this._config,this.hass),Object.values(e).every(e=>Yi(e,this._config))}).catch(e=>{this.schedules={}})}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?ka(this.hass,e.schedule_id).then(t=>{const i=this.schedules[e.schedule_id];let a=Object.assign({},this.schedules);t&&(this._config.discover_existing||Yi(t,this._config))?a=i?i.timestamps[i.next_entries[0]||0]==t.timestamps[t.next_entries[0]||0]?Object.assign(Object.assign({},a),{[e.schedule_id]:t}):fa(Object.assign(Object.assign({},a),{[e.schedule_id]:t}),this._config,this.hass):fa(Object.assign(Object.assign({},a),{[e.schedule_id]:t}),this._config,this.hass):i&&(a=Object.fromEntries(Object.entries(a).filter(([t])=>t!=e.schedule_id))),this.schedules=Object.assign({},a)}):this.schedules=Object.fromEntries(Object.entries(this.schedules||{}).filter(([t])=>t!==e.schedule_id))}_handleEditClick(e){if(!this.schedules)return;const t=e.detail.schedule_id,i={schedule:Ne(this.schedules[t],this.hass),cardConfig:this._config,editItem:t};wa(e.target,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return Ts})),dialogParams:i})}_addClick(e){const t=[this._config.tags||[]].flat().filter(e=>!["none","disabled","enabled"].includes(e));let i=JSON.parse(JSON.stringify(He));const a={schedule:Object.assign(Object.assign({},i),{tags:1==t.length?t:[]}),cardConfig:this._config};wa(this,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return Ts})),dialogParams:a})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked;Object.values(this.schedules).filter(e=>this.showDiscovered||Yi(e,this._config)).forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}static getConfigElement(){return document.createElement("scheduler-card-editor")}},e.SchedulerCard.styles=r`
    .card-header {
      display: flex;
      justify-content: space-between;
    }
