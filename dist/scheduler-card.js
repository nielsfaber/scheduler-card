...
/**
    ...
    `:q``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("mwc-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_toggleSelectEntity(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;t.querySelector("ha-checkbox");const i=t.getAttribute("key");this._params.entities.includes(i)?this._params={...this._params,entities:this._params.entities.filter(e=>e!=i)}:this._params={...this._params,entities:[...this._params.entities,i]}}_toggleSelectDomain(e){var t;let i=e.target;for(;"MWC-LIST-ITEM"!=i.tagName;)i=i.parentElement;const a=i.getAttribute("key"),s=null===(t=this.options)||void 0===t?void 0:t.find(e=>e.key==a).entities.map(e=>e.key);this._params.domains.includes(a)?this._params={...this._params,domains:this._params.domains.filter(e=>e!=a),entities:this._params.entities.filter(e=>!(null==s?void 0:s.includes(e)))}:this._params={...this._params,domains:[...this._params.domains,a]},e.stopPropagation()}closeGroupByKey(e){this.shadowRoot.querySelector("mwc-list").childNodes.forEach(t=>{if(t.nodeType==Node.ELEMENT_NODE&&"MWC-LIST-ITEM"==t.tagName&&t.getAttribute("key")==e){const e=t,i=e.nextElementSibling,a=e.querySelector("ha-icon-button");i.style.height="0px",e.removeAttribute("expanded"),a.classList.remove("expanded")}})}async _toggleExpandGroup(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;const i=t.querySelector("ha-icon-button"),a=t.getAttribute("key");this.expandedGroups.includes(a)||(this.expandedGroups.forEach(e=>this.closeGroupByKey(e)),this.expandedGroups=[a],await this.requestUpdate());const s=t.nextElementSibling,o=s.scrollHeight;t.hasAttribute("expanded")?(t.removeAttribute("expanded"),i.classList.remove("expanded"),s.style.height="0px",setTimeout(()=>{this.expandedGroups=this.expandedGroups.filter(e=>e!=a)},300)):(t.setAttribute("expanded","true"),i.classList.add("expanded"),s.style.height=`${o}px`)}_renderOptions(){if(!this.options)return;let e=[...this.options];const t=this._filter&&this._filter.trim().length;if(t){const t=this._filter.toLowerCase().trim().split(" ");e=e.map(e=>Ja(e,t)||(e={...e,entities:(e.entities||[]).filter(e=>Ja(e,t))}).entities.length?e:void 0).filter(e=>void 0!==e)}return e.length?Object.keys(e).map(i=>{var a,s;const o=e[i].key,n=null===(a=this._params)||void 0===a?void 0:a.domains.includes(o);let r=[...e[i].entities];"switch"==o&&(r=r.filter(e=>!this.scheduleEntities.includes(e.key)));const l=n?r.length:r.filter(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)}).length;return q`
        <mwc-list-item graphic="icon" twoline hasMeta @click=${this._toggleExpandGroup} key="${o}">
          ...
          <span>${e[i].name}</span>
          <span slot="secondary"
            >${qi("ui.panel.card_editor.fields.entities.included_number",this.hass,["{number}","{total}"],[l,r.length])}</span
          >
        </mwc-list-item>
    ...
    `}};t([de({attribute:!1})],Xa.prototype,"hass",void 0),t([de({type:String})],Xa.prototype,"icon",void 0),t([de({type:Boolean})],Xa.prototype,"useStateIcon",void 0),t([de({type:Boolean})],Xa.prototype,"selectable",void 0),t([de({type:Boolean})],Xa.prototype,"removable",void 0),t([de({type:Boolean})],Xa.prototype,"toggleable",void 0),t([de({type:Boolean})],Xa.prototype,"active",void 0),t([de({type:String})],Xa.prototype,"badge",void 0),t([de({type:String})],Xa.prototype,"value",void 0),t([de({type:Boolean})],Xa.prototype,"disabled",void 0),Xa=t([re("scheduler-chip")],Xa);let es=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?q` ${Object.values(this.items).map(e=>this.renderChipitem(e))} `:q``}renderChipitem(e){const t=e.useStateIcon&&!Object.keys(this.hass.states).includes(e.value||"");return q`
      <scheduler-chip
        .hass=${this.hass}
    ...
    `}get _value(){return this.value||""}_renderHelper(){return this.helper?q`<ha-input-helper-text .disabled=${this.disabled}>${this.helper}</ha-input-helper-text>`:V}_valueChanged(e){var t;e.stopPropagation(),this._comboBox.setTextFieldValue("");const i=null===(t=e.detail.value)||void 0===t?void 0:t.trim();i!==ts&&(this._items.find(e=>e.id==i)||this.allowCustomValue)&&i!==this._value&&this._setValue(i)}_filterChanged(e){if(!this._opened)return;let t=this._items;const i=e.target,a=e.detail.value.trim().split(" ").map(String).filter(e=>e.length).map(e=>e.trim());a.length&&(t=t.filter(e=>a.every(t=>{var i;return e.primary.includes(t)||(null===(i=e.secondary)||void 0===i?void 0:i.includes(t))}))),i.filteredItems=t}_clear(e){e.stopPropagation(),this._setValue(void 0)}_setValue(e){this.value=e,$a(this,"value-changed",{value:e})}async focus(){var e;await this.updateComplete,await(null===(e=this._comboBox)||void 0===e?void 0:e.focus())}async open(){var e;this._opened=!0,this._isOpening=!0,await this.updateComplete,null===(e=this._comboBox)||void 0===e||e.focus(),this._comboBox.open(),this._comboBox.value=""}async _openedChanged(e){var t;const i=e.detail.value;e.stopPropagation(),this._isOpening?this._isOpening=!1:this._opened&&!i&&(this._opened=!1,await this.updateComplete,null===(t=this._field)||void 0===t||t.focus())}static get styles(){return[r`
      ...
      `]}};t([de({attribute:!1})],is.prototype,"hass",void 0),t([de({type:Boolean})],is.prototype,"autofocus",void 0),t([de({type:Boolean})],is.prototype,"disabled",void 0),t([de({type:Boolean,attribute:"allow-custom-value"})],is.prototype,"allowCustomValue",void 0),t([de()],is.prototype,"label",void 0),t([de()],is.prototype,"value",void 0),t([de()],is.prototype,"helper",void 0),t([de()],is.prototype,"placeholder",void 0),t([de({type:String,attribute:"search-label"})],is.prototype,"searchLabel",void 0),t([de({attribute:"hide-clear-icon",type:Boolean})],is.prototype,"hideClearIcon",void 0),t([de({attribute:!1,type:Array})],is.prototype,"getItems",void 0),t([de({attribute:!1,type:Array})],is.prototype,"getAdditionalItems",void 0),t([de({attribute:!1})],is.prototype,"rowRenderer",void 0),t([de({attribute:!1})],is.prototype,"valueRenderer",void 0),t([de({attribute:"not-found-label",type:String})],is.prototype,"notFoundLabel",void 0),t([he(".textInput")],is.prototype,"_field",void 0),t([he("ha-combo-box")],is.prototype,"_comboBox",void 0),t([ce()],is.prototype,"_opened",void 0),is=t([re("scheduler-picker")],is);let as=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this.multipleMode=!1,this.scheduleEntities=[],this._valueRenderer=e=>{Array.isArray(e)&&(e=e.length?[...e].pop():"");const t=e||"",i=this.hass.states[t];if(!i)return q`
  ...
  `,t([de({attribute:!1})],as.prototype,"hass",void 0),t([de()],as.prototype,"domain",void 0),t([de()],as.prototype,"config",void 0),t([de({type:Array})],as.prototype,"value",void 0),t([de({type:Boolean})],as.prototype,"multiple",void 0),t([de({type:Boolean})],as.prototype,"disabled",void 0),t([ce()],as.prototype,"multipleMode",void 0),t([ce()],as.prototype,"scheduleEntities",void 0),as=t([re("scheduler-entity-picker")],as);let ss=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
      <div
  ...
  `,t([de({attribute:!1})],rs.prototype,"hass",void 0),t([de()],rs.prototype,"_config",void 0),t([de()],rs.prototype,"title",void 0),t([de()],rs.prototype,"tagOptions",void 0),rs=t([re("scheduler-card-editor")],rs);const ls=r`
  ha-dialog {
...
`;const ds=(e,t,i,a)=>{var s;const o=e.service,n=null===(s=e.target)||void 0===s?void 0:s.entity_id,r=Xi(e,a);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const l=r.fields[t];if(null===sa(o,n,t,i,a))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(l.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&l.supported_features)>0}))return!1}return!("light"==Vi(o)&&![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;const a=i.states[e].attributes.supported_color_modes||[];return"brightness"!=t||a.filter(e=>"onoff"!=e).length}))};var cs;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(cs||(cs={}));const us=(e,t,i)=>{let a=[];a=[...a,...e.entries.map(e=>((e,t)=>{const i=e.every((i,a)=>{const s=Te(i.start,t),o=void 0===i.stop?s:Te(i.stop,t)||86400;return!(s>o)&&e.every((e,i)=>i<=a||Te(e.start,t)>=o)});return i?null:cs.OverlappingTime})(e.slots,t)).filter(e=>null!==e)];let s=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return s.length||(a=[...a,cs.MissingAction]),a=[...a,...s.map(e=>((e,t,i)=>{var a;const s=Xi(e,i);return(null==s?void 0:s.target)&&!(null===(a=e.target)||void 0===a?void 0:a.entity_id)?cs.MissingTargetEntity:(null==s?void 0:s.fields)&&!Object.entries(s.fields).filter(([a])=>ds(e,a,t,i)).every(([a,s])=>{var o,n;let r=sa(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,a,t,i);const l=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||s.optional;return!(!Object.keys(e.service_data).includes(a)&&!l||!Ke(e.service_data[a])&&!l)})?cs.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],a.length?a.shift():null},hs=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;e={...e,entries:e.entries.map(e=>({...e,slots:e.slots.map(t).filter(e=>null!==e)}))};let i={weekdays:e.entries[0].weekdays.map(ms),timeslots:e.entries[0].slots.map(ps),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i={...i,schedule_id:e.schedule_id}),i},ms=e=>{switch(e){case ge.Monday:return"mon";case ge.Tuesday:return"tue";case ge.Wednesday:return"wed";case ge.Thursday:return"thu";case ge.Friday:return"fri";case ge.Saturday:return"sat";case ge.Sunday:return"sun";case ge.Workday:return"workday";case ge.Weekend:return"weekend";default:return"daily"}},ps=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>_s(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ve.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),_s=e=>{var t,i;const a=e=>Object.keys(e).filter(t=>Ke(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){let t=null==e?void 0:e.target.entity_id.map(t=>({service:e.service,service_data:a(e.service_data),entity_id:t}));return t}return{service:e.service,service_data:a(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:a(e.service_data)}},gs=(e,t,i)=>{const a={title:Zi("state_badge.default.error",i),description:q`
    ...
    `}renderTimebar(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=[1,2,3,4,6,8,12],i=Le(this.hass.locale),a=i?130:100;let s=Math.ceil(24/(e/a));for(;!t.includes(s);)s++;const o=[0,...Array.from(Array(24/s-1).keys()).map(e=>(e+1)*s),24];return o.map((e,t)=>{let a=s/24*100;a=Math.floor(100*a)/100;const n={mode:we.Fixed,hours:e,minutes:0};return 0==t?q`
        ...
        `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,a)=>{const s=Te(i.start,this.hass);let o=Te(i.stop||i.start,this.hass);!o&&s&&(o=$s);const n=(o-s)/$s*100,r=i.actions.length?ha(i.actions[0],this.hass,this.config.customize,!0,!0):"",l=parseFloat(getComputedStyle(this).getPropertyValue("width")),d=5*r.length+10,c=a>0?15:0,u=a<e.length-1?15:0,h=n*l/100-c-u,m=e[a+1];return q`
        <div
        ...
        >
          ${i.stop,""}
          ${i.actions.length?r&&(h>d/3||h>50)&&h>30?q`<span style="margin-left: ${c}px; margin-right: ${u}px">${r}</span>`:h>16?q`<ha-icon icon="${ys(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return V;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=we.Fixed&&(e=zs(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return q`
      ...
      `}}_renderSuffix(){if(this.large){const e=()=>{const e=Pe(this.hours).am_pm,t=Pe(this.hours).hours;this.hours=Ne(t,"AM"==e?Ie.PM:Ie.AM),this._valueChanged()},t=()=>{0!=this.hours?this.hours=-this.hours:this.minutes=-this.minutes,this._valueChanged()},i=()=>{this.mode=this.mode==we.Sunrise?we.Sunset:we.Sunrise,this._valueChanged()};return q`
        <div class="suffix">
          ${this.useAmPm&&this.mode==we.Fixed?q`
                <ha-button appearance="plain" @click=${e}>
                  <span class="large"> ${Pe(this.hours).am_pm==Ie.AM?"AM":"PM"} </span>
                </ha-button>
              `:V}
      ...
      `}return this.useAmPm&&this.mode==we.Fixed?q`
        <ha-select
          .required=${this.required}
          .value=${Pe(this.hours).am_pm==Ie.AM?"AM":"PM"}
          .disabled=${this.disabled}
          name="amPm"
          naturalMenuWidth
          fixedMenuPosition
      ...
      `:V}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=we.Fixed||this.mode==we.Fixed){const a=xs({hours:this.hours,minutes:this.minutes},t),s=xs({hours:this.hours,minutes:this.minutes},i),o=60*a.hours+a.minutes,n=60*s.hours+s.minutes,r=e||(Math.abs(o)<=Math.abs(n)?we.Sunrise:we.Sunset),l=r==we.Sunrise?a:s;return{mode:r,hours:l.hours,minutes:l.minutes}}{let e=this.mode==we.Sunrise?Oe(t):Oe(i);return e=Ae(e,{hours:this.hours,minutes:this.minutes}),{mode:we.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Pe(this.hours).am_pm;t=Ne(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.target.value;if(Pe(this.hours).am_pm==t)return;const i=Pe(this.hours).hours;this.hours=Ne(i,"AM"==t?Ie.AM:Ie.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=Ae(t,e),this.mode!=we.Fixed&&(t=zs(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};$a(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0,t=this.useAmPm&&this.mode==we.Fixed?Pe(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==we.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};Ss.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([de({attribute:!1})],Ss.prototype,"hass",void 0),t([ce()],Ss.prototype,"hours",void 0),t([ce()],Ss.prototype,"minutes",void 0),t([ce()],Ss.prototype,"mode",void 0),t([de({type:Boolean})],Ss.prototype,"autoValidate",void 0),t([de({type:Boolean})],Ss.prototype,"required",void 0),t([de({type:Boolean})],Ss.prototype,"disabled",void 0),t([de({type:String})],Ss.prototype,"label",void 0),t([de({type:Boolean})],Ss.prototype,"useAmPm",void 0),t([de({type:Boolean})],Ss.prototype,"large",void 0),t([de({attribute:!1})],Ss.prototype,"stepSize",void 0),Ss=t([re("scheduler-time-picker")],Ss);const Cs="Custom";let As=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![ge.Daily,ge.Weekend,ge.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
    ...
    `}};t([de({attribute:!1})],Ms.prototype,"hass",void 0),t([ce()],Ms.prototype,"_params",void 0),t([ce()],Ms.prototype,"_search",void 0),t([ce()],Ms.prototype,"_filter",void 0),t([ce()],Ms.prototype,"_width",void 0),t([ce()],Ms.prototype,"_height",void 0),t([ce()],Ms.prototype,"lockDomain",void 0),Ms=t([re("dialog-select-action")],Ms);var Ls=Object.freeze({__proto__:null,get DialogSelectAction(){return Ms}});let Is=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return q`
      ${this.showPrefix?q`
    ...
    `}};t([de({type:Boolean})],Is.prototype,"showPrefix",void 0),Is=t([re("scheduler-settings-row")],Is);let Ps=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this.large=!1,this.selectedEntry=0}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return q`
    ...
    `}_renderActionConfig(){var e,t,i,a;const s={...this.schedule.entries[this.selectedEntry].slots[this.selectedSlot]},o=s.actions.length?s.actions[0]:void 0;if(!o)return q`
      ...
      `;const n=Xi(o,this.config.customize),r=(null===(e=n.target)||void 0===e?void 0:e.domain)||Vi(o.service),l=Ke(null===(t=null==n?void 0:n.target)||void 0===t?void 0:t.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&Ke(null===(i=null===(t=Xi(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return q``;const d=Object.keys(n.fields||{}).filter(e=>ds(o,e,this.hass,this.config.customize));let c="",u=[(null===(i=o.target)||void 0===i?void 0:i.entity_id)||[]].flat();return!u.length&&["notify","script"].includes(r)&&(u=[o.service]),u.length&&(c+=u.map(e=>fa(e,this.hass,this.config.customize)).join(", "),c+=": "),c+=ha(o,this.hass,this.config.customize,!1,!0),q`
      <scheduler-collapsible-section ?expanded=${!0} ?disabled=${!0}>
        ...
        <div slot="content">
          ${n.target?q`
              ...
              `:""}
          ${d.map(e=>{var t;const i=sa(o.service,null===(t=o.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";const a=n.fields[e].optional||(i.number||{}).optional,s=!a||Object.keys(o.service_data).includes(e);return q`
              <scheduler-settings-row ?showPrefix=${a}>
                ${a?q`
                    ...
                    `:""}
                <span slot="heading"> ${((e,t,i,a)=>{var s;const o=Vi(e.service),n=Ri(e.service);let r=Zi(`component.${o}.services.${n}.fields.${t}.name`,i,!1);!r&&i.services[o]&&i.services[o][e.service]&&i.services[o][e.service].fields&&i.services[o][e.service].fields[t]&&(r=String(i.services[o][e.service].fields[t].name));const l=["script","notify"].includes(o)?[e.service]:[(null===(s=e.target)||void 0===s?void 0:s.entity_id)||[]].flat();let d=Qi(a||{},l.length?l[0]:o);if(d.length){let i=d.map(i=>i.service==e.service&&Object.keys(i.variables||{}).includes(t)?(i.variables||{})[t].name:null).filter(e=>void 0!==e);if(i.length)return i[0]}return r||(r=t.replace(/_/g," ")),r})(o,e,this.hass,this.config.customize)} </span>
                <scheduler-combo-selector
                  .hass=${this.hass}
                  .config=${i}
                  ?disabled=${!s}
    ...
    `}};t([de({attribute:!1})],Bs.prototype,"hass",void 0),t([de({attribute:!1})],Bs.prototype,"config",void 0),t([ce()],Bs.prototype,"schedule",void 0),t([ce()],Bs.prototype,"conditionIdx",void 0),t([ce()],Bs.prototype,"selectedDomain",void 0),t([ce()],Bs.prototype,"selectedEntity",void 0),t([ce()],Bs.prototype,"selectedMatchType",void 0),t([ce()],Bs.prototype,"conditionValue",void 0),t([ce()],Bs.prototype,"conditionValid",void 0),t([ce()],Bs.prototype,"startDate",void 0),t([ce()],Bs.prototype,"endDate",void 0),t([de()],Bs.prototype,"tags",void 0),Bs=t([re("scheduler-options-panel")],Bs);let Ws=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          <ha-icon-button
            slot="navigationIcon"
