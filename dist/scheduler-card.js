...
const wa=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}{constructor(e){var t;if(super(e),e.type!==ka||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`},"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ht){this.ht=new Set;for(const e in t)this.ht.add(e);return this.render(t)}this.ht.forEach(e=>{null==t[e]&&(this.ht.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")});for(const e in t){const a=t[e];if(null!=a){this.ht.add(e);const t="string"==typeof a&&a.endsWith(" !important");e.includes("-")||t?i.setProperty(e,t?a.slice(0,-11):a,t?"important":""):i[e]=a}}return N}}),xa=["alarm_control_panel","binary_sensor","climate","calendar","cover","device_tracker","fan","humidifier","input_boolean","input_number","input_select","light","lock","number","person","proximity","select","sensor","sun","switch","timer","water_heater"],$a=(e,t)=>{const i=Object.keys(t.states).includes(e)?t.states[e]:void 0,a=Zi(e),s=(null==i?void 0:i.attributes)||{};switch(a){case"alarm_control_panel":let e=["disarmed","triggered"];return 2&(s.supported_features||0)&&(e=[...e,"armed_away"]),1&(s.supported_features||0)&&(e=[...e,"armed_home"]),4&(s.supported_features||0)&&(e=[...e,"armed_night"]),16&(s.supported_features||0)&&(e=[...e,"armed_custom_bypass"]),32&(s.supported_features||0)&&(e=[...e,"armed_vacation"]),ta({options:e,translation_key:"component.${domain}.entity_component._.state.${value}"});case"binary_sensor":return ta({options:["on","off"],translation_key:"component.${domain}.entity_component.${deviceClass}.state.${value}"});case"climate":return ta({options:s.hvac_modes,translation_key:"component.${domain}.entity_component._.state.${value}"});case"calendar":case"fan":case"humidifier":case"input_boolean":case"light":case"switch":return ta({options:["on","off"],translation_key:"component.${domain}.entity_component._.state.${value}"});case"cover":return ta({options:["open","closed"],translation_key:"component.${domain}.entity_component._.state.${value}"});case"device_tracker":return ta({options:["home","not_home"],translation_key:"component.${domain}.entity_component._.state.${value}"});case"input_number":case"number":return ia({min:s.min,max:s.max,step:s.step,mode:s.mode,unit_of_measurement:s.unit_of_measurement});case"input_select":case"select":return ta({options:s.options});case"lock":return ta({options:["locked","unlocked"],translation_key:"component.${domain}.entity_component._.state.${value}"});case"person":const a=Object.keys(t.states).filter(e=>"zone"==Zi(e)).map(Wi);return ta({options:[...new Set(["home","not_home",...a])]});case"proximity":return ia({mode:"box",unit_of_measurement:s.unit_of_measurement});case"sensor":return isNaN(Number(null==i?void 0:i.state))?{text:{}}:ia({mode:"box",unit_of_measurement:s.unit_of_measurement});case"sun":return ta({options:["above_horizon","below_horizon"],translation_key:"component.${domain}.entity_component._.state.${value}"});case"timer":return ta({options:["active","paused","idle"],translation_key:"component.${domain}.entity_component._.state.${value}"});case"water_heater":case"climate":return ta({options:s.operation_list,translation_key:"component.${domain}.entity_component._.state.${value}"});default:return{text:{}}}},ja=e=>xa.includes(e),Oa=(e,t)=>{let i=Object.keys(e.states).map(e=>Zi(e)).reduce((e,t)=>e.includes(t)?e:[...e,t],[]).filter(ja);return i=i.filter(e=>((t.include||[]).some(t=>Ji(t,e))||Object.keys(t.customize||{}).some(t=>Ji(t,e)))&&!(t.exclude||[]).some(t=>Ji(t,e))),i.map(t=>Object({key:t,name:e.localize(`component.${t}.title`)||t.replace(/_/g," "),description:"",icon:fa(t)}))},za=(e,t)=>{if(!Object.keys(t.states).includes(e))return"mdi:help";const i=t.states[e];if(i.attributes.icon)return i.attributes.icon;const a=Zi(e);return fa(a)},Aa=e=>{let t=ba(e,{include:["*"]}),i=Oa(e,{include:["*"]});return i=i.filter(e=>!t.map(e=>e.key).includes(e.key)),[...t,...i]},Sa=(e,t)=>{if(["script","notify"].includes(e)){return Object.keys(t.services[e]).map(i=>{var a;return Object({key:`${e}.${i}`,name:t.states[`${e}.${i}`]?Ki(`${e}.${i}`,null===(a=t.states[`${e}.${i}`])||void 0===a?void 0:a.attributes):t.services[e][i].name,description:"",icon:t.states[`${e}.${i}`]?za(`${e}.${i}`,t):fa(e)})})}return Object.keys(t.states).filter(t=>Zi(t)==e).map(e=>{var i;return Object({key:e,name:Ki(e,null===(i=t.states[e])||void 0===i?void 0:i.attributes),description:"",icon:za(e,t)})})};let Ca=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0}async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.confirm({domains:this._params.domains,entities:this._params.entities}),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}render(){return this._params?R`
        ...
        <div slot="heading">
          <ha-dialog-header>
            ...
            <span slot="title">
              ...
              ${this.selectedDomain?R`
                - 
                ${Aa(this.hass).find(e=>e.key==this.selectedDomain).name}
              `:""}
            </span>
          </ha-dialog-header>
    ...
    `})}{let e=Aa(this.hass);return e.sort((e,t)=>Yi(e.name,t.name)),this._filter&&(e=e.filter(e=>{const t=this._filter.toLowerCase().trim().split(" ");return t.every(t=>e.name.toLowerCase().includes(t))||t.every(t=>e.key.toLowerCase().includes(t))})),Object.keys(e).map(t=>{var i,a;const s=e[t].key,o=Sa(s,this.hass),n=null===(i=this._params)||void 0===i?void 0:i.domains.includes(s);return R`
      <mwc-list-item
        graphic="icon"
        hasMeta
  ...
  `})}}toggleIncludeDomain(e,t){var i;e.stopImmediatePropagation(),(null===(i=this._params)||void 0===i?void 0:i.domains.includes(t))?this._params=Object.assign(Object.assign({},this._params),{domains:this._params.domains.filter(e=>e!=t)}):this._params=Object.assign(Object.assign({},this._params),{domains:[...this._params.domains,t]})}toggleIncludeEntity(e){var t;(null===(t=this._params)||void 0===t?void 0:t.entities.includes(e))?this._params=Object.assign(Object.assign({},this._params),{entities:this._params.entities.filter(t=>t!=e)}):this._params=Object.assign(Object.assign({},this._params),{entities:[...this._params.entities,e]})}_toggleIncludeDomain(e,t){var i;e.stopImmediatePropagation(),(null===(i=this._params)||void 0===i?void 0:i.domains.includes(t))?this._params=Object.assign(Object.assign({},this._params),{domains:this._params.domains.filter(e=>e!=t)}):this._params=Object.assign(Object.assign({},this._params),{domains:[...this._params.domains,t]})}_handleDomainClick(e){this.selectedDomain=e,this._clearSearch()}_clearDomain(){this.selectedDomain=void 0,this._clearSearch()}_clearSearch(){this._search="",this._filter=""}static get styles(){return r`
    ...
    `}};t([de({attribute:!1})],Ca.prototype,"hass",void 0),t([ce()],Ca.prototype,"_params",void 0),t([ce()],Ca.prototype,"_search",void 0),t([ce()],Ca.prototype,"_filter",void 0),t([ce()],Ca.prototype,"_width",void 0),t([ce()],Ca.prototype,"_height",void 0),t([ce()],Ca.prototype,"selectedDomain",void 0),Ca=t([re("dialog-select-entities")],Ca);var Ea=Object.freeze({__proto__:null,get DialogSelectEntities(){return Ca}});let Ta=class extends oe{constructor(){super(...arguments),this.valueMultiple=[],this.multiple=!1,this.allowMultiple=!1,this.initialValue="",this.rowRenderer=e=>R`
    ...
    `}renderChips(){if(!this.multiple)return R``;return R`
      <div class="chips">
        ...
        <div class="chip">
          ...
          <ha-icon icon="mdi:close" @click=${()=>this._removeValue(e)} ></ha-icon>
        </div>
      `})}
      </div>
    `}_filterChanged(e){this._filter=e.detail.value.toLowerCase()}_valueChanged(e){let t=e.detail.value;if(this.multiple){if(!t)return;this.valueMultiple=[...this.valueMultiple,t],e.target.setInputValue(void 0),pa(this,"value-changed",{value:this.valueMultiple})}else this.value=t,pa(this,"value-changed",{value:this.value});e.stopPropagation()}_toggleMultiple(){this.multiple?(this.multiple=!1,this.value=this.valueMultiple.shift(),this.valueMultiple=[]):(this.multiple=!0,this.valueMultiple=[this.value],this.value=void 0)}};Ta.styles=r`
    div.chip {
      height: 32px;
      border-radius: 16px;
  ...
  `,t([de({attribute:!1})],Ta.prototype,"hass",void 0),t([de()],Ta.prototype,"domain",void 0),t([de()],Ta.prototype,"config",void 0),t([ce()],Ta.prototype,"_filter",void 0),t([de()],Ta.prototype,"value",void 0),t([de()],Ta.prototype,"valueMultiple",void 0),t([de()],Ta.prototype,"multiple",void 0),t([de()],Ta.prototype,"allowMultiple",void 0),t([de()],Ta.prototype,"initialValue",void 0),Ta=t([re("scheduler-entity-picker")],Ta);let Da=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return R`
      <div
    ...
    `}};t([de({type:Boolean,reflect:!0})],Da.prototype,"expanded",void 0),t([de({type:Boolean,reflect:!0})],Da.prototype,"disabled",void 0),t([de({type:CustomEvent})],Da.prototype,"openClose",void 0),Da=t([re("collapsible-section")],Da);let Ma=class extends oe{set openedItem(e){e!==this._openedItem&&void 0!==e&&setTimeout(()=>{this.updateOpenedItem(e)},50)}constructor(){super(),this.disabled=!1,this._openedItem=-1,this._numItems=0,this.addEventListener("open-close",this.toggleActiveSection)}firstUpdated(){const e=this.querySelectorAll("collapsible-section");this._numItems=e.length}toggleActiveSection(e){if(this.disabled)return;const t=e.target,i=this.querySelectorAll("collapsible-section");let a=-1;i.forEach((function(e,i){e!==t||e.getAttribute("expanded")||(a=i)})),this.updateOpenedItem(a)}updateOpenedItem(e){this.querySelectorAll("collapsible-section").forEach((function(t,i){i!=e&&t.getAttribute("expanded")?t.removeAttribute("expanded"):i!=e||t.getAttribute("expanded")||t.setAttribute("expanded","true")})),this._openedItem=e;const t=new CustomEvent("openclose-changed",{detail:{item:e}});this.dispatchEvent(t)}render(){return R`
      <slot></slot>
    `}};t([de()],Ma.prototype,"disabled",void 0),t([ce()],Ma.prototype,"_openedItem",void 0),t([ce()],Ma.prototype,"_numItems",void 0),Ma=t([re("collapsible-group")],Ma);let Pa=class extends oe{constructor(){super(...arguments),this.disabled=!1,this.rowRenderer=e=>R`
      <mwc-list-item>
        <span>${e.label}</span>
      </mwc-list-item>
    `}render(){if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{this.value=t.filter(t=>t!=e),pa(this,"value-changed",{value:this.value})},a=()=>t.map(e=>R`
            <div class="chip">
              <span class="label">${e}</span>
              <ha-icon icon="mdi:close" @click=${()=>i(e)}></ha-icon>
            </div>
          `),s=()=>{let i=[...null==e?void 0:e.options];Array.isArray(this.value)&&(i=i.filter(e=>"object"==typeof e?!t.includes(e.value):!t.includes(e)));const a=e=>{var t;const i=null===(t=this.config.select)||void 0===t?void 0:t.translation_key;let a="";return i&&(a=this.hass.localize(i.replace("${value}",e))),a||(a=e),a};return i.map(e=>"object"==typeof e?e:Object({value:e,label:a(e)}))};return R`
        ${e.multiple?R`
          <div class="chips">
          ${a()}
          </div>
      ...
      `}if(this.config.number){const e=this.config.number;return R`
        ...
        <ha-slider
          ...
          .max=${e.max}
          .step=${e.step}
          .value=${this.value||e.min}
          @change=${this._valueChanged}
          ?disabled=${this.disabled}
        ></ha-slider>
        <span class="value">${this.value||e.min}${e.unit_of_measurement||""}</span>
        </div>
      `}if(this.config.text){this.config.text;return R`
          <ha-textfield
            ...
            ?disabled=${this.disabled}
          ></ha-textfield>      
      `}return R``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t],e.target.setInputValue("")}else if(e.detail){let t=e.detail.value;if(void 0===t)return;this.value=t}else this.value=e.target.value;pa(this,"value-changed",{value:this.value})}};Pa.styles=r`
      div.slider-wrapper {
        display: flex;
        flex-direction: row;
      }
  ...
  `,t([de({attribute:!1})],Pa.prototype,"hass",void 0),t([de({attribute:!1})],Pa.prototype,"config",void 0),t([de()],Pa.prototype,"value",void 0),t([de()],Pa.prototype,"disabled",void 0),Pa=t([re("combo-selector")],Pa);const La=e=>e.callWS({type:"scheduler/tags"});let qa=class extends oe{constructor(){super(...arguments),this._config=Ie,this.title="",this.tagOptions=[]}setConfig(e){this._config=Object.assign(Object.assign({},Ie),e)}async firstUpdated(){this.title="string"==typeof this._config.title?this._config.title:"";const e=(await La(this.hass)).map(e=>e.name);e.sort(Yi),this.tagOptions=e}render(){const e={select:{options:this.tagOptions,multiple:!0,custom_value:!0}};return R`
  ...
  `,t([de({attribute:!1})],qa.prototype,"hass",void 0),t([de()],qa.prototype,"_config",void 0),t([de()],qa.prototype,"title",void 0),t([de()],qa.prototype,"tagOptions",void 0),qa=t([re("scheduler-card-editor")],qa);const Ia=r`
  ha-dialog {
...
`;var Ra;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(Ra||(Ra={}));const Na=(e,t,i)=>{let a=[];a=[...a,...e.entries.map(e=>((e,t)=>e.every((i,a)=>{const s=Se(i.start,t),o=void 0===i.stop?s:Se(i.stop,t)||86400;return!(s>o)&&e.every((e,i)=>{if(i<=a)return!0;return Se(e.start,t)>=o})})?null:Ra.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let s=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return s.length||(a=[...a,Ra.MissingAction]),a=[...a,...s.map(e=>((e,t)=>{var i;const a=ea(e,t);return(null==a?void 0:a.target)&&!(null===(i=e.target)||void 0===i?void 0:i.entity_id)?Ra.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).every(([t,i])=>!(!Object.keys(e.service_data).includes(t)&&!i.optional))?Ra.MissingServiceParameter:null})(e,i)).filter(e=>null!==e)],a.length?a.shift():null},Ha=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(Va),timeslots:e.entries[0].slots.map(Ua),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},Va=e=>{switch(e){case he.Monday:return"mon";case he.Tuesday:return"tue";case he.Wednesday:return"wed";case he.Thursday:return"thu";case he.Friday:return"fri";case he.Saturday:return"sat";case he.Sunday:return"sun";case he.Workday:return"workday";case he.Weekend:return"weekend";default:return"daily"}},Ua=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>Fa(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==pe.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),Fa=e=>{var t,i;if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>Object({service:e.service,service_data:e.service_data,entity_id:t}))}return{service:e.service,service_data:e.service_data,entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}},Ba=(e,t,i)=>{const a={title:i.localize("state_badge.default.error"),description:R`
    <b>Something went wrong!</b><br />
    ${e.body.message}<br /><br />
    ${e.error}<br /><br />
    Please <a href="https://github.com/nielsfaber/scheduler-card/issues">report</a> the bug.
  `,primaryButtonLabel:i.localize("ui.dialogs.generic.ok"),confirm:()=>{},cancel:()=>{}};pa(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return hs})),dialogParams:a})},Wa=e=>{let t=e.locale.first_weekday;if(t&&"language"!=t)return Za.map(e=>e.toLowerCase()).findIndex(e=>e==t);if("weekInfo"in Intl.Locale.prototype)return new Intl.Locale(e.locale.language).weekInfo.firstDay%7;{const t="AEAFBHDJDZEGIQIRJOKWLYOMQASDSY".match(/../g),i="AGARASAUBDBRBSBTBWBZCACNCODMDOETGTGUHKHNIDILINJMJPKEKHKRLAMHMMMOMTMXMZNINPPAPEPHPKPRPTPYSASGSVTHTTTWUMUSVEVIWSYEZAZW".match(/../g),a=["ar","arq","arz","fa"],s="amasbndzengnguhehiidjajvkmknkolomhmlmrmtmyneomorpapssdsmsnsutatethtnurzhzu".match(/../g),o=e.locale.language.match(/^([a-z]{2,3})(?:-([a-z]{3})(?=$|-))?(?:-([a-z]{4})(?=$|-))?(?:-([a-z]{2}|\d{3})(?=$|-))?/i);return o[1]?i.includes(o[4])?0:t.includes(o[4])?6:1:s.includes(o[1])?0:a.includes(o[1])?6:1}},Za=[he.Sunday,he.Monday,he.Tuesday,he.Wednesday,he.Thursday,he.Friday,he.Saturday],Ka=(e,t,i)=>{const a=e=>{switch(e){case he.Daily:return Bi(`ui.components.date.day_types_${t}.daily`,i);case he.Workday:return Bi(`ui.components.date.day_types_${t}.workdays`,i);case he.Weekend:return Bi(`ui.components.date.day_types_${t}.weekend`,i);case he.Monday:case he.Tuesday:case he.Wednesday:case he.Thursday:case he.Friday:case he.Saturday:case he.Sunday:let a=new Date(2017,1,26),s=Za.findIndex(t=>t==e);return(()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1})()?(a.setDate(a.getDate()+s),a.toLocaleDateString(i.locale.language,{weekday:t})):Za[s];default:return""}},s=Wa(i);let o=((e,t)=>e.concat(e).slice(t,t+e.length))(Za,s);e.sort((e,t)=>o.findIndex(t=>t==e)-o.findIndex(e=>e==t));const n=e.filter(e=>o.includes(e)).map(e=>o.findIndex(t=>t==e)),r=(e=>{const t=[];for(let i=0;i<e.length-1;i++){let a=i+1;for(;e[a]-e[a-1]==1;)a++;t.push(a-i)}return t})(n),l=Math.max(...r);if(n.length){if(6==n.length){const e=[0,1,2,3,4,5,6].filter(e=>!n.includes(e)),t=a(o[e.pop()]);return Bi("ui.components.date.repeated_days_except",i,"{excludedDays}",t)}const e=n.map(e=>a(o[e]));if(n.length>=3&&l>=3){const t=r.reduce((e,t,i)=>t==l?i:e,0);e.splice(t,l,Bi("ui.components.date.days_range",i,["{startDay}","{endDay}"],[e[t],e[t+l-1]]))}const t=e.length>1?`${e.slice(0,-1).join(", ")} ${i.localize("ui.common.and")} ${e.pop()}`:""+e.pop();return n.length>=3&&l>=3?t:Bi("ui.components.date.repeated_days",i,"{days}",t)}return e.map(a).join(", ")},Ja={alarm_control_panel:{services:{alarm_arm_away:"mdi:shield-lock",alarm_arm_home:"mdi:shield-home",alarm_arm_night:"mdi:shield-moon",alarm_custom_bypass:"mdi:security",alarm_disarm:"mdi:shield-off",alarm_trigger:"mdi:bell-ring",alarm_arm_vacation:"mdi:shield-airplane"}},automation:{services:{turn_on:"mdi:robot",turn_off:"mdi:robot-off",trigger:"mdi:play"}},button:{services:{press:"mdi:gesture-tap-button"}},climate:{services:{set_temperature:"mdi:thermometer",set_hvac_mode:"mdi:cog-transfer-outline",set_preset_mode:"mdi:cloud-download-outline",set_fan_mode:"mdi:fan",set_humidity:"mdi:water-percent",set_swing_mode:"mdi:arrow-oscillating"},attributes:{hvac_mode:{cool:"mdi:snowflake",dry:"mdi:water-percent",fan_only:"mdi:fan",heat:"mdi:fire",heat_cool:"mdi:thermometer",off:"mdi:power"},preset_mode:{activity:"mdi:motion-sensor",away:"mdi:account-arrow-right",boost:"mdi:rocket-launch",comfort:"mdi:sofa",eco:"mdi:leaf",home:"mdi:home",sleep:"mdi:bed"},fan_mode:{diffuse:"mdi:weather-windy",focus:"mdi:target",high:"mdi:speedometer",low:"mdi:speedometer-slow",medium:"mdi:speedometer-medium",middle:"mdi:speedometer-medium",off:"mdi:fan-off",on:"mdi:fan"},swing_mode:{both:"mdi:arrow-all",horizontal:"mdi:arrow-left-right",off:"mdi:arrow-oscillating-off",on:"mdi:arrow-oscillating",vertical:"mdi:arrow-up-down"}}},cover:{services:{close_cover:"mdi:arrow-down-box",close_cover_tilt:"mdi:arrow-bottom-left",open_cover:"mdi:arrow-up-box",open_cover_tilt:"mdi:arrow-top-right",set_cover_position:"mdi:arrow-down-box",set_cover_tilt_position:"mdi:arrow-top-right"}},fan:{services:{oscillate:"mdi:arrow-oscillating",set_percentage:"mdi:fan",set_preset_mode:"mdi:fan-auto",turn_off:"mdi:fan-off",turn_on:"mdi:fan"}},humidifier:{services:{set_humidity:"mdi:water-percent",set_mode:"mdi:air-humidifier",turn_off:"mdi:air-humidifier-off",turn_on:"mdi:air-humidifier"},attributes:{mode:{auto:"mdi:refresh-auto",away:"mdi:account-arrow-right",baby:"mdi:baby-carriage",boost:"mdi:rocket-launch",comfort:"mdi:sofa",eco:"mdi:leaf",home:"mdi:home",normal:"mdi:water-percent",sleep:"mdi:power-sleep"}}},input_boolean:{services:{turn_off:"mdi:toggle-switch-off",turn_on:"mdi:toggle-switch"}},input_button:{services:{press:"mdi:gesture-tap-button"}},input_number:{services:{set_value:"mdi:counter"}},input_select:{services:{select_option:"mdi:counter"}},lawn_mower:{services:{dock:"mdi:home-import-outline",start_mowing:"mdi:play"}},light:{services:{turn_off:"mdi:lightbulb-off",turn_on:"mdi:lightbulb-on"}},lock:{services:{lock:"mdi:lock",unlock:"mdi:lock-open"}},media_player:{services:{media_play:"mdi:play",media_stop:"mdi:stop",play_media:"mdi:play",select_source:"mdi:import",turn_off:"mdi:power",turn_on:"mdi:power"}},notify:{services:{"{entity_id}":"mdi:message-alert"}},scene:{services:{turn_on:"mdi:play"}},script:{services:{turn_on:"mdi:flash",turn_off:"mdi:flash-off","{entity_id}":"mdi:play"}},select:{services:{select_option:"mdi:counter"}},switch:{services:{turn_off:"mdi:toggle-switch-variant-off",turn_on:"mdi:toggle-switch-variant"}},vacuum:{services:{send_command:"mdi:send",start:"mdi:play",turn_off:"mdi:stop",turn_on:"mdi:play"}},water_heater:{services:{set_away_mode:"mdi:account-arrow-right",set_operation_mode:"mdi:water-boiler",set_temperature:"mdi:thermometer",turn_off:"mdi:water-boiler-off",turn_on:"mdi:water-boiler"},attributes:{operation_mode:{eco:"mdi:leaf",electric:"mdi:lightning-bolt",gas:"mdi:fire-circle",heat_pump:"mdi:heat-wave",high_demand:"mdi:finance",off:"mdi:power",performance:"mdi:rocket-launch"}}}},Ga=(e,t)=>{const i=Zi(e.service),a=Wi(e.service);if(e.icon)return e.icon;if(!Object.keys(Ja).includes(i)||!Object.keys(Ja[i].services).includes(a))return"mdi:flash";if(void 0!==Ja[i].attributes){let t=Ja[i].attributes;const a=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(a&&Object.keys(t[a]).includes(e.service_data[a]))return t[a][e.service_data[a]]}return Ja[i].services[a]},Ya=(e,t)=>{const i=new Date(t),a=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let s=3600*e.hours+60*e.minutes-a;const o=s<0?-1:1;s=Math.abs(s);let n=Math.floor(s/3600),r=Math.round((s-3600*n)/60);return o<0&&(n>0?n=-n:r=-r),ze({hours:n,minutes:r})};let Qa=class extends oe{constructor(){super(),this.selectedSlot=null,this.timeout=0,this.large=!1,this.handleResize=this.handleResize.bind(this)}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){}render(){return R`
      <div class="bar">
    ...
    `}renderTimebar(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=[1,2,3,4,6,8,12],i=Te(this.hass.locale),a=i?130:100;let s=Math.ceil(24/(e/a));for(;!t.includes(s);)s++;const o=[0,...Array.from(Array(24/s-1).keys()).map(e=>(e+1)*s),24];return o.map((e,t)=>{let a=s/24*100;a=Math.floor(100*a)/100;let n={mode:fe.Fixed,hours:e,minutes:0};return 0==t?R`
        <span class="left" style=${wa({width:a/2+"%"})}>${Le(n,{seconds:!1,am_pm:i})}</span>
      `:t==o.length-1?R`
        <span class="right" style=${wa({width:a/2+"%"})}>${Le(n,{seconds:!1,am_pm:i})}</span>
      `:R`
        <span style=${wa({width:a+"%"})}>${Le(n,{seconds:!1,am_pm:i})}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,a)=>{let s=Se(i.start,this.hass),o=Se(i.stop||i.start,this.hass);!o&&s&&(o=86400);const n=(o-s)/86400*100,r=i.actions.length?ra(i.actions[0],this.hass,this.config.customize,!0):"",l=parseFloat(getComputedStyle(this).getPropertyValue("width")),d=5*r.length+10,c=a>0?15:0,u=a<e.length-1?15:0,m=n*l/100-c-u,h=e[a+1];return R`
        <div
          class="slot ${this.selectedSlot==a?"selected":""} ${i.actions.length?"":"empty"} ${void 0===i.stop?"short":""}"
          style="${wa({width:t[a]+"px"})}"
          @click=${this._toggleSelectTimeslot}
          idx="${a}"
        >
          ${i.stop,""}
          ${i.actions.length?r&&(m>d/3||m>50)&&m>30?R`<span style="margin-left: ${c}px; margin-right: ${u}px">${r}</span>`:m>16?R`<ha-icon icon="${Ga(i.actions[0],this.hass)}"></ha-icon>`:"":""}
        </div>
    ...
    `}};t([de({attribute:!1})],Qa.prototype,"hass",void 0),t([de({attribute:!1})],Qa.prototype,"config",void 0),t([ce()],Qa.prototype,"schedule",void 0),t([ce()],Qa.prototype,"selectedSlot",void 0),t([de({type:Boolean})],Qa.prototype,"large",void 0),t([
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */
function(e){return(({finisher:e,descriptor:t})=>(i,a)=>{var s;if(void 0===a){const a=null!==(s=i.originalKey)&&void 0!==s?s:i.key,o=null!=t?{kind:"method",placement:"prototype",key:a,descriptor:t(i.key)}:{...i,key:a};return null!=e&&(o.finisher=function(t){e(t,a)}),o}{const s=i.constructor;void 0!==t&&Object.defineProperty(i,a,t(a)),null==e||e(s,a)}})({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}({passive:!0})],Qa.prototype,"_handleDragStart",null),Qa=t([re("scheduler-timeslot-editor")],Qa);let Xa=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=fe.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1}set time(e){this.hours=Number(e.split(":")[0]),this.minutes=Number(e.split(":")[1]);const t=Ae(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return R`
    ...
    `}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Me(this.hours).am_pm;t=Pe(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.target.value,i=Me(this.hours).hours;this.hours=Pe(i,"AM"==t?De.AM:De.PM),this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};pa(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==fe.Fixed?Me(this.hours).hours:this.hours;return e?"-"+Math.abs(t).toFixed():t.toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}_handleMenuAction(e,t){const i=e.detail.index,a=(t=t.filter(e=>e!=this.mode))[i],s=this.convertTimeMode(a);this.hours=s.hours,this.minutes=s.minutes,this.mode=a,e.preventDefault();const o=e.target;setTimeout(()=>{o.firstElementChild.blur()},50);const n={mode:this.mode,hours:this.hours,minutes:this.minutes};pa(this,"value-changed",{value:n})}};Xa.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([de({attribute:!1})],Xa.prototype,"hass",void 0),t([ce()],Xa.prototype,"hours",void 0),t([ce()],Xa.prototype,"minutes",void 0),t([ce()],Xa.prototype,"mode",void 0),t([de({type:Boolean})],Xa.prototype,"autoValidate",void 0),t([de({type:Boolean})],Xa.prototype,"required",void 0),t([de({type:Boolean})],Xa.prototype,"disabled",void 0),t([de({type:String})],Xa.prototype,"label",void 0),t([de({type:Boolean})],Xa.prototype,"useAmPm",void 0),Xa=t([re("scheduler-time-picker")],Xa);let es=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![he.Daily,he.Weekend,he.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?R`
    ...
    `:R``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[he.Sunday,he.Monday,he.Tuesday,he.Wednesday,he.Thursday,he.Friday,he.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,Wa(this.hass))}else e=[he.Daily,he.Workday,he.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.every(e=>![he.Daily,he.Weekend,he.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>R`
        <mwc-list-item
          graphic="icon"
        ...
        >
          ...
          ${"Custom"==e?R`
            ...
            ${ca(Bi("ui.dialog.weekday_picker.choose",this.hass))}
    ...
    `:R``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("mwc-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_renderOptions(){var e;if(null===(e=this._params)||void 0===e?void 0:e.domainFilter){let e=this._params.domainFilter.map(e=>((e,t,i)=>{const a=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(e=>{if(!Object.keys(Qi).includes(t))return!1;let i=Object.keys(Qi[t]).includes(e);return!i&&Object.keys(Qi[t]).includes("{entity_id}")&&(i=!["turn_on","turn_off","reload","toggle","test"].includes(e)),i}):[],s=t=>e.localize(`component.${t}.title`)||t.replace(/_/g," "),o=i=>e.localize(`component.${t}.services.${i}.description`)||e.services[t][i].description;let n=a.map(i=>{return Object({key:i,name:`${s(t)}: ${a=i,e.localize(`component.${t}.services.${a}.name`)||e.services[t][a].name||a.replace(/_/g," ")}`,description:o(i),icon:fa(t),action:{service:i.includes(".")?i:`${t}.${i}`,service_data:{}}});var a});return Object.keys(i||{}).filter(e=>Zi(e)==t).map(e=>(i||{})[e].actions||[]).flat().forEach(e=>{let i=e.service;for(;n.find(e=>e.key==i);)i+="_2";n.push({key:i,name:e.name||"",description:e.name||"",icon:e.icon||fa(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},name:e.name,icon:e.icon}})}),n})(this.hass,e,this._params.cardConfig.customize)).flat();return Object.keys(e).map(t=>R`
        <mwc-list-item
          graphic="icon"
    ...
    `)}{let e=ba(this.hass,this._params.cardConfig);e.sort((e,t)=>Yi(e.name,t.name)),this._filter&&(e=e.filter(e=>{const t=this._filter.toLowerCase().trim().split(" ");return t.every(t=>e.name.toLowerCase().includes(t))||t.every(t=>e.key.toLowerCase().includes(t))}));let i=[];for(var t=e.length;t<7;t++)i.push(0);return R`
    ...
    `}};t([de({attribute:!1})],is.prototype,"hass",void 0),t([ce()],is.prototype,"_params",void 0),t([ce()],is.prototype,"_search",void 0),t([ce()],is.prototype,"_filter",void 0),t([ce()],is.prototype,"_width",void 0),t([ce()],is.prototype,"_height",void 0),t([ce()],is.prototype,"lockDomain",void 0),is=t([re("dialog-select-action")],is);var as=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return is}});let ss=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return R`
      ${this.showPrefix?R`
    ...
    `}};t([de({type:Boolean})],ss.prototype,"showPrefix",void 0),ss=t([re("settings-row")],ss);let os=class extends oe{constructor(){super(...arguments),this.selectedEntry=0,this.selectedSlot=null,this.large=!1}render(){return R`
    ${this.schedule.entries.map((e,t)=>R`
      ...
      <div class="weekdays">
        <span>
          ...
          ${Ka(e.weekdays,"short",this.hass)}
        </span>
        <ha-icon-button .path=${va} @click=${e=>this._showWeekdayDialog(e,t)}></ha-icon-button>
      </div>
    ...
    ${this.renderSlot()}
    `}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return R``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=Se(e,this.hass),a=(Se(t,this.hass)||86400)-i;return R`
      <div class="actions">
        <ha-icon-button .path=${_a} @click=${()=>{this.selectedSlot=this.selectedSlot-1}} ?disabled=${null===this.selectedSlot||this.selectedSlot<1}>
        </ha-icon-button> 
    ...
    `;const r=Zi(n.service),l=ea(n,this.config.customize);if(void 0===l)return R``;const d=Object.keys(l.fields||{}).filter(e=>((e,t,i,a)=>{var s;const o=e.service,n=null===(s=e.target)||void 0===s?void 0:s.entity_id,r=ea(e,a);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const l=r.fields[t];if(null===aa(o,n,t,i,a))return!1;if(l.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return 1==((i.states[e].attributes.supported_features||0)&l.supported_features)}))return!1}return!0})(n,e,this.hass,this.config.customize));let c="",u=[(null===(e=n.target)||void 0===e?void 0:e.entity_id)||[]].flat();return u.length&&(c+=u.map(e=>{var t;return Ki(e,null===(t=this.hass.states[e])||void 0===t?void 0:t.attributes)}).join(", "),c+=": "),c+=ra(n,this.hass,this.config.customize),R`
      <collapsible-section
        ?expanded=${!0}
        ?disabled=${!0}
      >
        <span slot="header">
          <ha-icon slot="icon" icon="${Ga(n,this.hass)}"></ha-icon>
          ${ca(c)}
        </span>
        ...
        <div slot="content">
          ...
          ${d.map(e=>{var t;const i=aa(n.service,null===(t=n.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let a=l.fields[e].optional||(i.number||{}).optional;const s=!a||Object.keys(n.service_data).includes(e);return R`
  ...
  div.slot-placeholder {
    ...
    `}};t([de({attribute:!1})],os.prototype,"hass",void 0),t([de({attribute:!1})],os.prototype,"config",void 0),t([ce()],os.prototype,"schedule",void 0),t([ce()],os.prototype,"selectedEntry",void 0),t([ce()],os.prototype,"selectedSlot",void 0),t([de({type:Boolean})],os.prototype,"large",void 0),os=t([re("scheduler-main-panel")],os);function ns(e){return e.toISOString().split("T")[0]}function rs(e){let t=new Date;const i=(e||"").match(/^([0-9]{4})-([0-9]{2})-([0-9]{2})/);null!==i&&t.setFullYear(Number(i[1]),Number(i[2])-1,Number(i[3]));const a=(e||"").match(/([0-9]{2}):([0-9]{2})(:([0-9]{2}))?$/);return null!==a&&t.setHours(Number(a[1]),Number(a[2]),a.length>4?Number(a[4]):t.getSeconds()),t}const ls=(e,t)=>"select"in t&&null!==t.select?((e,t)=>{var i;return((null===(i=t.select)||void 0===i?void 0:i.options)||[]).some(t=>"object"==typeof t?t.value==e:t==e)})(String(e),t):"number"in t&&null!==t.number?((e,t)=>{var i,a;return isNaN(e)||void 0!==(null===(i=t.number)||void 0===i?void 0:i.min)&&e<t.number.min||void 0!==(null===(a=t.number)||void 0===a?void 0:a.max)&&t.number.max,!1})(Number(e),t):!("text"in t)||null===t.text||String(e).length>0;let ds=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0}async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title")}render(){return this._params?R`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
    ...
    `}};t([de({attribute:!1})],ds.prototype,"hass",void 0),t([ce()],ds.prototype,"_params",void 0),t([ce()],ds.prototype,"_search",void 0),t([ce()],ds.prototype,"_filter",void 0),t([ce()],ds.prototype,"_width",void 0),t([ce()],ds.prototype,"_height",void 0),ds=t([re("dialog-select-condition")],ds);var cs=Object.freeze({__proto__:null,get DialogSelectCondition(){return ds}});let us=class extends oe{constructor(){super(...arguments),this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[]}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||ns(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||ns(new Date);const i=(await La(this.hass)).map(e=>e.name),a=[...this.config.tags].flat();this.tags=[...i,...a.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))]}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return R`
    ...
    `}renderConditions(){let e=this.schedule.entries[0].slots[0].conditions.items;return this.conditionIdx==e.length&&(e=[...e,{}]),e.map((e,t)=>{const i=this.selectedDomain||Zi(e.entity_id||""),a=$a(this.selectedEntity||i,this.hass),s=a&&a.hasOwnProperty("number")?[_e.Above,_e.Below]:[_e.Equal,_e.Unequal],o={[_e.Equal]:"mdi:equal",[_e.Unequal]:"mdi:not-equal-variant",[_e.Above]:"mdi:greater-than",[_e.Below]:"mdi:less-than"},n={[_e.Equal]:"ui.panel.options.conditions.types.equal_to",[_e.Unequal]:"ui.panel.options.conditions.types.unequal_to",[_e.Above]:"ui.panel.options.conditions.types.above",[_e.Below]:"ui.panel.options.conditions.types.below"};return this.conditionIdx!==t||this.selectedMatchType||(this.selectedMatchType=s[0]),R`
      <collapsible-section>
        <span slot="header">
          ${e.entity_id&&void 0!==e.value?R`
          <ha-icon slot="icon" icon="${za(e.entity_id,this.hass)}"></ha-icon>
          ${ca(Bi(n[e.match_type],this.hass,["{entity}","{value}"],[(r=e.entity_id,l=this.hass,(Object.keys(l.states).includes(r)&&l.states[r].attributes.friendly_name?l.states[r].attributes.friendly_name:Wi(r).replace(/_/g," "))||""),e.value||""]))}
          `:"new condition"}
        </span>
        <ha-button-menu
          slot="contextMenu" 
        ...
        <settings-row>
          <span slot="heading">
            ${ca(Bi(n[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
            <ha-button-menu
              @action=${e=>this._selectMatchType(e,s)}
              @closed=${e=>{e.stopPropagation()}}
              fixed
            >
              <ha-icon-button slot="trigger" .path=${va}>
              </ha-icon-button>
              ${s.map(i=>R`
                <mwc-list-item graphic="icon" ?noninteractive=${this.conditionIdx==t?this.selectedMatchType==i:e.match_type==i}>
                  ${ca(Bi(n[i],this.hass,["{entity}","{value}"],["",""]))}
    ...
    `}};t([de({attribute:!1})],us.prototype,"hass",void 0),t([de({attribute:!1})],us.prototype,"config",void 0),t([ce()],us.prototype,"schedule",void 0),t([ce()],us.prototype,"conditionIdx",void 0),t([ce()],us.prototype,"selectedDomain",void 0),t([ce()],us.prototype,"selectedEntity",void 0),t([ce()],us.prototype,"selectedMatchType",void 0),t([ce()],us.prototype,"conditionValue",void 0),t([ce()],us.prototype,"conditionValid",void 0),t([ce()],us.prototype,"startDate",void 0),t([ce()],us.prototype,"endDate",void 0),t([de()],us.prototype,"tags",void 0),us=t([re("scheduler-options-panel")],us);let ms=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?R`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          <ha-icon-button
            slot="navigationIcon"
    ...
    `}};t([de({attribute:!1})],ms.prototype,"hass",void 0),t([ce()],ms.prototype,"_params",void 0),ms=t([re("scheduler-generic-dialog")],ms);var hs=Object.freeze({__proto__:null,get GenericDialog(){return ms}});let ps=class extends oe{constructor(){super(...arguments),this.large=!1,this.selectedEntry=0,this.selectedSlot=0,this._panel="main"}async showDialog(e){this._params=e,this.schedule=e.schedule,this._panel="main",this.large=!1,await this.updateComplete}async closeDialog(){this._params=void 0}willUpdate(){this.hass.loadBackendTranslation("config")}render(){var e;return this._params?R`
    ...
    `:R``}_toggleOptionsPanel(){this._panel="main"==this._panel?"options":"main"}async _handleSaveClick(e){const t=Na(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const a={cancel:()=>i(!1),confirm:()=>i(!0),title:this.hass.localize("state_badge.default.error"),description:Bi("ui.panel.editor.validation_errors."+t,this.hass),primaryButtonLabel:this.hass.localize("ui.common.ok")};pa(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return hs})),dialogParams:a})});else if(this.schedule.schedule_id){const t=qe(await ha(this.hass,this.schedule.schedule_id),this.hass);if(me(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Bi("ui.dialog.enable_schedule.title",this.hass),description:Bi("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};pa(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return hs})),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=Ha(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>Ba(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=Ha(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>Ba(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Bi("ui.dialog.confirm_delete.title",this.hass),description:Bi("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:this.hass.localize("ui.dialogs.generic.ok"),secondaryButtonLabel:this.hass.localize("ui.dialogs.generic.cancel")};pa(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return hs})),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>Ba(e,this,this.hass)).then(()=>{this.closeDialog()})})}};ps.styles=Ia,t([de({attribute:!1})],ps.prototype,"hass",void 0),t([ce()],ps.prototype,"_params",void 0),t([de({type:Boolean,reflect:!0})],ps.prototype,"large",void 0),t([ce()],ps.prototype,"schedule",void 0),t([ce()],ps.prototype,"selectedEntry",void 0),t([ce()],ps.prototype,"selectedSlot",void 0),t([ce()],ps.prototype,"_panel",void 0),ps=t([re("dialog-scheduler-editor")],ps);var _s=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return ps}});let gs=class extends oe{render(){const e=this.hass.states[this.schedule.entity_id],t="off"==e.state,i=this.schedule.entries[0].slots[this.schedule.next_entries[0]].actions[0];return R`
      <ha-icon
        icon="${Ga(i,this.hass)}"
      >
      </ha-icon>
      ...
      >
        ${ua(this.schedule,this.config.display_options.primary_info,this.hass,this.config.customize)}
        <div class="secondary">
        ${ua(this.schedule,this.config.display_options.secondary_info,this.hass,this.config.customize)}
        </div>
      </div>
      <div class="state">
        <ha-entity-toggle
    ...
    `}};t([de()],gs.prototype,"hass",void 0),t([de()],gs.prototype,"schedule_id",void 0),t([de()],gs.prototype,"schedule",void 0),t([de()],gs.prototype,"config",void 0),gs=t([re("schedule-item-row")],gs),e.SchedulerCard=class extends(je(oe)){constructor(){super(...arguments),this._config=Ie,this.showDiscovered=!1,this.translationsLoaded=!1}setConfig(e){e=(e=>{let t=[];if(He(e,"include")&&!Be(e.include)&&t.push("'include' must be a list of strings"),He(e,"exclude")&&!Be(e.exclude)&&t.push("'exclude' must be a list of strings"),He(e,"discover_existing")&&!Ve(e.discover_existing)&&t.push("'discover_existing' must be a boolean"),!He(e,"title")||Ve(e.title)||Ue(e.title)||t.push("'title' must be a boolean or string"),He(e,"show_header_toggle")&&!Ve(e.show_header_toggle)&&t.push("'show_header_toggle' must be a boolean"),He(e,"show_add_button")&&!Ve(e.show_add_button)&&t.push("'show_add_button' must be a boolean"),He(e,"display_options")&&(Fe(e.display_options)?(!He(e.display_options,"primary_info")||Ue(e.display_options.primary_info)||Be(e.display_options.primary_info)||t.push("in 'display_options': 'primary_info' must be a string or list of strings"),!He(e.display_options,"secondary_info")||Ue(e.display_options.secondary_info)||Be(e.display_options.secondary_info)||t.push("in 'display_options': 'secondary_info' must be a string or list of strings"),He(e.display_options,"icon")&&!Ue(e.display_options.icon)&&t.push("in 'display_options': 'icon' must be a string ")):t.push("'display_options' must be a struct")),!He(e,"sort_by")||Ue(e.sort_by)||Be(e.sort_by)||t.push("'sort_by' must be a string or list of strings"),He(e,"customize")&&!Fe(e.customize)&&t.push("'customize' must be a struct"),!He(e,"tags")||Ue(e.tags)||Be(e.tags)||t.push("'tags' must be a string or list of strings"),!He(e,"exclude_tags")||Ue(e.tags)||Be(e.tags)||t.push("'exclude_tags' must be a string or list of strings"),t.length)throw new Error(`Invalid configuration provided (${t.length} error${t.length>1?"s":""}): ${t.join(", ")}.`);return e})(e),this._config=Object.assign(Object.assign({},Ie),e)}firstUpdated(){(async()=>{await(async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider")&&customElements.get("ha-combo-box"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.automation.load()})()})()}willUpdate(){this.hass.loadBackendTranslation("services")}hassSubscribe(){return this.loadSchedules(),[this.hass.connection.subscribeMessage(e=>this.handleScheduleItemUpdated(e),{type:"scheduler_updated"})]}shouldUpdate(e){const t=e.get("hass"),i=e.get("_config");if(i&&this._config){Object.keys(i).filter(e=>i[e]!==this._config[e]).some(e=>["tags","discover_existing","sort_by","display_options"].includes(e))&&(async()=>{await this.loadSchedules()})()}return!this.translationsLoaded&&this.hass.localize("component.input_boolean.services.turn_on.name").length?(this.translationsLoaded=!0,!0):!t||1!=e.size||!this.schedules||Object.values(this.schedules).some(e=>JSON.stringify(t.states[e.entity_id])!==JSON.stringify(this.hass.states[e.entity_id]))}render(){let e=Object.assign({},this.schedules),t=Object.keys(this.schedules||{}).filter(t=>Gi(e[t],this._config));const i=Object.entries(e).filter(([e])=>!!this.showDiscovered||t.includes(e)).some(([,e])=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")});return R`
      <ha-card>
    ...
    `}async loadSchedules(){var e;(e=this.hass,e.callWS({type:"scheduler"}).then(e=>Object.fromEntries(e.map(e=>[e.schedule_id,xe(e)])))).then(e=>{this.schedules=ma(e,this._config,this.hass),Object.values(e).every(e=>Gi(e,this._config))}).catch(e=>{this.schedules={}})}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?ha(this.hass,e.schedule_id).then(t=>{const i=this.schedules[e.schedule_id];let a=Object.assign({},this.schedules);t&&(this._config.discover_existing||Gi(t,this._config))?a=i?i.timestamps[i.next_entries[0]]==t.timestamps[t.next_entries[0]]?Object.assign(Object.assign({},a),{[e.schedule_id]:t}):ma(Object.assign(Object.assign({},a),{[e.schedule_id]:t}),this._config,this.hass):ma(Object.assign(Object.assign({},a),{[e.schedule_id]:t}),this._config,this.hass):i&&(a=Object.fromEntries(Object.entries(a).filter(([t])=>t!=e.schedule_id))),this.schedules=Object.assign({},a)}):this.schedules=Object.fromEntries(Object.entries(this.schedules||{}).filter(([t])=>t!==e.schedule_id))}_handleEditClick(e){if(!this.schedules)return;const t=e.detail.schedule_id,i={schedule:qe(this.schedules[t],this.hass),cardConfig:this._config,editItem:t};pa(e.target,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return _s})),dialogParams:i})}_addClick(e){const t=[this._config.tags||[]].flat().filter(e=>!["none","disabled","enabled"].includes(e)),i={schedule:Object.assign(Object.assign({},Ne),{tags:1==t.length?t:[]}),cardConfig:this._config};pa(this,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return _s})),dialogParams:i})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked;Object.values(this.schedules).filter(e=>this.showDiscovered||Gi(e,this._config)).forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}static getConfigElement(){return document.createElement("scheduler-card-editor")}},e.SchedulerCard.styles=r`
    .card-header {
      display: flex;
      justify-content: space-between;
    }
