...
/**
  ...
  `,t([K({type:Number})],rs.prototype,"value",null),t([K()],rs.prototype,"hass",void 0),t([K({type:String})],rs.prototype,"event",void 0),t([K({type:Boolean})],rs.prototype,"formatAmPm",void 0),t([K({type:Number})],rs.prototype,"stepSize",void 0),rs=t([Z("time-picker")],rs);let ls=class extends se{constructor(){super(...arguments),this.entries=[],this.actions=[],this.stepSize=10,this._activeEntry=null,this._activeThumb=null,this.formatAmPm=!1,this._currentTime=null,this._activeEntryMem=null}firstUpdated(){this.formatAmPm=ts(this.hass.language)}render(){return this.hass?L`
    ...
    `:L``}getSlots(){const e=[];return this.entries.forEach((t,i)=>{if(e.push(L`
      ...
      `),i<this.entries.length-1){const t=this.entries[i].endTime.value;e.push(L`
        ...
        `)}}),e}updated(){this.shadowRoot.querySelectorAll(".slider-thumb-tooltip").forEach((e,t)=>{const i=this.entries[t].endTime.value;e.innerText=ue(i,{amPm:this.formatAmPm}).time})}getEntryAction(e){if(!this.hass)return;if(!e.action)return"";const t=this.actions.find(t=>t.id==e.action);if(e.variable&&e.variable.type==ae.Level&&t.variable){if(e.variable.enabled)return Se(Number(e.variable.value),t.variable)}else if(e.variable&&e.variable.type==ae.List){const i=t.variable.options.find(t=>t.value==e.variable.value);return we(i&&i.name?i.name:String(e.variable.value))}const i=t.service;return we(t.name||Bt("services."+i,this.hass.language)||i)}_handleSegmentClick(e,t){e.target;this._activeEntry=this._activeEntry==t?null:t,this._activeEntryMem=t;const i=new CustomEvent("update",{detail:{entry:this._activeEntry}});this.dispatchEvent(i)}_handleTouchStart(e,t){let i=e.target;if(!i)return;"HA-ICON"==i.nodeName&&(i=i.parentElement);const s=i.parentNode,a=s.parentElement,n=a.getBoundingClientRect(),o=s.previousElementSibling,r=s.nextElementSibling,c=s.querySelector(".slider-thumb-tooltip");this._activeThumb=t;const l=o.offsetWidth+r.offsetWidth,d=n.width,u=Array.from(a.querySelectorAll(".slider-slot")),h=u.map(e=>e.offsetWidth);let m=0,p=-1;u.forEach((e,t)=>{e==o?p=t:-1==p&&(m+=h[t])});let _=e=>{let t;t="undefined"!=typeof TouchEvent&&e instanceof TouchEvent?e.changedTouches[0].pageX:e.pageX;let i=t-n.left;i<0?i=0:i>n.width&&(i=n.width),i>l+m&&(i=l+m),i<m&&(i=m),o.style.width=Math.round(i-m)+"px",r.style.width=Math.round(l-(i-m))+"px";let s=i/d*1440;s=Math.round(s)>=1440?1440:de(s,this.stepSize,!1),1440==s&&(s-=1),this._currentTime=s,c.dispatchEvent(new CustomEvent("update"))};const v=()=>{if(window.removeEventListener("mousemove",_),window.removeEventListener("touchmove",_),window.removeEventListener("mouseup",v),window.removeEventListener("touchend",v),_=()=>{},null!==this._currentTime){const e=this._currentTime,t=cs(this.entries[p])+cs(this.entries[p+1]),i=this.entries[p].time.value,s=[...this.entries];Object.assign(s[p],{endTime:{value:e}}),Object.assign(s[p+1],{time:{value:e},endTime:{value:i+t}});const a=new CustomEvent("update",{detail:{entries:s}});this.dispatchEvent(a)}this._currentTime=null,this._activeThumb=null};window.addEventListener("mouseup",v),window.addEventListener("touchend",v),window.addEventListener("blur",v),window.addEventListener("mousemove",_),window.addEventListener("touchmove",_)}_updateMarker(e){e.detail;const t=Number(this._currentTime);e.target.innerText=ue(t,{amPm:this.formatAmPm}).time}_addSlot(){const e=this.entries[this._activeEntry],t=e.time.value,i=e.endTime.value,s=de(t+cs(e)/2,this.stepSize),a=Object.assign({time:{value:s},endTime:{value:i},action:""},fe(e,["entity","days"])),n=[...this.entries];Object.assign(n[this._activeEntry],{endTime:{value:s}}),n.splice(this._activeEntry+1,0,a);const o=new CustomEvent("update",{detail:{entries:n}});this.dispatchEvent(o)}_removeSlot(){const e=this._activeEntry==this.entries.length-1?this._activeEntry-1:this._activeEntry,t=Object.assign({},this.entries[e+1]);Object.assign(t,{time:this.entries[e].time,endTime:this.entries[e+1].endTime});const i=[...this.entries];i.splice(e,2,t),this._activeEntry==this.entries.length&&this._activeEntry--;const s=new CustomEvent("update",{detail:{entries:i}});this.dispatchEvent(s)}};ls.styles=te`
    div.slider-track {
      height: 50px;
      width: 100%;
      display: flex;
