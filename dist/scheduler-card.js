  ...
  `,primaryButtonLabel:i.localize("ui.dialogs.generic.ok"),confirm:()=>{},cancel:()=>{}};va(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return gs})),dialogParams:a})},Ja=e=>{let t=e.locale.first_weekday;if(t&&"language"!=t)return Ga.map(e=>e.toLowerCase()).findIndex(e=>e==t);if("weekInfo"in Intl.Locale.prototype)return new Intl.Locale(e.locale.language).weekInfo.firstDay%7;{const t="AEAFBHDJDZEGIQIRJOKWLYOMQASDSY".match(/../g),i="AGARASAUBDBRBSBTBWBZCACNCODMDOETGTGUHKHNIDILINJMJPKEKHKRLAMHMMMOMTMXMZNINPPAPEPHPKPRPTPYSASGSVTHTTTWUMUSVEVIWSYEZAZW".match(/../g),a=["ar","arq","arz","fa"],s="amasbndzengnguhehiidjajvkmknkolomhmlmrmtmyneomorpapssdsmsnsutatethtnurzhzu".match(/../g),o=e.locale.language.match(/^([a-z]{2,3})(?:-([a-z]{3})(?=$|-))?(?:-([a-z]{4})(?=$|-))?(?:-([a-z]{2}|\d{3})(?=$|-))?/i);return o[1]?i.includes(o[4])?0:t.includes(o[4])?6:1:s.includes(o[1])?0:a.includes(o[1])?6:1}},Ga=[he.Sunday,he.Monday,he.Tuesday,he.Wednesday,he.Thursday,he.Friday,he.Saturday],Ya={alarm_control_panel:{services:{alarm_arm_away:"mdi:shield-lock",alarm_arm_home:"mdi:shield-home",alarm_arm_night:"mdi:shield-moon",alarm_custom_bypass:"mdi:security",alarm_disarm:"mdi:shield-off",alarm_trigger:"mdi:bell-ring",alarm_arm_vacation:"mdi:shield-airplane"}},automation:{services:{turn_on:"mdi:robot",turn_off:"mdi:robot-off",trigger:"mdi:play"}},button:{services:{press:"mdi:gesture-tap-button"}},climate:{services:{set_temperature:"mdi:thermometer",set_hvac_mode:"mdi:cog-transfer-outline",set_preset_mode:"mdi:cloud-download-outline",set_fan_mode:"mdi:fan",set_humidity:"mdi:water-percent",set_swing_mode:"mdi:arrow-oscillating"},attributes:{hvac_mode:{cool:"mdi:snowflake",dry:"mdi:water-percent",fan_only:"mdi:fan",heat:"mdi:fire",heat_cool:"mdi:thermometer",off:"mdi:power"},preset_mode:{activity:"mdi:motion-sensor",away:"mdi:account-arrow-right",boost:"mdi:rocket-launch",comfort:"mdi:sofa",eco:"mdi:leaf",home:"mdi:home",sleep:"mdi:bed"},fan_mode:{diffuse:"mdi:weather-windy",focus:"mdi:target",high:"mdi:speedometer",low:"mdi:speedometer-slow",medium:"mdi:speedometer-medium",middle:"mdi:speedometer-medium",off:"mdi:fan-off",on:"mdi:fan"},swing_mode:{both:"mdi:arrow-all",horizontal:"mdi:arrow-left-right",off:"mdi:arrow-oscillating-off",on:"mdi:arrow-oscillating",vertical:"mdi:arrow-up-down"}}},cover:{services:{close_cover:"mdi:arrow-down-box",close_cover_tilt:"mdi:arrow-bottom-left",open_cover:"mdi:arrow-up-box",open_cover_tilt:"mdi:arrow-top-right",set_cover_position:"mdi:arrow-down-box",set_cover_tilt_position:"mdi:arrow-top-right"}},fan:{services:{oscillate:"mdi:arrow-oscillating",set_percentage:"mdi:fan",set_preset_mode:"mdi:fan-auto",turn_off:"mdi:fan-off",turn_on:"mdi:fan"}},humidifier:{services:{set_humidity:"mdi:water-percent",set_mode:"mdi:air-humidifier",turn_off:"mdi:air-humidifier-off",turn_on:"mdi:air-humidifier"},attributes:{mode:{auto:"mdi:refresh-auto",away:"mdi:account-arrow-right",baby:"mdi:baby-carriage",boost:"mdi:rocket-launch",comfort:"mdi:sofa",eco:"mdi:leaf",home:"mdi:home",normal:"mdi:water-percent",sleep:"mdi:power-sleep"}}},input_boolean:{services:{turn_off:"mdi:toggle-switch-off",turn_on:"mdi:toggle-switch"}},input_button:{services:{press:"mdi:gesture-tap-button"}},input_number:{services:{set_value:"mdi:counter"}},input_select:{services:{select_option:"mdi:counter"}},lawn_mower:{services:{dock:"mdi:home-import-outline",start_mowing:"mdi:play"}},light:{services:{turn_off:"mdi:lightbulb-off",turn_on:"mdi:lightbulb-on"}},lock:{services:{lock:"mdi:lock",unlock:"mdi:lock-open"}},media_player:{services:{media_play:"mdi:play",media_stop:"mdi:stop",play_media:"mdi:play",select_source:"mdi:import",turn_off:"mdi:power",turn_on:"mdi:power"}},notify:{services:{"{entity_id}":"mdi:message-alert"}},scene:{services:{turn_on:"mdi:play"}},script:{services:{turn_on:"mdi:flash",turn_off:"mdi:flash-off","{entity_id}":"mdi:play"}},select:{services:{select_option:"mdi:counter"}},switch:{services:{turn_off:"mdi:toggle-switch-variant-off",turn_on:"mdi:toggle-switch-variant"}},vacuum:{services:{send_command:"mdi:send",start:"mdi:play",turn_off:"mdi:stop",turn_on:"mdi:play"}},water_heater:{services:{set_away_mode:"mdi:account-arrow-right",set_operation_mode:"mdi:water-boiler",set_temperature:"mdi:thermometer",turn_off:"mdi:water-boiler-off",turn_on:"mdi:water-boiler"},attributes:{operation_mode:{eco:"mdi:leaf",electric:"mdi:lightning-bolt",gas:"mdi:fire-circle",heat_pump:"mdi:heat-wave",high_demand:"mdi:finance",off:"mdi:power",performance:"mdi:rocket-launch"}}}},Qa=(e,t)=>{const i=ia(e,t),a=Zi(e.service),s=Wi(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z]+$/)?o:"mdi:"+o;var o;if(!Object.keys(Ya).includes(a)||!Object.keys(Ya[a].services).includes(s))return"mdi:flash";if(void 0!==Ya[a].attributes){let t=Ya[a].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return Ya[a].services[s]},Xa=(e,t)=>{const i=new Date(t),a=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let s=3600*e.hours+60*e.minutes-a;const o=s<0?-1:1;s=Math.abs(s);let n=Math.floor(s/3600),r=Math.round((s-3600*n)/60);return o<0&&(n>0?n=-n:r=-r),ze({hours:n,minutes:r})};let es=class extends oe{constructor(){super(),this.selectedSlot=null,this.timeout=0,this.large=!1,this.handleResize=this.handleResize.bind(this)}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){}render(){return R`
    ...
    `}renderTimebar(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=[1,2,3,4,6,8,12],i=Te(this.hass.locale),a=i?130:100;let s=Math.ceil(24/(e/a));for(;!t.includes(s);)s++;const o=[0,...Array.from(Array(24/s-1).keys()).map(e=>(e+1)*s),24];return o.map((e,t)=>{let a=s/24*100;a=Math.floor(100*a)/100;let n={mode:fe.Fixed,hours:e,minutes:0};return 0==t?R`
      ...
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,a)=>{let s=Ae(i.start,this.hass),o=Ae(i.stop||i.start,this.hass);!o&&s&&(o=86400);const n=(o-s)/86400*100,r=i.actions.length?ca(i.actions[0],this.hass,this.config.customize,!0):"",l=parseFloat(getComputedStyle(this).getPropertyValue("width")),d=5*r.length+10,c=a>0?15:0,u=a<e.length-1?15:0,m=n*l/100-c-u,h=e[a+1];return R`
        ...
        >
          ${i.stop,""}
          ${i.actions.length?r&&(m>d/3||m>50)&&m>30?R`<span style="margin-left: ${c}px; margin-right: ${u}px">${r}</span>`:m>16?R`<ha-icon icon="${Qa(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
...
function(e){return(({finisher:e,descriptor:t})=>(i,a)=>{var s;if(void 0===a){const a=null!==(s=i.originalKey)&&void 0!==s?s:i.key,o=null!=t?{kind:"method",placement:"prototype",key:a,descriptor:t(i.key)}:{...i,key:a};return null!=e&&(o.finisher=function(t){e(t,a)}),o}{const s=i.constructor;void 0!==t&&Object.defineProperty(i,a,t(a)),null==e||e(s,a)}})({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}({passive:!0})],es.prototype,"_handleDragStart",null),es=t([re("scheduler-timeslot-editor")],es);let ts=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=fe.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1}set time(e){this.hours=Number(e.split(":")[0]),this.minutes=Number(e.split(":")[1]);const t=Se(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return R`
  ...
  `,t([de({attribute:!1})],ts.prototype,"hass",void 0),t([ce()],ts.prototype,"hours",void 0),t([ce()],ts.prototype,"minutes",void 0),t([ce()],ts.prototype,"mode",void 0),t([de({type:Boolean})],ts.prototype,"autoValidate",void 0),t([de({type:Boolean})],ts.prototype,"required",void 0),t([de({type:Boolean})],ts.prototype,"disabled",void 0),t([de({type:String})],ts.prototype,"label",void 0),t([de({type:Boolean})],ts.prototype,"useAmPm",void 0),ts=t([re("scheduler-time-picker")],ts);let is=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![he.Daily,he.Weekend,he.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?R`
    ...
    `:R``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[he.Sunday,he.Monday,he.Tuesday,he.Wednesday,he.Thursday,he.Friday,he.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,Ja(this.hass))}else e=[he.Daily,he.Workday,he.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.every(e=>![he.Daily,he.Weekend,he.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>R`
        <mwc-list-item
          graphic="icon"
    ...
    `}};t([de({attribute:!1})],ss.prototype,"hass",void 0),t([ce()],ss.prototype,"_params",void 0),t([ce()],ss.prototype,"_search",void 0),t([ce()],ss.prototype,"_filter",void 0),t([ce()],ss.prototype,"_width",void 0),t([ce()],ss.prototype,"_height",void 0),t([ce()],ss.prototype,"lockDomain",void 0),ss=t([re("dialog-select-action")],ss);var os=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return ss}});let ns=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return R`
      ${this.showPrefix?R`
    ...
    `}};t([de({type:Boolean})],ns.prototype,"showPrefix",void 0),ns=t([re("settings-row")],ns);let rs=class extends oe{constructor(){super(...arguments),this.selectedEntry=0,this.selectedSlot=null,this.large=!1}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return R`
    ...
    `;const r=Zi(n.service),l=ia(n,this.config.customize);if(void 0===l)return R``;const d=Object.keys(l.fields||{}).filter(e=>((e,t,i,a)=>{var s;const o=e.service,n=null===(s=e.target)||void 0===s?void 0:s.entity_id,r=ia(e,a);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const l=r.fields[t];if(null===oa(o,n,t,i,a))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(l.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return 1==((i.states[e].attributes.supported_features||0)&l.supported_features)}))return!1}return!0})(n,e,this.hass,this.config.customize));let c="",u=[(null===(e=n.target)||void 0===e?void 0:e.entity_id)||[]].flat();return u.length&&(c+=u.map(e=>{var t;return Ki(e,null===(t=this.hass.states[e])||void 0===t?void 0:t.attributes)}).join(", "),c+=": "),c+=ca(n,this.hass,this.config.customize),R`
      <collapsible-section
        ?expanded=${!0}
        ?disabled=${!0}
      >
        <span slot="header">
          <ha-icon slot="icon" icon="${Qa(n,this.config.customize)}"></ha-icon>
          ${Qi(c)}
        </span>
  ...
  div.slot-placeholder {
    ...
    `}};t([de({attribute:!1})],rs.prototype,"hass",void 0),t([de({attribute:!1})],rs.prototype,"config",void 0),t([ce()],rs.prototype,"schedule",void 0),t([ce()],rs.prototype,"selectedEntry",void 0),t([ce()],rs.prototype,"selectedSlot",void 0),t([de({type:Boolean})],rs.prototype,"large",void 0),rs=t([re("scheduler-main-panel")],rs);const ls=["January","February","March","April","May","June","July","August","September","October","November","December"];function ds(e){return e.toISOString().split("T")[0]}function cs(e){let t=new Date;const i=(e||"").match(/^([0-9]{4})-([0-9]{2})-([0-9]{2})/);null!==i&&t.setFullYear(Number(i[1]),Number(i[2])-1,Number(i[3]));const a=(e||"").match(/([0-9]{2}):([0-9]{2})(:([0-9]{2}))?$/);return null!==a&&t.setHours(Number(a[1]),Number(a[2]),a.length>4?Number(a[4]):t.getSeconds()),t}const us=(e,t)=>"select"in t&&null!==t.select?((e,t)=>{var i;return((null===(i=t.select)||void 0===i?void 0:i.options)||[]).some(t=>"object"==typeof t?t.value==e:t==e)})(String(e),t):"number"in t&&null!==t.number?((e,t)=>{var i,a;return isNaN(e)||void 0!==(null===(i=t.number)||void 0===i?void 0:i.min)&&e<t.number.min||void 0!==(null===(a=t.number)||void 0===a?void 0:a.max)&&t.number.max,!1})(Number(e),t):!("text"in t)||null===t.text||String(e).length>0;let ms=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0}async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title")}render(){return this._params?R`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
    ...
    `}};t([de({attribute:!1})],ms.prototype,"hass",void 0),t([ce()],ms.prototype,"_params",void 0),t([ce()],ms.prototype,"_search",void 0),t([ce()],ms.prototype,"_filter",void 0),t([ce()],ms.prototype,"_width",void 0),t([ce()],ms.prototype,"_height",void 0),ms=t([re("dialog-select-condition")],ms);var hs=Object.freeze({__proto__:null,get DialogSelectCondition(){return ms}});let ps=class extends oe{constructor(){super(...arguments),this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[]}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||ds(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||ds(new Date);const i=(await Ra(this.hass)).map(e=>e.name),a=[...this.config.tags].flat();this.tags=[...i,...a.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return R`
    ...
    `}};t([de({attribute:!1})],ps.prototype,"hass",void 0),t([de({attribute:!1})],ps.prototype,"config",void 0),t([ce()],ps.prototype,"schedule",void 0),t([ce()],ps.prototype,"conditionIdx",void 0),t([ce()],ps.prototype,"selectedDomain",void 0),t([ce()],ps.prototype,"selectedEntity",void 0),t([ce()],ps.prototype,"selectedMatchType",void 0),t([ce()],ps.prototype,"conditionValue",void 0),t([ce()],ps.prototype,"conditionValid",void 0),t([ce()],ps.prototype,"startDate",void 0),t([ce()],ps.prototype,"endDate",void 0),t([de()],ps.prototype,"tags",void 0),ps=t([re("scheduler-options-panel")],ps);let _s=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?R`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          <ha-icon-button
            slot="navigationIcon"
    ...
    `}};t([de({attribute:!1})],_s.prototype,"hass",void 0),t([ce()],_s.prototype,"_params",void 0),_s=t([re("scheduler-generic-dialog")],_s);var gs=Object.freeze({__proto__:null,get GenericDialog(){return _s}});let vs=class extends oe{constructor(){super(...arguments),this.large=!1,this.selectedEntry=0,this.selectedSlot=0,this._panel="main"}async showDialog(e){this._params=e,this.schedule=e.schedule,this._panel="main",this.large=!1,await this.updateComplete}async closeDialog(){this._params=void 0}willUpdate(){this.hass.loadBackendTranslation("config")}render(){var e;return this._params?R`
    ...
    `:R``}_updateSchedule(e){let t=e.detail.schedule;t&&(this.schedule=t)}_toggleOptionsPanel(){this._panel="main"==this._panel?"options":"main"}async _handleSaveClick(e){const t=Va(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const a={cancel:()=>i(!1),confirm:()=>i(!0),title:this.hass.localize("state_badge.default.error"),description:Bi("ui.panel.editor.validation_errors."+t,this.hass),primaryButtonLabel:this.hass.localize("ui.common.ok")};va(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return gs})),dialogParams:a})});else if(this.schedule.schedule_id){const t=qe(await ga(this.hass,this.schedule.schedule_id),this.hass);if(me(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Bi("ui.dialog.enable_schedule.title",this.hass),description:Bi("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};va(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return gs})),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=Ua(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>Ka(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=Ua(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>Ka(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Bi("ui.dialog.confirm_delete.title",this.hass),description:Bi("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:this.hass.localize("ui.dialogs.generic.ok"),secondaryButtonLabel:this.hass.localize("ui.dialogs.generic.cancel")};va(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return gs})),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>Ka(e,this,this.hass)).then(()=>{this.closeDialog()})})}};vs.styles=Ha,t([de({attribute:!1})],vs.prototype,"hass",void 0),t([ce()],vs.prototype,"_params",void 0),t([de({type:Boolean,reflect:!0})],vs.prototype,"large",void 0),t([ce()],vs.prototype,"schedule",void 0),t([ce()],vs.prototype,"selectedEntry",void 0),t([ce()],vs.prototype,"selectedSlot",void 0),t([ce()],vs.prototype,"_panel",void 0),vs=t([re("dialog-scheduler-editor")],vs);var ys=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return vs}}),fs=window&&window.__assign||function(){return(fs=Object.assign||function(e){for(var t,i=1,a=arguments.length;i<a;i++)for(var s in t=arguments[i])Object.prototype.hasOwnProperty.call(t,s)&&(e[s]=t[s]);return e}).apply(this,arguments)};var bs={second:45,minute:45,hour:22,day:5};const ks=(e,t,i)=>{if(i===Ee.am_pm||!i&&t.time_format===Ee.am_pm){const t=Me(e.getHours()).am_pm;return`${Me(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===Ee.twenty_four||!i&&t.time_format===Ee.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:Te(t)}):Te(t)?ks(e,t,Ee.am_pm):ks(e,t,Ee.twenty_four)};let ws=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const a=i>=0?"past":"future";i=Math.abs(i);const s=Math.round(i);if("future"==a&&s>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),a=Math.floor((e.valueOf()-i.valueOf())/864e5);let s="";a>14?s=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},a=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return ls[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${a(e,"month")} ${a(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${a(e,"month")} ${a(e,"day")}, ${a(e,"year")}`}(e,this._hass.locale):a>7?s=Bi("ui.components.date.next_week_day",this._hass,"{weekday}",ha(e,"long",this._hass)):1==a?s=Bi("ui.components.date.tomorrow",this._hass):a>0&&(s=ha(e,"long",this._hass));let o=Bi("ui.components.time.absolute",this._hass,"{time}",ks(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Bi("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Bi("ui.components.time.at_midnight",this._hass)),String(s+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=this._hass.localize("ui.common.and");return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=this._hass.localize("ui.common.and");return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var a=fs(fs({},bs),i||{}),s=(+e-+t)/1e3;if(Math.abs(s)<a.second)return{value:Math.round(s),unit:"second"};var o=s/60;if(Math.abs(o)<a.minute)return{value:Math.round(o),unit:"minute"};var n=s/3600;if(Math.abs(n)<a.hour)return{value:Math.round(n),unit:"hour"};var r=s/86400;if(Math.abs(r)<a.day)return{value:Math.round(r),unit:"day"};var l=new Date(e),d=new Date(t),c=l.getFullYear()-d.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+l.getMonth()-d.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var m=s/604800;return{value:Math.round(m),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return R``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),R`
      ${Qi(this.relativeTime(this.datetime))}
    `}};t([de()],ws.prototype,"_hass",void 0),t([de()],ws.prototype,"datetime",void 0),ws=t([re("scheduler-relative-time")],ws);let xs=class extends oe{render(){const e=this.hass.states[this.schedule.entity_id];if(!e)return R``;const t="off"==e.state,i=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];return R`
      <ha-icon
        icon="${Qa(i,this.config.customize)}"
      >
      </ha-icon>
