...
/**
        ...
        <div slot="header">
          <ha-dialog-header>
            <ha-icon-button
              slot="navigationIcon"
              data-dialog="close"
              .label=${as("ui.dialogs.more_info_control.dismiss",this.hass)}
              .path=${Vs}
            ></ha-icon-button>
            <div slot="title">
          ...
          <ha-input
            dialogInitialFocus
            .placeholder=${as("ui.common.search",this.hass)}
            aria-label=${as("ui.common.search",this.hass)}
            ...
            <div class="trailing" slot="trailingIcon">
              ${this._search&&q`
                <ha-icon-button
                  ...
                  .label=${as("ui.common.clear",this.hass)}
                  .path=${Vs}
                  class="clear-button"
                ></ha-icon-button>
              `}
    ...
    `:q``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("ha-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_toggleSelectEntity(e){let t=e.target;for(;"HA-LIST-ITEM"!=t.tagName;)t=t.parentElement;t.querySelector("ha-checkbox");const i=t.getAttribute("key");this._params.entities.includes(i)?this._params=Object.assign(Object.assign({},this._params),{entities:this._params.entities.filter(e=>e!=i)}):this._params=Object.assign(Object.assign({},this._params),{entities:[...this._params.entities,i]})}_toggleSelectDomain(e,t){var i;let s=e.target;for(;"HA-LIST-ITEM"!=s.tagName;)s=s.parentElement;const a=s.getAttribute("key"),o=null===(i=this.options)||void 0===i?void 0:i.find(e=>e.key==a).entities.map(e=>e.key);this._params=t?Object.assign(Object.assign({},this._params),{domains:this._params.domains.filter(e=>e!=a),entities:this._params.entities.filter(e=>!(null==o?void 0:o.includes(e)))}):Object.assign(Object.assign({},this._params),{domains:[...this._params.domains,a]}),e.stopPropagation()}closeGroupByKey(e){this.shadowRoot.querySelector("ha-list").childNodes.forEach(t=>{if(t.nodeType==Node.ELEMENT_NODE&&"HA-LIST-ITEM"==t.tagName&&t.getAttribute("key")==e){const e=t,i=e.nextElementSibling,s=e.querySelector("ha-icon-button");i.style.height="0px",e.removeAttribute("expanded"),s.classList.remove("expanded")}})}async _toggleExpandGroup(e){let t=e.target;for(;"HA-LIST-ITEM"!=t.tagName;)t=t.parentElement;const i=t.querySelector("ha-icon-button"),s=t.getAttribute("key");this.expandedGroups.includes(s)||(this.expandedGroups.forEach(e=>this.closeGroupByKey(e)),this.expandedGroups=[s],await this.requestUpdate());const a=t.nextElementSibling,o=a.scrollHeight;t.hasAttribute("expanded")?(t.removeAttribute("expanded"),i.classList.remove("expanded"),a.style.height="0px",setTimeout(()=>{this.expandedGroups=this.expandedGroups.filter(e=>e!=s)},300)):(t.setAttribute("expanded","true"),i.classList.add("expanded"),a.style.height=`${o}px`)}_renderOptions(){if(!this.options)return;let e=[...this.options];const t=this._filter&&this._filter.trim().length;if(t){const t=this._filter.toLowerCase().trim().split(" ");e=e.map(e=>la(e,t)||(e=Object.assign(Object.assign({},e),{entities:(e.entities||[]).filter(e=>la(e,t))})).entities.length?e:void 0).filter(e=>void 0!==e)}return e.length?Object.keys(e).map(i=>{var s,a;const o=e[i].key,n=null===(s=this._params)||void 0===s?void 0:s.domains.includes(o);let r=[...e[i].entities];"switch"==o&&(r=r.filter(e=>!this.scheduleEntities.includes(e.key)));const d=n?r.length:r.filter(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)}).length,l=(null===(a=this._params)||void 0===a?void 0:a.domains.includes(o))||e[i].entities.every(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)});return q`
        ...
        >
          ...
          <div slot="meta" class="meta">
            <ha-button
              ...
              size="small"
            >
              ${as(l?"ui.components.media-browser.file_management.deselect_all":"ui.components.subpage-data-table.select_all",this.hass)}
            </ha-button>
            <ha-icon-button .path="${qs}" @click=${e=>{e.target.blur()}} class="chevron"></ha-icon-button>
          </div>
          <span>${e[i].name}</span>
      ...
      `}):q`
        <ha-list-item disabled>
          ${as("ui.components.entity.entity-picker.no_match",this.hass)}
        </ha-list-item>
    ...
    `}};t([le({attribute:!1})],ca.prototype,"hass",void 0),t([ce()],ca.prototype,"_params",void 0),t([ce()],ca.prototype,"_search",void 0),t([ce()],ca.prototype,"_filter",void 0),t([ce()],ca.prototype,"_width",void 0),t([ce()],ca.prototype,"_height",void 0),t([ce()],ca.prototype,"expandedGroups",void 0),t([ce()],ca.prototype,"options",void 0),t([ce()],ca.prototype,"scheduleEntities",void 0),ca=t([re("dialog-select-entities")],ca);var ua=Object.freeze({__proto__:null,get DialogSelectEntities(){return ca}});let ha=class extends oe{constructor(){super(...arguments),this.active=!1}render(){return q`
    ...
    `}renderIcon(){if(!this.icon&&!this.toggleable&&!this.useStateIcon)return V;if(this.toggleable)return q`
      ...
      `:q`
        <div class="trailing-icon" @click=${this._iconClick}>
          ...
          ${this.disabled?V:q`<ha-tooltip for="${e}">${as("ui.common.remove",this.hass)}</ha-tooltip>`}
        </div>
    ...
    `}};t([le({attribute:!1})],ha.prototype,"hass",void 0),t([le({type:String})],ha.prototype,"icon",void 0),t([le({type:Boolean})],ha.prototype,"useStateIcon",void 0),t([le({type:Boolean})],ha.prototype,"selectable",void 0),t([le({type:Boolean})],ha.prototype,"removable",void 0),t([le({type:Boolean})],ha.prototype,"toggleable",void 0),t([le({type:Boolean})],ha.prototype,"active",void 0),t([le({type:String})],ha.prototype,"badge",void 0),t([le({type:String})],ha.prototype,"value",void 0),t([le({type:Boolean})],ha.prototype,"disabled",void 0),ha=t([re("scheduler-chip")],ha);let ma=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?q`
    ...
    `}};t([le({attribute:!1})],ma.prototype,"hass",void 0),t([le({attribute:!1})],ma.prototype,"items",void 0),t([le({attribute:!1})],ma.prototype,"value",void 0),t([le({type:Boolean})],ma.prototype,"selectable",void 0),t([le({type:Boolean})],ma.prototype,"toggleable",void 0),t([le({type:Boolean})],ma.prototype,"removable",void 0),t([le({type:Boolean})],ma.prototype,"disabled",void 0),ma=t([re("scheduler-chip-set")],ma);const pa=[{name:"primary",weight:10},{name:"secondary",weight:8}];let _a=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this.multipleMode=!1,this.scheduleEntities=[],this._valueRenderer=e=>{Array.isArray(e)&&(e=e.length?[...e].pop():"");const t=e||"",i=this.hass.states[t];if(!i)return q`
        <ha-svg-icon
          slot="start"
          .path=${Us}
          style="margin: 0 4px"
    ...
    `},this._filteredItems=()=>{let e=Object.keys(this.hass.states);this.domain&&(e=e.filter(e=>Yi(e)==this.domain)),this.multiple&&(e=e.filter(e=>{var t;return!(null===(t=this.value)||void 0===t?void 0:t.includes(e))})),this.config&&(e=e.filter(e=>((this.config.include||He).some(t=>Xi(t,e))||Object.keys(this.config.customize||{}).some(t=>Xi(t,e)))&&!(this.config.exclude||[]).some(t=>Xi(t,e)))),e=e.filter(e=>!this.scheduleEntities.includes(e)),this.filterFunc&&(e=e.filter(e=>this.filterFunc(this.hass.states[e])));let t=e.map(e=>this._parseEntityItem(e));return t}}async firstUpdated(){this.scheduleEntities=Object.entries(await Oe(this.hass)).map(([,e])=>e.entity_id),this.domain&&this.config&&!es(this.domain,this.config)&&(this.config=Object.assign(Object.assign({},this.config),{include:[...this.config.include||[],this.domain],exclude:[...(this.config.exclude||[]).filter(e=>!e.startsWith(this.domain))]})),this._autoSelectIfSingleEntity()}updated(e){super.updated(e),e.has("domain")&&this._autoSelectIfSingleEntity()}_autoSelectIfSingleEntity(){if(this.value&&this.value.length>0)return;const e=this._filteredItems();1===e.length&&(this.value=[e[0].id],Ps(this,"value-changed",{value:this.value}))}render(){var e,t;return q`
      ${this.renderChips()}

      ${(null===(e=this.value)||void 0===e?void 0:e.length)&&!this.multipleMode&&this.multiple?V:q`

      <ha-generic-picker
        .label=${(null===(t=this.value)||void 0===t?void 0:t.length)?"":as("ui.components.entity.entity-picker.choose_entity",this.hass)}
        .hass=${this.hass}
        .autofocus=${this.autofocus}
        .notFoundLabel=${as("ui.components.combo-box.no_match",this.hass)}
        ...
        .searchKeys=${pa}
        .searchLabel=${as("ui.dialogs.quick-bar.filter_placeholder",this.hass)}
    ...
    `}renderChips(){if(!this.multiple)return V;let e=(this.value||[]).map(e=>{const t=this._parseEntityItem(e);return{name:t.primary,value:e,useStateIcon:!t.icon,icon:t.icon}});return q`
      ...
      <ha-icon-button
        ...
        .path=${this.multipleMode?"M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z":qs}
        slot="end"
      ></ha-icon-button>
      `:V}
      </div>
      </div>
      `}_valueChanged(e){let t=e.detail.value;const i=e.currentTarget;t&&(this.value=[...this.value||[],t],this.multiple&&(i.value=""),Ps(this,"value-changed",{value:this.value}),e.stopPropagation())}_removeClick(e){const t=e.detail;this.value=(this.value||[]).filter(e=>e!==t),Ps(this,"value-changed",{value:this.value})}_parseEntityItem(e){var t,i,s,a;const o=Object.entries((null===(t=this.config)||void 0===t?void 0:t.customize)||{}).filter(([t,i])=>Xi(t,e)).map(([e,t])=>t),n=null===(i=o.find(e=>"name"in e))||void 0===i?void 0:i.name,r=null===(s=o.find(e=>"icon"in e))||void 0===s?void 0:s.icon;return{id:e,primary:n||Qi(e,null===(a=this.hass.states[e])||void 0===a?void 0:a.attributes),secondary:e,icon:r}}};_a.styles=r`
    :host {
      display: flex;
  ...
  `,t([le({attribute:!1})],_a.prototype,"hass",void 0),t([le()],_a.prototype,"domain",void 0),t([le()],_a.prototype,"config",void 0),t([le({type:Array})],_a.prototype,"value",void 0),t([le({type:Boolean})],_a.prototype,"multiple",void 0),t([le({type:Boolean})],_a.prototype,"disabled",void 0),t([ce()],_a.prototype,"multipleMode",void 0),t([ce()],_a.prototype,"scheduleEntities",void 0),_a=t([re("scheduler-entity-picker")],_a);let ga=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
      <div
    ...
    `}};t([le()],va.prototype,"disabled",void 0),t([ce()],va.prototype,"_openedItem",void 0),t([ce()],va.prototype,"_numItems",void 0),va=t([re("scheduler-collapsible-group")],va);const ya="__NONE_OPTION__";let fa=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){var e;if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),Ps(this,"value-changed",{value:this.value})},s=()=>{let e=t.map(e=>Object({name:e,value:e}));return q`
        ...
        `)):q`
          <ha-dropdown-item .value=${ya}>
            ${this.hass.localize("ui.components.combo-box.no_match")}
          </ha-dropdown-item>
        `,l=e=>{let t=e.target,i=t.querySelector("ha-picker-field");this.style.setProperty("--select-menu-width",`${i.offsetWidth}px`),t.classList.add("opened")},c=e=>{e.target.classList.remove("opened")},u=e=>{const t=e.detail.item.value;(t!=ya&&!Array.isArray(this.value)||(e.target.value=void 0,t!=ya))&&this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))},h=()=>{this._valueChanged(new CustomEvent("value-changed",{detail:{value:void 0}}))},m=We(this.value)&&!Array.isArray(this.value)?n.find(e=>e.id===this.value):void 0,p=m?m.primary||m.id:We(this.value)&&!Array.isArray(this.value)?this.value:void 0;return q`
      ...
      `}if(this.config.number){const t=this.config.number,i="box"==t.mode||!We(t.min)||!We(t.max);let s=this.value;i||"number"==typeof s||(s=t.min),"number"==typeof t.scale_factor&&(s=Number(s)/t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(s=Math.round(Number(s)/t.step)*t.step),We(s)&&(s=hs(Number(s)));const a=e=>{let i=Number(e.target.value);"number"==typeof t.scale_factor&&(i*=t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(i=Math.round(i/t.step)*t.step),i=hs(i),this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}})),e.stopPropagation()},o=e=>{e.stopPropagation();let t=e.target.value;const i=""===t||isNaN(Number(t))?void 0:Number(t);this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}}))},n=(e,i)=>{let s=t.step&&Number(t.step)%1==0?null!==e.match(/^-?\d+$/):null!==e.match(/^[+-]?\d+([.,]\d+)?$/);return s&&We(t.min)&&(s=Number(e)>=t.min),s&&We(t.max)&&(s=Number(e)<=t.max),{valid:s,customError:!s}};return q`
      ...
      `;if(this.config.boolean){let e={select:{options:[{value:"true",label:"True",icon:"mdi:check"},{value:"false",label:"False",icon:"mdi:close"}]}};const t=e=>{let t=We(e.detail.value)?"true"===e.detail.value:void 0;e.stopPropagation(),this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))};return q`
      ...
      `}return q``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t]}else if(e.detail){let t=e.detail.value;void 0===t&&(t=null),this.value=t}else this.value=e.target.value;Ps(this,"value-changed",{value:this.value})}};fa.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
  ...
  `,t([le({attribute:!1})],fa.prototype,"hass",void 0),t([le({attribute:!1})],fa.prototype,"config",void 0),t([le()],fa.prototype,"value",void 0),t([le({type:Boolean})],fa.prototype,"disabled",void 0),fa=t([re("scheduler-combo-selector")],fa);let ba=class extends oe{constructor(){super(...arguments),this._config={},this.title="",this.tagOptions=[],this.customTagValue=""}setConfig(e){this._config=Object.assign({},e)}async firstUpdated(){this.title="string"==typeof this._config.title?this._config.title:"";const e=(await Is(this.hass)).map(e=>e.name);e.sort(is),this.tagOptions=e}render(){var e,t,i,s,a,o,n,r;const d={number:{min:0,max:30,step:1,unit_of_measurement:Gi("ui.panel.card_editor.fields.time_step.unit_minutes",this.hass)}},l={select:{options:this.tagOptions,multiple:!0,custom_value:!0}};return q`
      <div class="card-config">
        ...
        <div class="two-columns">
          ...
          >
            <ha-icon
              icon="${[this._config.sort_by||qe].flat().includes("relative-time")?"mdi:radiobox-marked":"mdi:radiobox-blank"}"
              class="${[this._config.sort_by||qe].flat().includes("relative-time")?"checked":""}"
            ></ha-icon>
          ...
          >
            <ha-icon
              icon="${[this._config.sort_by||qe].flat().includes("title")?"mdi:radiobox-marked":"mdi:radiobox-blank"}"
              class="${[this._config.sort_by||qe].flat().includes("title")?"checked":""}"
            ></ha-icon>
        ...
        <div class="two-columns">
          ...
          >
            <ha-icon
              icon="${[(null===(e=this._config.display_options)||void 0===e?void 0:e.primary_info)||Re].flat().includes("default")?"mdi:radiobox-marked":"mdi:radiobox-blank"}"
              class="${[(null===(t=this._config.display_options)||void 0===t?void 0:t.primary_info)||Re].flat().includes("default")?"checked":""}"
            ></ha-icon>
          ...
          >
            <ha-icon
              icon="${[(null===(i=this._config.display_options)||void 0===i?void 0:i.primary_info)||Re].flat().includes("{entity}: {action}")?"mdi:radiobox-marked":"mdi:radiobox-blank"}"
              class="${[(null===(s=this._config.display_options)||void 0===s?void 0:s.primary_info)||Re].flat().includes("{entity}: {action}")?"checked":""}"
            ></ha-icon>
        ...
        <div class="column">
          <ha-formfield label="${Gi("ui.panel.card_editor.fields.display_format_secondary.options.relative_time",this.hass)}">
            <ha-checkbox
              ...
              ?checked=${[(null===(a=this._config.display_options)||void 0===a?void 0:a.secondary_info)||Ve].flat().includes("relative-time")}
            >
            </ha-checkbox>
          </ha-formfield>
          ...
          <ha-formfield label="${Gi("ui.panel.card_editor.fields.display_format_secondary.options.time",this.hass)}">
            <ha-checkbox
              value="time"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(o=this._config.display_options)||void 0===o?void 0:o.secondary_info)||Ve].flat().includes("time")}
            >
            </ha-checkbox>
          </ha-formfield>
        ...
        <div class="column">
          <ha-formfield label="${Gi("ui.panel.card_editor.fields.display_format_secondary.options.days",this.hass)}">
            <ha-checkbox
              value="days"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(n=this._config.display_options)||void 0===n?void 0:n.secondary_info)||Ve].flat().includes("days")}
            >
            </ha-checkbox>
          </ha-formfield>
          ...
          <ha-formfield label="${Gi("ui.panel.card_editor.fields.display_format_secondary.options.additional_tasks",this.hass)}">
            <ha-checkbox
              ...
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(r=this._config.display_options)||void 0===r?void 0:r.secondary_info)||Ve].flat().includes("additional-tasks")}
            >
            </ha-checkbox>
          </ha-formfield>
        </div>
  ...
  `,t([le({attribute:!1})],ba.prototype,"hass",void 0),t([le()],ba.prototype,"_config",void 0),t([le()],ba.prototype,"title",void 0),t([le()],ba.prototype,"tagOptions",void 0),t([ce()],ba.prototype,"customTagValue",void 0),ba=t([re("scheduler-card-editor")],ba);const wa=r`
  ha-dialog {
...
`;const ka=(e,t,i,s)=>{var a;const o=e.service,n=null===(a=e.target)||void 0===a?void 0:a.entity_id,r=us(e,s,i);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const d=r.fields[t];if(null===gs(o,n,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(d.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&d.supported_features)>0}))return!1}return!("light"==Yi(o)&&![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;const s=i.states[e].attributes.supported_color_modes||[];return"brightness"!=t||s.filter(e=>"onoff"!=e).length}))};var xa;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(xa||(xa={}));const $a=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>{const i=e.every((i,s)=>{const a=Ae(i.start,t),o=void 0===i.stop?a:Ae(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>i<=s||Ae(e.start,t)>=o)});return i?null:xa.OverlappingTime})(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,xa.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{var s;const a=us(e,i,t);return(null==a?void 0:a.target)&&!(null===(s=e.target)||void 0===s?void 0:s.entity_id)?xa.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).filter(([s])=>ka(e,s,t,i)).every(([s,a])=>{var o,n;let r=gs(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,s,t,i);const d=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||a.optional;return!(!Object.keys(e.service_data).includes(s)&&!d||!We(e.service_data[s])&&!d)})?xa.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},ja=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))});let i={weekdays:e.entries[0].weekdays.map(Oa),timeslots:e.entries[0].slots.map(Sa),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},Oa=e=>{switch(e){case pe.Monday:return"mon";case pe.Tuesday:return"tue";case pe.Wednesday:return"wed";case pe.Thursday:return"thu";case pe.Friday:return"fri";case pe.Saturday:return"sat";case pe.Sunday:return"sun";case pe.Workday:return"workday";case pe.Weekend:return"weekend";default:return"daily"}},Sa=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>za(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==_e.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),za=e=>{var t,i;const s=e=>Object.keys(e).filter(t=>We(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){let t=null==e?void 0:e.target.entity_id.map(t=>({service:e.service,service_data:s(e.service_data),entity_id:t}));return t}return{service:e.service,service_data:s(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:s(e.service_data)}},Ca=(e,t,i)=>{const s={title:as("state_badge.default.error",i),description:q`
    <b>Something went wrong!</b><br />
    ${e.body.message}<br /><br />
    ${e.error}<br /><br />
    Please <a href="https://github.com/nielsfaber/scheduler-card/issues">report</a> the bug.
  `,primaryButtonLabel:as("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};Ps(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return no}),dialogParams:s})},Aa=e=>{if(!Object.keys(e).includes("select")||!e.select){if(Object.keys(e).includes("number")&&e.number){const t=e.number.min;return void 0!==t?t:0}return Object.keys(e).includes("boolean")&&e.boolean?void 0:(Object.keys(e).includes("text")&&e.text,"")}e.select.options},Ea=(e,t)=>{const i=us(e,t),s=Yi(e.service),a=Ji(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:`mdi:${o}`;if(Object.keys(_s).includes(s)&&Object.keys(_s[s].services).includes(a)){if(void 0!==_s[s].attributes){let t=_s[s].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return _s[s].services[a]}return Object.keys(_s).includes(s)&&Object.keys(_s[s].services).includes("{entity_id}")?_s[s].services["{entity_id}"]:"mdi:flash";var o},Ta=(e,t,i)=>{let s=Ae("string"==typeof e?Ce(e):e,i),a=Ae("string"==typeof t?Ce(t):t,i);return a>s?1:a<s?-1:0},Da=e=>Ce(e.start),Ma=e=>{if(We(e.stop)){const t=Ce(e.stop);return 0==t.hours&&0==t.minutes&&t.mode==be.Fixed?Object.assign(Object.assign({},t),{hours:24}):t}return Se(Da(e),{minutes:1})},La=(e,t,i,s)=>{let a=t;if(We(i.stop))return[e,a]=La(e,t+1,{start:i.stop},s),[e,a-1];if(!We(i.start))return[e,a];let o=Da(e[t]),n=i.start,r=Da(e[t]);for(let i=t-1;i>=0;i--){if(e[i].actions.length){r=i==t-1?Se(Da(e[i]),{minutes:1}):Ma(e[i]);break}r=Da(e[i])}let d=Se(Ma(e[t]),{minutes:-1});if(!We(e[t].stop))for(let i=t+1;i<e.length;i++){if(e[i].actions.length){d=i==t+1?Se(Ma(e[i]),{minutes:-1}):Da(e[i]);break}d=Ma(e[i])}if(Ta(r,n,s)<0&&(n=r),Ta(d,n,s)>0&&Ae(d,s)>0&&(n=d),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Ne(n)})}),Ta(o,n,s)<=0)for(let i=t-1;i>=0;i--){let t=Ta(Da(e[i]),n,s),o=Ta(Ma(e[i]),n,s);if(t>0&&o<=0){e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:Ne(n)})});break}if(o>=0)break;t<=0&&(e=Object.assign(e,{[i]:null}),a-=1)}if(Ta(o,n,s)<0&&!We(e[t].stop)&&(e=We(e[t+1].stop)&&!e[t+1].actions.length?Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:Ne(Ma(e[t]))})}):[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:Ne(Ma(e[t])),stop:Ne(Da(e[t+1])),actions:[]}),...e.slice(t+1)]),Ta(o,n,s)>=0)for(let t=a+1;t<e.length;t++){let i=Ma(e[a]),o=Ta(Da(e[t]),i,s),n=Ta(Ma(e[t]),i,s);if(o>=0&&n<0)e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Ne(i)})});else{if(o<0)break;n>=0&&(e=Object.assign(e,{[t]:null}))}}return Ta(o,n,s)>0&&(t>0&&We(e[t-1].stop)?e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:Ne(n)})}):(e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:t>0?Ne(Ma(e[t-1])):"00:00:00",stop:Ne(n),actions:[]}),...e.slice(t)],a=t+1)),[e=e.filter(We),a]},Pa=(e,t)=>{const i=new Date(t),s=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let a=3600*e.hours+60*e.minutes-s;const o=a<0?-1:1;a=Math.abs(a);let n=Math.floor(a/3600),r=Math.round((a-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),ze({hours:n,minutes:r})},Na=86400;let Ia=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this._width=0,this.large=!1}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=t.contentRect.width;e!==this._width&&(this._width=e)}}),this._resizeObserver.observe(this)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._resizeObserver)||void 0===e||e.disconnect()}render(){return q`
      <div class="bar">
    ...
    `}renderTimebar(){const e=this._width,t=[1,2,3,4,6,8,12],i=De(this.hass.locale),s=i?130:100;if(!e)return q``;let a=Math.ceil(24/(e/s));for(;!t.includes(a);)a++;const o=[0,...Array.from(Array(24/a-1).keys()).map(e=>(e+1)*a),24];return o.map((e,t)=>{let s=a/24*100;s=Math.floor(100*s)/100;let n={mode:be.Fixed,hours:e,minutes:0};return 0==t?q`
        <span class="left" style=${ea({width:s/2+"%"})}>${Ne(n,{seconds:!1,am_pm:i})}</span>
      `:t==o.length-1?q`
        <span class="right" style=${ea({width:s/2+"%"})}>${Ne(n,{seconds:!1,am_pm:i})}</span>
      `:q`
        <span style=${ea({width:`${s}%`})}>${Ne(n,{seconds:!1,am_pm:i})}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,s)=>{const a=i.actions.length?$s(i.actions[0],this.hass,this.config.customize,!0,!0):"",o=5*a.length+10,n=s>0?15:0,r=s<e.length-1?15:0,d=t[s]-n-r,l=e[s+1];return q`
        <div
          class="slot ${this.selectedSlot==s?"selected":""} ${i.actions.length?"":"empty"} ${void 0===i.stop?"short":""}"
          style="${ea({width:`${t[s]}px`})}"
          @click=${this._toggleSelectTimeslot}
          idx="${s}"
        >
          ${i.stop,""}
          ${i.actions.length?a&&(d>o/3||d>50)&&d>30?q`<span style="margin-left: ${n}px; margin-right: ${r}px">${a}</span>`:d>16?q`<ha-icon icon="${Ea(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
    ...
    `}};t([le({attribute:!1})],Ia.prototype,"config",void 0),t([ce()],Ia.prototype,"schedule",void 0),t([ce()],Ia.prototype,"selectedSlot",void 0),t([ce()],Ia.prototype,"_width",void 0),t([le({type:Boolean})],Ia.prototype,"large",void 0),Ia=t([re("scheduler-timeslot-editor")],Ia);const qa=e=>{let t=60*e.hours+e.minutes;return t>240?e=Object.assign(Object.assign({},e),{hours:4,minutes:0}):t<-240&&(e=Object.assign(Object.assign({},e),{hours:-4,minutes:0})),e};let Ra=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=be.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1,this.large=!1,this.stepSize=10}set time(e){const t=Ce(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return q`
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return V;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=be.Fixed&&(e=qa(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return q`
        <div class="mode">
    ...
    `}}_renderSuffix(){if(this.large){const e=()=>{let e=Le(this.hours).am_pm;const t=Le(this.hours).hours;this.hours=Pe(t,"AM"==e?Me.PM:Me.AM),this._valueChanged()},t=()=>{0!=this.hours?this.hours=-this.hours:this.minutes=-this.minutes,this._valueChanged()},i=()=>{this.mode=this.mode==be.Sunrise?be.Sunset:be.Sunrise,this._valueChanged()};return q`
      ...
      `:V}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=be.Fixed||this.mode==be.Fixed){const s=Pa({hours:this.hours,minutes:this.minutes},t),a=Pa({hours:this.hours,minutes:this.minutes},i),o=60*s.hours+s.minutes,n=60*a.hours+a.minutes;let r=e||(Math.abs(o)<=Math.abs(n)?be.Sunrise:be.Sunset),d=r==be.Sunrise?s:a;return{mode:r,hours:d.hours,minutes:d.minutes}}{let e=this.mode==be.Sunrise?Ce(t):Ce(i);return e=Se(e,{hours:this.hours,minutes:this.minutes}),{mode:be.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Le(this.hours).am_pm;t=Pe(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.detail.value;if(Le(this.hours).am_pm==t)return;const i=Le(this.hours).hours;this.hours=Pe(i,"AM"==t?Me.AM:Me.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=Se(t,e),e.minutes&&(t=ze(t,this.stepSize)),this.mode!=be.Fixed&&(t=qa(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};Ps(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==be.Fixed?Le(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==be.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};Ra.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([le({attribute:!1})],Ra.prototype,"hass",void 0),t([ce()],Ra.prototype,"hours",void 0),t([ce()],Ra.prototype,"minutes",void 0),t([ce()],Ra.prototype,"mode",void 0),t([le({type:Boolean})],Ra.prototype,"autoValidate",void 0),t([le({type:Boolean})],Ra.prototype,"required",void 0),t([le({type:Boolean})],Ra.prototype,"disabled",void 0),t([le({type:String})],Ra.prototype,"label",void 0),t([le({type:Boolean})],Ra.prototype,"useAmPm",void 0),t([le({type:Boolean})],Ra.prototype,"large",void 0),t([le({attribute:!1})],Ra.prototype,"stepSize",void 0),Ra=t([re("scheduler-time-picker")],Ra);const Va="Custom";let Ha=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![pe.Daily,pe.Weekend,pe.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0&&this._params.weekdays.length==this.selectedWeekdays.length}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        width="small"
    ...
    `:q``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[pe.Sunday,pe.Monday,pe.Tuesday,pe.Wednesday,pe.Thursday,pe.Friday,pe.Saturday];const t=(e,t)=>e.concat(e).slice(t,t+e.length);e=t(e,zs(this.hass))}else e=[pe.Daily,pe.Workday,pe.Weekend,Va];const t=e=>{var t,i;return e==Va?null===(t=this._params)||void 0===t?void 0:t.weekdays.some(e=>![pe.Daily,pe.Weekend,pe.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>q`
        <ha-list-item
          graphic="icon"
    ...
    `}};t([le({attribute:!1})],Ha.prototype,"hass",void 0),t([ce()],Ha.prototype,"_params",void 0),t([ce()],Ha.prototype,"weekdayTypeCustomSelected",void 0),t([ce()],Ha.prototype,"selectedWeekdays",void 0),Ha=t([re("dialog-select-weekdays")],Ha);var Fa=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return Ha}});const Ua=(e,t)=>((e,t)=>e<t?-1:e>t?1:0)(e.toLowerCase(),t.toLowerCase()),Ba=(e,t,i)=>{const s=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(e=>{if(!Object.keys(ns).includes(t))return!1;let s=Object.keys(ns[t]).includes(e);if(!s&&Object.keys(ns[t]).includes("{entity_id}")){if("script"==t&&["turn_on","turn_off","reload","toggle","test"].includes(e))return!1;s=es(`${t}.${e}`,i)}return s}):[],a=t=>as(`component.${t}.title`,e,!1)||t.replace(/_/g," "),o=s=>{let o=ss($s({service:`${t}.${s}`,service_data:{}},e,i.customize));return"script"==t?Object.keys(i.customize||{}).includes(`${t}.${s}`)&&We(i.customize[`${t}.${s}`].name)?i.customize[`${t}.${s}`].name:`${ss(Es(`${t}.${s}`,e,i.customize))}: ${o}`:`${a(t)}: ${o}`},n=i=>{let s=as(`component.${t}.services.${i}.description`,e,!1);return s||(s=e.services[t][i].description),s||"script"!=t||(s=as(`component.${t}.services.turn_on.description`,e,!1)),s};let r=s.map(s=>{return{key:s,name:o(s),description:n(s),icon:(a=s,"script"==t&&Object.keys(i.customize||{}).includes(`${t}.${a}`)&&We(i.customize[`${t}.${a}`].icon)?i.customize[`${t}.${a}`].icon:Object.keys(_s).includes(t)&&Object.keys(_s[t].services).includes(a)?_s[t].services[a]:Ws(t)),action:{service:s.includes(".")?s:`${t}.${s}`,service_data:{},target:e.services[t][s].target?{}:void 0}};var a}),d=(l=i.customize||{},c=t,Object.keys(l).filter(e=>{var t;return null===(t=l[e].exclude_actions)||void 0===t?void 0:t.length}).filter(e=>!c||!c.includes(".")&&Xi(Yi(e),c)||Xi(e,c)).map(e=>l[e].exclude_actions).flat().filter(We));var l,c;return d.length&&(r=r.filter(t=>!d.some(s=>Ua(Ji(t.action.service),s)>0||Ua($s(t.action,e,i.customize),s)>0))),cs(i.customize||{},t).forEach(e=>{let i=e.service;for(;r.find(e=>e.key==i);)i+="_2";e.variables&&Object.entries(e.variables).forEach(([t,i])=>{let s=fs(i),a=Aa(s);!We(e.service_data[t])&&We(a)?e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:a})}):We(e.service_data[t])||(e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:null})}))}),r.push({key:i,name:`${a(t)}: ${Wa(e.name||o(Ji(e.service)))}`,description:Wa(e.name||""),icon:e.icon||Ws(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},target:e.target?e.target:void 0,name:e.name,icon:e.icon}})}),r},Wa=e=>{if(null!==/<.+?>/g.exec(e)){e=(new DOMParser).parseFromString(e,"text/html").body.textContent||""}let t;for(;t=/\[([^\]]+)\]/.exec(e);)e=e.replace(t[0],"");for(;t=/\{([^\}]+)\}/.exec(e);)e=e.replace(t[0],"");return e};let Za=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.lockDomain=!1,this.showAll=!1}async showDialog(e){this._params=e,this.lockDomain=void 0!==e.domainFilter,this.showAll=!1,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title"),this.hass.loadBackendTranslation("services")}render(){return this._params?q`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        @wa-after-show=${this._opened}
      >
        <div slot="header">
          <ha-dialog-header>
            ...
            <ha-icon-button
              slot="navigationIcon"
              .label=${as("ui.common.back",this.hass)}
              .path=${Rs}
            ...
            ${!this.lockDomain&&We(this._params.cardConfig.include)?q`
            <ha-dropdown
              placement="bottom-end"
              slot="actionItems"
              @wa-after-hide=${e=>{e.target.firstElementChild.blur()}}
            >
              <ha-icon-button slot="trigger" .label=${this.hass.localize("ui.common.menu")} .path=${Hs}>
              </ha-icon-button>
    ...
    `}};t([le({attribute:!1})],Za.prototype,"hass",void 0),t([ce()],Za.prototype,"_params",void 0),t([ce()],Za.prototype,"_search",void 0),t([ce()],Za.prototype,"_filter",void 0),t([ce()],Za.prototype,"_width",void 0),t([ce()],Za.prototype,"_height",void 0),t([ce()],Za.prototype,"lockDomain",void 0),t([ce()],Za.prototype,"showAll",void 0),Za=t([re("dialog-select-action")],Za);var Ka=Object.freeze({__proto__:null,get DialogSelectAction(){return Za}});let Ga=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return q`
      ${this.showPrefix?q`
    ...
    `}};t([le({type:Boolean})],Ga.prototype,"showPrefix",void 0),Ga=t([re("scheduler-settings-row")],Ga);let Ja=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this.large=!1,this.selectedEntry=0}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return q`
      ...
      <div class="editor-header">
        <div class="weekdays">
          <span>
            ...
            ${As(e.weekdays,"short",this.hass)}
          </span>
          <ha-icon-button .path=${Fs} @click=${e=>this._showWeekdayDialog(e,t)}></ha-icon-button>
        </div>
    ...
    `}toggleViewMode(){const e=this.viewMode==me.Scheme?me.Single:me.Scheme;this.dispatchEvent(new CustomEvent("setViewMode",{detail:e}))}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return q``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=Ae(e,this.hass),s=(Ae(t,this.hass)||86400)-i;return q`
      <div class="actions">
        <ha-icon-button .path=${Rs} @click=${e=>{this._updateSelectedSlot(this.selectedSlot-1),e.target.blur()}} ?disabled=${null===this.selectedSlot||this.selectedSlot<1}>
        </ha-icon-button> 
    ...
    `;const n=us(o,this.config.customize,this.hass),r=(null===(e=n.target)||void 0===e?void 0:e.domain)||Yi(o.service),d=We(null===(t=null==n?void 0:n.target)||void 0===t?void 0:t.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&We(null===(i=null===(t=us(e.actions[0],this.config.customize,this.hass))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return q``;const l=Object.keys(n.fields||{}).filter(e=>ka(o,e,this.hass,this.config.customize));let c="",u=[(null===(i=o.target)||void 0===i?void 0:i.entity_id)||[]].flat();return!u.length&&["notify","script"].includes(r)&&(u=[o.service]),u.length&&(c+=u.map(e=>Es(e,this.hass,this.config.customize)).join(", "),c+=": "),c+=$s(o,this.hass,this.config.customize,!1,!0),q`
      <scheduler-collapsible-section
        ?expanded=${!0}
        ?disabled=${!0}
      >
        <div slot="header" class="header">
          <ha-icon slot="icon" icon="${Ea(o,this.config.customize)}"></ha-icon>
          <span>${ss(c)}</span>
        </div>
        ...
        <ha-dropdown
          ...
          placement="bottom-end"
        >
          <ha-icon-button slot="trigger" .path=${Hs}>
          </ha-icon-button>
          <ha-dropdown-item value="change_type">
            <ha-icon icon="mdi:pencil"></ha-icon>
            ${as("ui.panel.lovelace.editor.card.conditional.change_type",this.hass)}
          </ha-dropdown-item>
          <ha-dropdown-item variant="danger" value="delete">
            <ha-icon icon="mdi:delete"></ha-icon>
            ${as("ui.common.delete",this.hass)}
          </ha-dropdown-item>
        </ha-dropdown>
        ...
        <div slot="content">
          ...
          ${n.target?q`
          <scheduler-settings-row>
            <span slot="heading">${as("ui.components.entity.entity-picker.entity",this.hass)}</span>
          ...
          ${l.map(e=>{var t;const i=gs(o.service,null===(t=o.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let s=n.fields[e].optional||(i.number||{}).optional;const a=!s||Object.keys(o.service_data).includes(e);return q`
            <scheduler-settings-row ?showPrefix=${s}>
              ...
              `:""}
              <span slot="heading">
                ${((e,t,i,s)=>{var a;const o=Yi(e.service),n=Ji(e.service);let r=as(`component.${o}.services.${n}.fields.${t}.name`,i,!1);!r&&i.services[o]&&i.services[o][n]&&i.services[o][n].fields&&i.services[o][n].fields[t]&&(r=String(i.services[o][n].fields[t].name||""));const d=["script","notify"].includes(o)?[e.service]:[(null===(a=e.target)||void 0===a?void 0:a.entity_id)||[]].flat(),l=d.length?d[0]:e.service;let c=cs(s||{},l);if(c.length){let i=c.map(i=>i.service==e.service&&Object.keys(i.variables||{}).includes(t)?(i.variables||{})[t].name:null).filter(We);if(i.length)return i[0]}return r||(r=t.replace(/_/g," ")),r})(o,e,this.hass,this.config.customize)}
              </span>
              <scheduler-combo-selector
                .hass=${this.hass}
                .config=${i}
  ...
  ha-list-item.warning, ha-list-item.warning ha-icon {
    ...
    `}};t([le({attribute:!1})],Ja.prototype,"hass",void 0),t([le({attribute:!1})],Ja.prototype,"config",void 0),t([le({attribute:!1})],Ja.prototype,"viewMode",void 0),t([le({attribute:!1})],Ja.prototype,"selectedSlot",void 0),t([le({type:Boolean})],Ja.prototype,"large",void 0),t([ce()],Ja.prototype,"schedule",void 0),t([ce()],Ja.prototype,"selectedEntry",void 0),Ja=t([re("scheduler-main-panel")],Ja);const Ya=["January","February","March","April","May","June","July","August","September","October","November","December"];function Qa(e){return e.toISOString().split("T")[0]}function Xa(e){let t=new Date;const i=(e||"").match(/^([0-9]{4})-([0-9]{2})-([0-9]{2})/);null!==i&&t.setFullYear(Number(i[1]),Number(i[2])-1,Number(i[3]));const s=(e||"").match(/([0-9]{2}):([0-9]{2})(:([0-9]{2}))?$/);return null!==s&&t.setHours(Number(s[1]),Number(s[2]),s.length>4?Number(s[4]):t.getSeconds()),t}const eo=(e,t)=>"select"in t&&null!==t.select?((e,t)=>{var i;return((null===(i=t.select)||void 0===i?void 0:i.options)||[]).some(t=>"object"==typeof t?t.value==e:t==e)})(String(e),t):"number"in t&&null!==t.number?((e,t)=>{var i,s;return!(isNaN(e)||void 0!==(null===(i=t.number)||void 0===i?void 0:i.min)&&e<t.number.min||void 0!==(null===(s=t.number)||void 0===s?void 0:s.max)&&e>t.number.max)})(Number(e),t):!("text"in t)||null===t.text||String(e).length>0,to=e=>null==e||Array.isArray(e)?e:[e];let io=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.showAll=!1}async showDialog(e){this._params=e,this.showAll=!1,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title")}render(){return this._params?q`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        @wa-after-show=${this._opened}
    ...
    `}};t([le({attribute:!1})],io.prototype,"hass",void 0),t([ce()],io.prototype,"_params",void 0),t([ce()],io.prototype,"_search",void 0),t([ce()],io.prototype,"_filter",void 0),t([ce()],io.prototype,"_width",void 0),t([ce()],io.prototype,"_height",void 0),t([ce()],io.prototype,"showAll",void 0),io=t([re("dialog-select-condition")],io);var so=Object.freeze({__proto__:null,get DialogSelectCondition(){return io}});let ao=class extends oe{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[],this.customTagValue=""}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||Qa(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||Qa(new Date);const i=(await Is(this.hass)).map(e=>e.name),s=[this.config.tags||[]].flat();this.tags=[...new Set([...i,...s.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))])]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return q`
      ...
      <div class="period">
        ...
        <div class="input">
          <ha-date-input
            ...
            .label=${as("ui.components.date-range-picker.start_date",this.hass)}
        ...
        <div class="input">
          <ha-date-input
            .locale=${this.hass.locale}
            value=${this.endDate}
            .label=${as("ui.components.date-range-picker.end_date",this.hass)}
      ...
      <span class="header">${as("ui.common.name",this.hass)}:</span>
      <div class="period">
        <ha-input
          value=${this.schedule.name||""}
          placeholder=${this.schedule.name?"":as("ui.common.name",this.hass)}
      ...
      >
        ...
        ${as("ui.components.calendar.event.repeat.label",this.hass)}
      </ha-button>
      <ha-button
      ...
      >
        ...
        ${as("ui.dialogs.more_info_control.vacuum.stop",this.hass)}
      </ha-button>
      <ha-button
    ...
    `}renderConditions(){let e=this.schedule.entries[0].slots[0].conditions.items;return this.conditionIdx==e.length&&(e=[...e,{}]),e.map((e,t)=>{var i;const s=this.conditionIdx==t?this.selectedEntity||e.entity_id||"":e.entity_id||"",a=this.conditionIdx==t&&this.selectedDomain||Yi(s),o=oa(s||a,this.hass,this.config.customize),n=o&&o.hasOwnProperty("number")?[ge.Above,ge.Below]:[ge.Equal,ge.Unequal],r={[ge.Equal]:"mdi:equal",[ge.Unequal]:"mdi:not-equal-variant",[ge.Above]:"mdi:greater-than",[ge.Below]:"mdi:less-than"},d={[ge.Equal]:"ui.panel.options.conditions.types.equal_to",[ge.Unequal]:"ui.panel.options.conditions.types.unequal_to",[ge.Above]:"ui.panel.options.conditions.types.above",[ge.Below]:"ui.panel.options.conditions.types.below"};return this.conditionIdx!==t||this.selectedMatchType||(this.selectedMatchType=n[0]),q`
      <scheduler-collapsible-section idx="${t}">
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${as("ui.components.selectors.selector.types.entity",this.hass)}
          </span>
          <scheduler-entity-picker
            .hass=${this.hass}
            .config=${this.config}
            .domain=${a}
            @value-changed=${this._selectEntity}
            .value=${this.conditionIdx==t?to(this.selectedEntity):to(e.entity_id)}
            ?multiple=${!1}
          >
          </scheduler-entity-picker>
        </scheduler-settings-row>
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${ss(Gi(d[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
            <ha-dropdown
              @wa-select=${this._selectMatchType}
              @wa-after-hide=${e=>{e.target.firstElementChild.blur()}}
            >
              <ha-icon-button slot="trigger" .path=${Fs}>
              </ha-icon-button>
              ${n.map(i=>q`
                <ha-dropdown-item 
                ...
                >
                  ...
                  ${ss(Gi(d[i],this.hass,["{entity}","{value}"],["",""]))}
                </ha-dropdown-item>
              `)}
            </ha-dropdown>
          </span>
    ...
    `}};t([le({attribute:!1})],ao.prototype,"hass",void 0),t([le({attribute:!1})],ao.prototype,"config",void 0),t([ce()],ao.prototype,"schedule",void 0),t([ce()],ao.prototype,"conditionIdx",void 0),t([ce()],ao.prototype,"selectedDomain",void 0),t([ce()],ao.prototype,"selectedEntity",void 0),t([ce()],ao.prototype,"selectedMatchType",void 0),t([ce()],ao.prototype,"conditionValue",void 0),t([ce()],ao.prototype,"conditionValid",void 0),t([ce()],ao.prototype,"startDate",void 0),t([ce()],ao.prototype,"endDate",void 0),t([le()],ao.prototype,"tags",void 0),t([ce()],ao.prototype,"customTagValue",void 0),ao=t([re("scheduler-options-panel")],ao);let oo=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        width="small"
        ...
        `}
          ...
          <div class="buttons" slot="footer">
            ...
            <ha-button appearance="plain" @click=${this._handleSaveClick}>
              ${as("ui.common.save",this.hass)}
            </ha-button>
          </div>
      </ha-dialog>
    `:q``}_updateSchedule(e){let t=Object.keys(e.detail);if(t.includes("schedule")){let t=e.detail.schedule;this.schedule=t}t.includes("selectedSlot")&&(this.selectedSlot=e.detail.selectedSlot)}async _handleSaveClick(e){const t=$a(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const s={cancel:()=>i(!1),confirm:()=>i(!0),title:as("state_badge.default.error",this.hass),description:Gi(`ui.panel.editor.validation_errors.${t}`,this.hass),primaryButtonLabel:as("ui.common.ok",this.hass)};Ps(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return no}),dialogParams:s})});else if(this.schedule.schedule_id){const t=Ie(await Ls(this.hass,this.schedule.schedule_id),this.hass);if(he(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Gi("ui.dialog.enable_schedule.title",this.hass),description:Gi("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:as("ui.common.yes",this.hass),secondaryButtonLabel:as("ui.common.no",this.hass),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};Ps(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return no}),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=ja(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>Ca(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=ja(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>Ca(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Gi("ui.dialog.confirm_delete.title",this.hass),description:Gi("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:as("ui.common.ok",this.hass),secondaryButtonLabel:as("ui.common.cancel",this.hass)};Ps(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return no}),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>Ca(e,this,this.hass)).then(()=>{this.closeDialog()})})}_setViewMode(e){let t=e.detail;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1;if(t==me.Scheme){this.viewMode=t;if(he([...this.schedule.entries],[...Be.entries]))this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...Ue.entries]});else{const e=this.schedule.entries.some(e=>e.slots.some(e=>void 0===e.stop));e&&(this.schedule=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map((e,t,i)=>{if(void 0!==e.stop)return e;const s=i[t+1];return Object.assign(Object.assign({},e),{stop:s?s.start:"00:00:00"})})}))}))}return}if(t==me.Single&&!i){if(he([...this.schedule.entries],[...Ue.entries]))this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...Be.entries]});else{let e=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>{let t=e.slots.findIndex(e=>e.actions.length);return t<0&&(t=Math.floor(e.slots.length/2)),Object.assign(Object.assign({},e),{slots:e.slots.map((e,i)=>i==t?Object.assign(Object.assign({},e),{stop:void 0}):null).filter(We)})})});this.schedule=Ie(e,this.hass)}return void(this.viewMode=t)}new Promise(t=>{const i={title:Gi("ui.dialog.confirm_migrate.title",this.hass),description:Gi("ui.dialog.confirm_migrate.description",this.hass),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};Ps(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return no}),dialogParams:i})}).then(e=>{e&&(this.schedule=(e=>{const t=e=>{let t=e.findIndex(e=>e.actions.length);t<0&&(t=Math.floor(e.length/2));let i=Object.assign(Object.assign({},e[t]),{stop:void 0});const s=i.conditions,a=i.start;return[{start:"00:00:00",stop:a,actions:[],conditions:s},i,{start:Ne(Se(Ce(a),{minutes:1})),stop:"00:00:00",actions:[],conditions:s}]};return e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object(Object.assign(Object.assign({},e),{slots:t(e.slots)})))}),e})(this.schedule),this.viewMode=t)})}};ro.styles=wa,t([le({attribute:!1})],ro.prototype,"hass",void 0),t([ce()],ro.prototype,"_params",void 0),t([le({type:Boolean,reflect:!0})],ro.prototype,"large",void 0),t([ce()],ro.prototype,"schedule",void 0),t([ce()],ro.prototype,"selectedEntry",void 0),t([ce()],ro.prototype,"selectedSlot",void 0),t([ce()],ro.prototype,"_panel",void 0),t([ce()],ro.prototype,"_viewMode",void 0),ro=t([re("dialog-scheduler-editor")],ro);var lo=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return ro}});
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */class co extends Ys{constructor(e){if(super(e),this.et=V,e.type!==Gs)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===V||null==e)return this.ft=void 0,this.et=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}co.directiveName="unsafeHTML",co.resultType=1;const uo=Js(co);var ho=window&&window.__assign||function(){return ho=Object.assign||function(e){for(var t,i=1,s=arguments.length;i<s;i++)for(var a in t=arguments[i])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e},ho.apply(this,arguments)};var mo={second:45,minute:45,hour:22,day:5};const po=(e,t,i)=>{if(i===Te.am_pm||!i&&t.time_format===Te.am_pm){const t=Le(e.getHours()).am_pm;return`${Le(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===Te.twenty_four||!i&&t.time_format===Te.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:De(t)}):De(t)?po(e,t,Te.am_pm):po(e,t,Te.twenty_four)};let _o=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},s=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return Ya[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}, ${s(e,"year")}`}(e,this._hass.locale):s>7?a=Gi("ui.components.date.next_week_day",this._hass,"{weekday}",Ss(e,"long",this._hass)):1==s?a=Gi("ui.components.date.tomorrow",this._hass):s>0&&(a=Ss(e,"long",this._hass));let o=Gi("ui.components.time.absolute",this._hass,"{time}",po(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Gi("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Gi("ui.components.time.at_midnight",this._hass)),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=as("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=as("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=ho(ho({},mo),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var d=new Date(e),l=new Date(t),c=d.getFullYear()-l.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+d.getMonth()-l.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var h=a/604800;return{value:Math.round(h),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return q``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),q`
      ${ss(this.relativeTime(this.datetime))}
    `}};t([le()],_o.prototype,"_hass",void 0),t([le()],_o.prototype,"datetime",void 0),_o=t([re("scheduler-relative-time")],_o);let go=class extends oe{render(){var e,t,i,s,a;try{const o=this.hass.states[this.schedule.entity_id];if(!o)return q``;const n=["off","completed"].includes(o.state),r=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let d=Ea(r,this.config.customize);if("entity"==(null===(e=this.config.display_options)||void 0===e?void 0:e.icon)){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Yi(r.service))&&(e=r.service),e&&(d=ra(e,this.config.customize,this.hass))}const l=![(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat().every(e=>Object.keys(this.hass.states).includes(e));return l&&(d="mdi:help"),q`
      <ha-icon
        icon="${d}"
    ...
    `}catch(e){return q`
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return q`
        ...
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){let t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return q`
          ...
          </div>`}return uo(e)};return Ts(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>q`${t(e)}<br/>`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_toggleEnableDisable(e){const t=e.target.checked;this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:this.schedule.entity_id})}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
    ...
    `}};return t([le()],go.prototype,"hass",void 0),t([le()],go.prototype,"schedule_id",void 0),t([le()],go.prototype,"schedule",void 0),t([le()],go.prototype,"config",void 0),go=t([re("scheduler-item-row")],go),e.SchedulerCard=class extends oe{constructor(){super(...arguments),this._config={},this.showDiscovered=!1,this.translationsLoaded=!1,this.connectionError=!1}async setConfig(e){e=(e=>{let t=[];if(Ze(e,"include")&&!Qe(e.include)&&t.push("'include' must be a list of strings"),Ze(e,"exclude")&&!Qe(e.exclude)&&t.push("'exclude' must be a list of strings"),Ze(e,"discover_existing")&&!Ke(e.discover_existing)&&t.push("'discover_existing' must be a boolean"),!Ze(e,"title")||Ke(e.title)||Je(e.title)||t.push("'title' must be a boolean or string"),Ze(e,"time_step")&&(!Ge(e.time_step)||Number(e.time_step)<1||Number(e.time_step)>30)&&t.push("'time_step' must be a number between 1 and 30"),Ze(e,"show_header_toggle")&&!Ke(e.show_header_toggle)&&t.push("'show_header_toggle' must be a boolean"),Ze(e,"show_add_button")&&!Ke(e.show_add_button)&&t.push("'show_add_button' must be a boolean"),Ze(e,"show_toggle_switches")&&!Ke(e.show_toggle_switches)&&t.push("'show_toggle_switches' must be a boolean"),Ze(e,"display_options")&&(Ye(e.display_options)?(!Ze(e.display_options,"primary_info")||Je(e.display_options.primary_info)||Qe(e.display_options.primary_info)||t.push("in 'display_options': 'primary_info' must be a string or list of strings"),!Ze(e.display_options,"secondary_info")||Je(e.display_options.secondary_info)||Qe(e.display_options.secondary_info)||t.push("in 'display_options': 'secondary_info' must be a string or list of strings"),!Ze(e.display_options,"icon")||Je(e.display_options.icon)&&["action","entity"].includes(e.display_options.icon)||t.push("in 'display_options': 'icon' must be a set to either 'action' or 'entity' ")):t.push("'display_options' must be a struct")),!Ze(e,"sort_by")||Je(e.sort_by)||Qe(e.sort_by)||t.push("'sort_by' must be a string or list of strings"),Ze(e,"customize")&&!Ye(e.customize))t.push("'customize' must be a struct");else if(Ze(e,"customize")){let i=Object.entries(e.customize).map(([e,t])=>Xe(e,t)).filter(We);i.length&&t.push(...i)}if(!Ze(e,"tags")||Je(e.tags)||Qe(e.tags)||t.push("'tags' must be a string or list of strings"),!Ze(e,"exclude_tags")||Je(e.tags)||Qe(e.tags)||t.push("'exclude_tags' must be a string or list of strings"),t.length)throw new Error(`Invalid configuration provided (${t.length} error${t.length>1?"s":""}): ${t.join(", ")}.`);return e})(e),this._config=Object.assign({},e)}async firstUpdated(){await(async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider")&&customElements.get("ha-generic-picker"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.automation.load()})();document.querySelector("home-assistant")._loadFragmentTranslations(this.hass.language,"config"),await Ns(this.hass).then(e=>{e=Object.fromEntries(Object.entries(e).filter(([e])=>es(e,this._config))),this._config=Object.assign(Object.assign({},this._config),{customize:Object.assign(Object.assign({},e),this._config.customize||{})})})}willUpdate(){this.hass.loadBackendTranslation("services")}__checkSubscribed(){void 0===this.__unsubs&&this.isConnected&&void 0!==this.hass&&(this.__unsubs=this.hassSubscribe())}connectedCallback(){super.connectedCallback(),this.__checkSubscribed()}disconnectedCallback(){if(super.disconnectedCallback(),this.__unsubs){for(;this.__unsubs.length;){const e=this.__unsubs.pop();e instanceof Promise?e.then(e=>e()):e()}this.__unsubs=void 0}}updated(e){super.updated(e),e.has("hass")&&this.__checkSubscribed()}hassSubscribe(){return this.loadSchedules(),[this.hass.connection.subscribeMessage(e=>this.handleScheduleItemUpdated(e),{type:"scheduler_updated"})]}shouldUpdate(e){const t=e.get("hass"),i=e.get("_config");if(i&&this._config){const e=Object.keys(i).filter(e=>i[e]!==this._config[e]);e.some(e=>["tags","discover_existing","sort_by","display_options"].includes(e))&&(async()=>{await this.loadSchedules()})()}return!this.translationsLoaded&&as("component.input_boolean.services.turn_on.name",this.hass,!1).length&&as("ui.panel.config.automation.editor.conditions.type.sun.sunrise",this.hass,!1).length?(this.translationsLoaded=!0,!0):!t||1!=e.size||!this.schedules||Object.values(this.schedules).some(e=>JSON.stringify(t.states[e.entity_id])!==JSON.stringify(this.hass.states[e.entity_id]))}render(){let e=[...this.schedules||[]],t=e.filter(e=>ts(e,this._config)),i=e.filter(e=>!ts(e,this._config));const s=this.showDiscovered?e.some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")}):t.some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")});return q`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${!We(this._config.title)||"boolean"==typeof this._config.title&&this._config.title?Gi("ui.panel.common.title",this.hass):"boolean"==typeof this._config.title?"":this._config.title}
          </div>
      ...
      ${Object.keys(e).length>t.length&&!1!==this._config.discover_existing?this.showDiscovered?q`
        ...
        <div class="card-actions">
          ...
          <ha-button appearance="plain" variant="warning" @click=${this._retryConnection}
            >${as("ui.common.refresh",this.hass)}
          </ha-button>
            `:q`
          <ha-button appearance="plain" @click=${this._addClick}
            >${as("ui.common.add",this.hass)}
          </ha-button>
          `}
        </div>`:""}
      </ha-card>
    `}async loadSchedules(){Oe(this.hass).then(e=>{this.schedules=Ms(e,this._config,this.hass)}).catch(e=>{this.schedules=[],this.connectionError=!0})}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{var s;if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let a=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(a+=1);const o=(([(null===(s=this._config.display_options)||void 0===s?void 0:s.secondary_info)||[]].flat().length||2)+1)/2;this.schedules&&(a+=this.showDiscovered?Object.keys(this.schedules).length*o:Object.values(this.schedules).filter(e=>ts(e,this._config)).length*o),clearInterval(i),e(Math.round(a))},50)})}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?Ls(this.hass,e.schedule_id).then(t=>{const i=this.schedules.findIndex(t=>t.schedule_id==e.schedule_id),s=i>=0?this.schedules[i]:null;let a=[...this.schedules||[]];!t||!1===this._config.discover_existing&&!ts(t,this._config)?s&&(a=a.filter(t=>t.schedule_id!==e.schedule_id)):s?s.timestamps[s.next_entries[0]||0]==t.timestamps[t.next_entries[0]||0]?a=Object.assign(a,{[i]:t}):(a=Object.assign(a,{[i]:t}),a=Ms(a,this._config,this.hass)):a=Ms([...a,t],this._config,this.hass),this.schedules=[...a]}):this.schedules=(this.schedules||[]).filter(t=>t.schedule_id!==e.schedule_id)}_handleEditClick(e,t){if(!this.schedules)return;const i={schedule:Ie(t,this.hass),cardConfig:this._config,editItem:t.schedule_id};Ps(e.target,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then(function(){return lo}),dialogParams:i})}_addClick(e){const t=[this._config.tags||[]].flat().filter(e=>!["none","disabled","enabled"].includes(e));let i=this._config.default_editor==me.Scheme?JSON.parse(JSON.stringify(Ue)):JSON.parse(JSON.stringify(Be));const s={schedule:Object.assign(Object.assign({},i),{tags:1==t.length?t:[]}),cardConfig:this._config};Ps(this,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then(function(){return lo}),dialogParams:s})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked,i=Object.values(this.schedules).filter(e=>this.showDiscovered||ts(e,this._config));i.forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}static getConfigElement(){return document.createElement("scheduler-card-editor")}},e.SchedulerCard.styles=r`
    .card-header {
      display: flex;
      justify-content: space-between;
    }
