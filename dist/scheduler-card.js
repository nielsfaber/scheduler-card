...
const Ls=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}{constructor(e){var t;if(super(e),e.type!==Ds||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const s=e[i];return null==s?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ht){this.ht=new Set;for(const e in t)this.ht.add(e);return this.render(t)}this.ht.forEach(e=>{null==t[e]&&(this.ht.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")});for(const e in t){const s=t[e];if(null!=s){this.ht.add(e);const t="string"==typeof s&&s.endsWith(" !important");e.includes("-")||t?i.setProperty(e,t?s.slice(0,-11):s,t?"important":""):i[e]=s}}return R}}),Ps={alarm_control_panel:{disarmed:"mdi:lock-open-variant-outline",armed_away:"mdi:exit-run",armed_home:"mdi:home-outline",armed_night:"mdi:power-sleep",armed_custom_bypass:"mdi:security",armed_vacation:"mdi:shield-airplane",triggered:"mdi:alarm-light-outline"},binary_sensor:{battery:{on:"mdi:battery-outline",off:"mdi:battery"},battery_charging:{on:"mdi:battery-charging",off:"mdi:battery"},cold:{on:"mdi:snowflake",off:"mdi:thermometer"},connectivity:{on:"mdi:server-network",off:"mdi:server-network-off"},door:{on:"mdi:door-open",off:"mdi:door-closed"},garage_door:{on:"mdi:garage-open",off:"mdi:garage"},power:{on:"mdi:power-plug",off:"mdi:power-plug-off"},gas:{on:"mdi:alert-circle",off:"mdi:check-circle"},problem:{on:"mdi:alert-circle",off:"mdi:check-circle"},safety:{on:"mdi:alert-circle",off:"mdi:check-circle"},tamper:{on:"mdi:alert-circle",off:"mdi:check-circle"},smoke:{on:"mdi:smoke",off:"mdi:check-circle"},heat:{on:"mdi:fire",off:"mdi:thermometer"},light:{on:"mdi:brightness-7",off:"mdi:brightness-5"},lock:{on:"mdi:lock-open",off:"mdi:lock"},moisture:{on:"mdi:water",off:"mdi:water-off"},motion:{on:"mdi:run",off:"mdi:walk"},occupancy:{on:"mdi:home",off:"mdi:home-outline"},opening:{on:"mdi:square-outline",off:"mdi:square"},plug:{on:"mdi:power-plug",off:"mdi:power-plug-off"},presence:{on:"mdi:home",off:"mdi:home-outline"},running:{on:"mdi:play",off:"mdi:stop"},sound:{on:"mdi:music-note",off:"mdi:music-note-off"},update:{on:"mdi:package-up",off:"mdi:package"},vibration:{on:"mdi:vibrate",off:"mdi:crop-portrait"},window:{on:"mdi:window-open",off:"mdi:window-closed"},_:{on:"mdi:checkbox-marked-circle",off:"mdi:radiobox-blank"}},calendar:{on:"mdi:flash",off:"mdi:flash-off"},cover:{garage:{closed:"mdi:garage",open:"mdi:garage-open"},door:{closed:"mdi:door-closed",open:"mdi:door-open"},blind:{closed:"mdi:blinds",open:"mdi:blinds-open"},window:{closed:"mdi:window-closed",open:"mdi:window-open"},_:{closed:"mdi:window-shutter",open:"mdi:window-shutter-open"}},climate:{off:"mdi:power-off",heat:"mdi:fire",cool:"mdi:snowflake",heat_cool:"mdi:thermometer",auto:"mdi:autorenew",dry:"mdi:water-percent",fan_only:"mdi:fan"},device_tracker:{home:"mdi:home-outline",not_home:"mdi:exit-run"},fan:{on:"mdi:power",off:"mdi:power-off"},humidifier:{on:"mdi:power",off:"mdi:power-off"},input_boolean:{on:"mdi:flash",off:"mdi:flash-off"},light:{on:"mdi:lightbulb",off:"mdi:lightbulb-off"},lock:{unlocked:"mdi:lock-open-variant-outline",locked:"mdi:lock-outline"},person:{home:"mdi:home-outline",not_home:"mdi:exit-run"},sun:{below_horizon:"mdi:weather-sunny-off",above_horizon:"mdi:weather-sunny"},switch:{on:"mdi:flash",off:"mdi:flash-off"},timer:{active:"mdi:play",paused:"mdi:pause",idle:"mdi:sleep"},valve:{open:"mdi:valve-open",closed:"mdi:valve-closed"},water_heater:{off:"mdi:power-off",eco:"mdi:leaf",electric:"mdi:lightning-bolt",gas:"mdi:fire",heat_pump:"mdi:hvac",high_demand:"mdi:water-plus-outline",performance:"mdi:rocket-launch-outline"}},Is=(e,t,i)=>{const s=Gi(e);if(!Object.keys(Ps).includes(s))return;let a=Ps[s];if("object"==typeof Object.values(a)[0]){const t=i.states[e],s=null==t?void 0:t.attributes.device_class;a=s&&Object.keys(a).includes(s)?a[s]:a._}return Object.keys(a).includes(t)?a[t]:void 0},Ns=["alarm_control_panel","binary_sensor","climate","calendar","cover","device_tracker","fan","humidifier","input_boolean","input_number","input_select","light","lock","number","person","proximity","select","sensor","sun","switch","timer","valve","water_heater"],qs=(e,t)=>{const i=Object.keys(t.states).includes(e)?t.states[e]:void 0,s=Gi(e),a=(null==i?void 0:i.attributes)||{},o=i=>null==i?void 0:i.map(i=>Object({value:i,icon:Is(e,i,t)}));switch(s){case"alarm_control_panel":let e=["disarmed","triggered"];return 2&(a.supported_features||0)&&(e=[...e,"armed_away"]),1&(a.supported_features||0)&&(e=[...e,"armed_home"]),4&(a.supported_features||0)&&(e=[...e,"armed_night"]),16&(a.supported_features||0)&&(e=[...e,"armed_custom_bypass"]),32&(a.supported_features||0)&&(e=[...e,"armed_vacation"]),ds({options:o(e),translation_key:"component.alarm_control_panel.entity_component._.state.${value}"});case"binary_sensor":return ds({options:o(["on","off"]),translation_key:"component.binary_sensor.entity_component.${deviceClass}.state.${value}"});case"climate":return ds({options:o(a.hvac_modes),translation_key:"component.climate.entity_component._.state.${value}"});case"calendar":case"fan":case"humidifier":case"input_boolean":case"light":case"switch":return ds({options:o(["on","off"]),translation_key:"component.switch.entity_component._.state.${value}"});case"cover":return ds({options:o(["open","closed"]),translation_key:"component.cover.entity_component._.state.${value}"});case"device_tracker":return ds({options:o(["home","not_home"]),translation_key:"component.device_tracker.entity_component._.state.${value}"});case"input_number":case"number":return cs({min:a.min,max:a.max,step:a.step,mode:a.mode,unit_of_measurement:a.unit_of_measurement});case"input_select":case"select":return ds({options:a.options});case"lock":return ds({options:o(["locked","unlocked"]),translation_key:"component.lock.entity_component._.state.${value}"});case"person":const s=Object.keys(t.states).filter(e=>"zone"==Gi(e)).map(Ki);return ds({options:[...new Set(["home","not_home",...s])]});case"proximity":return cs({mode:"box",unit_of_measurement:a.unit_of_measurement});case"sensor":return isNaN(Number(null==i?void 0:i.state))?{text:{}}:cs({mode:"box",unit_of_measurement:a.unit_of_measurement});case"sun":return ds({options:o(["above_horizon","below_horizon"]),translation_key:"component.sun.entity_component._.state.${value}"});case"timer":return ds({options:o(["active","paused","idle"]),translation_key:"component.timer.entity_component._.state.${value}"});case"valve":return ds({options:o(["open","closed"]),translation_key:"component.valve.entity_component._.state.${value}"});case"water_heater":case"climate":return ds({options:o(a.operation_list),translation_key:"component.climate.entity_component._.state.${value}"});default:return{text:{}}}},Rs=e=>Ns.includes(e),Hs=(e,t)=>{let i=Object.keys(e.states).map(e=>Gi(e)).reduce((e,t)=>e.includes(t)?e:[...e,t],[]).filter(Rs);return i=i.filter(e=>((t.include||[]).some(t=>Yi(Gi(t),e))||Object.keys(t.customize||{}).some(t=>Yi(Gi(t),e)))&&!(t.exclude||[]).some(t=>Yi(t,e))),i.map(t=>Object({key:t,name:ts(`component.${t}.title`,e,!1)||t.replace(/_/g," "),description:"",icon:Ts(t)}))},Vs=(e,t,i)=>{if(!Object.keys(i.states).includes(e))return"mdi:help";let s=Object.entries(t).filter(([t,i])=>Yi(t,e)&&i.icon).map(([e,t])=>t);if(s.length)return s.map(e=>{return(t=e.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?t:"mdi:"+t;var t}).shift();const a=i.states[e];if(a.attributes.icon)return a.attributes.icon;const o=Gi(e);return Ts(o)},Fs=(e,t,i)=>{if(["script","notify"].includes(e)){let s=Object.keys(i.services[e]).map(s=>{var a;return Object({key:`${e}.${s}`,name:i.states[`${e}.${s}`]?Ji(`${e}.${s}`,null===(a=i.states[`${e}.${s}`])||void 0===a?void 0:a.attributes):i.services[e][s].name,description:"",icon:i.states[`${e}.${s}`]?Vs(`${e}.${s}`,t,i):Ts(e)})});return s.sort((e,t)=>Xi(e.name,t.name)),s}{let s=Object.keys(i.states).filter(t=>Gi(t)==e).map(e=>{var s;return Object({key:e,name:Ji(e,null===(s=i.states[e])||void 0===s?void 0:s.attributes),description:"",icon:Vs(e,t,i)})});return s.sort((e,t)=>Xi(e.name,t.name)),s}},Us=(e,t)=>t.every(t=>e.name.toLowerCase().includes(t))||t.every(t=>e.key.toLowerCase().includes(t));let Bs=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.expandedGroups=[]}async showDialog(e){this._params=e,this.loadOptions(),await this.updateComplete}async closeDialog(){this._params&&this._params.confirm({domains:this._params.domains,entities:this._params.entities}),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}loadOptions(){let e=(e=>{let t=Ms(e,{include:["*"]}),i=Hs(e,{include:["*"]});return i=i.filter(e=>!t.map(e=>e.key).includes(e.key)),t=[...t,...i],t.sort((e,t)=>Xi(e.name,t.name)),t})(this.hass);this.options=e.map(e=>Object(Object.assign(Object.assign({},e),{entities:Fs(e.key,this._params.cardConfig.customize,this.hass)})))}shouldUpdate(e){return!!(e.has("_params")||e.has("expandedGroups")||e.has("_filter"))}render(){return this._params?q`
        ...
        <div slot="heading">
          <ha-dialog-header>
            <ha-icon-button
              slot="navigationIcon"
              dialogAction="cancel"
              .label=${ts("ui.dialogs.more_info_control.dismiss",this.hass)}
              .path=${Ss}
            ></ha-icon-button>
            <span slot="title">
              ${Zi("ui.dialog.entity_picker.title",this.hass)}
            </span>
          </ha-dialog-header>

          <ha-textfield
            dialogInitialFocus
            .placeholder=${ts("ui.common.search",this.hass)}
            aria-label=${ts("ui.common.search",this.hass)}
            ...
            <div class="trailing" slot="trailingIcon">
              ${this._search&&q`
                <ha-icon-button
                  ...
                  .label=${ts("ui.common.clear",this.hass)}
                  .path=${Ss}
                  class="clear-button"
                ></ha-icon-button>
              `}
    ...
    `:q``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("mwc-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_toggleSelectEntity(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;t.querySelector("ha-checkbox");const i=t.getAttribute("key");this._params.entities.includes(i)?this._params=Object.assign(Object.assign({},this._params),{entities:this._params.entities.filter(e=>e!=i)}):this._params=Object.assign(Object.assign({},this._params),{entities:[...this._params.entities,i]})}_toggleSelectDomain(e){var t;let i=e.target;for(;"MWC-LIST-ITEM"!=i.tagName;)i=i.parentElement;const s=i.getAttribute("key"),a=null===(t=this.options)||void 0===t?void 0:t.find(e=>e.key==s).entities.map(e=>e.key);this._params.domains.includes(s)?this._params=Object.assign(Object.assign({},this._params),{domains:this._params.domains.filter(e=>e!=s),entities:this._params.entities.filter(e=>!(null==a?void 0:a.includes(e)))}):this._params=Object.assign(Object.assign({},this._params),{domains:[...this._params.domains,s]}),e.stopPropagation()}closeGroupByKey(e){this.shadowRoot.querySelector("mwc-list").childNodes.forEach(t=>{if(t.nodeType==Node.ELEMENT_NODE&&"MWC-LIST-ITEM"==t.tagName&&t.getAttribute("key")==e){const e=t,i=e.nextElementSibling,s=e.querySelector("ha-icon-button");i.style.height="0px",e.removeAttribute("expanded"),s.classList.remove("expanded")}})}async _toggleExpandGroup(e){let t=e.target;for(;"MWC-LIST-ITEM"!=t.tagName;)t=t.parentElement;const i=t.querySelector("ha-icon-button"),s=t.getAttribute("key");this.expandedGroups.includes(s)||(this.expandedGroups.forEach(e=>this.closeGroupByKey(e)),this.expandedGroups=[s],await this.requestUpdate());const a=t.nextElementSibling,o=a.scrollHeight;t.hasAttribute("expanded")?(t.removeAttribute("expanded"),i.classList.remove("expanded"),a.style.height="0px",setTimeout(()=>{this.expandedGroups=this.expandedGroups.filter(e=>e!=s)},300)):(t.setAttribute("expanded","true"),i.classList.add("expanded"),a.style.height=o+"px")}_renderOptions(){if(!this.options)return;let e=[...this.options];const t=this._filter&&this._filter.trim().length;if(t){const t=this._filter.toLowerCase().trim().split(" ");e=e.map(e=>Us(e,t)||(e=Object.assign(Object.assign({},e),{entities:(e.entities||[]).filter(e=>Us(e,t))})).entities.length?e:void 0).filter(e=>void 0!==e)}return e.length?Object.keys(e).map(i=>{var s,a;const o=e[i].key,n=Fs(o,this._params.cardConfig.customize,this.hass),r=(null===(s=this._params)||void 0===s?void 0:s.domains.includes(o))?n.length:e[i].entities.filter(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)}).length;return q`
        ...
        >
          ...
          <div slot="meta" class="meta">
            <ha-button
              ...
              size="small"
            >
              ${(null===(a=this._params)||void 0===a?void 0:a.domains.includes(o))||e[i].entities.every(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)})?ts("ui.components.media-browser.file_management.deselect_all",this.hass):ts("ui.components.subpage-data-table.select_all",this.hass)}
            </ha-button>
            <ha-icon-button .path="${js}" @click=${e=>{e.target.blur()}} class="chevron"></ha-icon-button>
          </div>
          <span>${e[i].name}</span>
          <span slot="secondary">${Zi("ui.panel.card_editor.fields.entities.included_number",this.hass,["{number}","{total}"],[r,n.length])}</span>
        </mwc-list-item>
      ...
      `}):q`
        <mwc-list-item disabled>
          ${ts("ui.components.entity.entity-picker.no_match",this.hass)}
        </mwc-list-item>
    ...
    `}};t([de({attribute:!1})],Bs.prototype,"hass",void 0),t([ce()],Bs.prototype,"_params",void 0),t([ce()],Bs.prototype,"_search",void 0),t([ce()],Bs.prototype,"_filter",void 0),t([ce()],Bs.prototype,"_width",void 0),t([ce()],Bs.prototype,"_height",void 0),t([ce()],Bs.prototype,"expandedGroups",void 0),t([ce()],Bs.prototype,"options",void 0),Bs=t([re("dialog-select-entities")],Bs);var Ws=Object.freeze({__proto__:null,get DialogSelectEntities(){return Bs}});let Zs=class extends oe{constructor(){super(...arguments),this.active=!1}render(){return q`
      ...
      `:q`
        <div class="trailing-icon" @click=${this._iconClick}>
          ${this.disabled?q`
            ...
            ></ha-icon>
          `:q`
          <ha-tooltip content="${ts("ui.common.remove",this.hass)}">
            <ha-icon icon="mdi:close"
            ></ha-icon>
          </ha-tooltip>
          `}
    ...
    `}};t([de({attribute:!1})],Zs.prototype,"hass",void 0),t([de({type:String})],Zs.prototype,"icon",void 0),t([de({type:Boolean})],Zs.prototype,"useStateIcon",void 0),t([de({type:Boolean})],Zs.prototype,"selectable",void 0),t([de({type:Boolean})],Zs.prototype,"removable",void 0),t([de({type:Boolean})],Zs.prototype,"toggleable",void 0),t([de({type:Boolean})],Zs.prototype,"active",void 0),t([de({type:String})],Zs.prototype,"badge",void 0),t([de({type:String})],Zs.prototype,"value",void 0),t([de({type:Boolean})],Zs.prototype,"disabled",void 0),Zs=t([re("scheduler-chip")],Zs);let Ks=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?q`
    ...
    `}};t([de({attribute:!1})],Ks.prototype,"hass",void 0),t([de({attribute:!1})],Ks.prototype,"items",void 0),t([de({attribute:!1})],Ks.prototype,"value",void 0),t([de({type:Boolean})],Ks.prototype,"selectable",void 0),t([de({type:Boolean})],Ks.prototype,"toggleable",void 0),t([de({type:Boolean})],Ks.prototype,"removable",void 0),t([de({type:Boolean})],Ks.prototype,"disabled",void 0),Ks=t([re("scheduler-chip-set")],Ks);let Gs=class extends oe{constructor(){super(...arguments),this.autofocus=!1,this.disabled=!1,this.hideClearIcon=!1,this._opened=!1,this._isOpening=!1,this._items=[],this._getItems=()=>{const e=(this.getItems?this.getItems():[]).sort((e,t)=>Xi(e.primary,t.primary));return e.length||e.push({id:"___no_matching_items_found___",primary:Zi("ui.dialog.entity_picker.no_results",this.hass),icon:"mdi:cancel"}),e}}shouldUpdate(e){return!!(e.has("value")||e.has("label")||e.has("disabled"))||!(!e.has("_opened")&&this._opened)}willUpdate(e){e.has("_opened")&&this._opened&&(this._items=this._getItems())}render(){const e=!!this.value&&!this.disabled&&!this.hideClearIcon;return q`
          ...
          >
            ${this.value?this.valueRenderer?this.valueRenderer(this.value):q`<span slot="headline">${this.value}</span>`:q`
              <span slot="headline" class="placeholder">
                ${this.placeholder||Zi("ui.dialog.entity_picker.choose",this.hass)}
              </span>
            `}
            ${e?q`
                <ha-icon-button
    ...
    `}get _value(){return this.value||""}_renderHelper(){return this.helper?q`<ha-input-helper-text .disabled=${this.disabled}
        ...
        >`:H}_valueChanged(e){var t;e.stopPropagation(),this._comboBox.setTextFieldValue("");const i=null===(t=e.detail.value)||void 0===t?void 0:t.trim();"___no_matching_items_found___"!==i&&(this._items.find(e=>e.id==i)||this.allowCustomValue)&&i!==this._value&&this._setValue(i)}_filterChanged(e){if(!this._opened)return;let t=this._items;const i=e.target,s=e.detail.value.trim().split(" ").map(String).filter(e=>e.length).map(e=>e.trim());s.length&&(t=t.filter(e=>s.every(t=>{var i;return e.primary.includes(t)||(null===(i=e.secondary)||void 0===i?void 0:i.includes(t))}))),i.filteredItems=t}_clear(e){e.stopPropagation(),this._setValue(void 0)}_setValue(e){this.value=e,xs(this,"value-changed",{value:e})}async focus(){var e;await this.updateComplete,await(null===(e=this._comboBox)||void 0===e?void 0:e.focus())}async open(){var e;this._opened=!0,this._isOpening=!0,await this.updateComplete,null===(e=this._comboBox)||void 0===e||e.focus(),this._comboBox.open(),this._comboBox.value=""}async _openedChanged(e){var t;const i=e.detail.value;e.stopPropagation(),this._isOpening?this._isOpening=!1:this._opened&&!i&&(this._opened=!1,await this.updateComplete,null===(t=this._field)||void 0===t||t.focus())}static get styles(){return[r`
        .container {
          position: relative;
          display: block;
        }
      ...
      `]}};t([de({attribute:!1})],Gs.prototype,"hass",void 0),t([de({type:Boolean})],Gs.prototype,"autofocus",void 0),t([de({type:Boolean})],Gs.prototype,"disabled",void 0),t([de({type:Boolean,attribute:"allow-custom-value"})],Gs.prototype,"allowCustomValue",void 0),t([de()],Gs.prototype,"label",void 0),t([de()],Gs.prototype,"value",void 0),t([de()],Gs.prototype,"helper",void 0),t([de()],Gs.prototype,"placeholder",void 0),t([de({type:String,attribute:"search-label"})],Gs.prototype,"searchLabel",void 0),t([de({attribute:"hide-clear-icon",type:Boolean})],Gs.prototype,"hideClearIcon",void 0),t([de({attribute:!1,type:Array})],Gs.prototype,"getItems",void 0),t([de({attribute:!1,type:Array})],Gs.prototype,"getAdditionalItems",void 0),t([de({attribute:!1})],Gs.prototype,"rowRenderer",void 0),t([de({attribute:!1})],Gs.prototype,"valueRenderer",void 0),t([de({attribute:"not-found-label",type:String})],Gs.prototype,"notFoundLabel",void 0),t([he(".textInput")],Gs.prototype,"_field",void 0),t([he("ha-combo-box")],Gs.prototype,"_comboBox",void 0),t([ce()],Gs.prototype,"_opened",void 0),Gs=t([re("scheduler-picker")],Gs);let Js=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this.multipleMode=!1,this._valueRenderer=e=>{const t=e||"",i=this.hass.states[t];if(!i)return q`
        <ha-svg-icon
          slot="start"
          .path=${zs}
          style="margin: 0 4px"
      ...
      `;const s=Ji(t,i.attributes)||t,a=t;return q`
      <state-badge
        .hass=${this.hass}
        .stateObj=${i}
        slot="start"
    ...
    `},this._filteredItems=()=>{let e=Object.keys(this.hass.states);return this.domain&&(e=e.filter(e=>Gi(e)==this.domain)),this.multiple&&(e=e.filter(e=>{var t;return!(null===(t=this.value)||void 0===t?void 0:t.includes(e))})),this.config&&(e=e.filter(e=>((this.config.include||[]).some(t=>Yi(t,e))||Object.keys(this.config.customize||{}).some(t=>Yi(t,e)))&&!(this.config.exclude||[]).some(t=>Yi(t,e)))),e.map(e=>{var t;return Object({id:e,primary:Ji(e,null===(t=this.hass.states[e])||void 0===t?void 0:t.attributes),secondary:e,state:this.hass.states[e]})})}}render(){var e;return q`
      ${this.renderChips()}
      ...
      `}
    `}renderChips(){if(!this.multiple)return H;let e=(this.value||[]).map(e=>{var t;return Object({name:Ji(e,null===(t=this.hass.states[e])||void 0===t?void 0:t.attributes),value:e,useStateIcon:!0})});return q`
      <div class="wrapper">
      <scheduler-chip-set
        .hass=${this.hass}
        .items=${e}
      ...
      <ha-icon-button
        ...
        .path=${this.multipleMode?"M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z":js}
        slot="end"
      ></ha-icon-button>
      `:H}
      </div>
      </div>
      `}_valueChanged(e){let t=e.detail.value;const i=e.currentTarget;t&&(this.value=[...this.value||[],t],this.multiple&&(i.value=""),xs(this,"value-changed",{value:this.value}),e.stopPropagation())}_removeClick(e){const t=e.detail;this.value=(this.value||[]).filter(e=>e!==t),xs(this,"value-changed",{value:this.value})}};Js.styles=r`
    :host {
      display: flex;
  ...
  `,t([de({attribute:!1})],Js.prototype,"hass",void 0),t([de()],Js.prototype,"domain",void 0),t([de()],Js.prototype,"config",void 0),t([de({type:Array})],Js.prototype,"value",void 0),t([de({type:Boolean})],Js.prototype,"multiple",void 0),t([de({type:Boolean})],Js.prototype,"disabled",void 0),t([ce()],Js.prototype,"multipleMode",void 0),Js=t([re("scheduler-entity-picker")],Js);let Ys=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
      <div
    ...
    `}};t([de()],Qs.prototype,"disabled",void 0),t([ce()],Qs.prototype,"_openedItem",void 0),t([ce()],Qs.prototype,"_numItems",void 0),Qs=t([re("scheduler-collapsible-group")],Qs);let Xs=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),xs(this,"value-changed",{value:this.value})},s=()=>{let e=t.map(e=>Object({name:e,value:e}));return q`
      ...
      `}if(this.config.number){const e=this.config.number;let t=e.min||0,i=e.max||255,s="number"==typeof this.value?this.value:t;"number"==typeof e.scale_factor&&(s=parseFloat((s/e.scale_factor).toPrecision(12))),"number"==typeof(null==e?void 0:e.step)&&(s=Math.round(s/e.step)*e.step);const a=t=>{let i=Number(t.target.value);"number"==typeof e.scale_factor&&(i*=e.scale_factor),"number"==typeof(null==e?void 0:e.step)&&(i=Math.round(i/e.step)*e.step),i=parseFloat(i.toFixed(2)),this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}}))};return q`
      ...
      `}return q``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t],e.target.value=""}else if(e.detail){let t=e.detail.value;if(void 0===t)return;this.value=t}else this.value=e.target.value;xs(this,"value-changed",{value:this.value})}};Xs.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
  ...
  `,t([de({attribute:!1})],Xs.prototype,"hass",void 0),t([de({attribute:!1})],Xs.prototype,"config",void 0),t([de()],Xs.prototype,"value",void 0),t([de()],Xs.prototype,"disabled",void 0),Xs=t([re("scheduler-combo-selector")],Xs);let ea=class extends oe{constructor(){super(...arguments),this._config=Re,this.title="",this.tagOptions=[]}setConfig(e){this._config=Object.assign(Object.assign({},Re),e)}async firstUpdated(){this.title="string"==typeof this._config.title?this._config.title:"";const e=(await $s(this.hass)).map(e=>e.name);e.sort(Xi),this.tagOptions=e}render(){const e={number:{min:0,max:30,step:1,unit_of_measurement:Zi("ui.panel.card_editor.fields.time_step.unit_minutes",this.hass)}},t={select:{options:this.tagOptions,multiple:!0,custom_value:!0}};return q`
      <div class="card-config">

        <ha-button @click=${this._showIncludedEntitiesDialog} outlined>
          ${Zi("ui.panel.card_editor.fields.entities.button_label",this.hass)}
          <ha-svg-icon
            slot="trailingIcon"
        ...
        <scheduler-settings-row ?showPrefix=${!0}>
          ...
          <span slot="heading">${Zi("ui.panel.card_editor.fields.title.heading",this.hass)}</span>

          <ha-textfield
            .value=${this.title}
            @input=${this._setTitle}
            .placeholder=${Zi("ui.panel.common.title",this.hass)}
        ...
        <div class="column">
          <ha-formfield label="${Zi("ui.panel.card_editor.fields.discover_existing.heading",this.hass)}">
            <ha-switch
        ...
        <div class="column">
          <ha-formfield label="${Zi("ui.panel.card_editor.fields.show_header_toggle.heading",this.hass)}">
            <ha-switch
        ...
        <scheduler-settings-row>
          <span slot="heading">${Zi("ui.panel.card_editor.fields.time_step.heading",this.hass)}</span>
        ...
        <span>${Zi("ui.panel.card_editor.fields.default_editor.heading",this.hass)}</span>
        <div class="two-columns">
          <div class="column">
            <ha-formfield label="${Zi("ui.panel.card_editor.fields.default_editor.options.single",this.hass)}">
              <ha-radio
                name="default_editor"
                value="${_e.Single}"
          ...
          <div class="column">
            <ha-formfield label="${Zi("ui.panel.card_editor.fields.default_editor.options.scheme",this.hass)}">
              <ha-radio
                name="default_editor"
                value="${_e.Scheme}"
          ...
          <span slot="heading">${Zi("ui.panel.card_editor.fields.sort_by.heading",this.hass)}</span>

        <div class="two-columns">
        <div class="column">

          <ha-formfield label="${Zi("ui.panel.card_editor.fields.sort_by.options.relative_time",this.hass)}">
            <ha-radio
              name="sort_by"
              value="relative-time"
        ...
        <div class="column">
          ...
          <ha-formfield label="${Zi("ui.panel.card_editor.fields.sort_by.options.title",this.hass)}">
            <ha-radio
              name="sort_by"
              value="title"
              @change=${this._setSortBy}
          ...
          <span>${Zi("ui.panel.card_editor.fields.display_format_primary.heading",this.hass)}</span>


        <div class="two-columns">
        <div class="column">

          <ha-formfield label="${Zi("ui.panel.card_editor.fields.display_format_primary.options.default",this.hass)}">
            <ha-radio
        ...
        <div class="column">
          ...
          <ha-formfield label="${Zi("ui.panel.card_editor.fields.display_format_primary.options.entity_action",this.hass)}">
            <ha-radio
              name="display_format_primary"
              value="{entity}: {action}"
              @change=${this._setDisplayOptionsPrimary}
          ...
          <span>${Zi("ui.panel.card_editor.fields.display_format_secondary.heading",this.hass)}</span>

        <div class="two-columns">
        <div class="column">
          <ha-formfield label="${Zi("ui.panel.card_editor.fields.display_format_secondary.options.relative_time",this.hass)}">
            <ha-checkbox
              value="relative-time"
          ...
          <ha-formfield label="${Zi("ui.panel.card_editor.fields.display_format_secondary.options.time",this.hass)}">
            <ha-checkbox
              value="time"
              @change=${this._setDisplayOptionsSecondary}
        ...
        <div class="column">
          <ha-formfield label="${Zi("ui.panel.card_editor.fields.display_format_secondary.options.days",this.hass)}">
            <ha-checkbox
              value="days"
              @change=${this._setDisplayOptionsSecondary}
          ...
          <ha-formfield label="${Zi("ui.panel.card_editor.fields.display_format_secondary.options.additional_tasks",this.hass)}">
            <ha-checkbox
        ...
        <scheduler-settings-row>
          <span slot="heading">${Zi("ui.panel.card_editor.fields.tags.heading",this.hass)}</span>
  ...
  `,t([de({attribute:!1})],ea.prototype,"hass",void 0),t([de()],ea.prototype,"_config",void 0),t([de()],ea.prototype,"title",void 0),t([de()],ea.prototype,"tagOptions",void 0),ea=t([re("scheduler-card-editor")],ea);const ta=r`
  ha-dialog {
...
`,(e,t,i,s)=>{var a;const o=e.service,n=null===(a=e.target)||void 0===a?void 0:a.entity_id,r=rs(e,s);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const l=r.fields[t];if(null===us(o,n,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(l.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return 1==((i.states[e].attributes.supported_features||0)&l.supported_features)}))return!1}return!0});var sa;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(sa||(sa={}));const aa=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>e.every((i,s)=>{const a=Ee(i.start,t),o=void 0===i.stop?a:Ee(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>{if(i<=s)return!0;return Ee(e.start,t)>=o})})?null:sa.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,sa.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{var s;const a=rs(e,i);return(null==a?void 0:a.target)&&!(null===(s=e.target)||void 0===s?void 0:s.entity_id)?sa.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).filter(([s])=>ia(e,s,t,i)).every(([t,i])=>!(!Object.keys(e.service_data).includes(t)&&!i.optional))?sa.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},oa=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(na),timeslots:e.entries[0].slots.map(ra),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},na=e=>{switch(e){case ge.Monday:return"mon";case ge.Tuesday:return"tue";case ge.Wednesday:return"wed";case ge.Thursday:return"thu";case ge.Friday:return"fri";case ge.Saturday:return"sat";case ge.Sunday:return"sun";case ge.Workday:return"workday";case ge.Weekend:return"weekend";default:return"daily"}},ra=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>la(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ve.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),la=e=>{var t,i;if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>Object({service:e.service,service_data:e.service_data,entity_id:t}))}return{service:e.service,service_data:e.service_data,entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:e.service_data}},da=(e,t,i)=>{const s={title:ts("state_badge.default.error",i),description:q`
    <b>Something went wrong!</b><br />
    ${e.body.message}<br /><br />
    ${e.error}<br /><br />
    Please <a href="https://github.com/nielsfaber/scheduler-card/issues">report</a> the bug.
  `,primaryButtonLabel:ts("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};xs(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return qa})),dialogParams:s})},ca=e=>{let t=e.locale.first_weekday;if(t&&"language"!=t)return ua.map(e=>e.toLowerCase()).findIndex(e=>e==t);if("weekInfo"in Intl.Locale.prototype)return new Intl.Locale(e.locale.language).weekInfo.firstDay%7;{const t="AEAFBHDJDZEGIQIRJOKWLYOMQASDSY".match(/../g),i="AGARASAUBDBRBSBTBWBZCACNCODMDOETGTGUHKHNIDILINJMJPKEKHKRLAMHMMMOMTMXMZNINPPAPEPHPKPRPTPYSASGSVTHTTTWUMUSVEVIWSYEZAZW".match(/../g),s=["ar","arq","arz","fa"],a="amasbndzengnguhehiidjajvkmknkolomhmlmrmtmyneomorpapssdsmsnsutatethtnurzhzu".match(/../g),o=e.locale.language.match(/^([a-z]{2,3})(?:-([a-z]{3})(?=$|-))?(?:-([a-z]{4})(?=$|-))?(?:-([a-z]{2}|\d{3})(?=$|-))?/i);return o[1]?i.includes(o[4])?0:t.includes(o[4])?6:1:a.includes(o[1])?0:s.includes(o[1])?6:1}},ua=[ge.Sunday,ge.Monday,ge.Tuesday,ge.Wednesday,ge.Thursday,ge.Friday,ge.Saturday],ha={alarm_control_panel:{services:{alarm_arm_away:"mdi:shield-lock",alarm_arm_home:"mdi:shield-home",alarm_arm_night:"mdi:shield-moon",alarm_custom_bypass:"mdi:security",alarm_disarm:"mdi:shield-off",alarm_trigger:"mdi:bell-ring",alarm_arm_vacation:"mdi:shield-airplane"}},automation:{services:{turn_on:"mdi:robot",turn_off:"mdi:robot-off",trigger:"mdi:play"}},button:{services:{press:"mdi:gesture-tap-button"}},climate:{services:{set_temperature:"mdi:thermometer",set_hvac_mode:"mdi:cog-transfer-outline",set_preset_mode:"mdi:cloud-download-outline",set_fan_mode:"mdi:fan",set_humidity:"mdi:water-percent",set_swing_mode:"mdi:arrow-oscillating"},attributes:{hvac_mode:{cool:"mdi:snowflake",dry:"mdi:water-percent",fan_only:"mdi:fan",heat:"mdi:fire",heat_cool:"mdi:thermometer",off:"mdi:power"},preset_mode:{activity:"mdi:motion-sensor",away:"mdi:account-arrow-right",boost:"mdi:rocket-launch",comfort:"mdi:sofa",eco:"mdi:leaf",home:"mdi:home",sleep:"mdi:bed"},fan_mode:{diffuse:"mdi:weather-windy",focus:"mdi:target",high:"mdi:speedometer",low:"mdi:speedometer-slow",medium:"mdi:speedometer-medium",middle:"mdi:speedometer-medium",off:"mdi:fan-off",on:"mdi:fan"},swing_mode:{both:"mdi:arrow-all",horizontal:"mdi:arrow-left-right",off:"mdi:arrow-oscillating-off",on:"mdi:arrow-oscillating",vertical:"mdi:arrow-up-down"}}},cover:{services:{close_cover:"mdi:arrow-down-box",close_cover_tilt:"mdi:arrow-bottom-left",open_cover:"mdi:arrow-up-box",open_cover_tilt:"mdi:arrow-top-right",set_cover_position:"mdi:arrow-down-box",set_cover_tilt_position:"mdi:arrow-top-right"}},fan:{services:{oscillate:"mdi:arrow-oscillating",set_percentage:"mdi:fan",set_preset_mode:"mdi:fan-auto",turn_off:"mdi:fan-off",turn_on:"mdi:fan"}},humidifier:{services:{set_humidity:"mdi:water-percent",set_mode:"mdi:air-humidifier",turn_off:"mdi:air-humidifier-off",turn_on:"mdi:air-humidifier"},attributes:{mode:{auto:"mdi:refresh-auto",away:"mdi:account-arrow-right",baby:"mdi:baby-carriage",boost:"mdi:rocket-launch",comfort:"mdi:sofa",eco:"mdi:leaf",home:"mdi:home",normal:"mdi:water-percent",sleep:"mdi:power-sleep"}}},input_boolean:{services:{turn_off:"mdi:toggle-switch-off",turn_on:"mdi:toggle-switch"}},input_button:{services:{press:"mdi:gesture-tap-button"}},input_number:{services:{set_value:"mdi:counter"}},input_select:{services:{select_option:"mdi:counter"}},lawn_mower:{services:{dock:"mdi:home-import-outline",start_mowing:"mdi:play"}},light:{services:{turn_off:"mdi:lightbulb-off",turn_on:"mdi:lightbulb-on"}},lock:{services:{lock:"mdi:lock",unlock:"mdi:lock-open"}},media_player:{services:{media_play:"mdi:play",media_stop:"mdi:stop",play_media:"mdi:play",select_source:"mdi:import",turn_off:"mdi:power",turn_on:"mdi:power"}},notify:{services:{"{entity_id}":"mdi:message-alert"}},scene:{services:{turn_on:"mdi:play"}},script:{services:{turn_on:"mdi:flash",turn_off:"mdi:flash-off","{entity_id}":"mdi:play"}},select:{services:{select_option:"mdi:counter"}},switch:{services:{turn_off:"mdi:toggle-switch-variant-off",turn_on:"mdi:toggle-switch-variant"}},vacuum:{services:{send_command:"mdi:send",start:"mdi:play",turn_off:"mdi:stop",turn_on:"mdi:play"}},valve:{services:{open_valve:"mdi:valve-open",close_valve:"mdi:valve-closed",set_valve_position:"mdi:valve"}},water_heater:{services:{set_away_mode:"mdi:account-arrow-right",set_operation_mode:"mdi:water-boiler",set_temperature:"mdi:thermometer",turn_off:"mdi:water-boiler-off",turn_on:"mdi:water-boiler"},attributes:{operation_mode:{eco:"mdi:leaf",electric:"mdi:lightning-bolt",gas:"mdi:fire-circle",heat_pump:"mdi:heat-wave",high_demand:"mdi:finance",off:"mdi:power",performance:"mdi:rocket-launch"}}}},ma=(e,t)=>{const i=rs(e,t),s=Gi(e.service),a=Ki(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:"mdi:"+o;if(Object.keys(ha).includes(s)&&Object.keys(ha[s].services).includes(a)){if(void 0!==ha[s].attributes){let t=ha[s].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return ha[s].services[a]}return Object.keys(ha).includes(s)&&Object.keys(ha[s].services).includes("{entity_id}")?ha[s].services["{entity_id}"]:"mdi:flash";var o},pa=(e,t,i)=>{let s=Ee("string"==typeof e?Ae(e):e,i),a=Ee("string"==typeof t?Ae(t):t,i);return a>s?1:a<s?-1:0},_a=e=>Ae(e.start),ga=e=>os(e.stop)?Ae(e.stop):Ce(_a(e),{minutes:1}),va=(e,t,i,s)=>{let a=t;if(i.start){const o=_a(e[t]);let n=i.start;if(pa(o,n,s)<0)for(let i=t-1;i>=0;i--){let t=pa(_a(e[i]),n,s),o=pa(ga(e[i]),n,s);if(o>=0)break;if(t>0&&o<0){e[i].actions.length?n=ga(e[i]):e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:Ne(n)})});break}if(t<=0){if(e[i].actions.length){n=ga(e[i]);break}e=Object.assign(e,{[i]:null}),a-=1}}else if(pa(o,i.start,s)>0){if(os(e[t].stop)){let i=t<e.length-1?ga(e[t]):Ae("24:00");pa(i,n,s)>=0&&(n=Ce(ga(e[t]),{minutes:-1}))}else{for(let i=t+1;i<e.length;i++){let t=Ce(n,{minutes:1}),a=pa(_a(e[i]),t,s),o=pa(ga(e[i]),t,s);if(a<=0)break;a>0&&o>=0?e[i].actions.length?n=Ce(_a(e[i]),{minutes:-1}):e=Object.assign(e,{[i]:null}):a>0&&o<0&&(e[i].actions.length?n=Ce(_a(e[i]),{minutes:-1}):e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{start:Ne(t)})}))}e=e.filter(os)}if(t>0)if(os(e[t-1].stop))e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:Ne(n)})});else{let i=Ne(ga(e[t-1])),s=Ne(n);e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:i,stop:s,actions:[]}),...e.slice(t)],a=t+=1}}if(t<(e=(e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Ne(n)})})).filter(os)).length-1&&!os(e[t].stop)){pa(ga(e[t]),_a(e[t+1]),s)>0&&(e=e[t+1].actions.length?[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:Ne(ga(e[t])),stop:Ne(_a(e[t+1])),actions:[]}),...e.slice(t+1)]:Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:Ne(ga(e[t]))})}))}}else if(i.stop){const a=ga(e[t]);let o=i.stop;if(pa(a,o,s)>0)for(let i=t+1;i<e.length;i++){let t=pa(_a(e[i]),o,s),a=pa(ga(e[i]),o,s);if(t<=0)break;if(t>0&&a>=0){if(e[i].actions.length){o=_a(e[i]);break}e=Object.assign(e,{[i]:null})}else t>0&&a<0&&(e[i].actions.length?o=_a(e[i]):e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{start:Ne(o)})}))}else{pa(_a(e[t]),o,s)<=0&&(o=Ce(_a(e[t]),{minutes:1}))}e=e.filter(os),e=Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:Ne(o)})}),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{stop:Ne(o)})})}return[e,a]},ya=(e,t)=>{const i=new Date(t),s=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let a=3600*e.hours+60*e.minutes-s;const o=a<0?-1:1;a=Math.abs(a);let n=Math.floor(a/3600),r=Math.round((a-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),ze({hours:n,minutes:r})};let fa=class extends oe{constructor(){super(),this.selectedSlot=null,this.timeout=0,this.large=!1,this.handleResize=this.handleResize.bind(this)}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){}render(){return q`
      <div class="bar">
    ...
    `}renderTimebar(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=[1,2,3,4,6,8,12],i=De(this.hass.locale),s=i?130:100;let a=Math.ceil(24/(e/s));for(;!t.includes(a);)a++;const o=[0,...Array.from(Array(24/a-1).keys()).map(e=>(e+1)*a),24];return o.map((e,t)=>{let s=a/24*100;s=Math.floor(100*s)/100;let n={mode:we.Fixed,hours:e,minutes:0};return 0==t?q`
        <span class="left" style=${Ls({width:s/2+"%"})}>${Ne(n,{seconds:!1,am_pm:i})}</span>
      `:t==o.length-1?q`
        <span class="right" style=${Ls({width:s/2+"%"})}>${Ne(n,{seconds:!1,am_pm:i})}</span>
      `:q`
        <span style=${Ls({width:s+"%"})}>${Ne(n,{seconds:!1,am_pm:i})}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,s)=>{let a=Ee(i.start,this.hass),o=Ee(i.stop||i.start,this.hass);!o&&a&&(o=86400);const n=(o-a)/86400*100,r=i.actions.length?gs(i.actions[0],this.hass,this.config.customize,!0):"",l=parseFloat(getComputedStyle(this).getPropertyValue("width")),d=5*r.length+10,c=s>0?15:0,u=s<e.length-1?15:0,h=n*l/100-c-u,m=e[s+1];return q`
        <div
          class="slot ${this.selectedSlot==s?"selected":""} ${i.actions.length?"":"empty"} ${void 0===i.stop?"short":""}"
          style="${Ls({width:t[s]+"px"})}"
          @click=${this._toggleSelectTimeslot}
          idx="${s}"
        >
          ${i.stop,""}
          ${i.actions.length?r&&(h>d/3||h>50)&&h>30?q`<span style="margin-left: ${c}px; margin-right: ${u}px">${r}</span>`:h>16?q`<ha-icon icon="${ma(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
    ...
    `}};t([de({attribute:!1})],fa.prototype,"config",void 0),t([ce()],fa.prototype,"schedule",void 0),t([ce()],fa.prototype,"selectedSlot",void 0),t([de({type:Boolean})],fa.prototype,"large",void 0),t([function(e){return ue({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}({passive:!0})],fa.prototype,"_handleDragStart",null),fa=t([re("scheduler-timeslot-editor")],fa);const ba=e=>{let t=60*e.hours+e.minutes;return t>240?e=Object.assign(Object.assign({},e),{hours:4,minutes:0}):t<-240&&(e=Object.assign(Object.assign({},e),{hours:-4,minutes:0})),e};let ka=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=we.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1,this.large=!1,this.stepSize=10}set time(e){const t=Ae(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return q`
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return H;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=we.Fixed&&(e=ba(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return q`
        <div class="mode">
    ...
    `}}_renderSuffix(){if(this.large){const e=()=>{let e=Pe(this.hours).am_pm;const t=Pe(this.hours).hours;this.hours=Ie(t,"AM"==e?Le.PM:Le.AM),this._valueChanged()},t=()=>{0!=this.hours?this.hours=-this.hours:this.minutes=-this.minutes,this._valueChanged()},i=()=>{this.mode=this.mode==we.Sunrise?we.Sunset:we.Sunrise,this._valueChanged()};return q`
      ...
      `:H}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=we.Fixed||this.mode==we.Fixed){const s=ya({hours:this.hours,minutes:this.minutes},t),a=ya({hours:this.hours,minutes:this.minutes},i),o=60*s.hours+s.minutes,n=60*a.hours+a.minutes;let r=e||Math.abs(o)<=Math.abs(n)?we.Sunrise:we.Sunset,l=r==we.Sunrise?s:a;return{mode:r,hours:l.hours,minutes:l.minutes}}{let e=this.mode==we.Sunrise?Ae(t):Ae(i);return e=Ce(e,{hours:this.hours,minutes:this.minutes}),{mode:we.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Pe(this.hours).am_pm;t=Ie(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.target.value,i=Pe(this.hours).hours;this.hours=Ie(i,"AM"==t?Le.AM:Le.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=Ce(t,e),this.mode!=we.Fixed&&(t=ba(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};xs(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==we.Fixed?Pe(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==we.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};ka.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([de({attribute:!1})],ka.prototype,"hass",void 0),t([ce()],ka.prototype,"hours",void 0),t([ce()],ka.prototype,"minutes",void 0),t([ce()],ka.prototype,"mode",void 0),t([de({type:Boolean})],ka.prototype,"autoValidate",void 0),t([de({type:Boolean})],ka.prototype,"required",void 0),t([de({type:Boolean})],ka.prototype,"disabled",void 0),t([de({type:String})],ka.prototype,"label",void 0),t([de({type:Boolean})],ka.prototype,"useAmPm",void 0),t([de({type:Boolean})],ka.prototype,"large",void 0),t([de({attribute:!1})],ka.prototype,"stepSize",void 0),ka=t([re("scheduler-time-picker")],ka);let wa=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![ge.Daily,ge.Weekend,ge.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          ...
          `};
          <span slot="title">
              ${Zi("ui.dialog.weekday_picker.title",this.hass)}
          </span>
        </ha-dialog-header>
        <div class="wrapper">
          <mwc-list>
    ...
    `:q``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[ge.Sunday,ge.Monday,ge.Tuesday,ge.Wednesday,ge.Thursday,ge.Friday,ge.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,ca(this.hass))}else e=[ge.Daily,ge.Workday,ge.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.every(e=>![ge.Daily,ge.Weekend,ge.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>q`
        ...
        >
          ...
          ${"Custom"==e?q`
            ...
            ${es(Zi("ui.dialog.weekday_picker.choose",this.hass))}
            ${t(e)?q`<span class="badge">${this.selectedWeekdays.length}</span>`:""}
            `:es(fs(e,"long",this.hass))}
    ...
    `}};t([de({attribute:!1})],wa.prototype,"hass",void 0),t([ce()],wa.prototype,"_params",void 0),t([ce()],wa.prototype,"weekdayTypeCustomSelected",void 0),wa=t([re("dialog-select-weekdays")],wa);var xa=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return wa}});const $a=(e,t)=>((e,t)=>e<t?-1:e>t?1:0)(e.toLowerCase(),t.toLowerCase()),ja=(e,t,i)=>{const s=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(e=>{if(!Object.keys(ss).includes(t))return!1;let i=Object.keys(ss[t]).includes(e);return!i&&Object.keys(ss[t]).includes("{entity_id}")&&(i=!["turn_on","turn_off","reload","toggle","test"].includes(e)),i}):[],a=t=>ts(`component.${t}.title`,e,!1)||t.replace(/_/g," "),o=i=>{let s=ts(`component.${t}.services.${i}.description`,e,!1);return s||(s=e.services[t][i].description),s||"script"!=t||(s=ts(`component.${t}.services.turn_on.description`,e,!1)),s};let n=s.map(i=>{return Object({key:i,name:`${a(t)}: ${s=i,ts(`component.${t}.services.${s}.name`,e,!1)||e.services[t][s].name||s.replace(/_/g," ")}`,description:o(i),icon:Object.keys(ha).includes(t)&&Object.keys(ha[t].services).includes(i)?ha[t].services[i]:Ts(t),action:{service:i.includes(".")?i:`${t}.${i}`,service_data:{},target:e.services[t][i].target?{}:void 0}});var s}),r=((e,t)=>Object.keys(e).filter(t=>{var i;return null===(i=e[t].exclude_actions)||void 0===i?void 0:i.length}).filter(e=>!t||!t.includes(".")&&Yi(Gi(e),t)||Yi(e,t)).map(t=>e[t].exclude_actions).flat().filter(os))(i||{},t);return r.length&&(n=n.filter(t=>!r.some(s=>$a(Ki(t.action.service),s)>0||$a(gs(t.action,e,i),s)>0))),ns(i||{},t).forEach(e=>{let i=e.service;for(;n.find(e=>e.key==i);)i+="_2";n.push({key:i,name:e.name||"",description:e.name||"",icon:e.icon||Ts(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},target:e.target?e.target:void 0,name:e.name,icon:e.icon}})}),n};let Oa=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.lockDomain=!1}async showDialog(e){this._params=e,e.domainFilter&&(this.lockDomain=!0),await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title"),this.hass.loadBackendTranslation("services")}render(){return this._params?q`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
      ...
      >
        <div slot="heading">
          <ha-dialog-header>
            ...
            <ha-icon-button
              slot="navigationIcon"
              .label=${ts("ui.common.back",this.hass)}
              .path=${Os}
              @click=${this._clearDomain}
            ></ha-icon-button>
            `}
            <span slot="title">
              ${Zi("ui.dialog.action_picker.title",this.hass)}
            </span>
          </ha-dialog-header>
    ...
    `):q`
          <mwc-list-item disabled>
            ${ts("ui.components.combo-box.no_match",this.hass)}
          </mwc-list-item>
        `}{let e=Ms(this.hass,this._params.cardConfig);e.sort((e,t)=>Xi(e.name,t.name)),this._filter&&(e=e.filter(e=>{const t=this._filter.toLowerCase().trim().split(" ");return t.every(t=>e.name.toLowerCase().includes(t))||t.every(t=>e.key.toLowerCase().includes(t))}));let t=[];for(var i=e.length;i<7;i++)t.push(0);return q`
    ...
    `}};t([de({attribute:!1})],Oa.prototype,"hass",void 0),t([ce()],Oa.prototype,"_params",void 0),t([ce()],Oa.prototype,"_search",void 0),t([ce()],Oa.prototype,"_filter",void 0),t([ce()],Oa.prototype,"_width",void 0),t([ce()],Oa.prototype,"_height",void 0),t([ce()],Oa.prototype,"lockDomain",void 0),Oa=t([re("dialog-select-action")],Oa);var Sa=Object.freeze({__proto__:null,get DialogSelectAction(){return Oa}});let Ca=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return q`
      ${this.showPrefix?q`
    ...
    `}};t([de({type:Boolean})],Ca.prototype,"showPrefix",void 0),Ca=t([re("scheduler-settings-row")],Ca);let za=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this.selectedEntry=0,this.large=!1}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),e.get("viewMode")&&this.viewMode==_e.Single&&(this.selectedSlot=1),!0}render(){return q`
    ${this.schedule.entries.map((e,t)=>q`
      
      <div class="editor-header">
        <div class="weekdays">
          <span>
            ${Zi("ui.panel.editor.repeated_days",this.hass)}:
            ${((e,t,i)=>{const s=ca(i);let a=((e,t)=>e.concat(e).slice(t,t+e.length))(ua,s);e.sort((e,t)=>a.findIndex(t=>t==e)-a.findIndex(e=>e==t));const o=e.filter(e=>a.includes(e)).map(e=>a.findIndex(t=>t==e)),n=(e=>{const t=[];for(let i=0;i<e.length-1;i++){let s=i+1;for(;e[s]-e[s-1]==1;)s++;t.push(s-i)}return t})(o),r=Math.max(...n);if(o.length){if(6==o.length){const e=[0,1,2,3,4,5,6].filter(e=>!o.includes(e)),s=fs(a[e.pop()],t,i);return Zi("ui.components.date.repeated_days_except",i,"{excludedDays}",s)}const e=o.map(e=>fs(a[e],t,i));if(o.length>=3&&r>=3){const t=n.reduce((e,t,i)=>t==r?i:e,0);e.splice(t,r,Zi("ui.components.date.days_range",i,["{startDay}","{endDay}"],[e[t],e[t+r-1]]))}const s=e.length>1?`${e.slice(0,-1).join(", ")} ${ts("ui.common.and",i)} ${e.pop()}`:""+e.pop();return o.length>=3&&r>=3?s:Zi("ui.components.date.repeated_days",i,"{days}",s)}return e.map(e=>fs(e,t,i)).join(", ")})(e.weekdays,"short",this.hass)}
          </span>
          <ha-icon-button .path=${Cs} @click=${e=>this._showWeekdayDialog(e,t)}></ha-icon-button>
        </div>
        <div class="weekdays-actions">
        <ha-button appearance="plain" size="small" @click=${this.toggleViewMode}>
          ${this.viewMode==_e.Scheme?Zi("ui.panel.editor.toggle_single_mode",this.hass):Zi("ui.panel.editor.toggle_scheme_mode",this.hass)}
    ...
    `}toggleViewMode(){const e=this.viewMode==_e.Scheme?_e.Single:_e.Scheme;this.dispatchEvent(new CustomEvent("setViewMode",{detail:e}))}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return q``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=Ee(e,this.hass),s=(Ee(t,this.hass)||86400)-i;return q`
      <div class="actions">
        <ha-icon-button .path=${Os} @click=${e=>{this.selectedSlot=this.selectedSlot-1,e.target.blur()}} ?disabled=${null===this.selectedSlot||this.selectedSlot<1}>
        </ha-icon-button> 
        <ha-icon-button .path=${"M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z"} @click=${e=>{this.selectedSlot=this.selectedSlot+1,e.target.blur()}} ?disabled=${null===this.selectedSlot||this.selectedSlot>this.schedule.entries[this.selectedEntry].slots.length-2}>
        </ha-icon-button> 
        ...
        <ha-icon-button .path=${As} @click=${this._removeTimeslot} ?disabled=${this.schedule.entries[this.selectedEntry].slots.length<=2}>
        </ha-icon-button> 
      </div>
    `}renderSlot(){if(null===this.selectedEntry||null===this.selectedSlot)return q`
        <div class="slot-placeholder"> 
          ${Zi("ui.panel.editor.select_timeslot",this.hass)}
        </div>
      ...
      <div class="two-column">
        <div class="column">
          <scheduler-time-picker
            .hass=${this.hass}
            label="${Zi("ui.panel.editor.start_time",this.hass)}:"
        ...
        <div class="column">
          ...
          <scheduler-time-picker
            .hass=${this.hass}
            label="${Zi("ui.panel.editor.stop_time",this.hass)}:"
      ...
      ${Zi("ui.panel.editor.action",this.hass)}:
    ...
    `}_renderActionConfig(){var e,t,i;const s=Object.assign({},this.schedule.entries[this.selectedEntry].slots[this.selectedSlot]),a=s.actions.length?s.actions[0]:void 0;if(!a)return q`
      <div>
        ...
        >
          ...
          ${Zi("ui.panel.editor.add_action",this.hass)}
        </ha-button>
      </div>
    `;const o=Gi(a.service),n=rs(a,this.config.customize),r=os(null===(e=null==n?void 0:n.target)||void 0===e?void 0:e.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&os(null===(i=null===(t=rs(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return q``;const l=Object.keys(n.fields||{}).filter(e=>ia(a,e,this.hass,this.config.customize));let d="",c=[(null===(t=a.target)||void 0===t?void 0:t.entity_id)||[]].flat();return!c.length&&["notify","script"].includes(o)&&(c=[a.service]),c.length&&(d+=c.map(e=>{var t;return Ji(e,null===(t=this.hass.states[e])||void 0===t?void 0:t.attributes)}).join(", "),d+=": "),d+=gs(a,this.hass,this.config.customize),q`
      <scheduler-collapsible-section
        ?expanded=${!0}
        ?disabled=${!0}
      >
        <div slot="header" class="header">
          <ha-icon slot="icon" icon="${ma(a,this.config.customize)}"></ha-icon>
          <span>${es(d)}</span>
        </div>
        <ha-icon-button slot="contextMenu" .path=${As} @click=${this._removeAction}></ha-icon-button>
        <div slot="content">

          ${n.target?q`
          <scheduler-settings-row>
            <span slot="heading">${ts("ui.components.entity.entity-picker.entity",this.hass)}</span>
          ...
          ${l.map(e=>{var t;const i=us(a.service,null===(t=a.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let s=n.fields[e].optional||(i.number||{}).optional;const o=!s||Object.keys(a.service_data).includes(e);return q`
  ...
  mwc-checkbox {
    ...
    `}};t([de({attribute:!1})],za.prototype,"hass",void 0),t([de({attribute:!1})],za.prototype,"config",void 0),t([de({attribute:!1})],za.prototype,"viewMode",void 0),t([de({attribute:!1})],za.prototype,"selectedSlot",void 0),t([ce()],za.prototype,"schedule",void 0),t([ce()],za.prototype,"selectedEntry",void 0),t([de({type:Boolean})],za.prototype,"large",void 0),za=t([re("scheduler-main-panel")],za);const Aa=["January","February","March","April","May","June","July","August","September","October","November","December"];function Ea(e){return e.toISOString().split("T")[0]}function Ta(e){let t=new Date;const i=(e||"").match(/^([0-9]{4})-([0-9]{2})-([0-9]{2})/);null!==i&&t.setFullYear(Number(i[1]),Number(i[2])-1,Number(i[3]));const s=(e||"").match(/([0-9]{2}):([0-9]{2})(:([0-9]{2}))?$/);return null!==s&&t.setHours(Number(s[1]),Number(s[2]),s.length>4?Number(s[4]):t.getSeconds()),t}const Ma=(e,t)=>"select"in t&&null!==t.select?((e,t)=>{var i;return((null===(i=t.select)||void 0===i?void 0:i.options)||[]).some(t=>"object"==typeof t?t.value==e:t==e)})(String(e),t):"number"in t&&null!==t.number?((e,t)=>{var i,s;return isNaN(e)||void 0!==(null===(i=t.number)||void 0===i?void 0:i.min)&&e<t.number.min||void 0!==(null===(s=t.number)||void 0===s?void 0:s.max)&&t.number.max,!1})(Number(e),t):!("text"in t)||null===t.text||String(e).length>0,Da=e=>null==e||Array.isArray(e)?e:[e];let La=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0}async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title")}render(){return this._params?q`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
      ...
      >
        <div slot="heading">
          <ha-dialog-header>
            ...
            ></ha-icon-button>
            <span slot="title">
              ${Zi("ui.panel.options.conditions.add_condition",this.hass)}
            </span>
          </ha-dialog-header>
    ...
    `}};t([de({attribute:!1})],La.prototype,"hass",void 0),t([ce()],La.prototype,"_params",void 0),t([ce()],La.prototype,"_search",void 0),t([ce()],La.prototype,"_filter",void 0),t([ce()],La.prototype,"_width",void 0),t([ce()],La.prototype,"_height",void 0),La=t([re("dialog-select-condition")],La);var Pa=Object.freeze({__proto__:null,get DialogSelectCondition(){return La}});let Ia=class extends oe{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[]}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||Ea(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||Ea(new Date);const i=(await $s(this.hass)).map(e=>e.name),s=[...this.config.tags].flat();this.tags=[...i,...s.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return q`
      <div class="header first">
        <span>${Zi("ui.panel.options.conditions.header",this.hass)}:</span>
      ...
      <span class="header">${Zi("ui.panel.options.period.header",this.hass)}:</span>
      <div class="period">
        <ha-checkbox
        ...
        <span>${Zi("ui.panel.options.period.start_date",this.hass)}</span>
        <ha-date-input
          .locale=${this.hass.locale}
          value=${this.startDate}
          .label=${ts("ui.components.date-range-picker.start_date",this.hass)}
          @value-changed=${this._setStartDate}
          ?disabled=${!this.schedule.start_date}
        >
        </ha-date-input>
        <span>${Zi("ui.panel.options.period.end_date",this.hass)}</span>
        <ha-date-input
          .locale=${this.hass.locale}
          value=${this.endDate}
          .label=${ts("ui.components.date-range-picker.end_date",this.hass)}
      ...
      <span class="header">${ts("ui.common.name",this.hass)}:</span>
      <div class="period">
        <ha-textfield
          value=${this.schedule.name||""}
          placeholder=${this.schedule.name?"":ts("ui.common.name",this.hass)}
          @input=${this.updateName}
        ></ha-textfield>
      </div>

      <span class="header">${Zi("ui.panel.options.tags",this.hass)}:</span>
      <div>
        <scheduler-combo-selector
          .hass=${this.hass}
          .config=${e}
      ...
      <span class="header">${Zi("ui.panel.options.repeat_type",this.hass)}:</span>
      <ha-button
      ...
      >
        ...
        ${ts("ui.components.calendar.event.repeat.label",this.hass)}
      </ha-button>
      <ha-button
      ...
      >
        ...
        ${ts("ui.dialogs.more_info_control.vacuum.stop",this.hass)}
      </ha-button>
      <ha-button
    ...
    `}renderConditions(){let e=this.schedule.entries[0].slots[0].conditions.items;return this.conditionIdx==e.length&&(e=[...e,{}]),e.map((e,t)=>{const i=this.selectedDomain||Gi(e.entity_id||""),s=qs(this.selectedEntity||i,this.hass),a=s&&s.hasOwnProperty("number")?[ye.Above,ye.Below]:[ye.Equal,ye.Unequal],o={[ye.Equal]:"mdi:equal",[ye.Unequal]:"mdi:not-equal-variant",[ye.Above]:"mdi:greater-than",[ye.Below]:"mdi:less-than"},n={[ye.Equal]:"ui.panel.options.conditions.types.equal_to",[ye.Unequal]:"ui.panel.options.conditions.types.unequal_to",[ye.Above]:"ui.panel.options.conditions.types.above",[ye.Below]:"ui.panel.options.conditions.types.below"};return this.conditionIdx!==t||this.selectedMatchType||(this.selectedMatchType=a[0]),q`
      <scheduler-collapsible-section idx="${t}">
        ...
        >
          ...
          <mwc-list-item graphic="icon">
            ${ts("ui.panel.lovelace.editor.card.conditional.change_type",this.hass)}
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${ts("ui.components.selectors.selector.types.entity",this.hass)}
          </span>
          <scheduler-entity-picker
            .hass=${this.hass}
            .config=${this.config}
            .domain=${i}
            @value-changed=${this._selectEntity}
            .value=${this.conditionIdx==t?Da(this.selectedEntity):Da(e.entity_id)}
            ?multiple=${!1}
          >
          </scheduler-entity-picker>
        </scheduler-settings-row>
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${es(Zi(n[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
            <ha-button-menu
              @action=${e=>this._selectMatchType(e,a)}
              @closed=${e=>{e.stopPropagation()}}
              fixed
            >
              <ha-icon-button slot="trigger" .path=${Cs}>
              </ha-icon-button>
              ${a.map(i=>q`
                <mwc-list-item graphic="icon" ?noninteractive=${this.conditionIdx==t?this.selectedMatchType==i:e.match_type==i}>
                  ${es(Zi(n[i],this.hass,["{entity}","{value}"],["",""]))}
    ...
    `}};t([de({attribute:!1})],Ia.prototype,"hass",void 0),t([de({attribute:!1})],Ia.prototype,"config",void 0),t([ce()],Ia.prototype,"schedule",void 0),t([ce()],Ia.prototype,"conditionIdx",void 0),t([ce()],Ia.prototype,"selectedDomain",void 0),t([ce()],Ia.prototype,"selectedEntity",void 0),t([ce()],Ia.prototype,"selectedMatchType",void 0),t([ce()],Ia.prototype,"conditionValue",void 0),t([ce()],Ia.prototype,"conditionValid",void 0),t([ce()],Ia.prototype,"startDate",void 0),t([ce()],Ia.prototype,"endDate",void 0),t([de()],Ia.prototype,"tags",void 0),Ia=t([re("scheduler-options-panel")],Ia);let Na=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          <ha-icon-button
            slot="navigationIcon"
    ...
    `}};t([de({attribute:!1})],Na.prototype,"hass",void 0),t([ce()],Na.prototype,"_params",void 0),Na=t([re("scheduler-generic-dialog")],Na);var qa=Object.freeze({__proto__:null,get GenericDialog(){return Na}});let Ra=class extends oe{constructor(){super(...arguments),this.large=!1,this.selectedEntry=0,this.selectedSlot=0,this._panel="main",this._viewMode=_e.Single}firstUpdated(){var e;this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length&&os(e.stop)).length>0||this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1||this.schedule.entries[this.selectedEntry].slots.length>3?this._viewMode=_e.Scheme:(this._viewMode=(null===(e=this._params)||void 0===e?void 0:e.cardConfig.default_editor)||_e.Single,this.selectedSlot=this.schedule.entries[this.selectedEntry].slots.findIndex(e=>e.actions.length),this.selectedSlot<0&&(this.selectedSlot=1))}shouldUpdate(e){return 1!=e.size||!e.has("hass")||!os(this.hass)}async showDialog(e){this._params=e,this.schedule=e.schedule,this._panel="main",this.large=!1,await this.updateComplete}async closeDialog(){this._params=void 0}willUpdate(){this.hass.loadBackendTranslation("config")}render(){var e;return this._params?q`
      <ha-dialog open @closed=${this.closeDialog} .heading=${!0} hideActions scrimClickAction="">
        <ha-dialog-header slot="heading">
          ...
          <span slot="title" @click=${()=>this.large=!this.large}>
            ${this._params.editItem?this.schedule.name?null===(e=this.schedule)||void 0===e?void 0:e.name:Zi("ui.panel.common.default_name",this.hass,"{id}",this._params.editItem):Zi("ui.panel.common.new_schedule",this.hass)}
          </span>
        ...
        <div class="buttons">
          ...
          <ha-button appearance="plain" @click=${this._handleSaveClick}>
            ${ts("ui.common.save",this.hass)}
          </ha-button>
        </div>
      </ha-dialog>
    `:q``}_updateSchedule(e){let t=e.detail.schedule;t&&(this.schedule=t)}async _handleSaveClick(e){const t=aa(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const s={cancel:()=>i(!1),confirm:()=>i(!0),title:ts("state_badge.default.error",this.hass),description:Zi("ui.panel.editor.validation_errors."+t,this.hass),primaryButtonLabel:ts("ui.common.ok",this.hass)};xs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return qa})),dialogParams:s})});else if(this.schedule.schedule_id){const t=qe(await ws(this.hass,this.schedule.schedule_id),this.hass);if(pe(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Zi("ui.dialog.enable_schedule.title",this.hass),description:Zi("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:ts("ui.common.yes",this.hass),secondaryButtonLabel:ts("ui.common.no",this.hass),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};xs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return qa})),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=oa(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>da(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=oa(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>da(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Zi("ui.dialog.confirm_delete.title",this.hass),description:Zi("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:ts("ui.common.ok",this.hass),secondaryButtonLabel:ts("ui.common.cancel",this.hass)};xs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return qa})),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>da(e,this,this.hass)).then(()=>{this.closeDialog()})})}_setViewMode(e){let t=e.detail;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1;if(t!=_e.Scheme){if(t==_e.Single&&!i){let e=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>{let t=e.slots.findIndex(e=>e.actions.length);return t<0&&(t=Math.floor(e.slots.length/2)),Object(Object.assign(Object.assign({},e),{slots:e.slots.map((e,i)=>i==t?Object.assign(Object.assign({},e),{stop:void 0}):null).filter(os)}))})});return this.schedule=qe(e,this.hass),this.selectedSlot=e.entries[this.selectedEntry].slots.findIndex(e=>e.actions.length),this.selectedSlot<0&&(this.selectedSlot=1),void(this._viewMode=t)}new Promise(t=>{const i={title:Zi("ui.dialog.confirm_migrate.title",this.hass),description:Zi("ui.dialog.confirm_migrate.description",this.hass),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};xs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return qa})),dialogParams:i})}).then(e=>{e&&(this.schedule=(e=>{const t=e=>{let t=e.findIndex(e=>e.actions.length);t<0&&(t=Math.floor(e.length/2));let i=Object.assign(Object.assign({},e[t]),{stop:void 0});const s=i.conditions,a=i.start;return e=[{start:"00:00:00",stop:a,actions:[],conditions:s},i,{start:Ne(Ce(Ae(a),{minutes:1})),stop:"00:00:00",actions:[],conditions:s}]};return e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object(Object.assign(Object.assign({},e),{slots:t(e.slots)})))})})(this.schedule),this.selectedSlot=1,this._viewMode=t)})}else this._viewMode=t}};Ra.styles=ta,t([de({attribute:!1})],Ra.prototype,"hass",void 0),t([ce()],Ra.prototype,"_params",void 0),t([de({type:Boolean,reflect:!0})],Ra.prototype,"large",void 0),t([ce()],Ra.prototype,"schedule",void 0),t([ce()],Ra.prototype,"selectedEntry",void 0),t([ce()],Ra.prototype,"selectedSlot",void 0),t([ce()],Ra.prototype,"_panel",void 0),t([ce()],Ra.prototype,"_viewMode",void 0),Ra=t([re("dialog-scheduler-editor")],Ra);var Ha=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return Ra}}),Va=window&&window.__assign||function(){return(Va=Object.assign||function(e){for(var t,i=1,s=arguments.length;i<s;i++)for(var a in t=arguments[i])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e}).apply(this,arguments)};var Fa={second:45,minute:45,hour:22,day:5};const Ua=(e,t,i)=>{if(i===Me.am_pm||!i&&t.time_format===Me.am_pm){const t=Pe(e.getHours()).am_pm;return`${Pe(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===Me.twenty_four||!i&&t.time_format===Me.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:De(t)}):De(t)?Ua(e,t,Me.am_pm):Ua(e,t,Me.twenty_four)};let Ba=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},s=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return Aa[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}, ${s(e,"year")}`}(e,this._hass.locale):s>7?a=Zi("ui.components.date.next_week_day",this._hass,"{weekday}",fs(e,"long",this._hass)):1==s?a=Zi("ui.components.date.tomorrow",this._hass):s>0&&(a=fs(e,"long",this._hass));let o=Zi("ui.components.time.absolute",this._hass,"{time}",Ua(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Zi("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Zi("ui.components.time.at_midnight",this._hass)),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=ts("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=ts("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=Va(Va({},Fa),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var l=new Date(e),d=new Date(t),c=l.getFullYear()-d.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+l.getMonth()-d.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var h=a/604800;return{value:Math.round(h),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return q``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),q`
      ${es(this.relativeTime(this.datetime))}
    `}};t([de()],Ba.prototype,"_hass",void 0),t([de()],Ba.prototype,"datetime",void 0),Ba=t([re("scheduler-relative-time")],Ba);let Wa=class extends oe{render(){var e;const t=this.hass.states[this.schedule.entity_id];if(!t)return q``;const i="off"==t.state,s=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let a=ma(s,this.config.customize);if("entity"==this.config.display_options.icon){let t=[(null===(e=s.target)||void 0===e?void 0:e.entity_id)||[]].flat().shift();["script","notify"].includes(Gi(s.service))&&(t=s.service),t&&(a=Vs(t,this.config.customize,this.hass))}return q`
      <ha-icon
        icon="${a}"
      ...
      >
        ${bs(this.schedule,this.config.display_options.primary_info,this.hass,this.config.customize)}
        <div class="secondary">
        ${bs(this.schedule,this.config.display_options.secondary_info,this.hass,this.config.customize)}
        </div>
      </div>
      <div class="state">
        <ha-entity-toggle
    ...
    `}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
    ...
    `}};t([de()],Wa.prototype,"hass",void 0),t([de()],Wa.prototype,"schedule_id",void 0),t([de()],Wa.prototype,"schedule",void 0),t([de()],Wa.prototype,"config",void 0),Wa=t([re("scheduler-item-row")],Wa),e.SchedulerCard=class extends oe{constructor(){super(...arguments),this._config=Re,this.showDiscovered=!1,this.translationsLoaded=!1,this.connectionError=!1}setConfig(e){e=(e=>{let t=[];if(Fe(e,"include")&&!Ze(e.include)&&t.push("'include' must be a list of strings"),Fe(e,"exclude")&&!Ze(e.exclude)&&t.push("'exclude' must be a list of strings"),Fe(e,"discover_existing")&&!Ue(e.discover_existing)&&t.push("'discover_existing' must be a boolean"),!Fe(e,"title")||Ue(e.title)||Be(e.title)||t.push("'title' must be a boolean or string"),Fe(e,"time_step")&&("number"!=typeof e.time_step||Number(e.time_step)<1||Number(e.time_step)>30)&&t.push("'time_step' must be a number between 1 and 30"),Fe(e,"show_header_toggle")&&!Ue(e.show_header_toggle)&&t.push("'show_header_toggle' must be a boolean"),Fe(e,"show_add_button")&&!Ue(e.show_add_button)&&t.push("'show_add_button' must be a boolean"),Fe(e,"display_options")&&(We(e.display_options)?(!Fe(e.display_options,"primary_info")||Be(e.display_options.primary_info)||Ze(e.display_options.primary_info)||t.push("in 'display_options': 'primary_info' must be a string or list of strings"),!Fe(e.display_options,"secondary_info")||Be(e.display_options.secondary_info)||Ze(e.display_options.secondary_info)||t.push("in 'display_options': 'secondary_info' must be a string or list of strings"),!Fe(e.display_options,"icon")||Be(e.display_options.icon)&&["action","entity"].includes(e.display_options.icon)||t.push("in 'display_options': 'icon' must be a set to either 'action' or 'entity' ")):t.push("'display_options' must be a struct")),!Fe(e,"sort_by")||Be(e.sort_by)||Ze(e.sort_by)||t.push("'sort_by' must be a string or list of strings"),Fe(e,"customize")&&!We(e.customize)&&t.push("'customize' must be a struct"),!Fe(e,"tags")||Be(e.tags)||Ze(e.tags)||t.push("'tags' must be a string or list of strings"),!Fe(e,"exclude_tags")||Be(e.tags)||Ze(e.tags)||t.push("'exclude_tags' must be a string or list of strings"),t.length)throw new Error(`Invalid configuration provided (${t.length} error${t.length>1?"s":""}): ${t.join(", ")}.`);return e})(e),this._config=Object.assign(Object.assign({},Re),e)}firstUpdated(){(async()=>{await(async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider")&&customElements.get("ha-combo-box"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.automation.load()})()})();document.querySelector("home-assistant")._loadFragmentTranslations(this.hass.language,"config")}willUpdate(){this.hass.loadBackendTranslation("services")}__checkSubscribed(){void 0===this.__unsubs&&this.isConnected&&void 0!==this.hass&&(this.__unsubs=this.hassSubscribe())}connectedCallback(){super.connectedCallback(),this.__checkSubscribed()}disconnectedCallback(){if(super.disconnectedCallback(),this.__unsubs){for(;this.__unsubs.length;){const e=this.__unsubs.pop();e instanceof Promise?e.then(e=>e()):e()}this.__unsubs=void 0}}updated(e){super.updated(e),e.has("hass")&&this.__checkSubscribed()}hassSubscribe(){return this.loadSchedules(),[this.hass.connection.subscribeMessage(e=>this.handleScheduleItemUpdated(e),{type:"scheduler_updated"})]}shouldUpdate(e){const t=e.get("hass"),i=e.get("_config");if(i&&this._config){Object.keys(i).filter(e=>i[e]!==this._config[e]).some(e=>["tags","discover_existing","sort_by","display_options"].includes(e))&&(async()=>{await this.loadSchedules()})()}return!this.translationsLoaded&&ts("component.input_boolean.services.turn_on.name",this.hass,!1).length&&ts("ui.panel.config.automation.editor.conditions.type.sun.sunrise",this.hass,!1).length?(this.translationsLoaded=!0,!0):!t||1!=e.size||!this.schedules||Object.values(this.schedules).some(e=>JSON.stringify(t.states[e.entity_id])!==JSON.stringify(this.hass.states[e.entity_id]))}render(){let e=Object.assign({},this.schedules),t=Object.keys(this.schedules||{}).filter(t=>Qi(e[t],this._config));const i=Object.entries(e).filter(([e])=>!!this.showDiscovered||t.includes(e)).some(([,e])=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")});return q`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${this._config.title?"string"==typeof this._config.title?this._config.title:Zi("ui.panel.common.title",this.hass):""}
          </div>
    ...
    ${this.connectionError?q`
        <div>
          <hui-warning .hass=${this.hass}>
            <span style="white-space: normal">
              ${Zi("ui.panel.overview.backend_error",this.hass)}
            </span>
          </hui-warning>
        </div>
      `:Object.keys(e).length?t.map(e=>q`
          ...
          `):q`
        <div>
          ${Zi("ui.panel.overview.no_entries",this.hass)}
        </div>
        `}
      ...
      ${Object.keys(e).length>t.length&&!1!==this._config.discover_existing?this.showDiscovered?q`
          ...
          ${Object.keys(e).filter(e=>!t.includes(e)).map(e=>q`
              ...
              <div>
                ...
                >
                  ${Zi("ui.panel.overview.hide_excluded",this.hass)}
                </ha-button>
              </div>
            `:q`
              <div>
                ...
                >
                  +
                  ${Zi("ui.panel.overview.excluded_items",this.hass,"{number}",Object.keys(e).length-t.length)}
                </ha-button>
              </div>
            `:""}
        </div>
        ...
        <div class="card-actions">
          ...
          <ha-button appearance="plain" variant="warning" @click=${this._retryConnection}
            >${ts("ui.common.refresh",this.hass)}
          </ha-button>
            `:q`
          <ha-button appearance="plain" @click=${this._addClick}
            >${ts("ui.common.add",this.hass)}
          </ha-button>
          `}
        </div>`:""}
      </ha-card>
    `}async loadSchedules(){var e;(e=this.hass,e.callWS({type:"scheduler"}).then(e=>Object.fromEntries(e.map(e=>[e.schedule_id,Oe(e)])))).then(e=>{this.schedules=ks(e,this._config,this.hass),Object.values(e).every(e=>Qi(e,this._config))}).catch(e=>{this.schedules={},this.connectionError=!0})}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let s=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(s+=1);const a=(([this._config.display_options.secondary_info||[]].flat().length||2)+1)/2;this.schedules&&(s+=this.showDiscovered?Object.keys(this.schedules).length*a:Object.values(this.schedules).filter(e=>Qi(e,this._config)).length*a),clearInterval(i),e(Math.round(s))},50)})}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?ws(this.hass,e.schedule_id).then(t=>{const i=this.schedules[e.schedule_id];let s=Object.assign({},this.schedules);t&&(this._config.discover_existing||Qi(t,this._config))?s=i?i.timestamps[i.next_entries[0]||0]==t.timestamps[t.next_entries[0]||0]?Object.assign(Object.assign({},s),{[e.schedule_id]:t}):ks(Object.assign(Object.assign({},s),{[e.schedule_id]:t}),this._config,this.hass):ks(Object.assign(Object.assign({},s),{[e.schedule_id]:t}),this._config,this.hass):i&&(s=Object.fromEntries(Object.entries(s).filter(([t])=>t!=e.schedule_id))),this.schedules=Object.assign({},s)}):this.schedules=Object.fromEntries(Object.entries(this.schedules||{}).filter(([t])=>t!==e.schedule_id))}_handleEditClick(e){if(!this.schedules)return;const t=e.detail.schedule_id,i={schedule:qe(this.schedules[t],this.hass),cardConfig:this._config,editItem:t};xs(e.target,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return Ha})),dialogParams:i})}_addClick(e){const t=[this._config.tags||[]].flat().filter(e=>!["none","disabled","enabled"].includes(e));let i=JSON.parse(JSON.stringify(Ve));const s={schedule:Object.assign(Object.assign({},i),{tags:1==t.length?t:[]}),cardConfig:this._config};xs(this,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return Ha})),dialogParams:s})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked;Object.values(this.schedules).filter(e=>this.showDiscovered||Qi(e,this._config)).forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}static getConfigElement(){return document.createElement("scheduler-card-editor")}},e.SchedulerCard.styles=r`
    .card-header {
      display: flex;
      justify-content: space-between;
    }
