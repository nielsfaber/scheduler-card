...
`;var qa="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",Va="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z";const Ra={alarm_control_panel:"domains.alarm_control_panel",automation:"ui.dialogs.quick-bar.commands.navigation.automation",binary_sensor:"domains.binary_sensor",calendar:"panel.calendar",climate:"domains.climate",cover:"domains.cover",fan:"domains.fan",group:"domains.group",humidifier:"domains.humidifier",input_boolean:"domains.input_boolean",input_number:"domains.input_number",input_select:"domains.input_select",light:"domains.light",lock:"domains.lock",media_player:"domains.media_player",notify:"domains.notify",person:"ui.dialogs.quick-bar.commands.navigation.person",scene:"ui.dialogs.quick-bar.commands.navigation.scene",script:"ui.dialogs.quick-bar.commands.navigation.script",sensor:"ui.panel.config.devices.entities.sensor",sun:"ui.panel.config.automation.editor.conditions.type.sun.label",switch:"domains.switch",vacuum:"domains.vacuum",water_heater:"domains.water_heater"},Ua=(e,t)=>{if(e in Ra){const i=Ra[e],s=i.startsWith("domains")?Gs(i,rt(t)):t.localize(i);if(s)return s}return e};function Ha(e,t,i){let s=[];t.groups&&t.groups.forEach(t=>{e.find(e=>ya(e,t))&&(s=[...s,{name:t.name,icon:t.icon||"folder-outline",entities:e.filter(e=>ya(e,t))}])});const a=e.filter(e=>!s.some(t=>t.entities.includes(e)));return a.map(Le).filter((e,t,i)=>i.indexOf(e)===t).forEach(e=>{s=[...s,{name:Ua(e,i),icon:(void 0===t.standard_configuration||t.standard_configuration)&&e in ct?ct[e]:"folder-outline",entities:a.filter(t=>ya(t,{include:[e],exclude:[]}))}]}),s}const Ba={options:["on","off"]},Fa={alarm_control_panel:{template:e=>{let t=["disarmed","triggered"];const i=At(e,"supported_features")||0;return 2&i&&(t=[...t,"armed_away"]),1&i&&(t=[...t,"armed_home"]),4&i&&(t=[...t,"armed_night"]),16&i&&(t=[...t,"armed_custom_bypass"]),32&i&&(t=[...t,"armed_vacation"]),{options:t}}},binary_sensor:Ba,climate:{options:"hvac_modes"},calendar:Ba,cover:{options:["open","closed"]},device_tracker:{options:["home","not_home"]},fan:Ba,humidifier:Ba,input_boolean:Ba,input_number:{min:"min",max:"max",unit:"unit_of_measurement",step:"step"},input_select:{options:"options"},light:Ba,lock:{options:["locked","unlocked"]},number:{min:"min",max:"max",step:"step"},person:{template:(e,t)=>{const i=Object.keys(t.states).filter(e=>"zone"==Le(e)).map(Pe);return{options:[...new Set(["home","not_home",...i])]}}},proximity:{unit:"unit_of_measurement"},select:{options:"options"},sensor:{template:e=>e&&!isNaN(Number(e.state))?"%"==Mt(e,"unit_of_measurement")?{min:0,max:100,unit:"%",step:1}:{unit:"unit_of_measurement"}:{}},sun:{options:["below_horizon","above_horizon"]},switch:Ba,timer:{options:["active","paused","idle"]},water_heater:{options:"operation_list"}},Ya=(e,t)=>He(Object.assign(Object.assign({},e),{state:t})),Za=(e,t)=>{const i="closed"==t;switch(e.attributes.device_class){case"garage":return i?"mdi:garage":"mdi:garage-open";case"door":return i?"mdi:door-closed":"mdi:door-open";case"blind":return i?"mdi:blinds":"mdi:blinds-open";case"window":return i?"mdi:window-closed":"mdi:window-open";default:return i?"mdi:window-shutter":"mdi:window-shutter-open"}},Wa={alarm_control_panel:{disarmed:"mdi:lock-open-variant-outline",armed_away:"mdi:exit-run",armed_home:"mdi:home-outline",armed_night:"mdi:power-sleep",triggered:"mdi:alarm-light-outline"},binary_sensor:{on:Ya,off:Ya},calendar:{on:"mdi:flash",off:"mdi:flash-off"},climate:{off:"mdi:power-off",heat:"mdi:fire",cool:"mdi:snowflake",heat_cool:"mdi:thermometer",auto:"mdi:autorenew",dry:"mdi:water-percent",fan_only:"mdi:fan"},cover:{closed:Za,open:Za},device_tracker:{home:"mdi:home-outline",not_home:"mdi:exit-run"},fan:{on:"mdi:power",off:"mdi:power-off"},humidifier:{on:"mdi:power",off:"mdi:power-off"},input_boolean:{on:"mdi:flash",off:"mdi:flash-off"},light:{on:"mdi:lightbulb",off:"mdi:lightbulb-off"},lock:{unlocked:"mdi:lock-open-variant-outline",locked:"mdi:lock-outline"},person:(e,t,i)=>{const s={home:"mdi:home-outline",not_home:"mdi:exit-run"};return Object.keys(i.states).filter(e=>"zone"==Le(e)).forEach(e=>{const t=Pe(e),a=i.states[e].attributes.icon;a&&(s[t]=a)}),t in s?s[t]:"mdi:flash"},sensor:{unit:"attributes.unit_of_measurement"},sun:{below_horizon:"mdi:weather-sunny-off",above_horizon:"mdi:weather-sunny"},switch:{on:"mdi:flash",off:"mdi:flash-off"},timer:{active:"mdi:play",paused:"mdi:pause",idle:"mdi:sleep"}},Ga=(e,t,i,s)=>{const a=Le(e.entity_id);if(t||(t=e.state),a in Wa){if(t in Wa[a]){const s=Wa[a][t];return"string"==typeof s?s:s(e,t,i)}if("function"==typeof Wa[a])return Wa[a](e,t,i)}return s||"folder-outline"};function Ka(e,t){const i=Le(e),s=t.states[e];if(!s)return null;if("group"==i){const i=t.states[e],s=Ct(i,"entity_id");if(!s.length)return null;const o=s.map(e=>Ka(e,t));return o.every(et)?(a=o).length&&a.every(e=>e.type==a[0].type)?a[0].type==$t.List?Ft(...a):a[0].type==$t.Level?Lt(...a):null:null:null}var a;if(!Object.keys(Fa).includes(i))return null;let o=Tt(Fa[i],s,t);if("options"in o&&et(o.options)){let e=[...o.options];return e=e.map(e=>Object.assign(e,{icon:e.icon?e.icon:Ga(s,e.value,t,"flash"),name:e.name?e.name:Ja(s,e.value,t)})),o=Object.assign(Object.assign({},o),{options:e}),e.length?Ft(o):null}return"min"in o&&et(o.min)&&"max"in o&&et(o.max)?Lt(o):"enable_seconds"in o&&et(o.enable_seconds)?Wt(o):Zt(o)}const Ja=(e,t,i)=>{const s=Le(e.entity_id);return e.attributes.device_class&&i.localize(`component.${s}.entity_component._.${e.attributes.device_class}.state.${t}`)||i.localize(`component.${s}.entity_component._.state.${t}`)||t};function Xa(e,t,i){let s=i.standard_configuration?Ka(e,t):null;const a=Object.entries(i.customize).filter(([t])=>mt(t,e)).sort((e,t)=>t[0].length-e[0].length).map(([,e])=>e.states).filter(et);return a.length&&a.forEach(e=>{s=Array.isArray(e)?Ft({options:e.map(e=>Object({value:e}))}):Lt(e)}),s}function Qa(e,t,i={filterActions:!0,filterStates:!1}){let s=Object.keys(e.states).filter(e=>ya(e,t));return"notify"in e.services&&(s=[...s,...Object.keys(e.services.notify).map(e=>"notify."+e).filter(e=>ya(e,t))]),i.filterActions&&i.filterStates?s=s.filter(i=>ga(i,e,t).length||Xa(i,e,t)):i.filterActions?s=s.filter(i=>ga(i,e,t).length):i.filterStates&&(s=s.filter(i=>Xa(i,e,t))),s}const eo=(e,t)=>{let i={entity_id:e,service:t.service,service_data:Object.assign({},t.service_data)};return Object.entries(t.variables||{}).forEach(([e,t])=>{Object.keys(i.service_data||{}).includes(e)||(t.type==$t.Level?(t=t,i=Object.assign(Object.assign({},i),{service_data:t.optional?Je(i.service_data||{},e):Object.assign(Object.assign({},i.service_data),{[e]:parseFloat((t.min*t.scale_factor).toPrecision(12))||0})})):t.type==$t.List?(t=t,i=Object.assign(Object.assign({},i),{service_data:Object.assign(Object.assign({},i.service_data),{[e]:t.options.length?t.options[0].value:void 0})})):t.type==$t.Time?(t=t,i=Object.assign(Object.assign({},i),{service_data:Object.assign(Object.assign({},i.service_data),{[e]:t.enable_seconds?"00:00:00":"00:00"})})):t.type==$t.Text&&(t=t,i=Object.assign(Object.assign({},i),{service_data:Object.assign(Object.assign({},i.service_data),{[e]:""})})))}),i},to=(e,t,i,s)=>{if(!e)return null;const a=fa(e,s);let o=i.find(e=>ra(e,a,!0));if(!o)return null;let n=t.map(e=>eo(e,o));return n=Object.keys(o.variables||{}).filter(t=>Object.keys(e.service_data||{}).includes(t)).reduce((t,i)=>{if(!t)return t;switch(o.variables[i].type){case $t.Level:const s=o.variables[i];let a=Number(e.service_data[i]);return a/=s.scale_factor,a=Math.round(a/s.step)*s.step,a=parseFloat(a.toPrecision(12)),a>s.max?a=s.max:a<s.min&&(a=s.min),a*=s.scale_factor,a=parseFloat(a.toFixed(2)),t.map(e=>Object.assign(e,{service_data:Object.assign(Object.assign({},e.service_data),{[i]:a})}));case $t.List:return o.variables[i].options.some(t=>t.value==e.service_data[i])?t.map(t=>Object.assign(t,{service_data:Object.assign(Object.assign({},t.service_data),{[i]:e.service_data[i]})})):null;case $t.Time:case $t.Text:return t.map(t=>Object.assign(t,{service_data:Object.assign(Object.assign({},t.service_data),{[i]:e.service_data[i]})}));default:return t}},n),n};function io(e,t){return e.id||e.value||t}let so=class extends oe{constructor(){super(...arguments),this.items=[],this.value=null}render(){return this.items.length?this.items.map((e,t)=>this.renderButton(e,t)):q`
        <div class="text-field">
          <slot></slot>
        </div>
      `}renderButton(e,t){const i=Array.isArray(this.value)?this.value:[this.value],s=io(e,t);return q`
      <mwc-button
    ...
    `:q``}selectGroup(e){this.selectedGroup=e,this.entities=[],this.selectedAction=void 0}async selectEntity(e){const t=lt("object"==typeof e?e.target.value:e);let i=this.selectedAction;if(i){let e=this.getActionsForEntity(t);this.entities.every(e=>"script"==Le(e))&&this.entities.includes(i.service)?(i=Object.assign(Object.assign({},i),{service:"script.script"}),e=e.map(e=>t.includes(e.service)?Object.assign(Object.assign({},e),{service:"script.script"}):e),i=e.find(e=>ra(e,i)),i=Object.assign(Object.assign({},i),{service:t[0]})):i=e.find(e=>ra(e,i))}else i=void 0;if(this.schedule&&t.length&&(this.timeSchemeSelected||this.selectedAction)){const s=await this.migrateSchedule(t,this.timeSchemeSelected?null:i);if(!s)return this.selectedAction=null,"object"==typeof e&&e.stopPropagation(),void(this.shadowRoot.querySelector("#selectedEntity").value=this.entities);this.entities=t,this.selectedAction=i,this.dispatchEvent(new CustomEvent("change",{detail:s}))}else this.entities=t,this.selectedAction=i}async selectAction(e){const t=e.detail;if(this.schedule){const i=await this.migrateSchedule(this.entities,t);if(!i)return this.selectedAction=null,e.stopPropagation(),void(this.shadowRoot.querySelector("#selectedAction").value=null);this.dispatchEvent(new CustomEvent("change",{detail:i}))}this.selectedAction=t,this.timeSchemeSelected=!1}async selectTimeScheme(e){if(this.schedule){const t=await this.migrateSchedule(this.entities,null);if(!t)return void e.stopPropagation();this.dispatchEvent(new CustomEvent("change",{detail:t}))}this.selectedAction=null,this.timeSchemeSelected=!0}nextClick(){if(!this.hass||!this.config||!this.selectedAction&&!this.timeSchemeSelected)return;const e=1==lt(this.config.tags).length?lt(this.config.tags).slice(0,1):[];if(this.timeSchemeSelected)this.actions=ga(this.entities,this.hass,this.config),this.schedule={weekdays:["daily"],timeslots:no,repeat_type:xt.Repeat,tags:e};else{let t=Ye(ja(new Date,rt(this.hass),De.twenty_four),this.hass);t=We(t,this.config.time_step,{wrapAround:!0}),this.actions=[this.selectedAction];const i={start:Ze(t),actions:this.entities.map(e=>eo(e,this.actions[0]))};this.schedule={weekdays:["daily"],timeslots:[i],repeat_type:xt.Repeat,tags:e}}this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule,entities:this.entities.map(e=>ht(e,this.hass,this.config)),actions:this.actions,tab:Be.Time}}))}migrateSchedule(e,t){let i=!0,s=function e(t){return null==t?t:t instanceof Array?t.reduce((t,i,s)=>(t[s]=e(i),t),[]):t instanceof Object?Object.keys(t).reduce((i,s)=>(i[s]=e(t[s]),i),{}):t}(this.schedule);const a=null!==t?[t]:ga(e,this.hass,this.config);if(this.timeSchemeSelected)if(null!==t){let t=Ye(ja(new Date,rt(this.hass),De.twenty_four),this.hass);t=We(t,this.config.time_step,{wrapAround:!0});const o={start:Ze(t),actions:e.map(e=>eo(e,a[0]))};s=Object.assign(Object.assign({},s),{timeslots:[o]}),i=!1}else{const t=s.timeslots.map(e=>e.actions[0]),o=t.map(t=>to(t,e,a,this.hass));i=t.every((e,t)=>null!==o[t]&&ra(e,o[t][0])),s=Object.assign(Object.assign({},s),{timeslots:s.timeslots.map((e,t)=>Object.assign(e,{actions:o[t]||[]}))})}else if(null!==t){const t=to(s.timeslots[0].actions[0],e,a,this.hass)||e.map(e=>eo(e,a[0]));s=Object.assign(Object.assign({},s),{timeslots:[Object.assign(Object.assign({},s.timeslots[0]),{actions:t})]})}else s=Object.assign(Object.assign({},s),{timeslots:no}),i=!1;const o={schedule:s,actions:a,entities:e.map(e=>ht(e,this.hass,this.config))};return new Promise(e=>{if(i)e(o);else{const t={title:Gs("ui.dialog.confirm_migrate.title",rt(this.hass)),description:Gs("ui.dialog.confirm_migrate.description",rt(this.hass)),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{e(!1)},confirm:()=>{e(o)}};gt(this,{dialogTag:"generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return oo})),dialogParams:t},this.cardEmbeddedInPopup)}})}};ro.styles=r`
    ${Pa}
  `,t([de()],ro.prototype,"hass",void 0),t([de()],ro.prototype,"config",void 0),t([de()],ro.prototype,"selectedGroup",void 0),t([de()],ro.prototype,"selectedAction",void 0),t([de()],ro.prototype,"entities",void 0),t([de()],ro.prototype,"schedule",void 0),t([de()],ro.prototype,"multipleEntity",void 0),t([de()],ro.prototype,"scheduleEntities",void 0),t([de()],ro.prototype,"timeSchemeSelected",void 0),t([de({type:Boolean})],ro.prototype,"editItem",void 0),ro=t([re("scheduler-editor-entity")],ro);const lo=(e,t,i={})=>{const s=Ge(e);if(!s)return e;const a=t.states["sun.sun"],o="sunrise"==s.event?Ye(a.attributes.next_rising,t):Ye(a.attributes.next_setting,t);let n="+"==s.sign?o+Ye(s.offset,t):o-Ye(s.offset,t);return i.stepSize&&(n=We(n,i.stepSize)),Ze(n)},co=(e,t,i,s={})=>{Ge(e)&&(e=lo(e,i));const a=Ye(e,i),o=i.states["sun.sun"],n=Ye(o.attributes.next_rising,i),r=Ye(o.attributes.next_setting,i);t||(t=Math.abs(a-n)<Math.abs(a-r)?Ot.Sunrise:Ot.Sunset);let l=a-(t==Ot.Sunrise?Ye(o.attributes.next_rising,i):Ye(o.attributes.next_setting,i));return s.stepSize&&(l=We(l,s.stepSize,{maxHours:6})),`${t}${l>0?"+":"-"}${Ze(Math.abs(l))}`};let uo=class extends oe{constructor(){super(...arguments),this.stepSize=10,this.relativeMode=!1,this.event=Ot.Sunrise,this.maxOffset=6}get time(){return this._time>=0?this._time:Math.abs(this._time)}set time(e){const t=We(e,this.stepSize,{wrapAround:!this.relativeMode,maxHours:this.relativeMode?this.maxOffset:void 0}),i=t!=this._time&&et(this._time);this._time=t,i&&this.updateValue()}firstUpdated(){const e=Ge(this.value);e?(this.relativeMode=!0,this.event=e.event==Ot.Sunrise?Ot.Sunrise:Ot.Sunset,this.time="+"==e.sign?Ye(e.offset,this.hass):-Ye(e.offset,this.hass)):this.time=Ye(this.value,this.hass)}updateValue(){if(this.relativeMode){const e=this._time>=0?"+":"-",t=Ze(this.time);this.value=`${this.event}${e}${t}`}else this.value=Ze(this.time);const e=new CustomEvent("change");this.dispatchEvent(e)}getTimeParts(){const e=(this.relativeMode?Ze(this.time):ja(za(Ze(this.time)),rt(this.hass))).split(/:|\ /);return e[0]=String(Number(e[0])),e}render(){const e=this.getTimeParts();return q`
    ...
    `:q``}getBeforeAfter(){return this.hass?this._time<0?this.hass.localize("ui.panel.config.automation.editor.conditions.type.sun.before").trim():this.hass.localize("ui.panel.config.automation.editor.conditions.type.sun.after").trim():""}toggleAmPm(){this.time=this._time+43200}toggleBeforeAfter(){this.time=-this._time,this.updateValue()}toggleSunriseSunset(){this.event=this.event==Ot.Sunrise?Ot.Sunset:Ot.Sunrise,this.updateValue()}toggleMode(){if(!this.hass)return;this.relativeMode=!this.relativeMode;const e=this.hass.states["sun.sun"],t=Ye(e.attributes.next_rising,this.hass),i=Ye(e.attributes.next_setting,this.hass);if(this.relativeMode){this.event=Math.abs(this._time-t)<Math.abs(this._time-i)?Ot.Sunrise:Ot.Sunset;let e=this.event==Ot.Sunrise?this._time-t:this._time-i;e>3600*this.maxOffset?e=3600*this.maxOffset:e<3600*-this.maxOffset&&(e=3600*-this.maxOffset),this.time=e}else this.time=this.event==Ot.Sunrise?this._time+t:this._time+i}_hoursChanged(e,t=!1){const i=e.target,s=i.value;let a=Number(s);const o=this.relativeMode?0:t?1:0,n=this.relativeMode?this.maxOffset:t?12:23;let r=!0;s.length>2&&(r=!1,a=Number(s.substring(0,2))),a<0&&(r=!1,a=-a),a<o&&(r=!1,a=o),a>n&&(r=!1,a=n),r||(i.value=String(a),i.blur())}_minutesChanged(e){const t=e.target,i=t.value;let s=Number(i),a=!0;i.length>2&&(a=!1,s=Number(i.substring(0,2))),s<0&&(a=!1,s=-s),s>59&&(a=!1,s=59),s%this.stepSize!=0&&(s=Math.round(s/this.stepSize)*this.stepSize),a||(t.value=String(s).padStart(2,"0"),t.blur())}_onFocus(e){e.target.value=""}_handleHoursInput(e,t){const i=e.target;let s=Number(i.value);if(!i.value.length)return void(i.value=t[0]);t.length>2&&12==s&&(s=0),t.length>2&&"PM"==t[2]&&(s+=12);const a=Number(t[1]);this.time=this._time>=0?3600*s+60*a:-(3600*s+60*a),i.value=this.getTimeParts()[0]}_handleMinutesInput(e,t){const i=e.target;let s=Number(i.value);if(!i.value.length)return void(i.value=t[1]);s%this.stepSize!=0&&(s=Math.round(s/this.stepSize)*this.stepSize);let a=Number(t[0]);t.length>2&&12==a&&(a=0),t.length>2&&"PM"==t[2]&&(a+=12),this.time=this._time>=0?3600*a+60*s:-(3600*a+60*s),i.value=this.getTimeParts()[1]}};uo.styles=r`
    div.time-picker {
      display: grid;
  ...
  `,t([de()],uo.prototype,"hass",void 0),t([de({type:Number})],uo.prototype,"stepSize",void 0),t([de()],uo.prototype,"relativeMode",void 0),t([de()],uo.prototype,"event",void 0),t([de()],uo.prototype,"_time",void 0),uo=t([re("time-picker")],uo);let mo=class extends oe{constructor(){super(),this.slots=[],this.actions=[],this.stepSize=10,this.isDragging=!1,this.currentTime=0,this.rangeMin=0,this.rangeMax=86400,this.activeSlot=null,this.activeMarker=null,this.previousSlot=null,this.timer=0,this.timeout=0,this.zoomFactor=1,this.large=!1,this.handleResize=this.handleResize.bind(this)}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){window.addEventListener("resize",this.handleResize)}disconnectedCallback(){window.removeEventListener("resize",this.handleResize),clearInterval(this.timer),clearTimeout(this.timeout),super.disconnectedCallback&&super.disconnectedCallback()}render(){if(!this.hass)return q``;const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=86400/(this.rangeMax-this.rangeMin)*e,i=-this.rangeMin/(this.rangeMax-this.rangeMin)*e;return q`
      <div class="outer">
        <div
    ...
    `}renderSlots(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=86400/(this.rangeMax-this.rangeMin)*e;let i=-this.rangeMin/(this.rangeMax-this.rangeMin)*e;return this.slots.map((s,a)=>{const o=((Ye(s.stop,this.hass)||86400)-Ye(s.start,this.hass))/86400,n=this.computeActionDisplay(s)||"",r=5*(n||"").length+10,l=i<0&&i+o*t>0?5-i:15,d=i+o*t>e&&i<e?o*t-(e-i)+5:15,c=o*t-l-d;i+=o*t;const u=(()=>{if(n&&(c>r/3||c>50)&&c>30)return q`
          ...
          `;const e=this.computeActionIcons(s);return e?q`
            <span style="margin-left: auto; margin-right: auto">
                ${e.map(e=>q`<ha-icon icon="${e}"></ha-icon>`)}
            </span>
          `:""})();return q`
        <div
    ...
    `}};t([de()],mo.prototype,"hass",void 0),t([de({type:Array})],mo.prototype,"slots",void 0),t([de({type:Array})],mo.prototype,"actions",void 0),t([de({type:Number})],mo.prototype,"stepSize",void 0),t([de()],mo.prototype,"rangeMin",void 0),t([de()],mo.prototype,"rangeMax",void 0),t([de()],mo.prototype,"activeSlot",void 0),t([de()],mo.prototype,"activeMarker",void 0),t([de({type:Boolean})],mo.prototype,"large",void 0),t([function(e){return ue({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */({passive:!0})],mo.prototype,"_handleTouchStart",null),mo=t([re("timeslot-editor")],mo);const ho=async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider")&&customElements.get("ha-combo-box"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.automation.load()};let po=class extends oe{constructor(){super(...arguments),this.min=0,this.max=255,this.step=1,this.scaleFactor=1,this.unit="",this.optional=!1,this.disabled=!1,this._displayedValue=0}set value(e){e=isNaN(e)?this.min:this._roundedValue(e/this.scaleFactor),this._displayedValue=e}firstUpdated(){(async()=>{await ho()})(),this.disabled&&!this.optional&&(this.disabled=!1,this.requestUpdate())}render(){return q`
    ...
    `:q``}toggleChecked(e){const t=e.target.checked;this.disabled=!t;const i=this.disabled?null:this._scaledValue(this._displayedValue);Ie(this,"value-changed",{value:i})}_updateValue(e){let t=Number(e.target.value);this._displayedValue=t,t=this._scaledValue(this._displayedValue),Ie(this,"value-changed",{value:t})}_roundedValue(e){return e=Math.round(e/this.step)*this.step,(e=parseFloat(e.toPrecision(12)))>this.max?e=this.max:e<this.min&&(e=this.min),e}_scaledValue(e){return e=this._roundedValue(e),e*=this.scaleFactor,e=parseFloat(e.toFixed(2))}};po.styles=r`
    ${Pa} :host {
      width: 100%;
    }
    ha-slider {
  ...
  `,t([de({type:Number})],po.prototype,"min",void 0),t([de({type:Number})],po.prototype,"max",void 0),t([de({type:Number})],po.prototype,"step",void 0),t([de({type:Number})],po.prototype,"value",null),t([de({type:Number})],po.prototype,"scaleFactor",void 0),t([de({type:String})],po.prototype,"unit",void 0),t([de({type:Boolean})],po.prototype,"optional",void 0),t([de({type:Boolean})],po.prototype,"disabled",void 0),t([de({type:Number})],po.prototype,"_displayedValue",void 0),po=t([re("variable-slider")],po);let _o=class extends oe{firstUpdated(){var e;null!==this.value&&void 0!==this.value||(null===(e=this.variable)||void 0===e?void 0:e.type)!=$t.Level||this.variable.optional||this.levelVariableUpdated(this.variable.min)}render(){return this.variable?this.variable.type==$t.Level?this.renderLevelVariable():this.variable.type==$t.List?this.renderListVariable():this.variable.type==$t.Text?this.renderTextVariable():this.variable.type==$t.Time?this.renderTimeVariable():q``:q``}levelVariableUpdated(e){const t="number"==typeof e?e:Number(e.detail.value);this.value=t,Ie(this,"value-changed",{value:t})}renderLevelVariable(){const e=this.variable,t=Number(this.value);return q`
      <variable-slider
        min=${e.min}
        max=${e.max}
        step=${e.step}
    ...
    `}renderTimeVariable(){if(!this.hass||!this.variable)return console.warn(this.renderTimeVariable.name+"() not rendering: undefined references"),q``;const e=this.variable,t=this.value;return q`
      <ha-time-input
        .enableSecond=${e.enable_seconds}
        .value=${t}
        .locale=${this.hass.locale}
        @value-changed=${this.listVariableUpdated}
      ></ha-time-input>
      <div class="key">${e.enable_seconds?"Hours:Minutes:Seconds":"Hours:Minutes"}</div>
    `}};_o.styles=r`
    ha-textfield {
      width: 100%;
    }
  ...
  `,t([de()],_o.prototype,"hass",void 0),t([de()],_o.prototype,"variable",void 0),t([de()],_o.prototype,"value",void 0),_o=t([re("scheduler-variable-picker")],_o);let vo=class extends oe{constructor(){super(...arguments),this.activeEntry=null,this.activeMarker=null,this.timeslots=!1,this.editItem=!1,this.large=!1}firstUpdated(){if(!this.actions||!this.hass)return;this.timeslots||(this.activeEntry=0);const e=this.actions.map(e=>{const t=Object.assign(Object.assign({},e),{service_data:Je(e.service_data||{},...Object.keys(e.variables||{}))});return Object.assign(e,{name:va(t)})});e.sort(it),this.actions=e}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){var e;if(!(this.hass&&this.config&&this.entities&&this.actions))return q``;let t="";return this.timeslots||(t=this.hass.localize("ui.dialogs.helper_settings.input_datetime.time"),(null===(e=this.entities)||void 0===e?void 0:e[0].id.startsWith("time"))&&(t+=` (${Gs("ui.panel.common.title",rt(this.hass))})`)),q`
      <div class="content">
        <div class="header">
          ${this.hass.localize("ui.panel.config.automation.editor.actions.type.device_id.action")}
        </div>
    ...
    `}getEntityName(e){return e.name||this.hass.states[e.id].attributes.friendly_name||Pe(e.id)}renderSummary(){return this.entities&&this.actions?q`
      <div class="summary">
        <div class="summary-entity">
          ${this.entities.map(e=>q`
              <div>
                <ha-icon icon="${ot(e.icon)}"> </ha-icon>
                ${st(at(this.getEntityName(e)))}
              </div>
            `)}
        </div>
    ...
    `:q``}renderDays(){if(!this.hass)return q``;let e=Array.from(Array(7).keys());const t=function(e){const t=e.match(/^([a-z]{2,3})(?:-([a-z]{3})(?=$|-))?(?:-([a-z]{4})(?=$|-))?(?:-([a-z]{2}|\d{3})(?=$|-))?/i),i=t[1],s=t[4],a="AEAFBHDJDZEGIQIRJOKWLYOMQASDSY".match(/../g),o="AGARASAUBDBRBSBTBWBZCACNCODMDOETGTGUHKHNIDILINJMJPKEKHKRLAMHMMMOMTMXMZNINPPAPEPHPKPRPTPYSASGSVTHTTTWUMUSVEVIWSYEZAZW".match(/../g),n="amasbndzengnguhehiidjajvkmknkolomhmlmrmtmyneomorpapssdsmsnsutatethtnurzhzu".match(/../g);return s?o.includes(s)?"sun":a.includes(s)?"sat":"mon":n.includes(i)?"sun":["ar","arq","arz","fa"].includes(i)?"sat":"mon"}(this.hass.language),i=e.length-ba.findIndex(e=>e.substr(0,3)==t);e=[...e.slice(-i),...e.slice(0,-i)];const s=e.map(e=>Object({value:ba[e].substr(0,3),name:ka(e,rt(this.hass),!0)})),a=[{value:St.Daily,name:Gs("ui.components.date.day_types_short.daily",rt(this.hass))},{value:St.Workday,name:Gs("ui.components.date.day_types_short.workdays",rt(this.hass))},{value:St.Weekend,name:Gs("ui.components.date.day_types_short.weekend",rt(this.hass))},{value:St.Custom,name:this.hass.localize("ui.panel.config.automation.editor.actions.type.choose.label")}];return q`
      <div class="header">${Gs("ui.components.date.days",rt(this.hass))}</div>
      <button-group .items=${a} value=${wa(this.schedule.weekdays)} @change=${this.selectDays}>
      </button-group>
      ${wa(this.schedule.weekdays)==St.Custom?q`
            <div>
              <button-group
                .items=${s}
  ...
  `,t([de()],vo.prototype,"hass",void 0),t([de()],vo.prototype,"config",void 0),t([de()],vo.prototype,"schedule",void 0),t([de()],vo.prototype,"actions",void 0),t([de()],vo.prototype,"entities",void 0),t([de()],vo.prototype,"activeEntry",void 0),t([de()],vo.prototype,"activeMarker",void 0),t([de({type:Boolean})],vo.prototype,"timeslots",void 0),t([de({type:Boolean})],vo.prototype,"editItem",void 0),t([de({type:Boolean})],vo.prototype,"large",void 0),vo=t([re("scheduler-editor-time")],vo);let fo=class extends oe{constructor(){super(...arguments),this.label="",this.items=[],this.clearable=!1,this.icons=!1,this.disabled=!1,this.allowCustomValue=!1,this.invalid=!1}disconnectedCallback(){super.disconnectedCallback(),this._overlayMutationObserver&&(this._overlayMutationObserver.disconnect(),this._overlayMutationObserver=void 0)}open(){this.updateComplete.then(()=>{var e,t;null===(t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("vaadin-combo-box-light"))||void 0===t||t.open()})}focus(){this.updateComplete.then(()=>{var e,t,i;null===(i=null===(t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("vaadin-combo-box-light"))||void 0===t?void 0:t.inputElement)||void 0===i||i.focus()})}shouldUpdate(e){if(e.get("items"))if(tt(this.items,e.get("items"))){if(1==e.size)return!1}else this.firstUpdated();return!0}firstUpdated(){(async()=>{await ho()})(),this._comboBox.items=this.items}render(){return q`
        ...
        >
          ${et(this._value)&&this.items.find(e=>e.value==this._value)?q`
                ${this.icons?q`
                    ...
                    `:""}
                ${this.clearable?q`
                      <ha-icon-button slot="suffix" class="clear-button" @click=${this._clearValue} .path=${qa}>
                      </ha-icon-button>
                    `:""}
              `:""}
        </ha-textfield>
    ...
    `}};t([de()],fo.prototype,"label",void 0),t([de()],fo.prototype,"value",void 0),t([de()],fo.prototype,"items",void 0),t([de()],fo.prototype,"clearable",void 0),t([de()],fo.prototype,"icons",void 0),t([de({type:Boolean})],fo.prototype,"disabled",void 0),t([ce()],fo.prototype,"_opened",void 0),t([de({attribute:"allow-custom-value",type:Boolean})],fo.prototype,"allowCustomValue",void 0),t([de({type:Boolean})],fo.prototype,"invalid",void 0),t([function(e,t){return ue({descriptor:i=>{const s={get(){var t,i;return null!==(i=null===(t=this.renderRoot)||void 0===t?void 0:t.querySelector(e))&&void 0!==i?i:null},enumerable:!0,configurable:!0};if(t){const t="symbol"==typeof i?Symbol():"__"+i;s.get=function(){var i,s;return void 0===this[t]&&(this[t]=null!==(s=null===(i=this.renderRoot)||void 0===i?void 0:i.querySelector(e))&&void 0!==s?s:null),this[t]}}return s}})}("vaadin-combo-box-light",!0)],fo.prototype,"_comboBox",void 0),fo=t([re("scheduler-select")],fo);let yo=class extends oe{constructor(){super(...arguments),this.items=[],this.value=[],this.label="",this.invalid=!1}shouldUpdate(e){return e.get("items")&&(tt(this.items,e.get("items"))||this.firstUpdated()),!0}firstUpdated(){this.value.some(e=>!this.items.map(e=>e.value).includes(e))&&(this.value=this.value.filter(e=>this.items.map(e=>e.value).includes(e)),Ie(this,"value-changed",{value:this.value}))}render(){return q`
      <div class="chip-set">
    ...
    `}renderAddCondition(){if(!this.addCondition||!this.hass||!this.config)return q``;if(this.selectedEntity){const e=this.selectedEntity,t=Xa(e.id,this.hass,this.config);let i;if((null==t?void 0:t.type)==$t.Level)i=[jt.Above,jt.Below];else if((null==t?void 0:t.type)==$t.List)i=[jt.Equal,jt.Unequal];else{const t=e.id in this.hass.states?this.hass.states[e.id].state:null;i=!t||["unavailable","unknown"].includes(t)?[jt.Equal,jt.Unequal,jt.Above,jt.Below]:isNaN(Number(t))?[jt.Equal,jt.Unequal]:[jt.Above,jt.Below]}const s=bo(this.hass,i);return q`
  ...
  `,t([de()],ko.prototype,"hass",void 0),t([de()],ko.prototype,"config",void 0),t([de()],ko.prototype,"schedule",void 0),t([de()],ko.prototype,"selectedGroup",void 0),t([de()],ko.prototype,"selectedEntity",void 0),t([de()],ko.prototype,"conditionMatchType",void 0),t([de()],ko.prototype,"conditionValue",void 0),t([de()],ko.prototype,"editConditionItem",void 0),t([de({type:Boolean})],ko.prototype,"editItem",void 0),t([de()],ko.prototype,"addCondition",void 0),t([de()],ko.prototype,"tags",void 0),t([ce()],ko.prototype,"startDate",void 0),t([ce()],ko.prototype,"endDate",void 0),ko=t([re("scheduler-editor-options")],ko);let wo=class extends oe{constructor(){super(...arguments),this.actions=[],this.editItem=null,this.large=!1,this._currTab=Be.Entity,this._tabs=[Be.Entity,Be.Time,Be.Options]}provideHass(e){e.hass=this.hass}async showDialog(e){this._params=e,this._config=e.config,this.entities=e.entities,this.actions=e.actions,this.schedule=e.schedule,this.editItem=e.editItem,this.cardEmbeddedInPopup=e.cardEmbeddedInPopup,this._currTab=null!==this.editItem?Be.Time:Be.Entity,await this.updateComplete}async closeDialog(){this._params=void 0,this.large=!1}render(){var e,t,i,s;const a=null===(e=this.schedule)||void 0===e?void 0:e.timeslots.every(e=>e.stop),o=e=>e==Be.Entity?this.hass.localize("ui.components.entity.entity-picker.entity"):e==Be.Time?this.hass.localize("ui.dialogs.helper_settings.input_datetime.time"):e==Be.Options?this.hass.localize("ui.dialogs.helper_settings.input_select.options"):e;return this._params?q`
    ...
    `}};t([de()],wo.prototype,"_config",void 0),t([ce()],wo.prototype,"_params",void 0),t([de()],wo.prototype,"editItem",void 0),t([de({type:Boolean,reflect:!0})],wo.prototype,"large",void 0),t([ce()],wo.prototype,"_currTab",void 0),wo=t([re("scheduler-editor-dialog")],wo);var xo=Object.freeze({__proto__:null,get SchedulerEditorDialog(){return wo}});let $o=class extends oe{constructor(){super(...arguments),this.scheduleEntities=[],this._cardTab=!1,this.selectedDomain=""}setConfig(e){this._config=e}async firstUpdated(){await ho(),this.scheduleEntities=(await ft(this.hass)).map(e=>e.entity_id);const e=(await kt(this.hass)).map(e=>e.name);e.sort(it),this.tagOptions=e}render(){return this.hass&&this._config?q`
    ...
    `}};t([de()],$o.prototype,"hass",void 0),t([de()],$o.prototype,"_config",void 0),t([de()],$o.prototype,"scheduleEntities",void 0),t([de()],$o.prototype,"tagOptions",void 0),t([ce()],$o.prototype,"_cardTab",void 0),t([de()],$o.prototype,"selectedDomain",void 0),$o=t([re("scheduler-card-editor")],$o);let jo=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=go(e,rt(this._hass)):s>7?a=Gs("ui.components.date.next_week_day",rt(this._hass),"{weekday}",ka(e,rt(this._hass))):1==s?a=Gs("ui.components.date.tomorrow",rt(this._hass)):s>0&&(a=ka(e,rt(this._hass)));let o=Gs("ui.components.time.absolute",rt(this._hass),"{time}",ja(e,rt(this._hass)));return 12==e.getHours()&&0==e.getMinutes()?o=Gs("ui.components.time.at_noon",rt(this._hass)):0==e.getHours()&&0==e.getMinutes()&&(o=Gs("ui.components.time.at_midnight",rt(this._hass))),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=this._hass.localize("ui.common.and");return`${new Intl.RelativeTimeFormat(rt(this._hass).language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(rt(this._hass).language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=this._hass.localize("ui.common.and");return`${new Intl.RelativeTimeFormat(rt(this._hass).language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(rt(this._hass).language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=qt(qt({},Vt),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var l=new Date(e),d=new Date(t),c=l.getFullYear()-d.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+l.getMonth()-d.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var m=a/604800;return{value:Math.round(m),unit:"week"}}(e);return new Intl.RelativeTimeFormat(rt(this._hass).language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return q``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),q`
      ${st(this.relativeTime(this.datetime))}
    `}};t([de()],jo.prototype,"_hass",void 0),t([de()],jo.prototype,"datetime",void 0),jo=t([re("my-relative-time")],jo),window.customCards=window.customCards||[],window.customCards.push({type:"scheduler-card",name:"Scheduler Card",description:"Card to manage schedule entities made with scheduler-component."}),console.info("%c  SCHEDULER-CARD  \n%c  Version: "+"v3.2.12".padEnd(7," "),"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");const zo=e=>new Date(e.timestamps[e.next_entries[0]]).valueOf(),Oo=(e,t)=>{var i,s;if(!e.timeslots.every(e=>e.actions.every(e=>ya(e.entity_id||e.service,t))))return!1;let a=!0;const o=lt(t.tags);o.length&&(a=!1,((e.tags||[]).some(e=>o.includes(e))||o.includes("none")&&!(null===(i=e.tags)||void 0===i?void 0:i.length)||o.includes("enabled")&&e.enabled||o.includes("disabled")&&!e.enabled)&&(a=!0));const n=lt(t.exclude_tags);return n.length&&a&&((e.tags||[]).some(e=>n.includes(e))||n.includes("none")&&!(null===(s=e.tags)||void 0===s?void 0:s.length)||n.includes("enabled")&&e.enabled||n.includes("disabled")&&!e.enabled)&&(a=!1),a},So=(e,t)=>!!t.discover_existing||!!e&&Oo(e,t),Eo=(e,t,i)=>({primaryInfo:Oa(e,t,i),secondaryInfo:Sa(e,t,i),icon:Ea(e,t,i)});e.SchedulerCard=class extends(Ta(oe)){constructor(){super(...arguments),this.showDiscovered=!1,this.translationsLoaded=!1,this.scheduleDisplayInfo={},this.connectionError=!1}static getConfigElement(){return document.createElement("scheduler-card-editor")}hassSubscribe(){return this.loadSchedules(),[this.hass.connection.subscribeMessage(e=>this.updateScheduleItem(e),{type:"scheduler_updated"})]}firstUpdated(){const e=this.hass;if(e.localize("ui.panel.config.automation.editor.actions.type.device_id.action"))this.translationsLoaded=!0;else{document.querySelector("home-assistant")._loadFragmentTranslations(e.language,"config").then(()=>{this.hass.localize})}}provideHass(e){e.hass=this.hass}async updateScheduleItem(e){var t;"scheduler_item_removed"!=e.event?yt(this.hass,e.schedule_id).then(t=>{var i;const s=null===(i=this.schedules)||void 0===i?void 0:i.find(t=>t.schedule_id==e.schedule_id);let a=[...this.schedules||[]];try{this.scheduleDisplayInfo=Object.assign(Object.assign({},this.scheduleDisplayInfo),{[t.schedule_id]:Eo(t,this._config,this.hass)})}catch(e){}t&&So(t,this._config)?a=s?zo(s)==zo(t)?a.map(e=>e.schedule_id==t.schedule_id?t:e):this.sortSchedules(a.map(e=>e.schedule_id==t.schedule_id?t:e)):this.sortSchedules([...a,t]):s&&(a=a.filter(t=>t.schedule_id!=e.schedule_id)),this.schedules=[...a]}):this.schedules=null===(t=this.schedules)||void 0===t?void 0:t.filter(t=>t.schedule_id!=e.schedule_id)}async loadSchedules(){ft(this.hass).then(e=>{const t=e.filter(e=>So(e,this._config));let i={};Object.keys(t).forEach(e=>{try{i=Object.assign(Object.assign({},i),{[t[e].schedule_id]:Eo(t[e],this._config,this.hass)})}catch(e){}}),this.scheduleDisplayInfo=i,this.schedules=this.sortSchedules(t)}).catch(e=>{this.schedules=[],this.connectionError=!0})}shouldUpdate(e){const t=e.get("hass"),i=e.get("_config");if(t&&1==e.size&&!this.translationsLoaded&&(t.localize("ui.panel.config.automation.editor.actions.type.device_id.action")||(this.translationsLoaded=!0)),i&&this._config){Object.keys(i).filter(e=>i[e]!==this._config[e]).some(e=>["tags","discover_existing","sort_by","display_options"].includes(e))&&(async()=>{await this.loadSchedules()})()}return!t||1!=e.size||!this.schedules||this.schedules.some(e=>JSON.stringify(t.states[e.entity_id])!==JSON.stringify(this.hass.states[e.entity_id]))}setConfig(e){dt(e);const t=Object.assign(Object.assign({},Fe),e);this._config=t}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let s=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(s+=1);const a=((lt(this._config.display_options.secondary_info||[]).length||2)+1)/2;this.schedules&&(s+=this.showDiscovered?this.schedules.length*a:this.schedules.filter(e=>Oo(e,this._config)).length*a),clearInterval(i),e(Math.round(s))},50)})}render(){return this.hass&&this._config&&this.schedules?q`
      <ha-card>
    ...
    `:q``}renderRows(){if(!this._config||!this.hass||!this.schedules)return q``;if(this.connectionError)return q`
      ...
      `;const e=this.schedules.filter(e=>Oo(e,this._config)),t=this.schedules.filter(e=>!Oo(e,this._config));return q`
