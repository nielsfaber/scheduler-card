...
`;var ya="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",ba="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z";const wa={alarm_control_panel:"domains.alarm_control_panel",automation:"ui.dialogs.quick-bar.commands.navigation.automation",binary_sensor:"domains.binary_sensor",calendar:"panel.calendar",climate:"domains.climate",cover:"domains.cover",fan:"domains.fan",group:"domains.group",humidifier:"domains.humidifier",input_boolean:"domains.input_boolean",input_number:"domains.input_number",input_select:"domains.input_select",light:"domains.light",lock:"domains.lock",media_player:"domains.media_player",notify:"domains.notify",person:"ui.dialogs.quick-bar.commands.navigation.person",scene:"ui.dialogs.quick-bar.commands.navigation.scene",script:"ui.dialogs.quick-bar.commands.navigation.script",sensor:"ui.panel.config.devices.entities.sensor",sun:"ui.panel.config.automation.editor.conditions.type.sun.label",switch:"domains.switch",vacuum:"domains.vacuum",water_heater:"domains.water_heater"},ka=(e,t)=>{if(e in wa){const i=wa[e],s=i.startsWith("domains")?Es(i,it(t)):t.localize(i);if(s)return s}return e};function xa(e,t,i){let s=[];t.groups&&t.groups.forEach(t=>{e.find(e=>Qs(e,t))&&(s=[...s,{name:t.name,icon:t.icon||"folder-outline",entities:e.filter(e=>Qs(e,t))}])});const a=e.filter(e=>!s.some(t=>t.entities.includes(e)));return a.map(Ce).filter((e,t,i)=>i.indexOf(e)===t).forEach(e=>{s=[...s,{name:ka(e,i),icon:(void 0===t.standard_configuration||t.standard_configuration)&&e in ot?ot[e]:"folder-outline",entities:a.filter(t=>Qs(t,{include:[e],exclude:[]}))}]}),s}const $a={options:["on","off"]},ja={alarm_control_panel:{template:e=>{let t=["disarmed","triggered"];const i=wt(e,"supported_features")||0;return 2&i&&(t=[...t,"armed_away"]),1&i&&(t=[...t,"armed_home"]),4&i&&(t=[...t,"armed_night"]),16&i&&(t=[...t,"armed_custom_bypass"]),32&i&&(t=[...t,"armed_vacation"]),{options:t}}},binary_sensor:$a,climate:{options:"hvac_modes"},calendar:$a,cover:{options:["open","closed"]},device_tracker:{options:["home","not_home"]},fan:$a,humidifier:$a,input_boolean:$a,input_number:{min:"min",max:"max",unit:"unit_of_measurement",step:"step"},input_select:{options:"options"},light:$a,lock:{options:["locked","unlocked"]},number:{min:"min",max:"max",step:"step"},person:{template:(e,t)=>{const i=Object.keys(t.states).filter(e=>"zone"==Ce(e)).map(Me);return{options:[...new Set(["home","not_home",...i])]}}},proximity:{unit:"unit_of_measurement"},select:{options:"options"},sensor:{template:e=>e&&!isNaN(Number(e.state))?"%"==xt(e,"unit_of_measurement")?{min:0,max:100,unit:"%",step:1}:{unit:"unit_of_measurement"}:{}},sun:{options:["below_horizon","above_horizon"]},switch:$a,water_heater:{options:"operation_list"}},za=(e,t)=>Pe(Object.assign(Object.assign({},e),{state:t})),Oa=(e,t)=>{const i="closed"==t;switch(e.attributes.device_class){case"garage":return i?"mdi:garage":"mdi:garage-open";case"door":return i?"mdi:door-closed":"mdi:door-open";case"blind":return i?"mdi:blinds":"mdi:blinds-open";case"window":return i?"mdi:window-closed":"mdi:window-open";default:return i?"mdi:window-shutter":"mdi:window-shutter-open"}},Sa={alarm_control_panel:{disarmed:"mdi:lock-open-variant-outline",armed_away:"mdi:exit-run",armed_home:"mdi:home-outline",armed_night:"mdi:power-sleep",triggered:"mdi:alarm-light-outline"},binary_sensor:{on:za,off:za},calendar:{on:"mdi:flash",off:"mdi:flash-off"},climate:{off:"mdi:power-off",heat:"mdi:fire",cool:"mdi:snowflake",heat_cool:"mdi:thermometer",auto:"mdi:autorenew",dry:"mdi:water-percent",fan_only:"mdi:fan"},cover:{closed:Oa,open:Oa},device_tracker:{home:"mdi:home-outline",not_home:"mdi:exit-run"},fan:{on:"mdi:power",off:"mdi:power-off"},humidifier:{on:"mdi:power",off:"mdi:power-off"},input_boolean:{on:"mdi:flash",off:"mdi:flash-off"},light:{on:"mdi:lightbulb",off:"mdi:lightbulb-off"},lock:{unlocked:"mdi:lock-outline",locked:"mdi:lock-open-variant-outline"},person:(e,t,i)=>{const s={home:"mdi:home-outline",not_home:"mdi:exit-run"};return Object.keys(i.states).filter(e=>"zone"==Ce(e)).forEach(e=>{const t=Me(e),a=i.states[e].attributes.icon;a&&(s[t]=a)}),t in s?s[t]:"mdi:flash"},sensor:{unit:"attributes.unit_of_measurement"},sun:{below_horizon:"mdi:weather-sunny-off",above_horizon:"mdi:weather-sunny"},switch:{on:"mdi:flash",off:"mdi:flash-off"}},Ea=(e,t,i,s)=>{const a=Ce(e.entity_id);if(t||(t=e.state),a in Sa){if(t in Sa[a]){const s=Sa[a][t];return"string"==typeof s?s:s(e,t,i)}if("function"==typeof Sa[a])return Sa[a](e,t,i)}return s||"folder-outline"};function Aa(e,t){const i=Ce(e),s=t.states[e];if(!s)return null;if("group"==i){const i=t.states[e],s=kt(i,"entity_id");if(!s.length)return null;const o=s.map(e=>Aa(e,t));return o.every(Ge)?(a=o).length&&a.every(e=>e.type==a[0].type)?a[0].type==_t.List?Mt(...a):a[0].type==_t.Level?Ot(...a):null:null:null}var a;if(!Object.keys(ja).includes(i))return null;let o=$t(ja[i],s,t);if("options"in o&&Ge(o.options)){let e=[...o.options];return e=e.map(e=>Object.assign(e,{icon:e.icon?e.icon:Ea(s,e.value,t,"flash"),name:e.name?e.name:Ca(s,e.value,t)})),o=Object.assign(Object.assign({},o),{options:e}),e.length?Mt(o):null}return"min"in o&&Ge(o.min)&&"max"in o&&Ge(o.max)?Ot(o):Dt(o)}const Ca=(e,t,i)=>{const s=Ce(e.entity_id);return e.attributes.device_class&&i.localize(`component.${s}.state.${e.attributes.device_class}.${t}`)||i.localize(`component.${s}.state._.${t}`)||t};function Ma(e,t,i){let s=i.standard_configuration?Aa(e,t):null;const a=Object.entries(i.customize).filter(([t])=>rt(t,e)).sort((e,t)=>t[0].length-e[0].length).map(([,e])=>e.states).filter(Ge);return a.length&&a.forEach(e=>{s=Array.isArray(e)?Mt({options:e.map(e=>Object({value:e}))}):Ot(e)}),s}function Ta(e,t,i={filterActions:!0,filterStates:!1}){let s=Object.keys(e.states).filter(e=>Qs(e,t));return"notify"in e.services&&(s=[...s,...Object.keys(e.services.notify).map(e=>"notify."+e).filter(e=>Qs(e,t))]),i.filterActions&&i.filterStates?s=s.filter(i=>Js(i,e,t).length||Ma(i,e,t)):i.filterActions?s=s.filter(i=>Js(i,e,t).length):i.filterStates&&(s=s.filter(i=>Ma(i,e,t))),s}const Da=(e,t)=>{let i={entity_id:e,service:t.service,service_data:Object.assign({},t.service_data)};return Object.entries(t.variables||{}).forEach(([e,t])=>{Object.keys(i.service_data||{}).includes(e)||(t.type==_t.Level?(t=t,i=Object.assign(Object.assign({},i),{service_data:t.optional?Ye(i.service_data||{},e):Object.assign(Object.assign({},i.service_data),{[e]:parseFloat((t.min*t.scale_factor).toPrecision(12))||0})})):t.type==_t.List?(t=t,i=Object.assign(Object.assign({},i),{service_data:Object.assign(Object.assign({},i.service_data),{[e]:t.options.length?t.options[0].value:void 0})})):t.type==_t.Text&&(t=t,i=Object.assign(Object.assign({},i),{service_data:Object.assign(Object.assign({},i.service_data),{[e]:""})})))}),i},Na=(e,t,i,s)=>{if(!e)return null;const a=Xs(e,s);let o=i.find(e=>Us(e,a,!0));if(!o)return null;let n=t.map(e=>Da(e,o));return n=Object.keys(o.variables||{}).filter(t=>Object.keys(e.service_data||{}).includes(t)).reduce((t,i)=>{if(!t)return t;switch(o.variables[i].type){case _t.Level:const s=o.variables[i];let a=Number(e.service_data[i]);return a/=s.scale_factor,a=Math.round(a/s.step)*s.step,a=parseFloat(a.toPrecision(12)),a>s.max?a=s.max:a<s.min&&(a=s.min),a*=s.scale_factor,a=parseFloat(a.toFixed(2)),t.map(e=>Object.assign(e,{service_data:Object.assign(Object.assign({},e.service_data),{[i]:a})}));case _t.List:return o.variables[i].options.some(t=>t.value==e.service_data[i])?t.map(t=>Object.assign(t,{service_data:Object.assign(Object.assign({},t.service_data),{[i]:e.service_data[i]})})):null;case _t.Text:return t.map(t=>Object.assign(t,{service_data:Object.assign(Object.assign({},t.service_data),{[i]:e.service_data[i]})}));default:return t}},n),n};function La(e,t){return e.id||e.value||t}let Ia=class extends ee{constructor(){super(...arguments),this.items=[],this.value=null}render(){return this.items.length?this.items.map((e,t)=>this.renderButton(e,t)):N`
    ...
    `:N``}selectGroup(e){this.selectedGroup=e,this.entities=[],this.selectedAction=void 0}async selectEntity(e){const t=st("object"==typeof e?e.target.value:e);let i=this.selectedAction;if(i){const e=this.getActionsForEntity(t);i=e.find(e=>Us(e,i))}else i=void 0;if(this.schedule&&t.length&&(this.timeSchemeSelected||this.selectedAction)){const s=await this.migrateSchedule(t,this.timeSchemeSelected?null:i);if(!s)return this.selectedAction=null,"object"==typeof e&&e.stopPropagation(),void(this.shadowRoot.querySelector("#selectedEntity").value=this.entities);this.entities=t,this.selectedAction=i,this.dispatchEvent(new CustomEvent("change",{detail:s}))}else this.entities=t,this.selectedAction=i}async selectAction(e){const t=e.detail;if(this.schedule){const i=await this.migrateSchedule(this.entities,t);if(!i)return this.selectedAction=null,e.stopPropagation(),void(this.shadowRoot.querySelector("#selectedAction").value=null);this.dispatchEvent(new CustomEvent("change",{detail:i}))}this.selectedAction=t,this.timeSchemeSelected=!1}async selectTimeScheme(e){if(this.schedule){const t=await this.migrateSchedule(this.entities,null);if(!t)return void e.stopPropagation();this.dispatchEvent(new CustomEvent("change",{detail:t}))}this.selectedAction=null,this.timeSchemeSelected=!0}nextClick(){if(!this.hass||!this.config||!this.selectedAction&&!this.timeSchemeSelected)return;const e=1==st(this.config.tags).length?st(this.config.tags).slice(0,1):[];if(this.timeSchemeSelected)this.actions=Js(this.entities,this.hass,this.config),this.schedule={weekdays:["daily"],timeslots:Ra,repeat_type:pt.Repeat,tags:e};else{let t=Ue(oa(new Date,it(this.hass),Ee.twenty_four),this.hass);t=He(t,this.config.time_step,{wrapAround:!0}),this.actions=[this.selectedAction];const i={start:Ve(t),actions:this.entities.map(e=>Da(e,this.actions[0]))};this.schedule={weekdays:["daily"],timeslots:[i],repeat_type:pt.Repeat,tags:e}}this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule,entities:this.entities.map(e=>lt(e,this.hass,this.config)),actions:this.actions,tab:qe.Time}}))}migrateSchedule(e,t){let i=!0,s=function e(t){return null==t?t:t instanceof Array?t.reduce((t,i,s)=>(t[s]=e(i),t),[]):t instanceof Object?Object.keys(t).reduce((i,s)=>(i[s]=e(t[s]),i),{}):t}(this.schedule);const a=null!==t?[t]:Js(e,this.hass,this.config);if(this.timeSchemeSelected)if(null!==t){let t=Ue(oa(new Date,it(this.hass),Ee.twenty_four),this.hass);t=He(t,this.config.time_step,{wrapAround:!0});const o={start:Ve(t),actions:e.map(e=>Da(e,a[0]))};s=Object.assign(Object.assign({},s),{timeslots:[o]}),i=!1}else{const t=s.timeslots.map(e=>e.actions[0]),o=t.map(t=>Na(t,e,a,this.hass));i=t.every((e,t)=>null!==o[t]&&Us(e,o[t][0])),s=Object.assign(Object.assign({},s),{timeslots:s.timeslots.map((e,t)=>Object.assign(e,{actions:o[t]||[]}))})}else if(null!==t){const t=Na(s.timeslots[0].actions[0],e,a,this.hass)||e.map(e=>Da(e,a[0]));s=Object.assign(Object.assign({},s),{timeslots:[Object.assign(Object.assign({},s.timeslots[0]),{actions:t})]})}else s=Object.assign(Object.assign({},s),{timeslots:Ra}),i=!1;const o={schedule:s,actions:a,entities:e.map(e=>lt(e,this.hass,this.config))};return new Promise(e=>{if(i)e(o);else{const t={title:Es("ui.dialog.confirm_migrate.title",it(this.hass)),description:Es("ui.dialog.confirm_migrate.description",it(this.hass)),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{e(!1)},confirm:()=>{e(o)}};Te(this,"show-dialog",{dialogTag:"generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return qa})),dialogParams:t})}})}};Ua.styles=r`
    ${ga}
  `,t([ae()],Ua.prototype,"hass",void 0),t([ae()],Ua.prototype,"config",void 0),t([ae()],Ua.prototype,"selectedGroup",void 0),t([ae()],Ua.prototype,"selectedAction",void 0),t([ae()],Ua.prototype,"entities",void 0),t([ae()],Ua.prototype,"schedule",void 0),t([ae()],Ua.prototype,"multipleEntity",void 0),t([ae()],Ua.prototype,"scheduleEntities",void 0),t([ae()],Ua.prototype,"timeSchemeSelected",void 0),t([ae({type:Boolean})],Ua.prototype,"editItem",void 0),Ua=t([ie("scheduler-editor-entity")],Ua);const Va=(e,t,i,s={})=>{if(Be(e))return e;const a=Ue(e,i),o=i.states["sun.sun"],n=Ue(o.attributes.next_rising,i),r=Ue(o.attributes.next_setting,i);t||(t=Math.abs(a-n)<Math.abs(a-r)?ft.Sunrise:ft.Sunset);let l=a-(t==ft.Sunrise?Ue(o.attributes.next_rising,i):Ue(o.attributes.next_setting,i));return s.stepSize&&(l=He(l,s.stepSize,{maxHours:2})),`${t}${l>0?"+":"-"}${Ve(Math.abs(l))}`};let Ha=class extends ee{constructor(){super(...arguments),this.stepSize=10,this.relativeMode=!1,this.event=ft.Sunrise,this.maxOffset=2}get time(){return this._time>=0?this._time:Math.abs(this._time)}set time(e){const t=He(e,this.stepSize,{wrapAround:!this.relativeMode,maxHours:this.relativeMode?this.maxOffset:void 0}),i=t!=this._time&&Ge(this._time);this._time=t,i&&this.updateValue()}firstUpdated(){const e=Be(this.value);e?(this.relativeMode=!0,this.event=e.event==ft.Sunrise?ft.Sunrise:ft.Sunset,this.time="+"==e.sign?Ue(e.offset,this.hass):-Ue(e.offset,this.hass)):this.time=Ue(this.value,this.hass)}updateValue(){if(this.relativeMode){const e=this._time>=0?"+":"-",t=Ve(this.time);this.value=`${this.event}${e}${t}`}else this.value=Ve(this.time);const e=new CustomEvent("change");this.dispatchEvent(e)}getTimeParts(){const e=(this.relativeMode?Ve(this.time):oa(na(Ve(this.time)),it(this.hass))).split(/:|\ /);return e[0]=String(Number(e[0])),e}render(){const e=this.getTimeParts();return N`
  ...
  `,t([ae()],Ha.prototype,"hass",void 0),t([ae({type:Number})],Ha.prototype,"stepSize",void 0),t([ae()],Ha.prototype,"relativeMode",void 0),t([ae()],Ha.prototype,"event",void 0),t([ae()],Ha.prototype,"_time",void 0),Ha=t([ie("time-picker")],Ha);let Ba=class extends ee{constructor(){super(),this.slots=[],this.actions=[],this.stepSize=10,this.isDragging=!1,this.currentTime=0,this.rangeMin=0,this.rangeMax=86400,this.activeSlot=null,this.activeMarker=null,this.previousSlot=null,this.timer=0,this.timeout=0,this.zoomFactor=1,this.large=!1,this.handleResize=this.handleResize.bind(this)}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){window.addEventListener("resize",this.handleResize)}disconnectedCallback(){window.removeEventListener("resize",this.handleResize),clearInterval(this.timer),clearTimeout(this.timeout),super.disconnectedCallback&&super.disconnectedCallback()}render(){if(!this.hass)return N``;const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=86400/(this.rangeMax-this.rangeMin)*e,i=-this.rangeMin/(this.rangeMax-this.rangeMin)*e;return N`
    ...
    `}};t([ae()],Ba.prototype,"hass",void 0),t([ae({type:Array})],Ba.prototype,"slots",void 0),t([ae({type:Array})],Ba.prototype,"actions",void 0),t([ae({type:Number})],Ba.prototype,"stepSize",void 0),t([ae()],Ba.prototype,"rangeMin",void 0),t([ae()],Ba.prototype,"rangeMax",void 0),t([ae()],Ba.prototype,"activeSlot",void 0),t([ae()],Ba.prototype,"activeMarker",void 0),t([ae({type:Boolean})],Ba.prototype,"large",void 0),t([function(e){return ne({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
  ...
  `,t([ae()],Wa.prototype,"variable",void 0),t([ae()],Wa.prototype,"value",void 0),Wa=t([ie("scheduler-variable-picker")],Wa);let Za=class extends ee{constructor(){super(...arguments),this.activeEntry=null,this.activeMarker=null,this.timeslots=!1,this.editItem=!1,this.large=!1}firstUpdated(){if(!this.actions||!this.hass)return;this.timeslots||(this.activeEntry=0);const e=this.actions.map(e=>{const t=Object.assign(Object.assign({},e),{service_data:Ye(e.service_data||{},...Object.keys(e.variables||{}))});return Object.assign(e,{name:Ks(t)})});e.sort(Je),this.actions=e}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return this.hass&&this.config&&this.entities&&this.actions?N`
      <div class="content">
        <div class="header">
          ${this.hass.localize("ui.panel.config.automation.editor.actions.type.device_id.action")}
        </div>
    ...
    `}renderMarkerOptions(){if(!this.hass||!this.config||null===this.activeMarker)return;const e=this.schedule.timeslots[this.activeMarker].start,t=Be(e),i=Ue(e,this.hass)-Ue("sunrise+00:00",this.hass),s=Ue(e,this.hass)-Ue("sunset+00:00",this.hass),a=[{value:"time",name:this.hass.localize("ui.panel.config.automation.editor.triggers.type.time.at"),icon:"mdi:clock-outline"},{value:ft.Sunrise,name:this.hass.localize("ui.panel.config.automation.editor.conditions.type.sun.sunrise"),icon:"mdi:weather-sunny",disabled:Math.abs(i)>7200},{value:ft.Sunset,name:this.hass.localize("ui.panel.config.automation.editor.conditions.type.sun.sunset"),icon:"mdi:weather-night",disabled:Math.abs(s)>7200}];return N`
