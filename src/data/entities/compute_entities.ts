...
export function computeEntities(hass: HomeAssistant, config: CardConfig, options: { filterActions: boolean, filterStates: boolean } = { filterActions: true, filterStates: false }) {
