...
customElements.define('action-handler-scheduler', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-scheduler')) {
    return body.querySelector('action-handler-scheduler') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-scheduler');
